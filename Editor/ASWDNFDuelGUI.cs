...
public class ASWDNFDuelGUI : ShaderGUI
{
  ...
  private static class Styles
  {
      ...
      public static GUIContent patText = new GUIContent("PAT Texture", "[Character Indentifier]_PAT");
    ...
    EditorGUI.BeginChangeCheck();
    {
      ...
      if (ASWStyles.DoFoldout(foldouts, mat, me, "Texture Settings")){
        ASWStyles.PropertyGroup( () => {
          ...
          me.TexturePropertySingleLine(Styles.patText, _PAT);
        });
        ASWStyles.PropertyGroup( () => {
          if(_EditorVersion.floatValue == 1){
