...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Transparent v7.1.0"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float VertexR33_g1412 = i.vertexColor.r;
			...
			float temp_output_36_0_g1411 = ( ( dotResult46_g825 + _GlobalLightPush ) * i.vertexColor.r );
			...
			float temp_output_42_0_g1412 = max( max( ( 1.0 - ( VertexR33_g1412 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1412 < RealShadow2Push18_g1412 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
			float temp_output_43_0_g1412 = ( max( ( 1.0 - ( VertexR33_g1412 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1412 < RealShadow1Push16_g1412 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1412 >= RealShadow2Push18_g1412 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1412 );
			...
			float temp_output_6_0_g1434 = temp_output_94_0_g1412;
			float4 temp_cast_71 = (temp_output_6_0_g1434).xxxx;
			float4 blendOpSrc19_g1434 = Base12_g1434;
			float4 blendOpDest19_g1434 = temp_cast_71;
			float4 lerpBlendMode19_g1434 = lerp(blendOpDest19_g1434,min( blendOpSrc19_g1434 , blendOpDest19_g1434 ),0.9);
			float4 LightColor779 = _LightColor;
			float4 LightColor16_g1434 = LightColor779;
			float3 desaturateInitialColor9_g1440 = ( ( ( BaseA13_g1434 * ( saturate( lerpBlendMode19_g1434 )) ) + ( Base12_g1434 * temp_output_6_0_g1434 ) ) * LightColor16_g1434 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
			float desaturateDot9_g1440 = dot( desaturateInitialColor9_g1440, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1440 = lerp( desaturateInitialColor9_g1440, desaturateDot9_g1440.xxx, ( 1.0 - _HighlightRimlightSaturation ) );
			...
			float temp_output_29_0_g1434 = clampResult87_g1412;
			float4 temp_cast_73 = (temp_output_29_0_g1434).xxxx;
			float4 blendOpSrc30_g1434 = Base12_g1434;
			float4 blendOpDest30_g1434 = temp_cast_73;
			float4 lerpBlendMode30_g1434 = lerp(blendOpDest30_g1434,min( blendOpSrc30_g1434 , blendOpDest30_g1434 ),0.9);
			float3 desaturateInitialColor9_g1436 = ( ( ( BaseA13_g1434 * ( saturate( lerpBlendMode30_g1434 )) ) + ( Base12_g1434 * temp_output_29_0_g1434 ) ) * LightColor16_g1434 * _SpecularIntensity * _SpecularTint ).rgb;
			float desaturateDot9_g1436 = dot( desaturateInitialColor9_g1436, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1436 = lerp( desaturateInitialColor9_g1436, desaturateDot9_g1436.xxx, ( 1.0 - _SpecularSaturation ) );
			...
			float3 desaturateInitialColor9_g1438 = ( ( Base12_g1434 * clampResult90_g1412 ) * LightColor16_g1434 * _BaseIntensity * _BaseTint ).rgb;
			float desaturateDot9_g1438 = dot( desaturateInitialColor9_g1438, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1438 = lerp( desaturateInitialColor9_g1438, desaturateDot9_g1438.xxx, ( 1.0 - _BaseSaturation ) );
			float3 SSS578 = temp_output_995_0[1];
			float4 SSS14_g1434 = float4( SSS578 , 0.0 );
			float4 AmbientColor780 = _AmbientColor;
			float4 AmbientColor68_g1434 = AmbientColor780;
			float3 desaturateInitialColor9_g1435 = ( ( temp_output_43_0_g1412 * Base12_g1434 * SSS14_g1434 ) * AmbientColor68_g1434 * _Shadow1Intensity * _Shadow1Tint ).rgb;
			float desaturateDot9_g1435 = dot( desaturateInitialColor9_g1435, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1435 = lerp( desaturateInitialColor9_g1435, desaturateDot9_g1435.xxx, ( 1.0 - _Shadow1Saturation ) );
			...
			float4 blendOpSrc51_g1434 = float4( 0,0,0,0 );
			float4 blendOpDest51_g1434 = ( Base12_g1434 * SSS14_g1434 );
			float4 lerpBlendMode51_g1434 = lerp(blendOpDest51_g1434,2.0f*blendOpDest51_g1434*blendOpSrc51_g1434 + blendOpDest51_g1434*blendOpDest51_g1434*(1.0f - 2.0f*blendOpSrc51_g1434),0.5);
			float3 desaturateInitialColor9_g1437 = ( ( clampResult91_g1412 * ( saturate( lerpBlendMode51_g1434 )) ) * AmbientColor68_g1434 * _Shadow2Intensity * _Shadow2Tint ).rgb;
			float desaturateDot9_g1437 = dot( desaturateInitialColor9_g1437, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1437 = lerp( desaturateInitialColor9_g1437, desaturateDot9_g1437.xxx, ( 1.0 - _Shadow2Saturation ) );
			...
			float temp_output_60_0_g1434 = temp_output_96_0_g1412;
			float4 blendOpSrc56_g1434 = float4( 0,0,0,0 );
			float4 blendOpDest56_g1434 = ( Base12_g1434 * SSS14_g1434 );
			float4 lerpBlendMode56_g1434 = lerp(blendOpDest56_g1434,2.0f*blendOpDest56_g1434*blendOpSrc56_g1434 + blendOpDest56_g1434*blendOpDest56_g1434*(1.0f - 2.0f*blendOpSrc56_g1434),0.5);
			float4 temp_output_56_0_g1434 = ( saturate( lerpBlendMode56_g1434 ));
			float3 desaturateInitialColor9_g1439 = ( ( ( ( temp_output_60_0_g1434 * ( temp_output_56_0_g1434 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1434 * temp_output_56_0_g1434 ) ) * ILMR573 ) * AmbientColor68_g1434 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
			float desaturateDot9_g1439 = dot( desaturateInitialColor9_g1439, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1439 = lerp( desaturateInitialColor9_g1439, desaturateDot9_g1439.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
			float3 temp_output_787_0 = ( desaturateVar9_g1440 + desaturateVar9_g1436 + desaturateVar9_g1438 + desaturateVar9_g1435 + desaturateVar9_g1437 + desaturateVar9_g1439 );
			...
			float ifLocalVar13_g1421 = 0;
			if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1421 = 0.0;
			else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1421 = IsThereWorldLight450;
			float4 temp_cast_83 = (_MinimumGlobalLightIntensity).xxxx;
			float4 temp_cast_84 = (5.0).xxxx;
			float4 clampResult18_g1421 = clamp( ase_lightColor , temp_cast_83 , temp_cast_84 );
			float4 temp_output_11_0_g1421 = ( ase_lightAtten * clampResult18_g1421 );
			float4 temp_output_8_0_g1421 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
			float4 ifLocalVar3_g1421 = 0;
			if( ifLocalVar13_g1421 > 0.0 )
				ifLocalVar3_g1421 = temp_output_11_0_g1421;
			else if( ifLocalVar13_g1421 == 0.0 )
				ifLocalVar3_g1421 = temp_output_8_0_g1421;
			#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1421 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1421 );
			#else
				float4 staticSwitch9_g1421 = ifLocalVar3_g1421;
			#endif
			float4 GlobalLightColor944 = staticSwitch9_g1421;
			float temp_output_48_0_g1425 = _DebugGroup;
			float temp_output_47_0_g1425 = _VertexChannel;
			float4 temp_output_59_0_g1425 = _DebugColor;
			float temp_output_50_0_g1425 = _ILMChannel;
			float3 ILM988 = linearToGamma277;
			float4 appendResult984 = (float4(ILM988 , ILMA357));
			float4 temp_output_54_0_g1425 = appendResult984;
			float4 break7_g1425 = temp_output_54_0_g1425;
			float temp_output_57_0_g1425 = 0.0;
			float4 Debug987 = ( temp_output_48_0_g1425 == 0.0 ? ( temp_output_47_0_g1425 == 0.0 ? i.vertexColor : ( temp_output_47_0_g1425 == 1.0 ? ( i.vertexColor.r * temp_output_59_0_g1425 ) : ( temp_output_47_0_g1425 == 2.0 ? ( i.vertexColor.g * temp_output_59_0_g1425 ) : ( temp_output_47_0_g1425 == 3.0 ? ( i.vertexColor.b * temp_output_59_0_g1425 ) : ( temp_output_47_0_g1425 == 4.0 ? ( i.vertexColor.a * temp_output_59_0_g1425 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1425 == 1.0 ? ( temp_output_50_0_g1425 == 0.0 ? temp_output_54_0_g1425 : ( temp_output_50_0_g1425 == 1.0 ? ( break7_g1425.r * temp_output_59_0_g1425 ) : ( temp_output_50_0_g1425 == 2.0 ? ( break7_g1425.g * temp_output_59_0_g1425 ) : ( temp_output_50_0_g1425 == 3.0 ? ( break7_g1425.b * temp_output_59_0_g1425 ) : ( temp_output_50_0_g1425 == 4.0 ? ( break7_g1425.a * temp_output_59_0_g1425 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1425 == 2.0 ? ( temp_output_57_0_g1425 == 0.0 ? ( BaseA580 * temp_output_59_0_g1425 ) : ( temp_output_57_0_g1425 == 1.0 ? ( 0.0 * temp_output_59_0_g1425 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float temp_output_94_0_g1412 = ( EnableRimlight82_g1412 == 1.0 ? clampResult88_g1412 : 0.0 );
			float temp_output_6_0_g1434 = temp_output_94_0_g1412;
			float4 temp_cast_29 = (temp_output_6_0_g1434).xxxx;
			float4 blendOpSrc19_g1434 = Base12_g1434;
			float4 blendOpDest19_g1434 = temp_cast_29;
			float4 lerpBlendMode19_g1434 = lerp(blendOpDest19_g1434,min( blendOpSrc19_g1434 , blendOpDest19_g1434 ),0.9);
			float4 LightColor779 = _LightColor;
			float4 LightColor16_g1434 = LightColor779;
			float3 desaturateInitialColor9_g1440 = ( ( ( BaseA13_g1434 * ( saturate( lerpBlendMode19_g1434 )) ) + ( Base12_g1434 * temp_output_6_0_g1434 ) ) * LightColor16_g1434 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
			...
			float clampResult87_g1412 = clamp( temp_output_68_0_g1412 , 0.0 , 1.0 );
			float temp_output_29_0_g1434 = clampResult87_g1412;
			float4 temp_cast_31 = (temp_output_29_0_g1434).xxxx;
			float4 blendOpSrc30_g1434 = Base12_g1434;
			float4 blendOpDest30_g1434 = temp_cast_31;
			float4 lerpBlendMode30_g1434 = lerp(blendOpDest30_g1434,min( blendOpSrc30_g1434 , blendOpDest30_g1434 ),0.9);
			float3 desaturateInitialColor9_g1436 = ( ( ( BaseA13_g1434 * ( saturate( lerpBlendMode30_g1434 )) ) + ( Base12_g1434 * temp_output_29_0_g1434 ) ) * LightColor16_g1434 * _SpecularIntensity * _SpecularTint ).rgb;
			float desaturateDot9_g1436 = dot( desaturateInitialColor9_g1436, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1436 = lerp( desaturateInitialColor9_g1436, desaturateDot9_g1436.xxx, ( 1.0 - _SpecularSaturation ) );
			...
			float4 clampResult18_g1421 = clamp( ase_lightColor , temp_cast_39 , temp_cast_40 );
			float4 temp_output_8_0_g1421 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
			float4 ifLocalVar17_g1421 = 0;
			if( ifLocalVar13_g1421 > 0.0 )
				ifLocalVar17_g1421 = clampResult18_g1421;
			else if( ifLocalVar13_g1421 == 0.0 )
				ifLocalVar17_g1421 = temp_output_8_0_g1421;
			float4 EmissionLightColor947 = ifLocalVar17_g1421;
			float4 EmissionRampMask920 = ( ( ( temp_output_94_0_g1412 * _HighlightRimlightEmissiveToggle ) * _HighlightRimlightEmissionIntensity ) + ( ( clampResult87_g1412 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1412 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1412 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1412 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( temp_output_96_0_g1412 * _ShadowRimlightEmissiveToggle ) * _ShadowRimlightEmissionIntensity ) + ( ( 1.0 - ILMA357 ) * _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) + ( ( 1.0 - Detail807 ) * _BodyLinesEmissionToggle * _BodyLinesEmissionIntensity ) );
...
/*ASEBEGIN
Version=18900
-2405;253;2298;1017;-3080.01;-5447.552;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;296;-2981.91,2744.822;Inherit;True;Property;_Base;Base;3;0;Create;True;0;0;0;False;0;False;-1;None;72ec7e5fb8db9a64090e6520468b394a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;297;-2937.471,2998.025;Inherit;True;Property;_SSS;SSS;4;0;Create;True;0;0;0;False;0;False;-1;None;d05f33fe3f7841b4cb7a01edae8b45a6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;855;-2717.466,5074.572;Inherit;False;Property;_Source5Color;Source 5 Color;51;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;826;-2717.466,3730.571;Inherit;False;Property;_Source2Color;Source 2 Color;39;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2039209,0.1568621,0.1372542,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;848;-2717.466,4402.572;Inherit;False;Property;_Target3Color;Target 3 Color;45;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.3215679,0.4235287,0.6666667,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;847;-2717.466,4178.572;Inherit;False;Property;_Source3Color;Source 3 Color;43;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.882353,0.8705883,0.7960785,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;852;-2717.466,4850.572;Inherit;False;Property;_Target4Color;Target 4 Color;49;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.937255,0.854902,0.6352941,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;851;-2717.466,4626.572;Inherit;False;Property;_Source4Color;Source 4 Color;47;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2470581,0.1607836,0.1176463,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;828;-2717.466,3954.571;Inherit;False;Property;_Target2Color;Target 2 Color;41;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2235287,0.2196071,0.1921562,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;824;-2717.466,3506.571;Inherit;False;Property;_Target1Color;Target 1 Color;37;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;856;-2717.466,5298.572;Inherit;False;Property;_Target5Color;Target 5 Color;53;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;822;-2749.466,3282.571;Inherit;False;Property;_Source1Color;Source 1 Color;35;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1028;-1125.44,3079.229;Inherit;False;Property;_BodyLinesColor;Body Lines Color;111;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;806;-1710.088,3115.39;Inherit;True;Property;_Detail;Detail;6;0;Create;True;0;0;0;False;0;False;-1;None;8cb987a7392caec4abd0d57df4eb5d12;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;274;-1737.02,2839.592;Inherit;True;Property;_ILM;ILM;5;0;Create;True;0;0;0;False;0;False;-1;None;14b1df6194a85834b892e1b3693e6423;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;990;-646.1214,2771.983;Inherit;False;Property;_ILMAlphaColor;ILM Alpha Color;10;0;Create;True;0;0;0;True;0;False;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1026;-1141.44,3256.229;Inherit;False;Property;_DetailColorSetting;Detail Color Setting;8;1;[Enum];Create;True;0;3;Default Black;0;Shadow Priority;1;Detail Priority;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;533;1058.975,3071.652;Inherit;False;Property;_LightDirectionSetting;Light Direction Setting;19;1;[Enum];Create;True;0;2;Automatic RECOMMENDED;0;Forced Fake;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LinearToGammaNode;277;-1282.827,2862.071;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;535;1060.975,3242.652;Inherit;False;Property;_FallbackLightDirection;Fallback Light Direction;20;1;[Enum];Create;True;0;2;Fake Light Direction;0;View Direction;1;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;991;-637.4034,2957.74;Inherit;False;Property;_ILMColorSetting;ILM Color Setting;7;1;[Enum];Create;True;0;3;Default Black;0;Shadow Priority;1;ILM Priority;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;472;941.7625,4009.256;Inherit;False;Property;_ViewDirOffsetYaw;View Dir Offset Yaw;15;0;Create;True;0;0;0;False;0;False;0;0;-90;90;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;471;941.7625,3929.256;Inherit;False;Property;_ViewDirOffsetPitch;View Dir Offset Pitch;14;0;Create;True;0;0;0;False;0;False;0;0;-90;90;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;434;1021.762,3769.256;Inherit;False;Property;_FakeLightDirX;Fake Light Dir X;12;0;Create;True;0;0;0;False;0;False;35;35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;435;1021.762,3849.256;Inherit;False;Property;_FakeLightDirY;Fake Light Dir Y;13;0;Create;True;0;0;0;False;0;False;-135;-135;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;707;2295,4051;Inherit;False;Property;_GlobalLightPush;Global Light Push;21;0;Create;True;0;0;0;False;0;False;1;1;-1;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;777;-410.4719,4775.769;Inherit;False;Property;_LightColor;Light Color;22;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;778;-410.4719,4985.769;Inherit;False;Property;_AmbientColor;Ambient Color;23;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;716;2992,4160;Inherit;False;Property;_Shadow1VertexRThreshold;Shadow 1 VertexR Threshold;27;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;924;3040,4544;Inherit;False;Property;_BaseEmissiveToggle;Base Emissive Toggle;71;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;731;2992,4288;Inherit;False;Property;_Shadow2VertexRThreshold;Shadow 2 VertexR Threshold;29;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;711;3008,4096;Inherit;False;Property;_Shadow1Push;Shadow 1 Push;26;0;Create;True;0;0;0;False;0;False;0.5;0.5;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;927;2992,4736;Inherit;False;Property;_ShadowRimlightEmissiveToggle;Shadow Rimlight Emissive Toggle;85;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;925;3008,4608;Inherit;False;Property;_Shadow1EmissiveToggle;Shadow 1 Emissive Toggle;76;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;746;3008,4032;Inherit;False;Property;_SpecularSize;Specular Size;25;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;926;3008,4672;Inherit;False;Property;_Shadow2EmissiveToggle;Shadow 2 Emissive Toggle;81;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;922;2992,4416;Inherit;False;Property;_HighlightRimlightEmissiveToggle;Highlight Rimlight Emissive Toggle;60;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;727;3008,4224;Inherit;False;Property;_Shadow2Push;Shadow 2 Push;28;0;Create;True;0;0;0;False;0;False;0.2;0.3;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;732;2992,4352;Inherit;False;Property;_PermanentShadowThreshold;Permanent Shadow Threshold;30;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;923;3024,4480;Inherit;False;Property;_SpecularEmissiveToggle;Specular Emissive Toggle;65;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1094;3936,5888;Inherit;False;Property;_ShadowRimlightBaseColor;Shadow Rimlight Base Color;0;0;Create;True;0;0;0;False;0;False;0.2392157,0.2392157,0.5294118,0;0.2392157,0.2392157,0.5294118,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;867;-1410.6,5022.889;Inherit;False;Property;_FakeGlobalLightColor;Fake Global Light Color;9;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;869;-1418.869,5197.192;Inherit;False;Property;_FakeGlobalLightIntensity;Fake Global Light Intensity;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;950;-1420.3,5278.388;Inherit;False;Property;_MinimumGlobalLightIntensity;Minimum Global Light Intensity;17;0;Create;True;0;0;0;False;0;False;0.4;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;968;3587.3,2900.72;Inherit;False;Property;_ILMAlphaLinesEmissionToggle;ILM Alpha Lines Emission Toggle;102;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;960;-1099.532,4903.766;Inherit;False;Light Color Calculation;-1;;1421;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;6;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.RangedFloatNode;1045;3597.194,3052.232;Inherit;False;Property;_BodyLinesEmissionToggle;Body Lines Emission Toggle;99;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;980;-241.5962,5906.203;Inherit;False;Property;_DebugGroup;Debug Group;106;1;[Enum];Create;True;0;3;Vertex Colors;0;ILM Channels;1;Base Alpha;2;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;981;-289.1011,6238.182;Inherit;False;Property;_ILMChannel;ILM Channel;109;1;[Enum];Create;True;0;5;All Channels;0;Red;1;Green;2;Blue;3;Alpha;4;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;983;-269.101,6154.182;Inherit;False;Property;_VertexChannel;Vertex Channel;56;1;[Enum];Create;True;0;5;All Channels;0;Red;1;Green;2;Blue;3;Alpha;4;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1001;6510.002,3882.956;Inherit;False;357;ILMA;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;967;3584.651,2969.63;Inherit;False;Property;_ILMAlphaEmissionIntensity;ILM Alpha Emission Intensity;97;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;986;175.4907,6202.33;Inherit;False;Debug;-1;;1425;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1042;4154.673,3311.612;Inherit;False;Emission - FighterZ;-1;;1424;2e32fe20ddeddef43b8b5dae014cc006;0;18;17;FLOAT;0;False;25;COLOR;0,0,0,0;False;24;FLOAT;0;False;20;FLOAT;0;False;26;FLOAT;0;False;27;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;22;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;21;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;933;7737.247,3247.347;Inherit;False;Property;_EmissionIntensity;Emission Intensity;24;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1011;7740,3807.01;Inherit;False;Property;_EnableDebug;Enable Debug;92;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1086;1812.631,3164.83;Inherit;False;Property;_FailFront;Fail Front;103;1;[Enum];Create;True;0;9;Default;0;Keep;1;Zero;2;Replace;3;IncrSat;4;DecrSat;5;Invert;6;IncrWrap;7;DecrWrap;8;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1081;1812.631,3228.83;Inherit;False;Property;_ZFailFront;ZFail Front;104;1;[Enum];Create;True;0;9;Default;0;Keep;1;Zero;2;Replace;3;IncrSat;4;DecrSat;5;Invert;6;IncrWrap;7;DecrWrap;8;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1090;1812.631,3036.83;Inherit;False;Property;_Comparison;Comparison;100;1;[Enum];Create;True;0;9;Default;0;Greater;1;Greater or Equal;2;Less;3;Less or Equal;4;Equal;5;Not Equal;6;Always;7;Never;8;1;UnityEngine.Rendering.CompareFunction;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1083;1813.631,2972.83;Inherit;False;Property;_WriteMask;Write Mask;98;1;[IntRange];Create;True;0;0;0;True;0;False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;904;6827.561,4754.573;Inherit;False;339;Base;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1089;2196.631,3052.83;Inherit;False;Property;_Units;Units;110;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1082;1812.631,3100.83;Inherit;False;Property;_PassFront;Pass Front;101;1;[Enum];Create;True;0;9;Default;0;Keep;1;Zero;2;Replace;3;IncrSat;4;DecrSat;5;Invert;6;IncrWrap;7;DecrWrap;8;1;UnityEngine.Rendering.StencilOp;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;909;6799.561,4442.573;Inherit;False;Property;_OutlineColor;Outline Color;89;0;Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1091;2196.631,2860.83;Inherit;False;Property;_ZWriteMode;ZWrite Mode;107;1;[Enum];Create;True;0;2;Off;0;On;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1084;1812.631,2908.83;Inherit;False;Property;_ReadMask;Read Mask;96;1;[IntRange];Create;True;0;0;0;True;0;False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1085;2196.631,2924.83;Inherit;False;Property;_ZTestMode;ZTest Mode;105;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;911;6721.561,4287.573;Inherit;False;Property;_EnableCameraDistanceMult;Enable Camera Distance Mult;88;1;[ToggleUI];Create;True;0;2;Disable;0;Enable;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1088;1812.631,2844.83;Inherit;False;Property;_Reference;Reference;95;1;[IntRange];Create;True;0;0;0;True;0;False;0;0;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;907;6723.561,4682.573;Inherit;False;Property;_OutlineEnableBaseColorMult;Outline Enable Base Color Mult;91;1;[ToggleUI];Create;True;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;908;6761.561,4607.573;Inherit;False;Property;_OutlineColorIntensity;Outline Color Intensity;90;0;Create;True;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;989;1494.345,2683.989;Inherit;False;Property;_EditorVersion;Editor Version;2;1;[Enum];Create;True;0;2;Basic;0;Advanced;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1057;7155.288,4375.559;Inherit;False;ASWOutline;-1;;1426;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
Node;AmplifyShaderEditor.RangedFloatNode;1087;2196.631,2988.83;Inherit;False;Property;_Factor;Factor;108;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;910;6833.561,4351.573;Inherit;False;Property;_DepthOffset;Depth Offset;16;0;Create;True;0;0;0;True;0;False;1;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;912;6801.561,4223.573;Inherit;False;Property;_OutlineThickness;Outline Thickness;87;0;Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1056;7238.736,4246.586;Inherit;False;Property;_EnableOutline;Enable Outline;86;1;[ToggleUI];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1073;8195.238,3800.795;Inherit;False;1072;myVarName;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1078;8132.021,3705.243;Inherit;False;Property;_Opacity;Opacity;112;0;Create;True;0;0;0;True;0;False;1;0.383;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;266;8477.993,3602.784;Float;False;True;-1;2;ASWFighterZGUI;0;0;CustomLighting;.Aerthas/Arc System Works/Game Select/FighterZ/Transparent v7.1.0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;1;True;1091;1;True;1085;True;0;True;1087;0;True;1089;False;0;Custom;0.5;True;True;0;True;Transparent;;AlphaTest;ForwardOnly;14;all;True;True;True;True;0;False;-1;True;0;True;1088;255;True;1084;255;True;1083;0;True;1090;0;True;1082;0;True;1086;0;True;1081;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1093;6;918;76
WireConnection;1093;29;918;69
WireConnection;1093;39;918;62
WireConnection;1093;41;918;0
WireConnection;1093;50;918;44
WireConnection;1093;60;918;54
WireConnection;1093;7;767;0
WireConnection;1093;8;768;0
WireConnection;1093;9;793;0
WireConnection;1093;64;804;0
WireConnection;1093;11;859;0
WireConnection;1093;67;860;0
WireConnection;1093;75;880;0
WireConnection;1093;76;881;0
WireConnection;1093;78;882;0
WireConnection;1093;81;885;0
WireConnection;1093;80;884;0
WireConnection;1093;79;883;0
WireConnection;1093;83;887;0
WireConnection;1093;82;888;0
WireConnection;1093;84;889;0
WireConnection;1093;85;894;0
WireConnection;1093;86;893;0
WireConnection;1093;87;892;0
WireConnection;1093;89;896;0
WireConnection;1093;88;897;0
WireConnection;1093;90;898;0
WireConnection;1093;94;1094;0
WireConnection;1093;91;877;0
WireConnection;1093;92;878;0
WireConnection;1093;93;879;0
WireConnection;787;0;1093;1
WireConnection;787;1;1093;0
WireConnection;787;2;1093;3
WireConnection;787;3;1093;2
WireConnection;787;4;1093;5
WireConnection;787;5;1093;4
...
WireConnection;266;9;1078;0
WireConnection;266;13;1016;0
ASEEND*/
//CHKSM=C65902F0BB935BFD13C61C392DE75B849396E53F