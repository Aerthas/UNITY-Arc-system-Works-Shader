...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Transparent v8.1.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1393_g827(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0394_g827(  )
			{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float3 localViewMatrix1393_g827 = ViewMatrix1393_g827();
				float3 normalizeResult396_g827 = normalize( localViewMatrix1393_g827 );
				float temp_output_395_0_g827 = radians( -_ViewDirOffsetYaw );
				float3 localViewMatrix0394_g827 = ViewMatrix0394_g827();
				float3 normalizeResult399_g827 = normalize( localViewMatrix0394_g827 );
				float3 rotatedValue400_g827 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult399_g827, normalizeResult396_g827, temp_output_395_0_g827 );
				float3 temp_output_408_0_g827 = ( ase_worldPos - i.ase_texcoord4.xyz );
				float3 localStereoCameraViewPosition30_g825 = StereoCameraViewPosition30_g825();
				float3 rotatedValue401_g827 = RotateAroundAxis( temp_output_408_0_g827, localStereoCameraViewPosition30_g825, normalizeResult396_g827, temp_output_395_0_g827 );
				float3 rotatedValue403_g827 = RotateAroundAxis( temp_output_408_0_g827, rotatedValue401_g827, rotatedValue400_g827, radians( _ViewDirOffsetPitch ) );
				float3 normalizeResult38_g825 = normalize( ( rotatedValue403_g827 - temp_output_408_0_g827 ) );
...
/*ASEBEGIN
Version=18900
2975;274;1355;932;-3431.63;-2642.772;1;True;True
...
ASEEND*/
//CHKSM=ED8D67E357A3269E5E2BA5BC9D7547FC59F8FC5F