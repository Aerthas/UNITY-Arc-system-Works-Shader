...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Transparent v8.1.3"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float NdV48_g1412 = ( ( 1.0 - ( dotResult31_g825 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1466 - blendOpDest15_g1466 ) )) ) );
				...
				float NdL20_g1412 = temp_output_1139_0;
				...
				float temp_output_68_0_g1412 = ( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1466) / max( blendOpSrc34_g1466, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) * temp_output_61_0_g1412 );
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1465 = _OutlineThickness;
				float3 temp_output_135_0_g1465 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1465 ) + temp_output_33_0_g1465 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1465 = ObjSpaceViewDir( float4( temp_output_135_0_g1465 , 0.0 ) );
				float4 normalizeResult142_g1465 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1465 , 0.0 ) - v.vertex ) );
				float clampResult141_g1465 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1465 = lerp( float4( temp_output_135_0_g1465 , 0.0 ) , -normalizeResult142_g1465 , ( 1.0 - clampResult141_g1465 ));
				
				o.ase_texcoord.xy = v.ase_texcoord.xy;
				o.ase_texcoord.zw = v.ase_texcoord1.xy;

				v.vertex.xyz += lerpResult145_g1465.xyz;
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1020 = lerp( ILMAColor992 , temp_output_1031_0 , ILMA357);
				float4 Base339 = ( _ILMColorSetting == 1.0 ? lerpResult1020 : ( ILMA357 * temp_output_1031_0 ) );
				float4 temp_output_13_0_g1465 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1465 * temp_output_13_0_g1465 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
2793;227;2049;932;-1863.846;-3384.15;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1057;7155.288,4375.559;Inherit;False;ASWOutline;-1;;1465;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1096;9809.348,4328.438;Float;False;True;-1;2;ASWFighterZGUI;100;8;.Aerthas/Arc System Works/Game Select/FighterZ/Transparent v8.1.3;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1088;255;True;1084;255;True;1083;7;True;1090;1;True;1082;1;True;1086;1;True;1081;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1091;True;3;True;1085;True;True;0;True;1087;0;True;1089;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;True;False;;False;0
...
ASEEND*/
//CHKSM=420E569C2CBD4167217AE5A040272DE6DD61656E