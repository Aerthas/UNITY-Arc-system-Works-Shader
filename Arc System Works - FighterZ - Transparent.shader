...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Transparent v8.1.4"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 Base12_g1470 = Base339;
				float EnableRimlight82_g1467 = _EnableRimlight;
				...
				float blendOpSrc15_g1466 = SSSA581;
				float blendOpDest15_g1466 = BaseA580;
				float NdV48_g1467 = ( ( 1.0 - ( dotResult31_g825 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1466 - blendOpDest15_g1466 ) )) ) );
				float VertexR33_g1467 = i.ase_color.r;
				...
				float temp_output_36_0_g1466 = ( ( dotResult46_g825 + _GlobalLightPush ) * i.ase_color.r );
				...
				float temp_output_1_0_g1466 = ILMG574;
				float temp_output_1139_0 = ( ( temp_output_36_0_g1466 * 0.5 ) + ( ( temp_output_1_0_g1466 * 2.0 ) - 1.0 ) );
				float NdL20_g1467 = temp_output_1139_0;
				float temp_output_2_0_g1468 = NdL20_g1467;
				float temp_output_3_0_g1468 = -_Shadow1Smoothness;
				float temp_output_9_0_g1467 = _Shadow1Push;
				float temp_output_11_0_g1467 = _Shadow2Push;
				float clampResult15_g1467 = clamp( temp_output_9_0_g1467 , temp_output_11_0_g1467 , temp_output_9_0_g1467 );
				float RealShadow1Push16_g1467 = clampResult15_g1467;
				float temp_output_1_0_g1468 = RealShadow1Push16_g1467;
				float smoothstepResult6_g1468 = smoothstep( ( ( temp_output_2_0_g1468 / 1.0 ) + temp_output_3_0_g1468 ) , temp_output_2_0_g1468 , temp_output_1_0_g1468);
				float lerpResult7_g1468 = lerp( smoothstepResult6_g1468 , ( temp_output_1_0_g1468 >= temp_output_2_0_g1468 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1468 ? 1.0 : 0.0 ));
				float clampResult17_g1467 = clamp( temp_output_11_0_g1467 , temp_output_11_0_g1467 , temp_output_9_0_g1467 );
				float RealShadow2Push18_g1467 = clampResult17_g1467;
				float temp_output_2_0_g1469 = NdL20_g1467;
				float temp_output_3_0_g1469 = -_Shadow2Smoothness;
				float temp_output_1_0_g1469 = RealShadow2Push18_g1467;
				float smoothstepResult6_g1469 = smoothstep( ( ( temp_output_2_0_g1469 / 1.0 ) + temp_output_3_0_g1469 ) , temp_output_2_0_g1469 , temp_output_1_0_g1469);
				float lerpResult7_g1469 = lerp( smoothstepResult6_g1469 , ( temp_output_1_0_g1469 >= temp_output_2_0_g1469 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1469 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1467 = max( max( ( 1.0 - ( VertexR33_g1467 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1469 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1467 = ( max( ( 1.0 - ( VertexR33_g1467 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1468 , ( RealShadow1Push16_g1467 >= RealShadow2Push18_g1467 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1467 );
				float temp_output_61_0_g1467 = ( 1.0 - ( temp_output_43_0_g1467 + temp_output_42_0_g1467 ) );
				float temp_output_75_0_g1467 = ceil( ( ( ( NdV48_g1467 * BaseA580 ) > 0.0 ? 1.0 : 0.0 ) * temp_output_61_0_g1467 ) );
				float clampResult88_g1467 = clamp( temp_output_75_0_g1467 , 0.0 , 1.0 );
				float temp_output_94_0_g1467 = ( EnableRimlight82_g1467 == 1.0 ? clampResult88_g1467 : 0.0 );
				float temp_output_6_0_g1470 = temp_output_94_0_g1467;
				float4 temp_cast_31 = (temp_output_6_0_g1470).xxxx;
				float4 blendOpSrc19_g1470 = Base12_g1470;
				float4 blendOpDest19_g1470 = temp_cast_31;
				float4 lerpBlendMode19_g1470 = lerp(blendOpDest19_g1470,min( blendOpSrc19_g1470 , blendOpDest19_g1470 ),0.9);
				float4 LightColor779 = _LightColor;
				float4 LightColor16_g1470 = LightColor779;
				float3 desaturateInitialColor9_g1471 = ( ( ( BaseA13_g1470 * ( saturate( lerpBlendMode19_g1470 )) ) + ( Base12_g1470 * temp_output_6_0_g1470 ) ) * LightColor16_g1470 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
				float desaturateDot9_g1471 = dot( desaturateInitialColor9_g1471, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1471 = lerp( desaturateInitialColor9_g1471, desaturateDot9_g1471.xxx, ( 1.0 - _HighlightRimlightSaturation ) );
				...
				float blendOpSrc34_g1466 = ILMB576;
				float blendOpDest34_g1466 = dotResult50_g825;
				float temp_output_68_0_g1467 = ( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1466) / max( blendOpSrc34_g1466, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) * temp_output_61_0_g1467 );
				float clampResult87_g1467 = clamp( temp_output_68_0_g1467 , 0.0 , 1.0 );
				float temp_output_29_0_g1470 = clampResult87_g1467;
				float4 temp_cast_33 = (temp_output_29_0_g1470).xxxx;
				float4 blendOpSrc30_g1470 = Base12_g1470;
				float4 blendOpDest30_g1470 = temp_cast_33;
				float4 lerpBlendMode30_g1470 = lerp(blendOpDest30_g1470,min( blendOpSrc30_g1470 , blendOpDest30_g1470 ),0.9);
				float3 desaturateInitialColor9_g1474 = ( ( ( BaseA13_g1470 * ( saturate( lerpBlendMode30_g1470 )) ) + ( Base12_g1470 * temp_output_29_0_g1470 ) ) * LightColor16_g1470 * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1474 = dot( desaturateInitialColor9_g1474, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1474 = lerp( desaturateInitialColor9_g1474, desaturateDot9_g1474.xxx, ( 1.0 - _SpecularSaturation ) );
				float temp_output_77_0_g1467 = ( temp_output_61_0_g1467 - temp_output_68_0_g1467 );
				float clampResult90_g1467 = clamp( ( EnableRimlight82_g1467 == 1.0 ? ( temp_output_77_0_g1467 - temp_output_75_0_g1467 ) : temp_output_77_0_g1467 ) , 0.0 , 1.0 );
				float3 desaturateInitialColor9_g1476 = ( ( Base12_g1470 * clampResult90_g1467 ) * LightColor16_g1470 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1476 = dot( desaturateInitialColor9_g1476, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1476 = lerp( desaturateInitialColor9_g1476, desaturateDot9_g1476.xxx, ( 1.0 - _BaseSaturation ) );
				float3 SSS578 = temp_output_995_0[1];
				float4 SSS14_g1470 = float4( SSS578 , 0.0 );
				float4 AmbientColor780 = _AmbientColor;
				float4 AmbientColor68_g1470 = AmbientColor780;
				float3 desaturateInitialColor9_g1475 = ( ( temp_output_43_0_g1467 * Base12_g1470 * SSS14_g1470 ) * AmbientColor68_g1470 * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1475 = dot( desaturateInitialColor9_g1475, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1475 = lerp( desaturateInitialColor9_g1475, desaturateDot9_g1475.xxx, ( 1.0 - _Shadow1Saturation ) );
				float ILMR573 = break292.x;
				float temp_output_53_0_g1467 = ceil( ( ( ( temp_output_42_0_g1467 * NdV48_g1467 ) > 0.1 ? 1.0 : 0.0 ) * ILMR573 ) );
				float clampResult91_g1467 = clamp( ( EnableRimlight82_g1467 == 1.0 ? ( temp_output_42_0_g1467 - temp_output_53_0_g1467 ) : temp_output_42_0_g1467 ) , 0.0 , 1.0 );
				float4 blendOpSrc51_g1470 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1470 = ( Base12_g1470 * SSS14_g1470 );
				float4 lerpBlendMode51_g1470 = lerp(blendOpDest51_g1470,2.0f*blendOpDest51_g1470*blendOpSrc51_g1470 + blendOpDest51_g1470*blendOpDest51_g1470*(1.0f - 2.0f*blendOpSrc51_g1470),0.5);
				float3 desaturateInitialColor9_g1473 = ( ( clampResult91_g1467 * ( saturate( lerpBlendMode51_g1470 )) ) * AmbientColor68_g1470 * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1473 = dot( desaturateInitialColor9_g1473, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1473 = lerp( desaturateInitialColor9_g1473, desaturateDot9_g1473.xxx, ( 1.0 - _Shadow2Saturation ) );
				float clampResult92_g1467 = clamp( temp_output_53_0_g1467 , 0.0 , 1.0 );
				float temp_output_96_0_g1467 = ( EnableRimlight82_g1467 == 1.0 ? clampResult92_g1467 : 0.0 );
				float temp_output_60_0_g1470 = temp_output_96_0_g1467;
				float4 blendOpSrc56_g1470 = float4( 0,0,0,0 );
				float4 blendOpDest56_g1470 = ( Base12_g1470 * SSS14_g1470 );
				float4 lerpBlendMode56_g1470 = lerp(blendOpDest56_g1470,2.0f*blendOpDest56_g1470*blendOpSrc56_g1470 + blendOpDest56_g1470*blendOpDest56_g1470*(1.0f - 2.0f*blendOpSrc56_g1470),0.5);
				float4 temp_output_56_0_g1470 = ( saturate( lerpBlendMode56_g1470 ));
				float3 desaturateInitialColor9_g1472 = ( ( ( ( temp_output_60_0_g1470 * ( temp_output_56_0_g1470 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1470 * temp_output_56_0_g1470 ) ) * ILMR573 ) * AmbientColor68_g1470 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
				float desaturateDot9_g1472 = dot( desaturateInitialColor9_g1472, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1472 = lerp( desaturateInitialColor9_g1472, desaturateDot9_g1472.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
				float3 temp_output_787_0 = ( desaturateVar9_g1471 + desaturateVar9_g1474 + desaturateVar9_g1476 + desaturateVar9_g1475 + desaturateVar9_g1473 + desaturateVar9_g1472 );
				...
				float ifLocalVar13_g1478 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1478 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1478 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_43 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_44 = (5.0).xxxx;
				float4 clampResult18_g1478 = clamp( ase_lightColor , temp_cast_43 , temp_cast_44 );
				float4 temp_output_11_0_g1478 = ( ase_atten * clampResult18_g1478 );
				float4 temp_output_8_0_g1478 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1478 = 0;
				if( ifLocalVar13_g1478 > 0.0 )
				ifLocalVar3_g1478 = temp_output_11_0_g1478;
				else if( ifLocalVar13_g1478 == 0.0 )
				ifLocalVar3_g1478 = temp_output_8_0_g1478;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1478 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1478 );
				#else
				float4 staticSwitch9_g1478 = ifLocalVar3_g1478;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1478;
				...
				float4 EmissionRampMask920 = max( ( ( ( temp_output_94_0_g1467 * _HighlightRimlightEmissiveToggle ) * _HighlightRimlightEmissionIntensity ) + ( ( clampResult87_g1467 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1467 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1467 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1467 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( temp_output_96_0_g1467 * _ShadowRimlightEmissiveToggle ) * _ShadowRimlightEmissionIntensity ) + ( ( 1.0 - ILMA357 ) * _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) + ( ( 1.0 - Detail807 ) * _BodyLinesEmissionToggle * _BodyLinesEmissionIntensity ) ) , temp_cast_47 );
				float4 temp_cast_49 = (EmissionRampMask920.r).xxxx;
				float4 ifLocalVar17_g1478 = 0;
				if( ifLocalVar13_g1478 > 0.0 )
				ifLocalVar17_g1478 = clampResult18_g1478;
				else if( ifLocalVar13_g1478 == 0.0 )
				ifLocalVar17_g1478 = temp_output_8_0_g1478;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1478 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1478 = max( temp_cast_49 , ifLocalVar17_g1478 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1478;
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1481 = _OutlineThickness;
				float3 temp_output_135_0_g1481 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1481 ) + temp_output_33_0_g1481 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1481 = ObjSpaceViewDir( float4( temp_output_135_0_g1481 , 0.0 ) );
				float4 normalizeResult142_g1481 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1481 , 0.0 ) - v.vertex ) );
				float clampResult141_g1481 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1481 = lerp( float4( temp_output_135_0_g1481 , 0.0 ) , -normalizeResult142_g1481 , ( 1.0 - clampResult141_g1481 ));
				
				o.ase_texcoord.xy = v.ase_texcoord.xy;
				o.ase_texcoord.zw = v.ase_texcoord1.xy;

				v.vertex.xyz += lerpResult145_g1481.xyz;
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1020 = lerp( ILMAColor992 , temp_output_1031_0 , ILMA357);
				float4 Base339 = ( _ILMColorSetting == 1.0 ? lerpResult1020 : ( ILMA357 * temp_output_1031_0 ) );
				float4 temp_output_13_0_g1481 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1481 * temp_output_13_0_g1481 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
2961;197;2049;932;3549.344;-2365.372;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;296;-2981.91,2744.822;Inherit;True;Property;_MainTex;MainTex;2;0;Create;True;0;0;0;False;0;False;-1;None;f527e23ef6fd0e645a3818a274d691fe;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;824;-2717.466,3506.571;Inherit;False;Property;_Target1Color;Target 1 Color;36;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.4039214,0.8078432,0.8666667,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;847;-2717.466,4178.572;Inherit;False;Property;_Source3Color;Source 3 Color;42;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2588233,0.4627448,0.07450969,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1042;4190.513,3288.804;Inherit;False;Emission - FighterZ;-1;;1477;2e32fe20ddeddef43b8b5dae014cc006;0;20;32;FLOAT;0;False;31;FLOAT;0;False;17;FLOAT;0;False;25;COLOR;0,0,0,0;False;24;FLOAT;0;False;20;FLOAT;0;False;26;FLOAT;0;False;27;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;22;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;21;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;960;-1099.532,4903.766;Inherit;False;Light Color Calculation;-1;;1478;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.RangedFloatNode;983;-269.101,6154.182;Inherit;False;Property;_VertexChannel;Vertex Channel;55;1;[Enum];Create;True;0;5;All Channels;0;Red;1;Green;2;Blue;3;Alpha;4;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;981;-289.1011,6238.182;Inherit;False;Property;_ILMChannel;ILM Channel;108;1;[Enum];Create;True;0;5;All Channels;0;Red;1;Green;2;Blue;3;Alpha;4;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1057;7155.288,4375.559;Inherit;False;ASWOutline;-1;;1481;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.FunctionNode;1129;9351.978,4618.632;Inherit;False;Smooth Greater or Equal;-1;;1480;b31d4560fccb5364a9448cb3ee46edb5;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
WireConnection;1139;5;637;0
WireConnection;1139;21;637;42
WireConnection;1139;6;637;52
WireConnection;1139;3;639;0
WireConnection;1139;4;640;0
WireConnection;1139;1;706;0
WireConnection;1139;2;629;0
WireConnection;1139;11;707;0
WireConnection;1139;10;641;0
WireConnection;339;0;1022;0
WireConnection;578;0;587;0
WireConnection;1136;1;1139;0
WireConnection;1136;3;1139;8
WireConnection;1136;2;1139;9
...
ASEEND*/
//CHKSM=794306C3D8514EAA1D09EB1F3690F93AAEB01CF9