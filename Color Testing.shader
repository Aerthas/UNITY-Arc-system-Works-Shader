...
Shader ".Aerthas/Arc System Works/Color Testing"
{
	Properties
	{
		...
		[Toggle]_ShowILMBlue("Show ILM Blue", Float) = 1
		...
		[Toggle]_ShowBaseAlpha("Show Base Alpha", Float) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_output_28_0 = ( (( _ShowVertexRed )?( ( break64.x * _VertexRed ) ):( float4( 0,0,0,0 ) )) + (( _ShowVertexGreen )?( ( break64.y * _VertexGreen ) ):( float4( 0,0,0,0 ) )) + (( _ShowVertexBlue )?( ( break64.z * _VertexBlue ) ):( float4( 0,0,0,0 ) )) + (( _ShowVertexAlpha )?( ( break64.w * _VertexAlpha ) ):( float4( 0,0,0,0 ) )) );
			...
			c.rgb = ( (( _NegateVertexColors )?( ( 1.0 - temp_output_28_0 ) ):( temp_output_28_0 )) + (( _NegateILMColors )?( ( 1.0 - temp_output_52_0 ) ):( temp_output_52_0 )) + (( _NegateSSSColors )?( ( 1.0 - temp_output_78_0 ) ):( temp_output_78_0 )) + (( _NegateBaseColors )?( ( 1.0 - temp_output_94_0 ) ):( temp_output_94_0 )) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
-1342;83;1187;718;95.55133;-925.5964;1.554107;True;True
...
Node;AmplifyShaderEditor.ColorNode;65;-1070.87,2734.164;Inherit;False;Property;_SSSAlpha;SSS Alpha;29;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;69;-1101.67,2480.756;Inherit;False;Property;_SSSBlue;SSS Blue;27;0;Create;True;0;0;False;0;0,0,1,0;0,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;42;-1479.882,721.5238;Inherit;True;Property;_ILM;ILM;10;0;Create;True;0;0;False;0;-1;None;04dadffc0a4f655418fc7102cdea9497;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;82;-1210.195,3513.925;Inherit;False;Property;_BaseGreen;Base Green;37;0;Create;True;0;0;False;0;0,1,0,0;0,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;84;-1221.954,3306.792;Inherit;False;Property;_BaseRed;Base Red;33;0;Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;85;-1618.161,3161.519;Inherit;True;Property;_Base;Base;30;0;Create;True;0;0;False;0;-1;None;a6c4c2dd836a7af4a8d538fedefc19a8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;67;-1505.736,1870.95;Inherit;True;Property;_SSS;SSS;20;0;Create;True;0;0;False;0;-1;None;cf5541dbba58f9a459d8625e4663b8df;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;81;-1214.095,3771.325;Inherit;False;Property;_BaseBlue;Base Blue;35;0;Create;True;0;0;False;0;0,0,1,0;0,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;68;-1109.529,2016.223;Inherit;False;Property;_SSSRed;SSS Red;23;0;Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;66;-1097.77,2223.356;Inherit;False;Property;_SSSGreen;SSS Green;25;0;Create;True;0;0;False;0;0,1,0,0;0,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;83;-1183.295,4024.733;Inherit;False;Property;_BaseAlpha;Base Alpha;39;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;74;-529.2495,2102.023;Inherit;False;Property;_ShowSSSGreen;Show SSS Green;24;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;93;-643.2744,3620.093;Inherit;False;Property;_ShowBaseBlue;Show Base Blue;34;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;91;-597.676,3256.186;Inherit;False;Property;_ShowBaseRed;Show Base Red;32;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;50;-505.9959,1180.098;Inherit;False;Property;_ShowILMBlue;Show ILM Blue;16;0;Create;True;0;0;False;0;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;92;-641.6743,3392.592;Inherit;False;Property;_ShowBaseGreen;Show Base Green;36;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;90;-614.4742,3865.5;Inherit;False;Property;_ShowBaseAlpha;Show Base Alpha;38;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;56;-476.1958,1425.506;Inherit;False;Property;_ShowILMAlpha;Show ILM Alpha;18;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;49;-503.3957,952.5974;Inherit;False;Property;_ShowILMGreen;Show ILM Green;14;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;76;-502.0495,2574.932;Inherit;False;Property;_ShowSSSAlpha;Show SSS Alpha;28;0;Create;True;0;0;False;0;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;51;-459.3976,816.1907;Inherit;False;Property;_ShowILMRed;Show ILM Red;12;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;75;-531.8497,2329.524;Inherit;False;Property;_ShowSSSBlue;Show SSS Blue;26;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;99;-425.5554,412.2696;Inherit;False;Property;_ShowVertexAlpha;Show Vertex Alpha;8;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;77;-485.2513,1965.617;Inherit;False;Property;_ShowSSSRed;Show SSS Red;22;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;96;-70.97523,3246.991;Inherit;False;Property;_NegateBaseColors;Negate Base Colors;31;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;80;41.44969,1956.423;Inherit;False;Property;_NegateSSSColors;Negate SSS Colors;21;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=267CBB69BE5ABD4042925AC9B91EB1B471CD51B3