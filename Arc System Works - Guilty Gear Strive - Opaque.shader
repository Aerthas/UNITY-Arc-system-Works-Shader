...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Opaque v8.0.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float ILMColorSetting60_g1675 = ILMColorSetting1007;
				float4 ILMAColor54_g1675 = ILMAColor1005;
				float DetailColorSetting44_g1675 = DetailColorSetting1070;
				float4 DetailColor41_g1675 = DetailColor1072;
				...
				float3x3 temp_output_24_0_g1675 = ( _EnableColorReplacer == 0.0 ? float3x3(appendResult762, appendResult763, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1668 == 5.0 ? lerpResult4_g1673 : ( temp_output_52_0_g1668 == 4.0 ? temp_output_105_0_g1668 : ( temp_output_52_0_g1668 == 3.0 ? temp_output_104_0_g1668 : ( temp_output_52_0_g1668 == 2.0 ? temp_output_102_0_g1668 : ( temp_output_52_0_g1668 == 1.0 ? temp_output_106_0_g1668 : float4( temp_output_67_0_g1668[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1673.rgb, float3( 0,0,0 )) );
				float2 uv2_Detail = i.ase_texcoord1.zw * _Detail_ST.xy + _Detail_ST.zw;
				float4 Detail1066 = tex2D( _Detail, uv2_Detail );
				float4 detail38_g1675 = Detail1066;
				float4 lerpResult10_g1675 = lerp( DetailColor41_g1675 , float4( temp_output_24_0_g1675[0] , 0.0 ) , detail38_g1675);
				float3 SSS50_g1675 = temp_output_24_0_g1675[1];
				float2 uv_OLM = i.ase_texcoord1.xy * _OLM_ST.xy + _OLM_ST.zw;
				float4 OLM1117 = tex2D( _OLM, uv_OLM );
				float4 OLM47_g1675 = OLM1117;
				float4 SSSOLM63_g1675 = ( float4( SSS50_g1675 , 0.0 ) * OLM47_g1675 );
				float4 lerpResult36_g1675 = lerp( SSSOLM63_g1675 , float4( temp_output_24_0_g1675[0] , 0.0 ) , detail38_g1675);
				float4 temp_output_20_0_g1675 = ( DetailColorSetting44_g1675 == 1.0 ? lerpResult10_g1675 : lerpResult36_g1675 );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1675 = ILMA357;
				float4 lerpResult12_g1675 = lerp( ILMAColor54_g1675 , temp_output_20_0_g1675 , ILMA57_g1675);
				float4 lerpResult65_g1675 = lerp( SSSOLM63_g1675 , temp_output_20_0_g1675 , ILMA57_g1675);
				float4 Base339 = ( ILMColorSetting60_g1675 == 1.0 ? lerpResult12_g1675 : lerpResult65_g1675 );
				float4 Base12_g88 = Base339;
				...
				float blendOpSrc34_g1674 = ILMB576;
				float blendOpDest34_g1674 = dotResult50_g1665;
				float clampResult87_g1693 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1674) / max( blendOpSrc34_g1674, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_29 = (clampResult87_g1693).xxxx;
				float4 blendOpSrc30_g88 = Base12_g88;
				float4 blendOpDest30_g88 = temp_cast_29;
				float4 lerpBlendMode30_g88 = lerp(blendOpDest30_g88,min( blendOpSrc30_g88 , blendOpDest30_g88 ),0.9);
				float3 desaturateInitialColor9_g91 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g88 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g91 = dot( desaturateInitialColor9_g91, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g91 = lerp( desaturateInitialColor9_g91, desaturateDot9_g91.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g93 = ( ( float4( desaturateVar9_g91 , 0.0 ) + Base12_g88 ) * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g93 = dot( desaturateInitialColor9_g93, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g93 = lerp( desaturateInitialColor9_g93, desaturateDot9_g93.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 Base52_g1675 = temp_output_24_0_g1675[0];
				float3 blendOpSrc31_g1675 = Base52_g1675;
				float3 blendOpDest31_g1675 = temp_output_24_0_g1675[1];
				float4 lerpResult7_g1675 = lerp( ( DetailColor41_g1675 * float4( ( saturate( abs( blendOpSrc31_g1675 - blendOpDest31_g1675 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1675[1] , 0.0 ) , detail38_g1675);
				float4 lerpResult69_g1675 = lerp( SSSOLM63_g1675 , float4( temp_output_24_0_g1675[1] , 0.0 ) , detail38_g1675);
				float4 temp_output_8_0_g1675 = ( DetailColorSetting44_g1675 == 1.0 ? lerpResult7_g1675 : lerpResult69_g1675 );
				float4 blendOpSrc32_g1675 = temp_output_20_0_g1675;
				float4 blendOpDest32_g1675 = temp_output_8_0_g1675;
				float4 lerpResult17_g1675 = lerp( ( ILMAColor54_g1675 * ( saturate( abs( blendOpSrc32_g1675 - blendOpDest32_g1675 ) )) ) , temp_output_8_0_g1675 , ILMA57_g1675);
				float4 lerpResult67_g1675 = lerp( SSSOLM63_g1675 , temp_output_8_0_g1675 , ILMA57_g1675);
				float4 SSS578 = ( ILMColorSetting60_g1675 == 1.0 ? lerpResult17_g1675 : lerpResult67_g1675 );
				float4 SSS14_g88 = SSS578;
				float3 desaturateInitialColor9_g90 = ( SSS14_g88 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g90 = dot( desaturateInitialColor9_g90, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g90 = lerp( desaturateInitialColor9_g90, desaturateDot9_g90.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc108_g88 = float4( 0,0,0,0 );
				float4 blendOpDest108_g88 = Base12_g88;
				float4 blendOpSrc51_g88 = ( saturate( min( blendOpSrc108_g88 , blendOpDest108_g88 ) ));
				float4 blendOpDest51_g88 = SSS14_g88;
				float4 lerpBlendMode51_g88 = lerp(blendOpDest51_g88,2.0f*blendOpDest51_g88*blendOpSrc51_g88 + blendOpDest51_g88*blendOpDest51_g88*(1.0f - 2.0f*blendOpSrc51_g88),0.5);
				float3 desaturateInitialColor9_g89 = ( ( saturate( lerpBlendMode51_g88 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g89 = dot( desaturateInitialColor9_g89, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g89 = lerp( desaturateInitialColor9_g89, desaturateDot9_g89.xxx, ( 1.0 - _Shadow2Saturation ) );
				float VertexR33_g1693 = i.ase_color.r;
				float dotResult46_g1665 = dot( ifLocalVar9_g1665 , normalizedWorldNormal );
				float temp_output_36_0_g1674 = ( ( dotResult46_g1665 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1674 = ILMG574;
				float NdL20_g1693 = ( temp_output_36_0_g1674 * temp_output_1_0_g1674 );
				float temp_output_2_0_g1694 = NdL20_g1693;
				float temp_output_3_0_g1694 = -_Shadow1Smoothness;
				float temp_output_9_0_g1693 = _Shadow1Push;
				float temp_output_11_0_g1693 = _Shadow2Push;
				float clampResult15_g1693 = clamp( temp_output_9_0_g1693 , temp_output_11_0_g1693 , temp_output_9_0_g1693 );
				float RealShadow1Push16_g1693 = clampResult15_g1693;
				float temp_output_1_0_g1694 = RealShadow1Push16_g1693;
				float smoothstepResult6_g1694 = smoothstep( ( ( temp_output_2_0_g1694 / 1.0 ) + temp_output_3_0_g1694 ) , temp_output_2_0_g1694 , temp_output_1_0_g1694);
				float lerpResult7_g1694 = lerp( smoothstepResult6_g1694 , ( temp_output_1_0_g1694 >= temp_output_2_0_g1694 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1694 ? 1.0 : 0.0 ));
				float clampResult17_g1693 = clamp( temp_output_11_0_g1693 , temp_output_11_0_g1693 , temp_output_9_0_g1693 );
				float RealShadow2Push18_g1693 = clampResult17_g1693;
				float temp_output_2_0_g1695 = NdL20_g1693;
				float temp_output_3_0_g1695 = -_Shadow2Smoothness;
				float temp_output_1_0_g1695 = RealShadow2Push18_g1693;
				float smoothstepResult6_g1695 = smoothstep( ( ( temp_output_2_0_g1695 / 1.0 ) + temp_output_3_0_g1695 ) , temp_output_2_0_g1695 , temp_output_1_0_g1695);
				float lerpResult7_g1695 = lerp( smoothstepResult6_g1695 , ( temp_output_1_0_g1695 >= temp_output_2_0_g1695 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1695 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1693 = max( max( ( 1.0 - ( VertexR33_g1693 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1695 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1693 = ( max( ( 1.0 - ( VertexR33_g1693 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1694 , ( RealShadow1Push16_g1693 >= RealShadow2Push18_g1693 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1693 );
				float3 lerpResult100_g88 = lerp( desaturateVar9_g90 , desaturateVar9_g89 , ( 1.0 - temp_output_43_0_g1693 ));
				float clampResult90_g1693 = clamp( ( 1.0 - ( temp_output_43_0_g1693 + temp_output_42_0_g1693 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g88 = clampResult90_g1693;
				float4 lerpResult101_g88 = lerp( float4( desaturateVar9_g93 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g88 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g88 ));
				float EnableRimlight82_g1693 = _EnableRimlight;
				float dotResult31_g1665 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1665 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g1693 = ( ( 1.0 - ( dotResult31_g1665 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				float clampResult91_g1693 = clamp( temp_output_42_0_g1693 , 0.0 , 1.0 );
				float clampResult88_g1693 = clamp( ( ceil( ( ( NdV48_g1693 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1693 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1693 = ( EnableRimlight82_g1693 == 1.0 ? clampResult88_g1693 : 0.0 );
				float3 desaturateInitialColor9_g92 = ( ( Base12_g88 * temp_output_94_0_g1693 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g92 = dot( desaturateInitialColor9_g92, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g92 = lerp( desaturateInitialColor9_g92, desaturateDot9_g92.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g88 + float4( desaturateVar9_g92 , 0.0 ) );
				float4 temp_output_1_0_g1688 = ColorOut1025;
				float4 lerpResult8_g1688 = lerp( DetailColor1072 , temp_output_1_0_g1688 , Detail1066);
				float4 temp_output_9_0_g1688 = ( DetailColorSetting1070 == 2.0 ? lerpResult8_g1688 : temp_output_1_0_g1688 );
				float4 lerpResult10_g1688 = lerp( ILMAColor1005 , temp_output_9_0_g1688 , ILMA357);
				float LightColorSetting872 = _LightColorSetting;
				float ifLocalVar13_g1684 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1684 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1684 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_42 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_43 = (5.0).xxxx;
				float4 clampResult18_g1684 = clamp( ase_lightColor , temp_cast_42 , temp_cast_43 );
				float4 temp_output_11_0_g1684 = ( ase_atten * clampResult18_g1684 );
				float4 temp_output_8_0_g1684 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1684 = 0;
				if( ifLocalVar13_g1684 > 0.0 )
				ifLocalVar3_g1684 = temp_output_11_0_g1684;
				else if( ifLocalVar13_g1684 == 0.0 )
				ifLocalVar3_g1684 = temp_output_8_0_g1684;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1684 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1684 );
				#else
				float4 staticSwitch9_g1684 = ifLocalVar3_g1684;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1684;
				float temp_output_12_0_g1677 = ( ( ( temp_output_94_0_g1693 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1693 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1693 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1693 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1693 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				float SSSA581 = tex2DNode297.a;
				float temp_output_28_0_g1677 = ( _SSSAlphaEmissiveToggle * ( SSSA581 >= 0.5 ? _SSSAlphaEmissiveIntensity : 0.0 ) );
				float clampResult30_g1677 = clamp( ( temp_output_12_0_g1677 - temp_output_28_0_g1677 ) , 0.0 , temp_output_12_0_g1677 );
				float EmissionRampMask920 = ( clampResult30_g1677 + temp_output_28_0_g1677 );
				float4 temp_cast_44 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1684 = 0;
				if( ifLocalVar13_g1684 > 0.0 )
				ifLocalVar17_g1684 = clampResult18_g1684;
				else if( ifLocalVar13_g1684 == 0.0 )
				ifLocalVar17_g1684 = temp_output_8_0_g1684;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1684 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1684 = max( temp_cast_44 , ifLocalVar17_g1684 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1684;
				float4 lerpResult1169 = lerp( ( ( ILMColorSetting1007 == 2.0 ? lerpResult10_g1688 : temp_output_9_0_g1688 ) * GlobalLightColor944 ) , ( _EmissionIntensity * ColorOut1025 * EmissionLightColor947 ) , EmissionRampMask920);
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1689 = _OutlineThickness;
				float3 temp_output_135_0_g1689 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1689 ) + temp_output_33_0_g1689 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1689 = ObjSpaceViewDir( float4( temp_output_135_0_g1689 , 0.0 ) );
				float4 normalizeResult142_g1689 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1689 , 0.0 ) - v.vertex ) );
				float clampResult141_g1689 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1689 = lerp( float4( temp_output_135_0_g1689 , 0.0 ) , -normalizeResult142_g1689 , ( 1.0 - clampResult141_g1689 ));
				
				o.ase_texcoord.xy = v.ase_texcoord.xy;
				o.ase_texcoord.zw = v.ase_texcoord1.xy;

				v.vertex.xyz += lerpResult145_g1689.xyz;
...
/*ASEBEGIN
Version=18900
-2009;121;1790;816;-2504.758;-3783.428;1.249893;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1085;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1674;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;1156;-800,3456;Inherit;False;Shadow Priority Color Change;-1;;1675;e12dd788f9ad90545a25b4603cc00a62;0;8;24;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;35;COLOR;0,0,0,0;False;29;FLOAT;0;False;26;COLOR;0,0,0,0;False;25;COLOR;0,0,0,0;False;30;FLOAT;0;False;27;FLOAT;0;False;28;COLOR;0,0,0,0;False;2;COLOR;0;COLOR;23
...
Node;AmplifyShaderEditor.FunctionNode;1201;4240,3376;Inherit;False;Emission - Guilty Gear Strive;-1;;1677;282e2fc31b84cbb48b669c6910d1914b;0;16;25;FLOAT;0;False;24;FLOAT;0;False;26;FLOAT;0;False;17;FLOAT;0;False;22;FLOAT;0;False;20;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1181;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1684;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;1;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1106;5456,4384;Inherit;False;Line Priority Color Change;-1;;1688;e71d6fe87185a054c9d0e635f7af6cdb;0;7;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1158;6288,4896;Inherit;False;ASWOutline - Strive;-1;;1689;45e68a0e07691604398d794ebf3282a2;0;8;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;155;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1188;8668.341,4363.591;Float;False;True;-1;2;ASWGuiltyGearStriveGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Opaque v8.0.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;True;False;;False;0
...
WireConnection;1209;1;1085;0
WireConnection;1209;3;1085;8
WireConnection;1209;2;1085;9
WireConnection;1209;5;753;0
WireConnection;1209;7;729;0
WireConnection;1209;80;758;0
WireConnection;1209;8;746;0
WireConnection;1209;9;711;0
WireConnection;1209;121;1206;0
WireConnection;1209;10;716;0
WireConnection;1209;11;727;0
WireConnection;1209;120;1207;0
WireConnection;1209;12;731;0
WireConnection;1209;13;732;0
WireConnection;1209;97;922;0
WireConnection;1209;101;923;0
WireConnection;1209;104;924;0
WireConnection;1209;107;925;0
WireConnection;1209;110;926;0
...
WireConnection;1201;1;1209;100
WireConnection;1201;2;1209;103
WireConnection;1201;3;1209;106
WireConnection;1201;4;1209;109
WireConnection;1201;5;1209;112
...
WireConnection;1222;6;1209;76
WireConnection;1222;29;1209;69
WireConnection;1222;39;1209;62
WireConnection;1222;41;1209;0
...
ASEEND*/
//CHKSM=2C70A4C45B9F8E6C142E04769841D49CAAE9A96E