...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Opaque v7.2.2"
{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix0375_g1658(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1658(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1656(  )
			{
			...
			float3 StereoCameraViewDirection32_g1656( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float ILMColorSetting60_g1668 = ILMColorSetting1007;
				float4 ILMAColor54_g1668 = ILMAColor1005;
				float DetailColorSetting44_g1668 = DetailColorSetting1070;
				float4 DetailColor41_g1668 = DetailColor1072;
				...
				float3x3 temp_output_24_0_g1668 = ( _EnableColorReplacer == 0.0 ? float3x3(appendResult762, appendResult763, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1659 == 5.0 ? lerpResult4_g1664 : ( temp_output_52_0_g1659 == 4.0 ? temp_output_105_0_g1659 : ( temp_output_52_0_g1659 == 3.0 ? temp_output_104_0_g1659 : ( temp_output_52_0_g1659 == 2.0 ? temp_output_102_0_g1659 : ( temp_output_52_0_g1659 == 1.0 ? temp_output_106_0_g1659 : float4( temp_output_67_0_g1659[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1664.rgb, float3( 0,0,0 )) );
				float2 uv2_Detail = i.ase_texcoord1.zw * _Detail_ST.xy + _Detail_ST.zw;
				float4 Detail1066 = tex2D( _Detail, uv2_Detail );
				float4 detail38_g1668 = Detail1066;
				float4 lerpResult10_g1668 = lerp( DetailColor41_g1668 , float4( temp_output_24_0_g1668[0] , 0.0 ) , detail38_g1668);
				float3 SSS50_g1668 = temp_output_24_0_g1668[1];
				float2 uv_OLM = i.ase_texcoord1.xy * _OLM_ST.xy + _OLM_ST.zw;
				float4 OLM1117 = tex2D( _OLM, uv_OLM );
				float4 OLM47_g1668 = OLM1117;
				float4 SSSOLM63_g1668 = ( float4( SSS50_g1668 , 0.0 ) * OLM47_g1668 );
				float4 lerpResult36_g1668 = lerp( SSSOLM63_g1668 , float4( temp_output_24_0_g1668[0] , 0.0 ) , detail38_g1668);
				float4 temp_output_20_0_g1668 = ( DetailColorSetting44_g1668 == 1.0 ? lerpResult10_g1668 : lerpResult36_g1668 );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1668 = ILMA357;
				float4 lerpResult12_g1668 = lerp( ILMAColor54_g1668 , temp_output_20_0_g1668 , ILMA57_g1668);
				float4 lerpResult65_g1668 = lerp( SSSOLM63_g1668 , temp_output_20_0_g1668 , ILMA57_g1668);
				float4 Base339 = ( ILMColorSetting60_g1668 == 1.0 ? lerpResult12_g1668 : lerpResult65_g1668 );
				...
				float3 localViewMatrix0375_g1658 = ViewMatrix0375_g1658();
				float3 normalizeResult384_g1658 = normalize( localViewMatrix0375_g1658 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_380_0_g1658 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1658 = ViewMatrix1373_g1658();
				float3 normalizeResult376_g1658 = normalize( localViewMatrix1373_g1658 );
				float3 localStereoCameraViewPosition30_g1656 = StereoCameraViewPosition30_g1656();
				float3 rotatedValue385_g1658 = RotateAroundAxis( temp_output_380_0_g1658, localStereoCameraViewPosition30_g1656, normalizeResult376_g1658, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1658 = RotateAroundAxis( temp_output_380_0_g1658, rotatedValue385_g1658, normalize( normalizeResult384_g1658 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1658 = normalize( ( rotatedValue387_g1658 - temp_output_380_0_g1658 ) );
				float3 normalizeResult38_g1656 = normalize( normalizeResult389_g1658 );
				float3 appendResult15_g1657 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1657 = normalize( appendResult15_g1657 );
				float3 normalizeResult26_g1656 = normalize( normalizeResult2_g1657 );
				float3 ifLocalVar3_g1656 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1656 = normalizeResult38_g1656;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1656 = normalizeResult26_g1656;
				...
				float3 ifLocalVar8_g1656 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1656 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1656 = ifLocalVar3_g1656;
				float3 ifLocalVar9_g1656 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1656 = ifLocalVar3_g1656;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1656 = ifLocalVar8_g1656;
				float3 normalizeResult48_g1656 = normalize( ifLocalVar9_g1656 );
				float3 worldPos32_g1656 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1656 = StereoCameraViewDirection32_g1656( worldPos32_g1656 );
				float3 normalizeResult51_g1656 = normalize( ( normalizeResult48_g1656 + localStereoCameraViewDirection32_g1656 ) );
				float dotResult50_g1656 = dot( normalizedWorldNormal , normalizeResult51_g1656 );
				float blendOpSrc34_g1665 = ILMB576;
				float blendOpDest34_g1665 = dotResult50_g1656;
				float clampResult87_g1667 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1665) / max( blendOpSrc34_g1665, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_29 = (clampResult87_g1667).xxxx;
				...
				float3 Base52_g1668 = temp_output_24_0_g1668[0];
				float3 blendOpSrc31_g1668 = Base52_g1668;
				float3 blendOpDest31_g1668 = temp_output_24_0_g1668[1];
				float4 lerpResult7_g1668 = lerp( ( DetailColor41_g1668 * float4( ( saturate( abs( blendOpSrc31_g1668 - blendOpDest31_g1668 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1668[1] , 0.0 ) , detail38_g1668);
				float4 lerpResult69_g1668 = lerp( SSSOLM63_g1668 , float4( temp_output_24_0_g1668[1] , 0.0 ) , detail38_g1668);
				float4 temp_output_8_0_g1668 = ( DetailColorSetting44_g1668 == 1.0 ? lerpResult7_g1668 : lerpResult69_g1668 );
				float4 blendOpSrc32_g1668 = temp_output_20_0_g1668;
				float4 blendOpDest32_g1668 = temp_output_8_0_g1668;
				float4 lerpResult17_g1668 = lerp( ( ILMAColor54_g1668 * ( saturate( abs( blendOpSrc32_g1668 - blendOpDest32_g1668 ) )) ) , temp_output_8_0_g1668 , ILMA57_g1668);
				float4 lerpResult67_g1668 = lerp( SSSOLM63_g1668 , temp_output_8_0_g1668 , ILMA57_g1668);
				float4 SSS578 = ( ILMColorSetting60_g1668 == 1.0 ? lerpResult17_g1668 : lerpResult67_g1668 );
				...
				float VertexR33_g1667 = i.ase_color.r;
				float dotResult46_g1656 = dot( ifLocalVar9_g1656 , normalizedWorldNormal );
				float temp_output_36_0_g1665 = ( ( dotResult46_g1656 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1665 = ILMG574;
				float NdL20_g1667 = ( temp_output_36_0_g1665 * temp_output_1_0_g1665 );
				float temp_output_9_0_g1667 = _Shadow1Push;
				float temp_output_11_0_g1667 = _Shadow2Push;
				float clampResult15_g1667 = clamp( temp_output_9_0_g1667 , temp_output_11_0_g1667 , temp_output_9_0_g1667 );
				float RealShadow1Push16_g1667 = clampResult15_g1667;
				float clampResult17_g1667 = clamp( temp_output_11_0_g1667 , temp_output_11_0_g1667 , temp_output_9_0_g1667 );
				float RealShadow2Push18_g1667 = clampResult17_g1667;
				float temp_output_42_0_g1667 = max( max( ( 1.0 - ( VertexR33_g1667 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1667 < RealShadow2Push18_g1667 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1667 = ( max( ( 1.0 - ( VertexR33_g1667 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1667 < RealShadow1Push16_g1667 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1667 >= RealShadow2Push18_g1667 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1667 );
				float3 lerpResult100_g1677 = lerp( desaturateVar9_g1681 , desaturateVar9_g1679 , ( 1.0 - temp_output_43_0_g1667 ));
				float clampResult90_g1667 = clamp( ( 1.0 - ( temp_output_43_0_g1667 + temp_output_42_0_g1667 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1677 = clampResult90_g1667;
				...
				float EnableRimlight82_g1667 = _EnableRimlight;
				float dotResult31_g1656 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1656 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g1667 = ( ( 1.0 - ( dotResult31_g1656 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				float clampResult91_g1667 = clamp( temp_output_42_0_g1667 , 0.0 , 1.0 );
				float clampResult88_g1667 = clamp( ( ceil( ( ( NdV48_g1667 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1667 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1667 = ( EnableRimlight82_g1667 == 1.0 ? clampResult88_g1667 : 0.0 );
				float3 desaturateInitialColor9_g1682 = ( ( Base12_g1677 * temp_output_94_0_g1667 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				...
				float temp_output_12_0_g1676 = ( ( ( temp_output_94_0_g1667 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1667 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1667 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1667 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1667 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				...
				float temp_output_48_0_g1685 = _DebugGroup;
				float temp_output_47_0_g1685 = _VertexChannel;
				float4 temp_output_59_0_g1685 = _DebugColor;
				float temp_output_50_0_g1685 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1685 = appendResult1031;
				float4 break7_g1685 = temp_output_54_0_g1685;
				float temp_output_57_0_g1685 = _BaseSSSAlphaSwap;
				float4 Debug987 = ( temp_output_48_0_g1685 == 0.0 ? ( temp_output_47_0_g1685 == 0.0 ? i.ase_color : ( temp_output_47_0_g1685 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1685 ) : ( temp_output_47_0_g1685 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1685 ) : ( temp_output_47_0_g1685 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1685 ) : ( temp_output_47_0_g1685 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1685 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1685 == 1.0 ? ( temp_output_50_0_g1685 == 0.0 ? temp_output_54_0_g1685 : ( temp_output_50_0_g1685 == 1.0 ? ( break7_g1685.r * temp_output_59_0_g1685 ) : ( temp_output_50_0_g1685 == 2.0 ? ( break7_g1685.g * temp_output_59_0_g1685 ) : ( temp_output_50_0_g1685 == 3.0 ? ( break7_g1685.b * temp_output_59_0_g1685 ) : ( temp_output_50_0_g1685 == 4.0 ? ( break7_g1685.a * temp_output_59_0_g1685 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1685 == 2.0 ? ( temp_output_57_0_g1685 == 0.0 ? ( BaseA580 * temp_output_59_0_g1685 ) : ( temp_output_57_0_g1685 == 1.0 ? ( SSSA581 * temp_output_59_0_g1685 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1687 = _OutlineThickness;
				float3 temp_output_135_0_g1687 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1687 ) + temp_output_33_0_g1687 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1687 = ObjSpaceViewDir( float4( temp_output_135_0_g1687 , 0.0 ) );
				float4 normalizeResult142_g1687 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1687 , 0.0 ) - v.vertex ) );
				float clampResult141_g1687 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1687 = lerp( float4( temp_output_135_0_g1687 , 0.0 ) , -normalizeResult142_g1687 , ( 1.0 - clampResult141_g1687 ));
				
				o.ase_texcoord.xy = v.ase_texcoord.xy;
				o.ase_texcoord.zw = v.ase_texcoord1.xy;

				v.vertex.xyz += lerpResult145_g1687.xyz;
...
/*ASEBEGIN
Version=18900
84;367;2298;1011;-5053.285;-4544.063;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1656;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.FunctionNode;1085;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1665;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;1156;-800,3456;Inherit;False;Shadow Priority Color Change;-1;;1668;e12dd788f9ad90545a25b4603cc00a62;0;8;24;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;35;COLOR;0,0,0,0;False;29;FLOAT;0;False;26;COLOR;0,0,0,0;False;25;COLOR;0,0,0,0;False;30;FLOAT;0;False;27;FLOAT;0;False;28;COLOR;0,0,0,0;False;2;COLOR;0;COLOR;23
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1685;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1158;6288,4896;Inherit;False;ASWOutline - Strive;-1;;1687;45e68a0e07691604398d794ebf3282a2;0;8;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;155;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1194;8655.341,4624.591;Float;False;False;-1;2;ASEMaterialInspector;100;8;New Amplify Shader;fd5163ddf7350f946aff871fd3d7e3fe;True;ShadowCaster;0;4;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=A5964A07348FAFDA9A4AD49514C9A6527667ACDA