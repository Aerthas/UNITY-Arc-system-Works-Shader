...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.1.2"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1418_g1504(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0417_g1504(  )
			{
			...
			float3 StereoCameraViewPosition30_g1502(  )
			{
			...
			float3 StereoCameraViewDirection32_g1502( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float ILMColorSetting60_g1515 = ILMColorSetting1007;
				float4 ILMAColor54_g1515 = ILMAColor1005;
				float DetailColorSetting44_g1515 = DetailColorSetting1067;
				float4 DetailColor41_g1515 = DetailColor1066;
				...
				float3x3 temp_output_24_0_g1515 = ( _EnableColorReplacer == 0.0 ? float3x3(appendResult762, appendResult763, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1505 == 5.0 ? lerpResult4_g1510 : ( temp_output_52_0_g1505 == 4.0 ? temp_output_105_0_g1505 : ( temp_output_52_0_g1505 == 3.0 ? temp_output_104_0_g1505 : ( temp_output_52_0_g1505 == 2.0 ? temp_output_102_0_g1505 : ( temp_output_52_0_g1505 == 1.0 ? temp_output_106_0_g1505 : float4( temp_output_67_0_g1505[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1510.rgb, float3( 0,0,0 )) );
				float2 uv2_Detail = i.ase_texcoord1.zw * _Detail_ST.xy + _Detail_ST.zw;
				float4 Detail1062 = tex2D( _Detail, uv2_Detail );
				float4 detail38_g1515 = Detail1062;
				float4 lerpResult10_g1515 = lerp( DetailColor41_g1515 , float4( temp_output_24_0_g1515[0] , 0.0 ) , detail38_g1515);
				float3 SSS50_g1515 = temp_output_24_0_g1515[1];
				float2 uv_OLM = i.ase_texcoord1.xy * _OLM_ST.xy + _OLM_ST.zw;
				float4 OLM1090 = tex2D( _OLM, uv_OLM );
				float4 OLM47_g1515 = OLM1090;
				float4 SSSOLM63_g1515 = ( float4( SSS50_g1515 , 0.0 ) * OLM47_g1515 );
				float4 lerpResult36_g1515 = lerp( SSSOLM63_g1515 , float4( temp_output_24_0_g1515[0] , 0.0 ) , detail38_g1515);
				float4 temp_output_20_0_g1515 = ( DetailColorSetting44_g1515 == 1.0 ? lerpResult10_g1515 : lerpResult36_g1515 );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1515 = ILMA357;
				float4 lerpResult12_g1515 = lerp( ILMAColor54_g1515 , temp_output_20_0_g1515 , ILMA57_g1515);
				float4 lerpResult65_g1515 = lerp( SSSOLM63_g1515 , temp_output_20_0_g1515 , ILMA57_g1515);
				float4 Base1076 = ( ILMColorSetting60_g1515 == 1.0 ? lerpResult12_g1515 : lerpResult65_g1515 );
				...
				float3 localViewMatrix1418_g1504 = ViewMatrix1418_g1504();
				float3 normalizeResult422_g1504 = normalize( localViewMatrix1418_g1504 );
				int localIsInMirror411_g1504 = ( unity_CameraProjection[2][0] != 0.f || unity_CameraProjection[2][1] != 0.f );
				float temp_output_297_0_g1504 = _ViewDirOffsetYaw;
				float temp_output_424_0_g1504 = radians( ( (float)localIsInMirror411_g1504 == 0.0 ? -temp_output_297_0_g1504 : temp_output_297_0_g1504 ) );
				float3 localViewMatrix0417_g1504 = ViewMatrix0417_g1504();
				float3 normalizeResult425_g1504 = normalize( localViewMatrix0417_g1504 );
				float3 rotatedValue428_g1504 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult425_g1504, normalizeResult422_g1504, temp_output_424_0_g1504 );
				float3 normalizeResult429_g1504 = normalize( rotatedValue428_g1504 );
				int localIsInMirror423_g1504 = ( unity_CameraProjection[2][0] != 0.f || unity_CameraProjection[2][1] != 0.f );
				float temp_output_296_0_g1504 = _ViewDirOffsetPitch;
				float3 localStereoCameraViewPosition30_g1502 = StereoCameraViewPosition30_g1502();
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 rotatedValue431_g1504 = RotateAroundAxis( float3( 0,0,0 ), ( localStereoCameraViewPosition30_g1502 - ( ase_worldPos - i.ase_texcoord4.xyz ) ), normalizeResult422_g1504, temp_output_424_0_g1504 );
				float3 rotatedValue432_g1504 = RotateAroundAxis( float3( 0,0,0 ), rotatedValue431_g1504, normalizeResult429_g1504, radians( ( (float)localIsInMirror423_g1504 == 0.0 ? temp_output_296_0_g1504 : -temp_output_296_0_g1504 ) ) );
				float3 normalizeResult433_g1504 = ASESafeNormalize( rotatedValue432_g1504 );
				float3 normalizeResult38_g1502 = normalize( normalizeResult433_g1504 );
				float3 appendResult15_g1503 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1503 = normalize( appendResult15_g1503 );
				float3 normalizeResult26_g1502 = normalize( normalizeResult2_g1503 );
				float3 ifLocalVar3_g1502 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1502 = normalizeResult38_g1502;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1502 = normalizeResult26_g1502;
				...
				float3 ifLocalVar8_g1502 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1502 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1502 = ifLocalVar3_g1502;
				float3 ifLocalVar9_g1502 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1502 = ifLocalVar3_g1502;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1502 = ifLocalVar8_g1502;
				float3 normalizeResult48_g1502 = normalize( ifLocalVar9_g1502 );
				float3 worldPos32_g1502 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1502 = StereoCameraViewDirection32_g1502( worldPos32_g1502 );
				float3 normalizeResult51_g1502 = normalize( ( normalizeResult48_g1502 + localStereoCameraViewDirection32_g1502 ) );
				float dotResult50_g1502 = dot( normalizedWorldNormal , normalizeResult51_g1502 );
				float blendOpSrc34_g1511 = ILMB576;
				float blendOpDest34_g1511 = dotResult50_g1502;
				float clampResult87_g1512 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1511) / max( blendOpSrc34_g1511, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_31 = (clampResult87_g1512).xxxx;
				float4 blendOpSrc30_g1519 = Base12_g1519;
				float4 blendOpDest30_g1519 = temp_cast_31;
				...
				float3 desaturateInitialColor9_g1524 = ( ( float4( desaturateVar9_g1522 , 0.0 ) + Base12_g1519 ) * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1524 = dot( desaturateInitialColor9_g1524, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1524 = lerp( desaturateInitialColor9_g1524, desaturateDot9_g1524.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 Base52_g1515 = temp_output_24_0_g1515[0];
				float3 blendOpSrc31_g1515 = Base52_g1515;
				float3 blendOpDest31_g1515 = temp_output_24_0_g1515[1];
				float4 lerpResult7_g1515 = lerp( ( DetailColor41_g1515 * float4( ( saturate( abs( blendOpSrc31_g1515 - blendOpDest31_g1515 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1515[1] , 0.0 ) , detail38_g1515);
				float4 lerpResult69_g1515 = lerp( SSSOLM63_g1515 , float4( temp_output_24_0_g1515[1] , 0.0 ) , detail38_g1515);
				float4 temp_output_8_0_g1515 = ( DetailColorSetting44_g1515 == 1.0 ? lerpResult7_g1515 : lerpResult69_g1515 );
				float4 blendOpSrc32_g1515 = temp_output_20_0_g1515;
				float4 blendOpDest32_g1515 = temp_output_8_0_g1515;
				float4 lerpResult17_g1515 = lerp( ( ILMAColor54_g1515 * ( saturate( abs( blendOpSrc32_g1515 - blendOpDest32_g1515 ) )) ) , temp_output_8_0_g1515 , ILMA57_g1515);
				float4 lerpResult67_g1515 = lerp( SSSOLM63_g1515 , temp_output_8_0_g1515 , ILMA57_g1515);
				float4 SSS1077 = ( ILMColorSetting60_g1515 == 1.0 ? lerpResult17_g1515 : lerpResult67_g1515 );
				float4 SSS14_g1519 = SSS1077;
				float3 desaturateInitialColor9_g1521 = ( SSS14_g1519 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1521 = dot( desaturateInitialColor9_g1521, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1521 = lerp( desaturateInitialColor9_g1521, desaturateDot9_g1521.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc108_g1519 = float4( 0,0,0,0 );
				float4 blendOpDest108_g1519 = Base12_g1519;
				float4 blendOpSrc51_g1519 = ( saturate( min( blendOpSrc108_g1519 , blendOpDest108_g1519 ) ));
				float4 blendOpDest51_g1519 = SSS14_g1519;
				...
				float3 desaturateInitialColor9_g1520 = ( ( saturate( lerpBlendMode51_g1519 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1520 = dot( desaturateInitialColor9_g1520, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1520 = lerp( desaturateInitialColor9_g1520, desaturateDot9_g1520.xxx, ( 1.0 - _Shadow2Saturation ) );
				float VertexR33_g1512 = pow( pow( i.ase_color.r , 2.2 ) , 2.2 );
				float dotResult46_g1502 = dot( ifLocalVar9_g1502 , normalizedWorldNormal );
				float temp_output_36_0_g1511 = ( ( dotResult46_g1502 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1511 = ILMG574;
				float temp_output_1087_0 = ( temp_output_36_0_g1511 * temp_output_1_0_g1511 );
				float NdL20_g1512 = temp_output_1087_0;
				float temp_output_2_0_g1513 = NdL20_g1512;
				float temp_output_3_0_g1513 = -_Shadow1Smoothness;
				float temp_output_9_0_g1512 = _Shadow1Push;
				float temp_output_11_0_g1512 = _Shadow2Push;
				float clampResult15_g1512 = clamp( temp_output_9_0_g1512 , temp_output_11_0_g1512 , temp_output_9_0_g1512 );
				float RealShadow1Push16_g1512 = clampResult15_g1512;
				float temp_output_1_0_g1513 = RealShadow1Push16_g1512;
				float smoothstepResult6_g1513 = smoothstep( ( ( temp_output_2_0_g1513 / 1.0 ) + temp_output_3_0_g1513 ) , temp_output_2_0_g1513 , temp_output_1_0_g1513);
				float lerpResult7_g1513 = lerp( smoothstepResult6_g1513 , ( temp_output_1_0_g1513 >= temp_output_2_0_g1513 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1513 ? 1.0 : 0.0 ));
				float clampResult17_g1512 = clamp( temp_output_11_0_g1512 , temp_output_11_0_g1512 , temp_output_9_0_g1512 );
				float RealShadow2Push18_g1512 = clampResult17_g1512;
				float temp_output_2_0_g1514 = NdL20_g1512;
				float temp_output_3_0_g1514 = -_Shadow2Smoothness;
				float temp_output_1_0_g1514 = RealShadow2Push18_g1512;
				float smoothstepResult6_g1514 = smoothstep( ( ( temp_output_2_0_g1514 / 1.0 ) + temp_output_3_0_g1514 ) , temp_output_2_0_g1514 , temp_output_1_0_g1514);
				float lerpResult7_g1514 = lerp( smoothstepResult6_g1514 , ( temp_output_1_0_g1514 >= temp_output_2_0_g1514 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1514 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1512 = max( max( ( 1.0 - ( VertexR33_g1512 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1514 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1512 = ( max( ( 1.0 - ( VertexR33_g1512 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1513 , ( RealShadow1Push16_g1512 >= RealShadow2Push18_g1512 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1512 );
				float3 lerpResult100_g1519 = lerp( desaturateVar9_g1521 , desaturateVar9_g1520 , ( 1.0 - temp_output_43_0_g1512 ));
				float clampResult90_g1512 = clamp( ( 1.0 - ( temp_output_43_0_g1512 + temp_output_42_0_g1512 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1519 = clampResult90_g1512;
				float4 lerpResult101_g1519 = lerp( float4( desaturateVar9_g1524 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1519 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1519 ));
				float EnableRimlight82_g1512 = _EnableRimlight;
				float dotResult31_g1502 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1502 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g1512 = ( ( 1.0 - ( dotResult31_g1502 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				float clampResult91_g1512 = clamp( temp_output_42_0_g1512 , 0.0 , 1.0 );
				float clampResult88_g1512 = clamp( ( ceil( ( ( NdV48_g1512 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1512 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1512 = ( EnableRimlight82_g1512 == 1.0 ? clampResult88_g1512 : 0.0 );
				float3 desaturateInitialColor9_g1523 = ( ( Base12_g1519 * temp_output_94_0_g1512 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1523 = dot( desaturateInitialColor9_g1523, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1523 = lerp( desaturateInitialColor9_g1523, desaturateDot9_g1523.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1519 + float4( desaturateVar9_g1523 , 0.0 ) );
				float4 temp_output_1_0_g1531 = ColorOut1025;
				float4 lerpResult8_g1531 = lerp( DetailColor1066 , temp_output_1_0_g1531 , Detail1062);
				float4 temp_output_9_0_g1531 = ( DetailColorSetting1067 == 2.0 ? lerpResult8_g1531 : temp_output_1_0_g1531 );
				float4 lerpResult10_g1531 = lerp( ILMAColor1005 , temp_output_9_0_g1531 , ILMA357);
				...
				float4 clampResult18_g1525 = clamp( ase_lightColor , temp_cast_44 , temp_cast_45 );
				...
				float temp_output_12_0_g1518 = ( ( ( temp_output_94_0_g1512 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1512 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1512 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1512 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1512 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				...
				float EmissionRampMask920 = max( ( clampResult30_g1518 + temp_output_28_0_g1518 ) , ( tex2D( _EmissionMask, uv_EmissionMask ).r * _EmissionMaskIntensity ) );
				...
				#else
				float4 staticSwitch30_g1525 = max( temp_cast_47 , ifLocalVar17_g1525 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1525;
				float4 lerpResult1100 = lerp( ( ( ILMColorSetting1007 == 2.0 ? lerpResult10_g1531 : temp_output_9_0_g1531 ) * GlobalLightColor944 ) , ( _EmissionIntensity * ColorOut1025 * EmissionLightColor947 ) , EmissionRampMask920);
				float temp_output_48_0_g1530 = _DebugGroup;
				float temp_output_47_0_g1530 = _VertexChannel;
				float4 temp_output_59_0_g1530 = _DebugColor;
				float temp_output_50_0_g1530 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1530 = appendResult1031;
				float4 break7_g1530 = temp_output_54_0_g1530;
				float temp_output_57_0_g1530 = _BaseSSSAlphaSwap;
				float4 Debug987 = ( temp_output_48_0_g1530 == 0.0 ? ( temp_output_47_0_g1530 == 0.0 ? i.ase_color : ( temp_output_47_0_g1530 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1530 ) : ( temp_output_47_0_g1530 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1530 ) : ( temp_output_47_0_g1530 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1530 ) : ( temp_output_47_0_g1530 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1530 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1530 == 1.0 ? ( temp_output_50_0_g1530 == 0.0 ? temp_output_54_0_g1530 : ( temp_output_50_0_g1530 == 1.0 ? ( break7_g1530.r * temp_output_59_0_g1530 ) : ( temp_output_50_0_g1530 == 2.0 ? ( break7_g1530.g * temp_output_59_0_g1530 ) : ( temp_output_50_0_g1530 == 3.0 ? ( break7_g1530.b * temp_output_59_0_g1530 ) : ( temp_output_50_0_g1530 == 4.0 ? ( break7_g1530.a * temp_output_59_0_g1530 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1530 == 2.0 ? ( temp_output_57_0_g1530 == 0.0 ? ( BaseA580 * temp_output_59_0_g1530 ) : ( temp_output_57_0_g1530 == 1.0 ? ( SSSA581 * temp_output_59_0_g1530 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
...
/*ASEBEGIN
Version=18900
2793;227;2049;932;-2767.11;-3304.467;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1502;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.FunctionNode;1087;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1511;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;1086;5503.274,4297.582;Inherit;False;Line Priority Color Change;-1;;1531;e71d6fe87185a054c9d0e635f7af6cdb;0;7;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1530;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;5556.248,5059.576;Inherit;False;ASWOutline;-1;;1532;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
ASEEND*/
//CHKSM=8B440B42743C8E16FDFA815514F0633FC2536671