...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.1.3"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float clampResult87_g1516 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1511) / max( blendOpSrc34_g1511, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_31 = (clampResult87_g1516).xxxx;
				float4 blendOpSrc30_g1520 = Base12_g1520;
				float4 blendOpDest30_g1520 = temp_cast_31;
				float4 lerpBlendMode30_g1520 = lerp(blendOpDest30_g1520,min( blendOpSrc30_g1520 , blendOpDest30_g1520 ),0.9);
				float3 desaturateInitialColor9_g1523 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1520 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1523 = dot( desaturateInitialColor9_g1523, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1523 = lerp( desaturateInitialColor9_g1523, desaturateDot9_g1523.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1525 = ( ( float4( desaturateVar9_g1523 , 0.0 ) + Base12_g1520 ) * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				...
				float4 SSS14_g1520 = SSS1077;
				float3 desaturateInitialColor9_g1522 = ( SSS14_g1520 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1522 = dot( desaturateInitialColor9_g1522, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1522 = lerp( desaturateInitialColor9_g1522, desaturateDot9_g1522.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc108_g1520 = float4( 0,0,0,0 );
				float4 blendOpDest108_g1520 = Base12_g1520;
				float4 blendOpSrc51_g1520 = ( saturate( min( blendOpSrc108_g1520 , blendOpDest108_g1520 ) ));
				float4 blendOpDest51_g1520 = SSS14_g1520;
				float4 lerpBlendMode51_g1520 = lerp(blendOpDest51_g1520,2.0f*blendOpDest51_g1520*blendOpSrc51_g1520 + blendOpDest51_g1520*blendOpDest51_g1520*(1.0f - 2.0f*blendOpSrc51_g1520),0.5);
				float3 desaturateInitialColor9_g1521 = ( ( saturate( lerpBlendMode51_g1520 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				...
				float temp_output_1087_0 = ( ( ( ( dotResult46_g1502 + _GlobalLightPush ) * i.ase_color.r ) * 0.5 ) + ( ( ILMG574 * 2.0 ) - 1.0 ) );
				...
				float3 lerpResult100_g1520 = lerp( desaturateVar9_g1522 , desaturateVar9_g1521 , ( 1.0 - temp_output_43_0_g1516 ));
				float clampResult90_g1516 = clamp( ( 1.0 - ( temp_output_43_0_g1516 + temp_output_42_0_g1516 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1520 = clampResult90_g1516;
				float4 lerpResult101_g1520 = lerp( float4( desaturateVar9_g1525 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1520 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1520 ));
				...
				float NdV48_g1516 = ( ( 1.0 - ( dotResult31_g1502 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				...
				float3 desaturateInitialColor9_g1524 = ( ( Base12_g1520 * temp_output_94_0_g1516 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				...
				float4 ColorOut1025 = ( lerpResult101_g1520 + float4( desaturateVar9_g1524 , 0.0 ) );
				...
				float ifLocalVar13_g1526 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1526 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1526 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_44 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_45 = (5.0).xxxx;
				float4 clampResult18_g1526 = clamp( ase_lightColor , temp_cast_44 , temp_cast_45 );
				float4 temp_output_11_0_g1526 = ( ase_atten * clampResult18_g1526 );
				float4 temp_output_8_0_g1526 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1526 = 0;
				if( ifLocalVar13_g1526 > 0.0 )
				ifLocalVar3_g1526 = temp_output_11_0_g1526;
				else if( ifLocalVar13_g1526 == 0.0 )
				ifLocalVar3_g1526 = temp_output_8_0_g1526;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1526 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1526 );
				#else
				float4 staticSwitch9_g1526 = ifLocalVar3_g1526;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1526;
				float temp_output_12_0_g1519 = ( ( ( temp_output_94_0_g1516 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1516 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1516 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1516 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1516 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				float SSSA581 = tex2DNode297.a;
				float temp_output_28_0_g1519 = ( _SSSAlphaEmissiveToggle * ( SSSA581 >= 0.5 ? _SSSAlphaEmissiveIntensity : 0.0 ) );
				float clampResult30_g1519 = clamp( ( temp_output_12_0_g1519 - temp_output_28_0_g1519 ) , 0.0 , temp_output_12_0_g1519 );
				float2 uv_EmissionMask = i.ase_texcoord1.xy * _EmissionMask_ST.xy + _EmissionMask_ST.zw;
				float EmissionRampMask920 = max( ( clampResult30_g1519 + temp_output_28_0_g1519 ) , ( tex2D( _EmissionMask, uv_EmissionMask ).r * _EmissionMaskIntensity ) );
				float4 temp_cast_47 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1526 = 0;
				if( ifLocalVar13_g1526 > 0.0 )
				ifLocalVar17_g1526 = clampResult18_g1526;
				else if( ifLocalVar13_g1526 == 0.0 )
				ifLocalVar17_g1526 = temp_output_8_0_g1526;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1526 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1526 = max( temp_cast_47 , ifLocalVar17_g1526 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1526;
...
Node;AmplifyShaderEditor.FunctionNode;1093;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1526;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1053;5556.248,5059.576;Inherit;False;ASWOutline;-1;;1533;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1095;8035.982,4319.474;Float;False;True;-1;2;ASWGuiltyGearStriveGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.1.3;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;False;True;False;;False;0
...
ASEEND*/
//CHKSM=84C52A38D6B410B14880476BEA6165BF888A84CB