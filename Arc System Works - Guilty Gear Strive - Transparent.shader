...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.0.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_2_0_g1501 = NdL20_g1500;
				float temp_output_3_0_g1501 = -_Shadow1Smoothness;
				...
				float temp_output_1_0_g1501 = RealShadow1Push16_g1500;
				float smoothstepResult6_g1501 = smoothstep( ( ( temp_output_2_0_g1501 / 1.0 ) + temp_output_3_0_g1501 ) , temp_output_2_0_g1501 , temp_output_1_0_g1501);
				float lerpResult7_g1501 = lerp( smoothstepResult6_g1501 , ( temp_output_1_0_g1501 >= temp_output_2_0_g1501 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1501 ? 1.0 : 0.0 ));
				...
				float temp_output_2_0_g1502 = NdL20_g1500;
				float temp_output_3_0_g1502 = -_Shadow2Smoothness;
				float temp_output_1_0_g1502 = RealShadow2Push18_g1500;
				float smoothstepResult6_g1502 = smoothstep( ( ( temp_output_2_0_g1502 / 1.0 ) + temp_output_3_0_g1502 ) , temp_output_2_0_g1502 , temp_output_1_0_g1502);
				float lerpResult7_g1502 = lerp( smoothstepResult6_g1502 , ( temp_output_1_0_g1502 >= temp_output_2_0_g1502 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1502 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1500 = max( max( ( 1.0 - ( VertexR33_g1500 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1502 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1500 = ( max( ( 1.0 - ( VertexR33_g1500 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1501 , ( RealShadow1Push16_g1500 >= RealShadow2Push18_g1500 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1500 );
				float3 lerpResult100_g1519 = lerp( desaturateVar9_g1521 , desaturateVar9_g1520 , ( 1.0 - temp_output_43_0_g1500 ));
				...
				float3 desaturateInitialColor9_g1523 = ( ( Base12_g1519 * temp_output_94_0_g1500 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				...
				#else
				float4 staticSwitch30_g1525 = max( temp_cast_44 , ifLocalVar17_g1525 );
				#endif
...
/*ASEBEGIN
Version=18900
-2009;121;1790;816;817.675;-5885.277;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1053;5556.248,5059.576;Inherit;False;ASWOutline;-1;;1529;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1095;8035.982,4319.474;Float;False;True;-1;2;ASWGuiltyGearStriveGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.0.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;False;False;False;;False;0
...
WireConnection;965;121;1105;0
WireConnection;965;10;716;0
WireConnection;965;11;727;0
WireConnection;965;120;1106;0
...
ASEEND*/
//CHKSM=BB5FD71BDA029CFDD1A957D1BF9DC19D2EB58381