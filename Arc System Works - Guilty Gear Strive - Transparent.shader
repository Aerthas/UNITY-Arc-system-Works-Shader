...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v7.2.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float ILMColorSetting60_g1497 = ILMColorSetting1007;
				float4 ILMAColor54_g1497 = ILMAColor1005;
				float DetailColorSetting44_g1497 = DetailColorSetting1067;
				float4 DetailColor41_g1497 = DetailColor1066;
				...
				float3x3 temp_output_24_0_g1497 = ( _EnableColorReplacer == 0.0 ? float3x3(appendResult762, appendResult763, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1487 == 5.0 ? lerpResult4_g1492 : ( temp_output_52_0_g1487 == 4.0 ? temp_output_105_0_g1487 : ( temp_output_52_0_g1487 == 3.0 ? temp_output_104_0_g1487 : ( temp_output_52_0_g1487 == 2.0 ? temp_output_102_0_g1487 : ( temp_output_52_0_g1487 == 1.0 ? temp_output_106_0_g1487 : float4( temp_output_67_0_g1487[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1492.rgb, float3( 0,0,0 )) );
				float2 uv2_Detail = i.ase_texcoord1.zw * _Detail_ST.xy + _Detail_ST.zw;
				float4 Detail1062 = tex2D( _Detail, uv2_Detail );
				float4 detail38_g1497 = Detail1062;
				float4 lerpResult10_g1497 = lerp( DetailColor41_g1497 , float4( temp_output_24_0_g1497[0] , 0.0 ) , detail38_g1497);
				float3 SSS50_g1497 = temp_output_24_0_g1497[1];
				float2 uv_OLM = i.ase_texcoord1.xy * _OLM_ST.xy + _OLM_ST.zw;
				float4 OLM1090 = tex2D( _OLM, uv_OLM );
				float4 OLM47_g1497 = OLM1090;
				float4 SSSOLM63_g1497 = ( float4( SSS50_g1497 , 0.0 ) * OLM47_g1497 );
				float4 lerpResult36_g1497 = lerp( SSSOLM63_g1497 , float4( temp_output_24_0_g1497[0] , 0.0 ) , detail38_g1497);
				float4 temp_output_20_0_g1497 = ( DetailColorSetting44_g1497 == 1.0 ? lerpResult10_g1497 : lerpResult36_g1497 );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1497 = ILMA357;
				float4 lerpResult12_g1497 = lerp( ILMAColor54_g1497 , temp_output_20_0_g1497 , ILMA57_g1497);
				float4 lerpResult65_g1497 = lerp( SSSOLM63_g1497 , temp_output_20_0_g1497 , ILMA57_g1497);
				float4 Base1076 = ( ILMColorSetting60_g1497 == 1.0 ? lerpResult12_g1497 : lerpResult65_g1497 );
				float4 Base12_g1507 = Base1076;
				...
				float clampResult87_g1498 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1496) / max( blendOpSrc34_g1496, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_29 = (clampResult87_g1498).xxxx;
				float4 blendOpSrc30_g1507 = Base12_g1507;
				float4 blendOpDest30_g1507 = temp_cast_29;
				float4 lerpBlendMode30_g1507 = lerp(blendOpDest30_g1507,min( blendOpSrc30_g1507 , blendOpDest30_g1507 ),0.9);
				float3 desaturateInitialColor9_g1510 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1507 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1510 = dot( desaturateInitialColor9_g1510, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1510 = lerp( desaturateInitialColor9_g1510, desaturateDot9_g1510.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 temp_output_95_0_g1507 = ( float4( desaturateVar9_g1510 , 0.0 ) + Base12_g1507 );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1508 = ( temp_output_95_0_g1507 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1508 = dot( desaturateInitialColor9_g1508, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1508 = lerp( desaturateInitialColor9_g1508, desaturateDot9_g1508.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 Base52_g1497 = temp_output_24_0_g1497[0];
				float3 blendOpSrc31_g1497 = Base52_g1497;
				float3 blendOpDest31_g1497 = temp_output_24_0_g1497[1];
				float4 lerpResult7_g1497 = lerp( ( DetailColor41_g1497 * float4( ( saturate( abs( blendOpSrc31_g1497 - blendOpDest31_g1497 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1497[1] , 0.0 ) , detail38_g1497);
				float4 lerpResult69_g1497 = lerp( SSSOLM63_g1497 , float4( temp_output_24_0_g1497[1] , 0.0 ) , detail38_g1497);
				float4 temp_output_8_0_g1497 = ( DetailColorSetting44_g1497 == 1.0 ? lerpResult7_g1497 : lerpResult69_g1497 );
				float4 blendOpSrc32_g1497 = temp_output_20_0_g1497;
				float4 blendOpDest32_g1497 = temp_output_8_0_g1497;
				float4 lerpResult17_g1497 = lerp( ( ILMAColor54_g1497 * ( saturate( abs( blendOpSrc32_g1497 - blendOpDest32_g1497 ) )) ) , temp_output_8_0_g1497 , ILMA57_g1497);
				float4 lerpResult67_g1497 = lerp( SSSOLM63_g1497 , temp_output_8_0_g1497 , ILMA57_g1497);
				float4 SSS1077 = ( ILMColorSetting60_g1497 == 1.0 ? lerpResult17_g1497 : lerpResult67_g1497 );
				float4 SSS14_g1507 = SSS1077;
				float3 desaturateInitialColor9_g1511 = ( SSS14_g1507 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1511 = dot( desaturateInitialColor9_g1511, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1511 = lerp( desaturateInitialColor9_g1511, desaturateDot9_g1511.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc51_g1507 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1507 = ( temp_output_95_0_g1507 * SSS14_g1507 );
				float4 lerpBlendMode51_g1507 = lerp(blendOpDest51_g1507,2.0f*blendOpDest51_g1507*blendOpSrc51_g1507 + blendOpDest51_g1507*blendOpDest51_g1507*(1.0f - 2.0f*blendOpSrc51_g1507),0.5);
				float3 desaturateInitialColor9_g1509 = ( ( saturate( lerpBlendMode51_g1507 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1509 = dot( desaturateInitialColor9_g1509, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1509 = lerp( desaturateInitialColor9_g1509, desaturateDot9_g1509.xxx, ( 1.0 - _Shadow2Saturation ) );
				float VertexR33_g1498 = i.ase_color.r;
				...
				float NdL20_g1498 = temp_output_1087_0;
				float temp_output_9_0_g1498 = _Shadow1Push;
				float temp_output_11_0_g1498 = _Shadow2Push;
				float clampResult15_g1498 = clamp( temp_output_9_0_g1498 , temp_output_11_0_g1498 , temp_output_9_0_g1498 );
				float RealShadow1Push16_g1498 = clampResult15_g1498;
				float clampResult17_g1498 = clamp( temp_output_11_0_g1498 , temp_output_11_0_g1498 , temp_output_9_0_g1498 );
				float RealShadow2Push18_g1498 = clampResult17_g1498;
				float temp_output_42_0_g1498 = max( max( ( 1.0 - ( VertexR33_g1498 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1498 < RealShadow2Push18_g1498 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1498 = ( max( ( 1.0 - ( VertexR33_g1498 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1498 < RealShadow1Push16_g1498 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1498 >= RealShadow2Push18_g1498 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1498 );
				float3 lerpResult100_g1507 = lerp( desaturateVar9_g1511 , desaturateVar9_g1509 , ( 1.0 - temp_output_43_0_g1498 ));
				float clampResult90_g1498 = clamp( ( 1.0 - ( temp_output_43_0_g1498 + temp_output_42_0_g1498 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1507 = clampResult90_g1498;
				float4 lerpResult101_g1507 = lerp( float4( desaturateVar9_g1508 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1507 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1507 ));
				float EnableRimlight82_g1498 = _EnableRimlight;
				float dotResult31_g1484 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1484 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g1498 = ( ( 1.0 - ( dotResult31_g1484 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				float clampResult91_g1498 = clamp( temp_output_42_0_g1498 , 0.0 , 1.0 );
				float clampResult88_g1498 = clamp( ( ceil( ( ( NdV48_g1498 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1498 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1498 = ( EnableRimlight82_g1498 == 1.0 ? clampResult88_g1498 : 0.0 );
				float3 desaturateInitialColor9_g1512 = ( ( Base12_g1507 * temp_output_94_0_g1498 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1512 = dot( desaturateInitialColor9_g1512, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1512 = lerp( desaturateInitialColor9_g1512, desaturateDot9_g1512.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1507 + float4( desaturateVar9_g1512 , 0.0 ) );
				float4 temp_output_1_0_g1514 = ColorOut1025;
				float4 lerpResult8_g1514 = lerp( DetailColor1066 , temp_output_1_0_g1514 , Detail1062);
				float4 temp_output_9_0_g1514 = ( DetailColorSetting1067 == 2.0 ? lerpResult8_g1514 : temp_output_1_0_g1514 );
				float4 lerpResult10_g1514 = lerp( ILMAColor1005 , temp_output_9_0_g1514 , ILMA357);
				float LightColorSetting872 = _LightColorSetting;
				float ifLocalVar13_g1513 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1513 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1513 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_43 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_44 = (5.0).xxxx;
				float4 clampResult18_g1513 = clamp( ase_lightColor , temp_cast_43 , temp_cast_44 );
				float4 temp_output_11_0_g1513 = ( ase_atten * clampResult18_g1513 );
				float4 temp_output_8_0_g1513 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1513 = 0;
				if( ifLocalVar13_g1513 > 0.0 )
				ifLocalVar3_g1513 = temp_output_11_0_g1513;
				else if( ifLocalVar13_g1513 == 0.0 )
				ifLocalVar3_g1513 = temp_output_8_0_g1513;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1513 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1513 );
				#else
				float4 staticSwitch9_g1513 = ifLocalVar3_g1513;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1513;
				float EmissionRampMask920 = ( ( ( temp_output_94_0_g1498 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1498 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1498 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1498 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1498 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				float4 temp_cast_45 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1513 = 0;
				if( ifLocalVar13_g1513 > 0.0 )
				ifLocalVar17_g1513 = clampResult18_g1513;
				else if( ifLocalVar13_g1513 == 0.0 )
				ifLocalVar17_g1513 = temp_output_8_0_g1513;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1513 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1513 = max( temp_cast_45 , ifLocalVar17_g1513 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1513;
				float4 lerpResult1100 = lerp( ( ( ILMColorSetting1007 == 2.0 ? lerpResult10_g1514 : temp_output_9_0_g1514 ) * GlobalLightColor944 ) , ( _EmissionIntensity * ColorOut1025 * EmissionLightColor947 ) , EmissionRampMask920);
				float temp_output_48_0_g1515 = _DebugGroup;
				float temp_output_47_0_g1515 = _VertexChannel;
				float4 temp_output_59_0_g1515 = _DebugColor;
				float temp_output_50_0_g1515 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1515 = appendResult1031;
				float4 break7_g1515 = temp_output_54_0_g1515;
				float temp_output_57_0_g1515 = 0.0;
				float4 Debug987 = ( temp_output_48_0_g1515 == 0.0 ? ( temp_output_47_0_g1515 == 0.0 ? i.ase_color : ( temp_output_47_0_g1515 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1515 ) : ( temp_output_47_0_g1515 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1515 ) : ( temp_output_47_0_g1515 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1515 ) : ( temp_output_47_0_g1515 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1515 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1515 == 1.0 ? ( temp_output_50_0_g1515 == 0.0 ? temp_output_54_0_g1515 : ( temp_output_50_0_g1515 == 1.0 ? ( break7_g1515.r * temp_output_59_0_g1515 ) : ( temp_output_50_0_g1515 == 2.0 ? ( break7_g1515.g * temp_output_59_0_g1515 ) : ( temp_output_50_0_g1515 == 3.0 ? ( break7_g1515.b * temp_output_59_0_g1515 ) : ( temp_output_50_0_g1515 == 4.0 ? ( break7_g1515.a * temp_output_59_0_g1515 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1515 == 2.0 ? ( temp_output_57_0_g1515 == 0.0 ? ( BaseA580 * temp_output_59_0_g1515 ) : ( temp_output_57_0_g1515 == 1.0 ? ( 0.0 * temp_output_59_0_g1515 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
...
/*ASEBEGIN
Version=18900
-2365;171;2298;1017;-3245.174;-3812.783;3.073311;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1093;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1513;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1515;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1086;5503.274,4297.582;Inherit;False;Line Priority Color Change;-1;;1514;e71d6fe87185a054c9d0e635f7af6cdb;0;7;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;5556.248,5059.576;Inherit;False;ASWOutline;-1;;1516;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1095;8035.982,4319.474;Float;False;True;-1;2;ASWGuiltyGearStriveGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v7.2.1;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;False;False;False;;False;0
...
ASEEND*/
//CHKSM=55DA58BABF68AD4FDA75DB9A7080408CB9CA691D