...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.1.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1393_g1504(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0394_g1504(  )
			{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float ILMColorSetting60_g1506 = ILMColorSetting1007;
				float4 ILMAColor54_g1506 = ILMAColor1005;
				float DetailColorSetting44_g1506 = DetailColorSetting1067;
				float4 DetailColor41_g1506 = DetailColor1066;
				...
				float3x3 temp_output_67_0_g1496 = float3x3(appendResult762, appendResult763, float3( 0,0,0 ));
				...
				float3x3 temp_output_24_0_g1506 = ( _EnableColorReplacer == 0.0 ? float3x3(appendResult762, appendResult763, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1496 == 5.0 ? lerpResult4_g1501 : ( temp_output_52_0_g1496 == 4.0 ? temp_output_105_0_g1496 : ( temp_output_52_0_g1496 == 3.0 ? temp_output_104_0_g1496 : ( temp_output_52_0_g1496 == 2.0 ? temp_output_102_0_g1496 : ( temp_output_52_0_g1496 == 1.0 ? temp_output_106_0_g1496 : float4( temp_output_67_0_g1496[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1501.rgb, float3( 0,0,0 )) );
				float2 uv2_Detail = i.ase_texcoord1.zw * _Detail_ST.xy + _Detail_ST.zw;
				float4 Detail1062 = tex2D( _Detail, uv2_Detail );
				float4 detail38_g1506 = Detail1062;
				float4 lerpResult10_g1506 = lerp( DetailColor41_g1506 , float4( temp_output_24_0_g1506[0] , 0.0 ) , detail38_g1506);
				float3 SSS50_g1506 = temp_output_24_0_g1506[1];
				float2 uv_OLM = i.ase_texcoord1.xy * _OLM_ST.xy + _OLM_ST.zw;
				float4 OLM1090 = tex2D( _OLM, uv_OLM );
				float4 OLM47_g1506 = OLM1090;
				float4 SSSOLM63_g1506 = ( float4( SSS50_g1506 , 0.0 ) * OLM47_g1506 );
				float4 lerpResult36_g1506 = lerp( SSSOLM63_g1506 , float4( temp_output_24_0_g1506[0] , 0.0 ) , detail38_g1506);
				float4 temp_output_20_0_g1506 = ( DetailColorSetting44_g1506 == 1.0 ? lerpResult10_g1506 : lerpResult36_g1506 );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1506 = ILMA357;
				float4 lerpResult12_g1506 = lerp( ILMAColor54_g1506 , temp_output_20_0_g1506 , ILMA57_g1506);
				float4 lerpResult65_g1506 = lerp( SSSOLM63_g1506 , temp_output_20_0_g1506 , ILMA57_g1506);
				float4 Base1076 = ( ILMColorSetting60_g1506 == 1.0 ? lerpResult12_g1506 : lerpResult65_g1506 );
				...
				float3 localViewMatrix1393_g1504 = ViewMatrix1393_g1504();
				float3 normalizeResult396_g1504 = normalize( localViewMatrix1393_g1504 );
				float temp_output_395_0_g1504 = radians( -_ViewDirOffsetYaw );
				float3 localViewMatrix0394_g1504 = ViewMatrix0394_g1504();
				float3 normalizeResult399_g1504 = normalize( localViewMatrix0394_g1504 );
				float3 rotatedValue400_g1504 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult399_g1504, normalizeResult396_g1504, temp_output_395_0_g1504 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_408_0_g1504 = ( ase_worldPos - i.ase_texcoord4.xyz );
				float3 localStereoCameraViewPosition30_g1502 = StereoCameraViewPosition30_g1502();
				float3 rotatedValue401_g1504 = RotateAroundAxis( temp_output_408_0_g1504, localStereoCameraViewPosition30_g1502, normalizeResult396_g1504, temp_output_395_0_g1504 );
				float3 rotatedValue403_g1504 = RotateAroundAxis( temp_output_408_0_g1504, rotatedValue401_g1504, rotatedValue400_g1504, radians( _ViewDirOffsetPitch ) );
				float3 normalizeResult38_g1502 = normalize( ( rotatedValue403_g1504 - temp_output_408_0_g1504 ) );
				...
				float blendOpSrc34_g1505 = ILMB576;
				float blendOpDest34_g1505 = dotResult50_g1502;
				float clampResult87_g1507 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1505) / max( blendOpSrc34_g1505, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_29 = (clampResult87_g1507).xxxx;
				...
				float3 Base52_g1506 = temp_output_24_0_g1506[0];
				float3 blendOpSrc31_g1506 = Base52_g1506;
				float3 blendOpDest31_g1506 = temp_output_24_0_g1506[1];
				float4 lerpResult7_g1506 = lerp( ( DetailColor41_g1506 * float4( ( saturate( abs( blendOpSrc31_g1506 - blendOpDest31_g1506 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1506[1] , 0.0 ) , detail38_g1506);
				float4 lerpResult69_g1506 = lerp( SSSOLM63_g1506 , float4( temp_output_24_0_g1506[1] , 0.0 ) , detail38_g1506);
				float4 temp_output_8_0_g1506 = ( DetailColorSetting44_g1506 == 1.0 ? lerpResult7_g1506 : lerpResult69_g1506 );
				float4 blendOpSrc32_g1506 = temp_output_20_0_g1506;
				float4 blendOpDest32_g1506 = temp_output_8_0_g1506;
				float4 lerpResult17_g1506 = lerp( ( ILMAColor54_g1506 * ( saturate( abs( blendOpSrc32_g1506 - blendOpDest32_g1506 ) )) ) , temp_output_8_0_g1506 , ILMA57_g1506);
				float4 lerpResult67_g1506 = lerp( SSSOLM63_g1506 , temp_output_8_0_g1506 , ILMA57_g1506);
				float4 SSS1077 = ( ILMColorSetting60_g1506 == 1.0 ? lerpResult17_g1506 : lerpResult67_g1506 );
				...
				float VertexR33_g1507 = pow( pow( i.ase_color.r , 2.2 ) , 2.2 );
				float dotResult46_g1502 = dot( ifLocalVar9_g1502 , normalizedWorldNormal );
				float temp_output_36_0_g1505 = ( ( dotResult46_g1502 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1505 = ILMG574;
				float temp_output_1087_0 = ( temp_output_36_0_g1505 * temp_output_1_0_g1505 );
				float NdL20_g1507 = temp_output_1087_0;
				float temp_output_2_0_g1508 = NdL20_g1507;
				float temp_output_3_0_g1508 = -_Shadow1Smoothness;
				float temp_output_9_0_g1507 = _Shadow1Push;
				float temp_output_11_0_g1507 = _Shadow2Push;
				float clampResult15_g1507 = clamp( temp_output_9_0_g1507 , temp_output_11_0_g1507 , temp_output_9_0_g1507 );
				float RealShadow1Push16_g1507 = clampResult15_g1507;
				float temp_output_1_0_g1508 = RealShadow1Push16_g1507;
				float smoothstepResult6_g1508 = smoothstep( ( ( temp_output_2_0_g1508 / 1.0 ) + temp_output_3_0_g1508 ) , temp_output_2_0_g1508 , temp_output_1_0_g1508);
				float lerpResult7_g1508 = lerp( smoothstepResult6_g1508 , ( temp_output_1_0_g1508 >= temp_output_2_0_g1508 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1508 ? 1.0 : 0.0 ));
				float clampResult17_g1507 = clamp( temp_output_11_0_g1507 , temp_output_11_0_g1507 , temp_output_9_0_g1507 );
				float RealShadow2Push18_g1507 = clampResult17_g1507;
				float temp_output_2_0_g1509 = NdL20_g1507;
				float temp_output_3_0_g1509 = -_Shadow2Smoothness;
				float temp_output_1_0_g1509 = RealShadow2Push18_g1507;
				...
				float temp_output_42_0_g1507 = max( max( ( 1.0 - ( VertexR33_g1507 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1509 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1507 = ( max( ( 1.0 - ( VertexR33_g1507 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1508 , ( RealShadow1Push16_g1507 >= RealShadow2Push18_g1507 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1507 );
				float3 lerpResult100_g1519 = lerp( desaturateVar9_g1521 , desaturateVar9_g1520 , ( 1.0 - temp_output_43_0_g1507 ));
				float clampResult90_g1507 = clamp( ( 1.0 - ( temp_output_43_0_g1507 + temp_output_42_0_g1507 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1519 = clampResult90_g1507;
				...
				float EnableRimlight82_g1507 = _EnableRimlight;
				float dotResult31_g1502 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1502 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g1507 = ( ( 1.0 - ( dotResult31_g1502 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				float clampResult91_g1507 = clamp( temp_output_42_0_g1507 , 0.0 , 1.0 );
				float clampResult88_g1507 = clamp( ( ceil( ( ( NdV48_g1507 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1507 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1507 = ( EnableRimlight82_g1507 == 1.0 ? clampResult88_g1507 : 0.0 );
				float3 desaturateInitialColor9_g1523 = ( ( Base12_g1519 * temp_output_94_0_g1507 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				...
				float4 temp_output_1_0_g1529 = ColorOut1025;
				float4 lerpResult8_g1529 = lerp( DetailColor1066 , temp_output_1_0_g1529 , Detail1062);
				float4 temp_output_9_0_g1529 = ( DetailColorSetting1067 == 2.0 ? lerpResult8_g1529 : temp_output_1_0_g1529 );
				float4 lerpResult10_g1529 = lerp( ILMAColor1005 , temp_output_9_0_g1529 , ILMA357);
				...
				float4 clampResult18_g1525 = clamp( ase_lightColor , temp_cast_42 , temp_cast_43 );
				...
				float temp_output_12_0_g1518 = ( ( ( temp_output_94_0_g1507 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1507 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1507 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1507 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1507 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				...
				float4 lerpResult1100 = lerp( ( ( ILMColorSetting1007 == 2.0 ? lerpResult10_g1529 : temp_output_9_0_g1529 ) * GlobalLightColor944 ) , ( _EmissionIntensity * ColorOut1025 * EmissionLightColor947 ) , EmissionRampMask920);
...
/*ASEBEGIN
Version=18900
2975;274;1355;932;-3114.11;-3304.467;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1087;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1505;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;1112;3473.26,3694.933;Inherit;False;Ramp Creation - Guilty Gear Strive;-1;;1507;5daec4314cbb03243a1aa4ab943e34b3;0;19;1;FLOAT;0;False;3;FLOAT;0;False;2;FLOAT;0;False;5;FLOAT;0;False;7;FLOAT;0;False;80;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;121;FLOAT;0;False;10;FLOAT;0;False;11;FLOAT;0;False;120;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;97;FLOAT;0;False;101;FLOAT;0;False;104;FLOAT;0;False;107;FLOAT;0;False;110;FLOAT;0;False;10;FLOAT;100;FLOAT;103;FLOAT;106;FLOAT;109;FLOAT;112;FLOAT;76;FLOAT;69;FLOAT;62;FLOAT;0;FLOAT;44
Node;AmplifyShaderEditor.FunctionNode;1075;-812.1314,3454.46;Inherit;False;Shadow Priority Color Change;-1;;1506;e12dd788f9ad90545a25b4603cc00a62;0;8;24;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;35;COLOR;0,0,0,0;False;29;FLOAT;0;False;26;COLOR;0,0,0,0;False;25;COLOR;0,0,0,0;False;30;FLOAT;0;False;27;FLOAT;0;False;28;COLOR;0,0,0,0;False;2;COLOR;0;COLOR;23
...
Node;AmplifyShaderEditor.FunctionNode;1086;5503.274,4297.582;Inherit;False;Line Priority Color Change;-1;;1529;e71d6fe87185a054c9d0e635f7af6cdb;0;7;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;5556.248,5059.576;Inherit;False;ASWOutline;-1;;1531;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
ASEEND*/
//CHKSM=AAF76DE8256093D866703309D7EB4BE4BDC471DE