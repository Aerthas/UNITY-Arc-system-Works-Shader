	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float NdV48_g1498 = ( ( 1.0 - ( dotResult31_g1493 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				...
				float4 temp_output_1_0_g1516 = ColorOut1025;
				float4 lerpResult8_g1516 = lerp( DetailColor1066 , temp_output_1_0_g1516 , Detail1062);
				float4 temp_output_9_0_g1516 = ( DetailColorSetting1067 == 2.0 ? lerpResult8_g1516 : temp_output_1_0_g1516 );
				float4 lerpResult10_g1516 = lerp( ILMAColor1005 , temp_output_9_0_g1516 , ILMA357);
				...
				float4 lerpResult1100 = lerp( ( ( ILMColorSetting1007 == 2.0 ? lerpResult10_g1516 : temp_output_9_0_g1516 ) * GlobalLightColor944 ) , ( _EmissionIntensity * ColorOut1025 * EmissionLightColor947 ) , EmissionRampMask920);
...
/*ASEBEGIN
Version=18900
-2365;171;2298;1017;-3193.432;-2920.531;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1086;5503.274,4297.582;Inherit;False;Line Priority Color Change;-1;;1516;e71d6fe87185a054c9d0e635f7af6cdb;0;7;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;5556.248,5059.576;Inherit;False;ASWOutline;-1;;1517;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
ASEEND*/
//CHKSM=709D6AFA8B6D2985B555A65637C54F747AC006E5