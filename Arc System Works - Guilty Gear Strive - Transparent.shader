...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.1.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float ILMColorSetting60_g1503 = ILMColorSetting1007;
				float4 ILMAColor54_g1503 = ILMAColor1005;
				float DetailColorSetting44_g1503 = DetailColorSetting1067;
				float4 DetailColor41_g1503 = DetailColor1066;
				...
				float3x3 temp_output_24_0_g1503 = ( _EnableColorReplacer == 0.0 ? float3x3(appendResult762, appendResult763, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1487 == 5.0 ? lerpResult4_g1492 : ( temp_output_52_0_g1487 == 4.0 ? temp_output_105_0_g1487 : ( temp_output_52_0_g1487 == 3.0 ? temp_output_104_0_g1487 : ( temp_output_52_0_g1487 == 2.0 ? temp_output_102_0_g1487 : ( temp_output_52_0_g1487 == 1.0 ? temp_output_106_0_g1487 : float4( temp_output_67_0_g1487[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1492.rgb, float3( 0,0,0 )) );
				float2 uv2_Detail = i.ase_texcoord1.zw * _Detail_ST.xy + _Detail_ST.zw;
				float4 Detail1062 = tex2D( _Detail, uv2_Detail );
				float4 detail38_g1503 = Detail1062;
				float4 lerpResult10_g1503 = lerp( DetailColor41_g1503 , float4( temp_output_24_0_g1503[0] , 0.0 ) , detail38_g1503);
				float3 SSS50_g1503 = temp_output_24_0_g1503[1];
				float2 uv_OLM = i.ase_texcoord1.xy * _OLM_ST.xy + _OLM_ST.zw;
				float4 OLM1090 = tex2D( _OLM, uv_OLM );
				float4 OLM47_g1503 = OLM1090;
				float4 SSSOLM63_g1503 = ( float4( SSS50_g1503 , 0.0 ) * OLM47_g1503 );
				float4 lerpResult36_g1503 = lerp( SSSOLM63_g1503 , float4( temp_output_24_0_g1503[0] , 0.0 ) , detail38_g1503);
				float4 temp_output_20_0_g1503 = ( DetailColorSetting44_g1503 == 1.0 ? lerpResult10_g1503 : lerpResult36_g1503 );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1503 = ILMA357;
				float4 lerpResult12_g1503 = lerp( ILMAColor54_g1503 , temp_output_20_0_g1503 , ILMA57_g1503);
				float4 lerpResult65_g1503 = lerp( SSSOLM63_g1503 , temp_output_20_0_g1503 , ILMA57_g1503);
				float4 Base1076 = ( ILMColorSetting60_g1503 == 1.0 ? lerpResult12_g1503 : lerpResult65_g1503 );
				...
				float clampResult87_g6 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1496) / max( blendOpSrc34_g1496, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_29 = (clampResult87_g6).xxxx;
				...
				float3 Base52_g1503 = temp_output_24_0_g1503[0];
				float3 blendOpSrc31_g1503 = Base52_g1503;
				float3 blendOpDest31_g1503 = temp_output_24_0_g1503[1];
				float4 lerpResult7_g1503 = lerp( ( DetailColor41_g1503 * float4( ( saturate( abs( blendOpSrc31_g1503 - blendOpDest31_g1503 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1503[1] , 0.0 ) , detail38_g1503);
				float4 lerpResult69_g1503 = lerp( SSSOLM63_g1503 , float4( temp_output_24_0_g1503[1] , 0.0 ) , detail38_g1503);
				float4 temp_output_8_0_g1503 = ( DetailColorSetting44_g1503 == 1.0 ? lerpResult7_g1503 : lerpResult69_g1503 );
				float4 blendOpSrc32_g1503 = temp_output_20_0_g1503;
				float4 blendOpDest32_g1503 = temp_output_8_0_g1503;
				float4 lerpResult17_g1503 = lerp( ( ILMAColor54_g1503 * ( saturate( abs( blendOpSrc32_g1503 - blendOpDest32_g1503 ) )) ) , temp_output_8_0_g1503 , ILMA57_g1503);
				float4 lerpResult67_g1503 = lerp( SSSOLM63_g1503 , temp_output_8_0_g1503 , ILMA57_g1503);
				float4 SSS1077 = ( ILMColorSetting60_g1503 == 1.0 ? lerpResult17_g1503 : lerpResult67_g1503 );
				...
				float VertexR33_g6 = pow( pow( i.ase_color.r , 2.2 ) , 2.2 );
				...
				float NdL20_g6 = temp_output_1087_0;
				float temp_output_2_0_g7 = NdL20_g6;
				float temp_output_3_0_g7 = -_Shadow1Smoothness;
				float temp_output_9_0_g6 = _Shadow1Push;
				float temp_output_11_0_g6 = _Shadow2Push;
				float clampResult15_g6 = clamp( temp_output_9_0_g6 , temp_output_11_0_g6 , temp_output_9_0_g6 );
				float RealShadow1Push16_g6 = clampResult15_g6;
				float temp_output_1_0_g7 = RealShadow1Push16_g6;
				float smoothstepResult6_g7 = smoothstep( ( ( temp_output_2_0_g7 / 1.0 ) + temp_output_3_0_g7 ) , temp_output_2_0_g7 , temp_output_1_0_g7);
				float lerpResult7_g7 = lerp( smoothstepResult6_g7 , ( temp_output_1_0_g7 >= temp_output_2_0_g7 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g7 ? 1.0 : 0.0 ));
				float clampResult17_g6 = clamp( temp_output_11_0_g6 , temp_output_11_0_g6 , temp_output_9_0_g6 );
				float RealShadow2Push18_g6 = clampResult17_g6;
				float temp_output_2_0_g8 = NdL20_g6;
				float temp_output_3_0_g8 = -_Shadow2Smoothness;
				float temp_output_1_0_g8 = RealShadow2Push18_g6;
				float smoothstepResult6_g8 = smoothstep( ( ( temp_output_2_0_g8 / 1.0 ) + temp_output_3_0_g8 ) , temp_output_2_0_g8 , temp_output_1_0_g8);
				float lerpResult7_g8 = lerp( smoothstepResult6_g8 , ( temp_output_1_0_g8 >= temp_output_2_0_g8 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g8 ? 1.0 : 0.0 ));
				float temp_output_42_0_g6 = max( max( ( 1.0 - ( VertexR33_g6 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g8 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g6 = ( max( ( 1.0 - ( VertexR33_g6 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g7 , ( RealShadow1Push16_g6 >= RealShadow2Push18_g6 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g6 );
				float3 lerpResult100_g1519 = lerp( desaturateVar9_g1521 , desaturateVar9_g1520 , ( 1.0 - temp_output_43_0_g6 ));
				float clampResult90_g6 = clamp( ( 1.0 - ( temp_output_43_0_g6 + temp_output_42_0_g6 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1519 = clampResult90_g6;
				...
				float EnableRimlight82_g6 = _EnableRimlight;
				float dotResult31_g1493 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1493 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g6 = ( ( 1.0 - ( dotResult31_g1493 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				float clampResult91_g6 = clamp( temp_output_42_0_g6 , 0.0 , 1.0 );
				float clampResult88_g6 = clamp( ( ceil( ( ( NdV48_g6 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g6 ) , 0.0 , 1.0 );
				float temp_output_94_0_g6 = ( EnableRimlight82_g6 == 1.0 ? clampResult88_g6 : 0.0 );
				float3 desaturateInitialColor9_g1523 = ( ( Base12_g1519 * temp_output_94_0_g6 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				...
				float temp_output_12_0_g1518 = ( ( ( temp_output_94_0_g6 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g6 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g6 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g6 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g6 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				...
				float temp_output_48_0_g1528 = _DebugGroup;
				float temp_output_47_0_g1528 = _VertexChannel;
				float4 temp_output_59_0_g1528 = _DebugColor;
				float temp_output_50_0_g1528 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1528 = appendResult1031;
				float4 break7_g1528 = temp_output_54_0_g1528;
				float temp_output_57_0_g1528 = _BaseSSSAlphaSwap;
				float4 Debug987 = ( temp_output_48_0_g1528 == 0.0 ? ( temp_output_47_0_g1528 == 0.0 ? i.ase_color : ( temp_output_47_0_g1528 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1528 ) : ( temp_output_47_0_g1528 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1528 ) : ( temp_output_47_0_g1528 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1528 ) : ( temp_output_47_0_g1528 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1528 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1528 == 1.0 ? ( temp_output_50_0_g1528 == 0.0 ? temp_output_54_0_g1528 : ( temp_output_50_0_g1528 == 1.0 ? ( break7_g1528.r * temp_output_59_0_g1528 ) : ( temp_output_50_0_g1528 == 2.0 ? ( break7_g1528.g * temp_output_59_0_g1528 ) : ( temp_output_50_0_g1528 == 3.0 ? ( break7_g1528.b * temp_output_59_0_g1528 ) : ( temp_output_50_0_g1528 == 4.0 ? ( break7_g1528.a * temp_output_59_0_g1528 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1528 == 2.0 ? ( temp_output_57_0_g1528 == 0.0 ? ( BaseA580 * temp_output_59_0_g1528 ) : ( temp_output_57_0_g1528 == 1.0 ? ( SSSA581 * temp_output_59_0_g1528 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
...
/*ASEBEGIN
Version=18900
-2301;179;2236;938;-2673.61;-3301.467;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;727;3008,4288;Inherit;False;Property;_Shadow2Push;Shadow 2 Push;24;0;Create;True;0;0;0;False;0;False;-1;0.2;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1104;3616,2928;Inherit;False;Property;_SSSAlphaEmissiveIntensity;SSS Alpha Emissive Intensity;111;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1103;3632,2848;Inherit;False;Property;_SSSAlphaEmissiveToggle;SSS Alpha Emissive Toggle;110;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1528;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;5556.248,5059.576;Inherit;False;ASWOutline;-1;;1530;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1095;8035.982,4319.474;Float;False;True;-1;2;ASWGuiltyGearStriveGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Strive/Transparent v8.1.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;False;False;False;;False;0
...
ASEEND*/
//CHKSM=6AD6B84ED6F07A1CD7A879FA8259A523ACC50054