...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Transparent v8.1.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 blendOpSrc30_g1469 = Base12_g1469;
				float4 blendOpDest30_g1469 = temp_cast_28;
				float4 lerpBlendMode30_g1469 = lerp(blendOpDest30_g1469,min( blendOpSrc30_g1469 , blendOpDest30_g1469 ),0.9);
				float3 desaturateInitialColor9_g1472 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1469 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				...
				float4 temp_output_95_0_g1469 = ( float4( desaturateVar9_g1472 , 0.0 ) + Base12_g1469 );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1470 = ( temp_output_95_0_g1469 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1470 = dot( desaturateInitialColor9_g1470, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1470 = lerp( desaturateInitialColor9_g1470, desaturateDot9_g1470.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 SSS578 = temp_output_993_0[1];
				float4 SSS14_g1469 = float4( SSS578 , 0.0 );
				float4 temp_output_97_0_g1469 = ( temp_output_95_0_g1469 * SSS14_g1469 );
				float3 desaturateInitialColor9_g1473 = ( temp_output_97_0_g1469 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				...
				float4 blendOpSrc51_g1469 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1469 = temp_output_97_0_g1469;
				float4 lerpBlendMode51_g1469 = lerp(blendOpDest51_g1469,2.0f*blendOpDest51_g1469*blendOpSrc51_g1469 + blendOpDest51_g1469*blendOpDest51_g1469*(1.0f - 2.0f*blendOpSrc51_g1469),0.5);
				float3 desaturateInitialColor9_g1471 = ( ( saturate( lerpBlendMode51_g1469 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				...
				float temp_output_126_0_g1465 = pow( i.ase_color.r , 2.2 );
				float VertexR33_g1465 = temp_output_126_0_g1465;
				...
				float temp_output_2_0_g1466 = NdL20_g1465;
				float temp_output_3_0_g1466 = -_Shadow1Smoothness;
				...
				float temp_output_1_0_g1466 = RealShadow1Push16_g1465;
				float smoothstepResult6_g1466 = smoothstep( ( ( temp_output_2_0_g1466 / 1.0 ) + temp_output_3_0_g1466 ) , temp_output_2_0_g1466 , temp_output_1_0_g1466);
				float lerpResult7_g1466 = lerp( smoothstepResult6_g1466 , ( temp_output_1_0_g1466 >= temp_output_2_0_g1466 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1466 ? 1.0 : 0.0 ));
				...
				float temp_output_2_0_g1467 = NdL20_g1465;
				float temp_output_3_0_g1467 = -_Shadow2Smoothness;
				float temp_output_1_0_g1467 = RealShadow2Push18_g1465;
				float smoothstepResult6_g1467 = smoothstep( ( ( temp_output_2_0_g1467 / 1.0 ) + temp_output_3_0_g1467 ) , temp_output_2_0_g1467 , temp_output_1_0_g1467);
				float lerpResult7_g1467 = lerp( smoothstepResult6_g1467 , ( temp_output_1_0_g1467 >= temp_output_2_0_g1467 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1467 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1465 = max( max( ( 1.0 - ( VertexR33_g1465 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1467 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1465 = ( max( ( 1.0 - ( VertexR33_g1465 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1466 , ( RealShadow1Push16_g1465 >= RealShadow2Push18_g1465 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1465 );
				float3 lerpResult100_g1469 = lerp( desaturateVar9_g1473 , desaturateVar9_g1471 , ( 1.0 - temp_output_43_0_g1465 ));
				float clampResult90_g1465 = clamp( ( 1.0 - ( temp_output_43_0_g1465 + temp_output_42_0_g1465 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1469 = clampResult90_g1465;
				float4 lerpResult101_g1469 = lerp( float4( desaturateVar9_g1470 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1469 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1469 ));
				...
				float3 desaturateInitialColor9_g1474 = ( ( Base12_g1469 * temp_output_94_0_g1465 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1474 = dot( desaturateInitialColor9_g1474, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1474 = lerp( desaturateInitialColor9_g1474, desaturateDot9_g1474.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1469 + float4( desaturateVar9_g1474 , 0.0 ) );
				float4 lerpResult1021 = lerp( ILMAColor1005 , ColorOut1025 , ILMA357);
				float LightColorSetting872 = _LightColorSetting;
				float ifLocalVar13_g1475 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1475 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1475 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_41 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_42 = (5.0).xxxx;
				float4 clampResult18_g1475 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				float4 temp_output_11_0_g1475 = ( ase_atten * clampResult18_g1475 );
				float4 temp_output_8_0_g1475 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1475 = 0;
				if( ifLocalVar13_g1475 > 0.0 )
				ifLocalVar3_g1475 = temp_output_11_0_g1475;
				else if( ifLocalVar13_g1475 == 0.0 )
				ifLocalVar3_g1475 = temp_output_8_0_g1475;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1475 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1475 );
				#else
				float4 staticSwitch9_g1475 = ifLocalVar3_g1475;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1475;
				float2 uv_EmissionMask = i.ase_texcoord1.xy * _EmissionMask_ST.xy + _EmissionMask_ST.zw;
				float EmissionRampMask920 = max( ( ( ( temp_output_94_0_g1465 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1465 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1465 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1465 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1465 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) ) , ( tex2D( _EmissionMask, uv_EmissionMask ).r * _EmissionMaskIntensity ) );
				float4 temp_cast_44 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1475 = 0;
				if( ifLocalVar13_g1475 > 0.0 )
				ifLocalVar17_g1475 = clampResult18_g1475;
				else if( ifLocalVar13_g1475 == 0.0 )
				ifLocalVar17_g1475 = temp_output_8_0_g1475;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1475 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1475 = max( temp_cast_44 , ifLocalVar17_g1475 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1475;
				...
				float temp_output_48_0_g1476 = _DebugGroup;
				float temp_output_47_0_g1476 = _VertexChannel;
				float4 temp_output_59_0_g1476 = _DebugColor;
				float temp_output_50_0_g1476 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1476 = appendResult1031;
				float4 break7_g1476 = temp_output_54_0_g1476;
				float temp_output_57_0_g1476 = 0.0;
				float4 Debug987 = ( temp_output_48_0_g1476 == 0.0 ? ( temp_output_47_0_g1476 == 0.0 ? i.ase_color : ( temp_output_47_0_g1476 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1476 ) : ( temp_output_47_0_g1476 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1476 ) : ( temp_output_47_0_g1476 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1476 ) : ( temp_output_47_0_g1476 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1476 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1476 == 1.0 ? ( temp_output_50_0_g1476 == 0.0 ? temp_output_54_0_g1476 : ( temp_output_50_0_g1476 == 1.0 ? ( break7_g1476.r * temp_output_59_0_g1476 ) : ( temp_output_50_0_g1476 == 2.0 ? ( break7_g1476.g * temp_output_59_0_g1476 ) : ( temp_output_50_0_g1476 == 3.0 ? ( break7_g1476.b * temp_output_59_0_g1476 ) : ( temp_output_50_0_g1476 == 4.0 ? ( break7_g1476.a * temp_output_59_0_g1476 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1476 == 2.0 ? ( temp_output_57_0_g1476 == 0.0 ? ( BaseA580 * temp_output_59_0_g1476 ) : ( temp_output_57_0_g1476 == 1.0 ? ( 0.0 * temp_output_59_0_g1476 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
...
/*ASEBEGIN
Version=18900
-2301;179;2236;938;-3140.674;-2983.967;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;727;3008,4288;Inherit;False;Property;_Shadow2Push;Shadow 2 Push;23;0;Create;True;0;0;0;False;0;False;-1;0.2;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1123;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1475;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1476;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;6272.546,4921.826;Inherit;False;ASWOutline;-1;;1477;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1104;8818.479,4367.882;Float;False;True;-1;2;ASWGuiltyGearXrdGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Transparent v8.1.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;False;False;False;;False;0
...
ASEEND*/
//CHKSM=8378C91A744F60AFA323DC530F1CE16F6F7233F7