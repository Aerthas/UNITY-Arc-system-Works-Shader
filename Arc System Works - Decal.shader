...
Shader ".Aerthas/Arc System Works/Decal"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
				float2 uv_Decal = IN.texcoord.xy * _Decal_ST.xy + _Decal_ST.zw;
				
				fixed4 c = ( tex2D( _Decal, uv_Decal ) * _DecalTint );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
