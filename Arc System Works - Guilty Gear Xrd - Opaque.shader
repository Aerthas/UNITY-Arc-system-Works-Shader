...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v8.1.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix0375_g1539(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1539(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1537(  )
			{
			...
			float3 StereoCameraViewDirection32_g1537( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float3 localViewMatrix0375_g1539 = ViewMatrix0375_g1539();
				float3 normalizeResult384_g1539 = normalize( localViewMatrix0375_g1539 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_380_0_g1539 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1539 = ViewMatrix1373_g1539();
				float3 normalizeResult376_g1539 = normalize( localViewMatrix1373_g1539 );
				float3 localStereoCameraViewPosition30_g1537 = StereoCameraViewPosition30_g1537();
				float3 rotatedValue385_g1539 = RotateAroundAxis( temp_output_380_0_g1539, localStereoCameraViewPosition30_g1537, normalizeResult376_g1539, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1539 = RotateAroundAxis( temp_output_380_0_g1539, rotatedValue385_g1539, normalize( normalizeResult384_g1539 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1539 = normalize( ( rotatedValue387_g1539 - temp_output_380_0_g1539 ) );
				float3 normalizeResult38_g1537 = normalize( normalizeResult389_g1539 );
				float3 appendResult15_g1538 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1538 = normalize( appendResult15_g1538 );
				float3 normalizeResult26_g1537 = normalize( normalizeResult2_g1538 );
				float3 ifLocalVar3_g1537 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1537 = normalizeResult38_g1537;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1537 = normalizeResult26_g1537;
				...
				#endif //aselc
				float clampResult7_g1532 = clamp( ( ( abs( worldSpaceLightDir ).x > float3( 0,0,0 ) ? 1.0 : 0.0 ) + ( ase_lightColor.a > 0.0 ? 1.0 : 0.0 ) ) , 0.0 , 1.0 );
				float4 color14_g1532 = IsGammaSpace() ? float4(1,0,0,0) : float4(1,0,0,0);
				float4 color8_g1532 = IsGammaSpace() ? float4(0,1,0,0) : float4(0,1,0,0);
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1532 = color8_g1532;
				#else
				float4 staticSwitch9_g1532 = ( clampResult7_g1532 * color14_g1532 );
				#endif
				float4 break10_g1532 = staticSwitch9_g1532;
				float IsThereWorldLight450 = break10_g1532.r;
				float3 ifLocalVar8_g1537 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1537 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1537 = ifLocalVar3_g1537;
				float3 ifLocalVar9_g1537 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1537 = ifLocalVar3_g1537;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1537 = ifLocalVar8_g1537;
				float3 normalizeResult48_g1537 = normalize( ifLocalVar9_g1537 );
				float3 worldPos32_g1537 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1537 = StereoCameraViewDirection32_g1537( worldPos32_g1537 );
				float3 normalizeResult51_g1537 = normalize( ( normalizeResult48_g1537 + localStereoCameraViewDirection32_g1537 ) );
				float dotResult50_g1537 = dot( normalizedWorldNormal , normalizeResult51_g1537 );
				float blendOpSrc34_g1552 = ILMB576;
				float blendOpDest34_g1552 = dotResult50_g1537;
				float clampResult87_g1556 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1552) / max( blendOpSrc34_g1552, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_28 = (clampResult87_g1556).xxxx;
				float4 blendOpSrc30_g1541 = Base12_g1541;
				float4 blendOpDest30_g1541 = temp_cast_28;
				float4 lerpBlendMode30_g1541 = lerp(blendOpDest30_g1541,min( blendOpSrc30_g1541 , blendOpDest30_g1541 ),0.9);
				float3 desaturateInitialColor9_g1544 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1541 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1544 = dot( desaturateInitialColor9_g1544, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1544 = lerp( desaturateInitialColor9_g1544, desaturateDot9_g1544.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 temp_output_95_0_g1541 = ( float4( desaturateVar9_g1544 , 0.0 ) + Base12_g1541 );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1542 = ( temp_output_95_0_g1541 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1542 = dot( desaturateInitialColor9_g1542, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1542 = lerp( desaturateInitialColor9_g1542, desaturateDot9_g1542.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 SSS578 = temp_output_993_0[1];
				float4 SSS14_g1541 = float4( SSS578 , 0.0 );
				float4 temp_output_97_0_g1541 = ( temp_output_95_0_g1541 * SSS14_g1541 );
				float3 desaturateInitialColor9_g1545 = ( temp_output_97_0_g1541 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1545 = dot( desaturateInitialColor9_g1545, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1545 = lerp( desaturateInitialColor9_g1545, desaturateDot9_g1545.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc51_g1541 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1541 = temp_output_97_0_g1541;
				float4 lerpBlendMode51_g1541 = lerp(blendOpDest51_g1541,2.0f*blendOpDest51_g1541*blendOpSrc51_g1541 + blendOpDest51_g1541*blendOpDest51_g1541*(1.0f - 2.0f*blendOpSrc51_g1541),0.5);
				float3 desaturateInitialColor9_g1543 = ( ( saturate( lerpBlendMode51_g1541 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1543 = dot( desaturateInitialColor9_g1543, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1543 = lerp( desaturateInitialColor9_g1543, desaturateDot9_g1543.xxx, ( 1.0 - _Shadow2Saturation ) );
				float temp_output_126_0_g1556 = pow( i.ase_color.r , 2.2 );
				float VertexR33_g1556 = temp_output_126_0_g1556;
				float dotResult46_g1537 = dot( ifLocalVar9_g1537 , normalizedWorldNormal );
				float temp_output_36_0_g1552 = ( ( dotResult46_g1537 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1552 = ILMG574;
				float temp_output_1083_0 = ( temp_output_36_0_g1552 * temp_output_1_0_g1552 );
				float NdL20_g1556 = temp_output_1083_0;
				float temp_output_2_0_g1557 = NdL20_g1556;
				float temp_output_3_0_g1557 = -_Shadow1Smoothness;
				float temp_output_9_0_g1556 = _Shadow1Push;
				float temp_output_11_0_g1556 = _Shadow2Push;
				float clampResult15_g1556 = clamp( temp_output_9_0_g1556 , temp_output_11_0_g1556 , temp_output_9_0_g1556 );
				float RealShadow1Push16_g1556 = clampResult15_g1556;
				float temp_output_1_0_g1557 = RealShadow1Push16_g1556;
				float smoothstepResult6_g1557 = smoothstep( ( ( temp_output_2_0_g1557 / 1.0 ) + temp_output_3_0_g1557 ) , temp_output_2_0_g1557 , temp_output_1_0_g1557);
				float lerpResult7_g1557 = lerp( smoothstepResult6_g1557 , ( temp_output_1_0_g1557 >= temp_output_2_0_g1557 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1557 ? 1.0 : 0.0 ));
				float clampResult17_g1556 = clamp( temp_output_11_0_g1556 , temp_output_11_0_g1556 , temp_output_9_0_g1556 );
				float RealShadow2Push18_g1556 = clampResult17_g1556;
				float temp_output_2_0_g1558 = NdL20_g1556;
				float temp_output_3_0_g1558 = -_Shadow2Smoothness;
				float temp_output_1_0_g1558 = RealShadow2Push18_g1556;
				float smoothstepResult6_g1558 = smoothstep( ( ( temp_output_2_0_g1558 / 1.0 ) + temp_output_3_0_g1558 ) , temp_output_2_0_g1558 , temp_output_1_0_g1558);
				float lerpResult7_g1558 = lerp( smoothstepResult6_g1558 , ( temp_output_1_0_g1558 >= temp_output_2_0_g1558 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1558 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1556 = max( max( ( 1.0 - ( VertexR33_g1556 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1558 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1556 = ( max( ( 1.0 - ( VertexR33_g1556 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1557 , ( RealShadow1Push16_g1556 >= RealShadow2Push18_g1556 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1556 );
				float3 lerpResult100_g1541 = lerp( desaturateVar9_g1545 , desaturateVar9_g1543 , ( 1.0 - temp_output_43_0_g1556 ));
				float clampResult90_g1556 = clamp( ( 1.0 - ( temp_output_43_0_g1556 + temp_output_42_0_g1556 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1541 = clampResult90_g1556;
				float4 lerpResult101_g1541 = lerp( float4( desaturateVar9_g1542 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1541 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1541 ));
				float EnableRimlight82_g1556 = _EnableRimlight;
				float dotResult31_g1537 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1537 );
				float SSSA581 = tex2DNode297.a;
				float BaseA580 = tex2DNode296.a;
				float blendOpSrc15_g1552 = SSSA581;
				float blendOpDest15_g1552 = BaseA580;
				float NdV48_g1556 = ( ( 1.0 - ( dotResult31_g1537 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1552 - blendOpDest15_g1552 ) )) ) );
				float clampResult91_g1556 = clamp( temp_output_42_0_g1556 , 0.0 , 1.0 );
				float clampResult88_g1556 = clamp( ( ceil( ( ( NdV48_g1556 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1556 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1556 = ( EnableRimlight82_g1556 == 1.0 ? clampResult88_g1556 : 0.0 );
				float3 desaturateInitialColor9_g1546 = ( ( Base12_g1541 * temp_output_94_0_g1556 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1546 = dot( desaturateInitialColor9_g1546, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1546 = lerp( desaturateInitialColor9_g1546, desaturateDot9_g1546.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1541 + float4( desaturateVar9_g1546 , 0.0 ) );
				float4 lerpResult1021 = lerp( ILMAColor1005 , ColorOut1025 , ILMA357);
				float LightColorSetting872 = _LightColorSetting;
				float ifLocalVar13_g1547 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1547 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1547 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_41 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_42 = (5.0).xxxx;
				float4 clampResult18_g1547 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				float4 temp_output_11_0_g1547 = ( ase_atten * clampResult18_g1547 );
				float4 temp_output_8_0_g1547 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1547 = 0;
				if( ifLocalVar13_g1547 > 0.0 )
				ifLocalVar3_g1547 = temp_output_11_0_g1547;
				else if( ifLocalVar13_g1547 == 0.0 )
				ifLocalVar3_g1547 = temp_output_8_0_g1547;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1547 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1547 );
				#else
				float4 staticSwitch9_g1547 = ifLocalVar3_g1547;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1547;
				float2 uv_EmissionMask = i.ase_texcoord1.xy * _EmissionMask_ST.xy + _EmissionMask_ST.zw;
				float EmissionRampMask920 = max( ( ( ( temp_output_94_0_g1556 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1556 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1556 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1556 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1556 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) ) , ( tex2D( _EmissionMask, uv_EmissionMask ).r * _EmissionMaskIntensity ) );
				float4 temp_cast_44 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1547 = 0;
				if( ifLocalVar13_g1547 > 0.0 )
				ifLocalVar17_g1547 = clampResult18_g1547;
				else if( ifLocalVar13_g1547 == 0.0 )
				ifLocalVar17_g1547 = temp_output_8_0_g1547;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1547 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1547 = max( temp_cast_44 , ifLocalVar17_g1547 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1547;
				...
				float temp_output_48_0_g1540 = _DebugGroup;
				float temp_output_47_0_g1540 = _VertexChannel;
				float4 temp_output_59_0_g1540 = _DebugColor;
				float temp_output_50_0_g1540 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1540 = appendResult1031;
				float4 break7_g1540 = temp_output_54_0_g1540;
				float temp_output_57_0_g1540 = 0.0;
				float4 Debug987 = ( temp_output_48_0_g1540 == 0.0 ? ( temp_output_47_0_g1540 == 0.0 ? i.ase_color : ( temp_output_47_0_g1540 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1540 ) : ( temp_output_47_0_g1540 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1540 ) : ( temp_output_47_0_g1540 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1540 ) : ( temp_output_47_0_g1540 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1540 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1540 == 1.0 ? ( temp_output_50_0_g1540 == 0.0 ? temp_output_54_0_g1540 : ( temp_output_50_0_g1540 == 1.0 ? ( break7_g1540.r * temp_output_59_0_g1540 ) : ( temp_output_50_0_g1540 == 2.0 ? ( break7_g1540.g * temp_output_59_0_g1540 ) : ( temp_output_50_0_g1540 == 3.0 ? ( break7_g1540.b * temp_output_59_0_g1540 ) : ( temp_output_50_0_g1540 == 4.0 ? ( break7_g1540.a * temp_output_59_0_g1540 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1540 == 2.0 ? ( temp_output_57_0_g1540 == 0.0 ? ( BaseA580 * temp_output_59_0_g1540 ) : ( temp_output_57_0_g1540 == 1.0 ? ( 0.0 * temp_output_59_0_g1540 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1548 = _OutlineThickness;
				float3 temp_output_135_0_g1548 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1548 ) + temp_output_33_0_g1548 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1548 = ObjSpaceViewDir( float4( temp_output_135_0_g1548 , 0.0 ) );
				float4 normalizeResult142_g1548 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1548 , 0.0 ) - v.vertex ) );
				float clampResult141_g1548 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1548 = lerp( float4( temp_output_135_0_g1548 , 0.0 ) , -normalizeResult142_g1548 , ( 1.0 - clampResult141_g1548 ));
				...
				v.vertex.xyz += lerpResult145_g1548.xyz;
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1010 = lerp( ILMAColor1005 , float4( temp_output_993_0[0] , 0.0 ) , ILMA357);
				float4 Base339 = ( ILMColorSetting1007 == 1.0 ? lerpResult1010 : float4( ( ILMA357 * temp_output_993_0[0] ) , 0.0 ) );
				float4 temp_output_13_0_g1548 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1548 * temp_output_13_0_g1548 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
-2301;179;2236;938;-2963.304;-3067.47;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;297;-2678.854,3006.014;Inherit;True;Property;_SSS;SSS;2;0;Create;True;0;0;0;False;0;False;-1;None;3469f53e7d1befe49a63b70614962e6f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;296;-2723.293,2752.811;Inherit;True;Property;_Base;Base;1;0;Create;True;0;0;0;False;0;False;-1;None;d2da38049713df04cb2842b6ce906495;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;852;-2458.85,4858.562;Inherit;False;Property;_Target4Color;Target 4 Color;44;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;856;-2458.85,5306.562;Inherit;False;Property;_Target5Color;Target 5 Color;48;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;824;-2458.85,3514.56;Inherit;False;Property;_Target1Color;Target 1 Color;32;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;821;-2516.85,3216.56;Inherit;False;Property;_TotalReplacements;Total Replacements;29;1;[IntRange];Create;True;0;0;0;False;0;False;1;2;1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;826;-2458.85,3738.56;Inherit;False;Property;_Source2Color;Source 2 Color;34;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2470588,0.1607843,0.117647,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;847;-2458.85,4186.562;Inherit;False;Property;_Source3Color;Source 3 Color;38;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;855;-2458.85,5082.562;Inherit;False;Property;_Source5Color;Source 5 Color;46;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;851;-2458.85,4634.562;Inherit;False;Property;_Source4Color;Source 4 Color;42;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;828;-2458.85,3962.56;Inherit;False;Property;_Target2Color;Target 2 Color;36;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.8261052,0,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;848;-2458.85,4410.562;Inherit;False;Property;_Target3Color;Target 3 Color;40;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;822;-2490.85,3290.56;Inherit;False;Property;_Source1Color;Source 1 Color;30;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6235294,0.2470588,0.1921569,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;274;-1490.404,2845.581;Inherit;True;Property;_ILM;ILM;3;0;Create;True;0;0;0;False;0;False;-1;None;853ac78659dac774398d8bf23c6a1fca;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;909;7245.105,5208.887;Inherit;False;Property;_OutlineColor;Outline Color;81;0;Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;472;941.7625,4009.256;Inherit;False;Property;_ViewDirOffsetYaw;View Dir Offset Yaw;11;0;Create;True;0;0;0;False;0;False;0;-45;-90;90;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1083;2707.013,3668.041;Inherit;False;Final Dot Calculation;-1;;1552;966aa02f52a17a443a5106621d0d8d24;0;9;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
Node;AmplifyShaderEditor.FunctionNode;1085;3472,3680;Inherit;False;Ramp Creation - Guilty Gear Xrd;-1;;1556;92a8a58660488504fb4c65a454407910;0;19;1;FLOAT;0;False;3;FLOAT;0;False;2;FLOAT;0;False;5;FLOAT;0;False;7;FLOAT;0;False;80;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;121;FLOAT;0;False;10;FLOAT;0;False;11;FLOAT;0;False;120;FLOAT;0;False;12;FLOAT;0;False;13;FLOAT;0;False;97;FLOAT;0;False;101;FLOAT;0;False;104;FLOAT;0;False;107;FLOAT;0;False;110;FLOAT;0;False;10;FLOAT;100;FLOAT;103;FLOAT;106;FLOAT;109;FLOAT;112;FLOAT;76;FLOAT;69;FLOAT;62;FLOAT;0;FLOAT;44
...
Node;AmplifyShaderEditor.FunctionNode;1075;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1547;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;634;1049.433,2895.548;Inherit;False;Is There A Light;-1;;1532;65e24b0fdfa2e3146a301178490755c7;0;0;2;FLOAT;0;FLOAT;15
...
Node;AmplifyShaderEditor.RangedFloatNode;981;-291.8691,6048.467;Inherit;False;Property;_VertexChannel;Vertex Channel;49;1;[Enum];Create;True;0;5;All Channels;0;Red;1;Green;2;Blue;3;Alpha;4;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1540;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1537;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
Node;AmplifyShaderEditor.RangedFloatNode;711;3008,4096;Inherit;False;Property;_Shadow1Push;Shadow 1 Push;21;0;Create;True;0;0;0;False;0;False;0.5;0.328;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1078;4243.784,3442.179;Inherit;False;Emission - Guilty Gear Xrd;-1;;1549;0804f3eb9e8a1224897e481e37ef96e3;0;15;25;FLOAT;0;False;26;FLOAT;0;False;17;FLOAT;0;False;22;FLOAT;0;False;20;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1053;7678.969,5104.001;Inherit;False;ASWOutline;-1;;1548;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1066;8426.12,4375.02;Float;False;True;-1;2;ASWGuiltyGearXrdGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v8.1.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;False;False;;False;0
...
ASEEND*/
//CHKSM=E4BCAF89B0A7C53F1AD12B389B71858D0C61D5C2