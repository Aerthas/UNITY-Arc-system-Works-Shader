...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v7.1.0"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_33_0_g1441 = _OutlineThickness;
			float3 temp_output_135_0_g1441 = ( ( ase_vertexNormal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.color.g * temp_output_33_0_g1441 ) + temp_output_33_0_g1441 ) * v.color.a ) );
			float3 objectSpaceViewDir136_g1441 = ObjSpaceViewDir( float4( temp_output_135_0_g1441 , 0.0 ) );
			float4 ase_vertex4Pos = v.vertex;
			float4 normalizeResult142_g1441 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1441 , 0.0 ) - ase_vertex4Pos ) );
			float clampResult141_g1441 = clamp( ( v.color.b + _DepthOffset ) , 0.0 , 1.0 );
			float4 lerpResult145_g1441 = lerp( float4( temp_output_135_0_g1441 , 0.0 ) , -normalizeResult142_g1441 , ( 1.0 - clampResult141_g1441 ));
			float3 outlineVar = lerpResult145_g1441.xyz;
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_output_13_0_g1441 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
			o.Emission = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1441 * temp_output_13_0_g1441 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float blendOpSrc34_g1428 = ILMB576;
			float blendOpDest34_g1428 = dotResult50_g843;
			float clampResult87_g1429 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1428) / max( blendOpSrc34_g1428, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
			float4 temp_cast_72 = (clampResult87_g1429).xxxx;
			float4 blendOpSrc30_g1430 = Base12_g1430;
			float4 blendOpDest30_g1430 = temp_cast_72;
			float4 lerpBlendMode30_g1430 = lerp(blendOpDest30_g1430,min( blendOpSrc30_g1430 , blendOpDest30_g1430 ),0.9);
			float3 desaturateInitialColor9_g1433 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1430 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
			float desaturateDot9_g1433 = dot( desaturateInitialColor9_g1433, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1433 = lerp( desaturateInitialColor9_g1433, desaturateDot9_g1433.xxx, ( 1.0 - _SpecularSaturation ) );
			float4 temp_output_95_0_g1430 = ( float4( desaturateVar9_g1433 , 0.0 ) + Base12_g1430 );
			float4 LightColor779 = _LightColor;
			float3 desaturateInitialColor9_g1431 = ( temp_output_95_0_g1430 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
			float desaturateDot9_g1431 = dot( desaturateInitialColor9_g1431, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1431 = lerp( desaturateInitialColor9_g1431, desaturateDot9_g1431.xxx, ( 1.0 - _BaseSaturation ) );
			float4 AmbientColor780 = _AmbientColor;
			float3 SSS578 = temp_output_993_0[1];
			float4 SSS14_g1430 = float4( SSS578 , 0.0 );
			float4 temp_output_97_0_g1430 = ( temp_output_95_0_g1430 * SSS14_g1430 );
			float3 desaturateInitialColor9_g1434 = ( temp_output_97_0_g1430 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
			float desaturateDot9_g1434 = dot( desaturateInitialColor9_g1434, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1434 = lerp( desaturateInitialColor9_g1434, desaturateDot9_g1434.xxx, ( 1.0 - _Shadow1Saturation ) );
			float4 blendOpSrc51_g1430 = float4( 0,0,0,0 );
			float4 blendOpDest51_g1430 = temp_output_97_0_g1430;
			float4 lerpBlendMode51_g1430 = lerp(blendOpDest51_g1430,2.0f*blendOpDest51_g1430*blendOpSrc51_g1430 + blendOpDest51_g1430*blendOpDest51_g1430*(1.0f - 2.0f*blendOpSrc51_g1430),0.5);
			float3 desaturateInitialColor9_g1432 = ( ( saturate( lerpBlendMode51_g1430 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
			float desaturateDot9_g1432 = dot( desaturateInitialColor9_g1432, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1432 = lerp( desaturateInitialColor9_g1432, desaturateDot9_g1432.xxx, ( 1.0 - _Shadow2Saturation ) );
			float VertexR33_g1429 = i.vertexColor.r;
			float dotResult46_g843 = dot( ifLocalVar9_g843 , ase_normWorldNormal );
			float temp_output_36_0_g1428 = ( ( dotResult46_g843 + _GlobalLightPush ) * i.vertexColor.r );
			float ILMG574 = break292.y;
			float temp_output_1_0_g1428 = ILMG574;
			float temp_output_1064_0 = ( temp_output_36_0_g1428 * temp_output_1_0_g1428 );
			float NdL20_g1429 = temp_output_1064_0;
			float temp_output_9_0_g1429 = _Shadow1Push;
			float temp_output_11_0_g1429 = _Shadow2Push;
			float clampResult15_g1429 = clamp( temp_output_9_0_g1429 , temp_output_11_0_g1429 , temp_output_9_0_g1429 );
			float RealShadow1Push16_g1429 = clampResult15_g1429;
			float clampResult17_g1429 = clamp( temp_output_11_0_g1429 , temp_output_11_0_g1429 , temp_output_9_0_g1429 );
			float RealShadow2Push18_g1429 = clampResult17_g1429;
			float temp_output_42_0_g1429 = max( max( ( 1.0 - ( VertexR33_g1429 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1429 < RealShadow2Push18_g1429 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
			float temp_output_43_0_g1429 = ( max( ( 1.0 - ( VertexR33_g1429 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1429 < RealShadow1Push16_g1429 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1429 >= RealShadow2Push18_g1429 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1429 );
			float3 lerpResult100_g1430 = lerp( desaturateVar9_g1434 , desaturateVar9_g1432 , ( 1.0 - temp_output_43_0_g1429 ));
			float clampResult90_g1429 = clamp( ( 1.0 - ( temp_output_43_0_g1429 + temp_output_42_0_g1429 ) ) , 0.0 , 1.0 );
			float temp_output_39_0_g1430 = clampResult90_g1429;
			float4 lerpResult101_g1430 = lerp( float4( desaturateVar9_g1431 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1430 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1430 ));
			float EnableRimlight82_g1429 = _EnableRimlight;
			...
			float blendOpSrc15_g1428 = SSSA581;
			float blendOpDest15_g1428 = BaseA580;
			float NdV48_g1429 = ( ( 1.0 - ( dotResult31_g843 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1428 - blendOpDest15_g1428 ) )) ) );
			float clampResult91_g1429 = clamp( temp_output_42_0_g1429 , 0.0 , 1.0 );
			float clampResult88_g1429 = clamp( ( ceil( ( ( NdV48_g1429 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1429 ) , 0.0 , 1.0 );
			float temp_output_94_0_g1429 = ( EnableRimlight82_g1429 == 1.0 ? clampResult88_g1429 : 0.0 );
			float3 desaturateInitialColor9_g1435 = ( ( Base12_g1430 * temp_output_94_0_g1429 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
			float desaturateDot9_g1435 = dot( desaturateInitialColor9_g1435, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1435 = lerp( desaturateInitialColor9_g1435, desaturateDot9_g1435.xxx, ( 1.0 - _RimlightSaturation ) );
			float4 ColorOut1025 = ( lerpResult101_g1430 + float4( desaturateVar9_g1435 , 0.0 ) );
			float4 lerpResult1021 = lerp( ILMAColor1005 , ColorOut1025 , ILMA357);
			float LightColorSetting872 = _LightColorSetting;
			float ifLocalVar13_g1436 = 0;
			if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1436 = 0.0;
			else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1436 = IsThereWorldLight450;
			float4 temp_cast_85 = (_MinimumGlobalLightIntensity).xxxx;
			float4 temp_cast_86 = (5.0).xxxx;
			float4 clampResult18_g1436 = clamp( ase_lightColor , temp_cast_85 , temp_cast_86 );
			float4 temp_output_11_0_g1436 = ( ase_lightAtten * clampResult18_g1436 );
			float4 temp_output_8_0_g1436 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
			float4 ifLocalVar3_g1436 = 0;
			if( ifLocalVar13_g1436 > 0.0 )
				ifLocalVar3_g1436 = temp_output_11_0_g1436;
			else if( ifLocalVar13_g1436 == 0.0 )
				ifLocalVar3_g1436 = temp_output_8_0_g1436;
			#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1436 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1436 );
			#else
				float4 staticSwitch9_g1436 = ifLocalVar3_g1436;
			#endif
			float4 GlobalLightColor944 = staticSwitch9_g1436;
			float temp_output_48_0_g1440 = _DebugGroup;
			float temp_output_47_0_g1440 = _VertexChannel;
			float4 temp_output_59_0_g1440 = _DebugColor;
			float temp_output_50_0_g1440 = _ILMChannel;
			float3 ILM988 = linearToGamma277;
			float4 appendResult1031 = (float4(ILM988 , ILMA357));
			float4 temp_output_54_0_g1440 = appendResult1031;
			float4 break7_g1440 = temp_output_54_0_g1440;
			float temp_output_57_0_g1440 = 0.0;
			float4 Debug987 = ( temp_output_48_0_g1440 == 0.0 ? ( temp_output_47_0_g1440 == 0.0 ? i.vertexColor : ( temp_output_47_0_g1440 == 1.0 ? ( i.vertexColor.r * temp_output_59_0_g1440 ) : ( temp_output_47_0_g1440 == 2.0 ? ( i.vertexColor.g * temp_output_59_0_g1440 ) : ( temp_output_47_0_g1440 == 3.0 ? ( i.vertexColor.b * temp_output_59_0_g1440 ) : ( temp_output_47_0_g1440 == 4.0 ? ( i.vertexColor.a * temp_output_59_0_g1440 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1440 == 1.0 ? ( temp_output_50_0_g1440 == 0.0 ? temp_output_54_0_g1440 : ( temp_output_50_0_g1440 == 1.0 ? ( break7_g1440.r * temp_output_59_0_g1440 ) : ( temp_output_50_0_g1440 == 2.0 ? ( break7_g1440.g * temp_output_59_0_g1440 ) : ( temp_output_50_0_g1440 == 3.0 ? ( break7_g1440.b * temp_output_59_0_g1440 ) : ( temp_output_50_0_g1440 == 4.0 ? ( break7_g1440.a * temp_output_59_0_g1440 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1440 == 2.0 ? ( temp_output_57_0_g1440 == 0.0 ? ( BaseA580 * temp_output_59_0_g1440 ) : ( temp_output_57_0_g1440 == 1.0 ? ( 0.0 * temp_output_59_0_g1440 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float blendOpDest34_g1428 = dotResult50_g843;
			float clampResult87_g1429 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1428) / max( blendOpSrc34_g1428, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
			float4 temp_cast_28 = (clampResult87_g1429).xxxx;
			float4 blendOpSrc30_g1430 = Base12_g1430;
			float4 blendOpDest30_g1430 = temp_cast_28;
			float4 lerpBlendMode30_g1430 = lerp(blendOpDest30_g1430,min( blendOpSrc30_g1430 , blendOpDest30_g1430 ),0.9);
			float3 desaturateInitialColor9_g1433 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1430 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
			float desaturateDot9_g1433 = dot( desaturateInitialColor9_g1433, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1433 = lerp( desaturateInitialColor9_g1433, desaturateDot9_g1433.xxx, ( 1.0 - _SpecularSaturation ) );
			...
			float4 clampResult18_g1436 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
			float4 temp_output_8_0_g1436 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
			float4 ifLocalVar17_g1436 = 0;
			if( ifLocalVar13_g1436 > 0.0 )
				ifLocalVar17_g1436 = clampResult18_g1436;
			else if( ifLocalVar13_g1436 == 0.0 )
				ifLocalVar17_g1436 = temp_output_8_0_g1436;
			float4 EmissionLightColor947 = ifLocalVar17_g1436;
			float EmissionRampMask920 = ( ( ( temp_output_94_0_g1429 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1429 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1429 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1429 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1429 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
...
/*ASEBEGIN
Version=18900
-2526;104;2298;1017;-481.4453;-2220.594;1.772855;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1064;2707.013,3668.041;Inherit;False;Final Dot Calculation;-1;;1428;966aa02f52a17a443a5106621d0d8d24;0;9;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.RangedFloatNode;869;-1746.997,4618.438;Inherit;False;Property;_FakeGlobalLightIntensity;Fake Global Light Intensity;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;960;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1436;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;6;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1035;4243.784,3442.179;Inherit;False;Emission - Guilty Gear Xrd;-1;;1439;0804f3eb9e8a1224897e481e37ef96e3;0;13;17;FLOAT;0;False;22;FLOAT;0;False;20;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1440;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;915;5808.458,4724.881;Inherit;False;1167.994;700.8105;;9;1036;903;904;907;908;912;910;911;909;Outline;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;909;5930.458,4983.881;Inherit;False;Property;_OutlineColor;Outline Color;81;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;911;5856.458,4836.881;Inherit;False;Property;_EnableCameraDistanceMult;Enable Camera Distance Mult;79;1;[ToggleUI];Create;True;0;2;Disable;0;Enable;1;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;6272.546,4921.826;Inherit;False;ASWOutline;-1;;1441;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.GetLocalVarNode;1059;6959.712,4294.757;Inherit;False;1058;myVarName;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;266;7467.201,4094.323;Float;False;True;-1;2;ASWGuiltyGearXrdGUI;0;0;CustomLighting;.Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v7.1.0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;True;1046;0;True;1052;True;0;True;1049;0;True;1050;False;1;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;14;all;True;True;True;True;0;False;-1;True;0;True;1038;255;True;1039;255;True;1040;0;True;1041;0;True;1042;0;True;1043;0;True;1044;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;0;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=E45FE76EDE5F7D1AED2FE4E89DAFE04DCCB12E1F