...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v8.1.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1393_g1569(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0394_g1569(  )
			{
			...
			float3 StereoCameraViewPosition30_g1567(  )
			{
			...
			float3 StereoCameraViewDirection32_g1567( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float3 localViewMatrix1393_g1569 = ViewMatrix1393_g1569();
				float3 normalizeResult396_g1569 = normalize( localViewMatrix1393_g1569 );
				float temp_output_395_0_g1569 = radians( -_ViewDirOffsetYaw );
				float3 localViewMatrix0394_g1569 = ViewMatrix0394_g1569();
				float3 normalizeResult399_g1569 = normalize( localViewMatrix0394_g1569 );
				float3 rotatedValue400_g1569 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult399_g1569, normalizeResult396_g1569, temp_output_395_0_g1569 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_408_0_g1569 = ( ase_worldPos - i.ase_texcoord4.xyz );
				float3 localStereoCameraViewPosition30_g1567 = StereoCameraViewPosition30_g1567();
				float3 rotatedValue401_g1569 = RotateAroundAxis( temp_output_408_0_g1569, localStereoCameraViewPosition30_g1567, normalizeResult396_g1569, temp_output_395_0_g1569 );
				float3 rotatedValue403_g1569 = RotateAroundAxis( temp_output_408_0_g1569, rotatedValue401_g1569, rotatedValue400_g1569, radians( _ViewDirOffsetPitch ) );
				float3 normalizeResult38_g1567 = normalize( ( rotatedValue403_g1569 - temp_output_408_0_g1569 ) );
				float3 appendResult15_g1568 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1568 = normalize( appendResult15_g1568 );
				float3 normalizeResult26_g1567 = normalize( normalizeResult2_g1568 );
				float3 ifLocalVar3_g1567 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1567 = normalizeResult38_g1567;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1567 = normalizeResult26_g1567;
				...
				#endif //aselc
				float clampResult7_g1560 = clamp( ( ( abs( worldSpaceLightDir ).x > float3( 0,0,0 ) ? 1.0 : 0.0 ) + ( ase_lightColor.a > 0.0 ? 1.0 : 0.0 ) ) , 0.0 , 1.0 );
				float4 color14_g1560 = IsGammaSpace() ? float4(1,0,0,0) : float4(1,0,0,0);
				float4 color8_g1560 = IsGammaSpace() ? float4(0,1,0,0) : float4(0,1,0,0);
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1560 = color8_g1560;
				#else
				float4 staticSwitch9_g1560 = ( clampResult7_g1560 * color14_g1560 );
				#endif
				float4 break10_g1560 = staticSwitch9_g1560;
				float IsThereWorldLight450 = break10_g1560.r;
				float3 ifLocalVar8_g1567 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1567 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1567 = ifLocalVar3_g1567;
				float3 ifLocalVar9_g1567 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1567 = ifLocalVar3_g1567;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1567 = ifLocalVar8_g1567;
				float3 normalizeResult48_g1567 = normalize( ifLocalVar9_g1567 );
				float3 worldPos32_g1567 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1567 = StereoCameraViewDirection32_g1567( worldPos32_g1567 );
				float3 normalizeResult51_g1567 = normalize( ( normalizeResult48_g1567 + localStereoCameraViewDirection32_g1567 ) );
				float dotResult50_g1567 = dot( normalizedWorldNormal , normalizeResult51_g1567 );
				float blendOpSrc34_g1570 = ILMB576;
				float blendOpDest34_g1570 = dotResult50_g1567;
				float clampResult87_g1571 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1570) / max( blendOpSrc34_g1570, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_28 = (clampResult87_g1571).xxxx;
				float4 blendOpSrc30_g1575 = Base12_g1575;
				float4 blendOpDest30_g1575 = temp_cast_28;
				float4 lerpBlendMode30_g1575 = lerp(blendOpDest30_g1575,min( blendOpSrc30_g1575 , blendOpDest30_g1575 ),0.9);
				float3 desaturateInitialColor9_g1578 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1575 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1578 = dot( desaturateInitialColor9_g1578, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1578 = lerp( desaturateInitialColor9_g1578, desaturateDot9_g1578.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 temp_output_95_0_g1575 = ( float4( desaturateVar9_g1578 , 0.0 ) + Base12_g1575 );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1576 = ( temp_output_95_0_g1575 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1576 = dot( desaturateInitialColor9_g1576, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1576 = lerp( desaturateInitialColor9_g1576, desaturateDot9_g1576.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 SSS578 = temp_output_993_0[1];
				float4 SSS14_g1575 = float4( SSS578 , 0.0 );
				float4 temp_output_97_0_g1575 = ( temp_output_95_0_g1575 * SSS14_g1575 );
				float3 desaturateInitialColor9_g1579 = ( temp_output_97_0_g1575 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1579 = dot( desaturateInitialColor9_g1579, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1579 = lerp( desaturateInitialColor9_g1579, desaturateDot9_g1579.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc51_g1575 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1575 = temp_output_97_0_g1575;
				float4 lerpBlendMode51_g1575 = lerp(blendOpDest51_g1575,2.0f*blendOpDest51_g1575*blendOpSrc51_g1575 + blendOpDest51_g1575*blendOpDest51_g1575*(1.0f - 2.0f*blendOpSrc51_g1575),0.5);
				float3 desaturateInitialColor9_g1577 = ( ( saturate( lerpBlendMode51_g1575 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1577 = dot( desaturateInitialColor9_g1577, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1577 = lerp( desaturateInitialColor9_g1577, desaturateDot9_g1577.xxx, ( 1.0 - _Shadow2Saturation ) );
				float temp_output_126_0_g1571 = pow( i.ase_color.r , 2.2 );
				float VertexR33_g1571 = temp_output_126_0_g1571;
				float dotResult46_g1567 = dot( ifLocalVar9_g1567 , normalizedWorldNormal );
				float temp_output_36_0_g1570 = ( ( dotResult46_g1567 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1570 = ILMG574;
				float temp_output_1083_0 = ( temp_output_36_0_g1570 * temp_output_1_0_g1570 );
				float NdL20_g1571 = temp_output_1083_0;
				float temp_output_2_0_g1572 = NdL20_g1571;
				float temp_output_3_0_g1572 = -_Shadow1Smoothness;
				float temp_output_9_0_g1571 = _Shadow1Push;
				float temp_output_11_0_g1571 = _Shadow2Push;
				float clampResult15_g1571 = clamp( temp_output_9_0_g1571 , temp_output_11_0_g1571 , temp_output_9_0_g1571 );
				float RealShadow1Push16_g1571 = clampResult15_g1571;
				float temp_output_1_0_g1572 = RealShadow1Push16_g1571;
				float smoothstepResult6_g1572 = smoothstep( ( ( temp_output_2_0_g1572 / 1.0 ) + temp_output_3_0_g1572 ) , temp_output_2_0_g1572 , temp_output_1_0_g1572);
				float lerpResult7_g1572 = lerp( smoothstepResult6_g1572 , ( temp_output_1_0_g1572 >= temp_output_2_0_g1572 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1572 ? 1.0 : 0.0 ));
				float clampResult17_g1571 = clamp( temp_output_11_0_g1571 , temp_output_11_0_g1571 , temp_output_9_0_g1571 );
				float RealShadow2Push18_g1571 = clampResult17_g1571;
				float temp_output_2_0_g1573 = NdL20_g1571;
				float temp_output_3_0_g1573 = -_Shadow2Smoothness;
				float temp_output_1_0_g1573 = RealShadow2Push18_g1571;
				...
				float temp_output_42_0_g1571 = max( max( ( 1.0 - ( VertexR33_g1571 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1573 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1571 = ( max( ( 1.0 - ( VertexR33_g1571 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1572 , ( RealShadow1Push16_g1571 >= RealShadow2Push18_g1571 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1571 );
				float3 lerpResult100_g1575 = lerp( desaturateVar9_g1579 , desaturateVar9_g1577 , ( 1.0 - temp_output_43_0_g1571 ));
				float clampResult90_g1571 = clamp( ( 1.0 - ( temp_output_43_0_g1571 + temp_output_42_0_g1571 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1575 = clampResult90_g1571;
				float4 lerpResult101_g1575 = lerp( float4( desaturateVar9_g1576 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1575 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1575 ));
				float EnableRimlight82_g1571 = _EnableRimlight;
				float dotResult31_g1567 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1567 );
				float SSSA581 = tex2DNode297.a;
				float BaseA580 = tex2DNode296.a;
				float blendOpSrc15_g1570 = SSSA581;
				float blendOpDest15_g1570 = BaseA580;
				float NdV48_g1571 = ( ( 1.0 - ( dotResult31_g1567 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1570 - blendOpDest15_g1570 ) )) ) );
				float clampResult91_g1571 = clamp( temp_output_42_0_g1571 , 0.0 , 1.0 );
				float clampResult88_g1571 = clamp( ( ceil( ( ( NdV48_g1571 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1571 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1571 = ( EnableRimlight82_g1571 == 1.0 ? clampResult88_g1571 : 0.0 );
				float3 desaturateInitialColor9_g1580 = ( ( Base12_g1575 * temp_output_94_0_g1571 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1580 = dot( desaturateInitialColor9_g1580, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1580 = lerp( desaturateInitialColor9_g1580, desaturateDot9_g1580.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1575 + float4( desaturateVar9_g1580 , 0.0 ) );
				float4 lerpResult1021 = lerp( ILMAColor1005 , ColorOut1025 , ILMA357);
				float LightColorSetting872 = _LightColorSetting;
				float ifLocalVar13_g1581 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1581 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1581 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_41 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_42 = (5.0).xxxx;
				float4 clampResult18_g1581 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				float4 temp_output_11_0_g1581 = ( ase_atten * clampResult18_g1581 );
				float4 temp_output_8_0_g1581 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1581 = 0;
				if( ifLocalVar13_g1581 > 0.0 )
				ifLocalVar3_g1581 = temp_output_11_0_g1581;
				else if( ifLocalVar13_g1581 == 0.0 )
				ifLocalVar3_g1581 = temp_output_8_0_g1581;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1581 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1581 );
				#else
				float4 staticSwitch9_g1581 = ifLocalVar3_g1581;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1581;
				float2 uv_EmissionMask = i.ase_texcoord1.xy * _EmissionMask_ST.xy + _EmissionMask_ST.zw;
				float EmissionRampMask920 = max( ( ( ( temp_output_94_0_g1571 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1571 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1571 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1571 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1571 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) ) , ( tex2D( _EmissionMask, uv_EmissionMask ).r * _EmissionMaskIntensity ) );
				float4 temp_cast_44 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1581 = 0;
				if( ifLocalVar13_g1581 > 0.0 )
				ifLocalVar17_g1581 = clampResult18_g1581;
				else if( ifLocalVar13_g1581 == 0.0 )
				ifLocalVar17_g1581 = temp_output_8_0_g1581;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1581 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1581 = max( temp_cast_44 , ifLocalVar17_g1581 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1581;
				...
				float temp_output_48_0_g1582 = _DebugGroup;
				float temp_output_47_0_g1582 = _VertexChannel;
				float4 temp_output_59_0_g1582 = _DebugColor;
				float temp_output_50_0_g1582 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1582 = appendResult1031;
				float4 break7_g1582 = temp_output_54_0_g1582;
				float temp_output_57_0_g1582 = 0.0;
				float4 Debug987 = ( temp_output_48_0_g1582 == 0.0 ? ( temp_output_47_0_g1582 == 0.0 ? i.ase_color : ( temp_output_47_0_g1582 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1582 ) : ( temp_output_47_0_g1582 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1582 ) : ( temp_output_47_0_g1582 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1582 ) : ( temp_output_47_0_g1582 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1582 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1582 == 1.0 ? ( temp_output_50_0_g1582 == 0.0 ? temp_output_54_0_g1582 : ( temp_output_50_0_g1582 == 1.0 ? ( break7_g1582.r * temp_output_59_0_g1582 ) : ( temp_output_50_0_g1582 == 2.0 ? ( break7_g1582.g * temp_output_59_0_g1582 ) : ( temp_output_50_0_g1582 == 3.0 ? ( break7_g1582.b * temp_output_59_0_g1582 ) : ( temp_output_50_0_g1582 == 4.0 ? ( break7_g1582.a * temp_output_59_0_g1582 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1582 == 2.0 ? ( temp_output_57_0_g1582 == 0.0 ? ( BaseA580 * temp_output_59_0_g1582 ) : ( temp_output_57_0_g1582 == 1.0 ? ( 0.0 * temp_output_59_0_g1582 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1010 = lerp( ILMAColor1005 , float4( temp_output_993_0[0] , 0.0 ) , ILMA357);
				float4 Base339 = ( ILMColorSetting1007 == 1.0 ? lerpResult1010 : float4( ( ILMA357 * temp_output_993_0[0] ) , 0.0 ) );
				float4 temp_output_13_0_g1583 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1583 * temp_output_13_0_g1583 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
2975;274;1355;932;-3403.804;-3070.47;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;634;1049.433,2895.548;Inherit;False;Is There A Light;-1;;1560;65e24b0fdfa2e3146a301178490755c7;0;0;2;FLOAT;0;FLOAT;15
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1567;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.FunctionNode;1078;4243.784,3442.179;Inherit;False;Emission - Guilty Gear Xrd;-1;;1574;0804f3eb9e8a1224897e481e37ef96e3;0;15;25;FLOAT;0;False;26;FLOAT;0;False;17;FLOAT;0;False;22;FLOAT;0;False;20;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1075;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1581;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1582;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;7678.969,5104.001;Inherit;False;ASWOutline;-1;;1583;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
ASEEND*/
//CHKSM=E7001186A9BC9C1C341F77C584ABA9F2461FDFC3