...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v8.0.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix0375_g1538(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1538(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1536(  )
			{
			...
			float3 StereoCameraViewDirection32_g1536( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float3 localViewMatrix0375_g1538 = ViewMatrix0375_g1538();
				float3 normalizeResult384_g1538 = normalize( localViewMatrix0375_g1538 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_380_0_g1538 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1538 = ViewMatrix1373_g1538();
				float3 normalizeResult376_g1538 = normalize( localViewMatrix1373_g1538 );
				float3 localStereoCameraViewPosition30_g1536 = StereoCameraViewPosition30_g1536();
				float3 rotatedValue385_g1538 = RotateAroundAxis( temp_output_380_0_g1538, localStereoCameraViewPosition30_g1536, normalizeResult376_g1538, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1538 = RotateAroundAxis( temp_output_380_0_g1538, rotatedValue385_g1538, normalize( normalizeResult384_g1538 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1538 = normalize( ( rotatedValue387_g1538 - temp_output_380_0_g1538 ) );
				float3 normalizeResult38_g1536 = normalize( normalizeResult389_g1538 );
				float3 appendResult15_g1537 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1537 = normalize( appendResult15_g1537 );
				float3 normalizeResult26_g1536 = normalize( normalizeResult2_g1537 );
				float3 ifLocalVar3_g1536 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1536 = normalizeResult38_g1536;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1536 = normalizeResult26_g1536;
				...
				#endif //aselc
				float clampResult7_g1530 = clamp( ( ( abs( worldSpaceLightDir ).x > float3( 0,0,0 ) ? 1.0 : 0.0 ) + ( ase_lightColor.a > 0.0 ? 1.0 : 0.0 ) ) , 0.0 , 1.0 );
				float4 color14_g1530 = IsGammaSpace() ? float4(1,0,0,0) : float4(1,0,0,0);
				float4 color8_g1530 = IsGammaSpace() ? float4(0,1,0,0) : float4(0,1,0,0);
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1530 = color8_g1530;
				#else
				float4 staticSwitch9_g1530 = ( clampResult7_g1530 * color14_g1530 );
				#endif
				float4 break10_g1530 = staticSwitch9_g1530;
				float IsThereWorldLight450 = break10_g1530.r;
				float3 ifLocalVar8_g1536 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1536 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1536 = ifLocalVar3_g1536;
				float3 ifLocalVar9_g1536 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1536 = ifLocalVar3_g1536;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1536 = ifLocalVar8_g1536;
				float3 normalizeResult48_g1536 = normalize( ifLocalVar9_g1536 );
				float3 worldPos32_g1536 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1536 = StereoCameraViewDirection32_g1536( worldPos32_g1536 );
				float3 normalizeResult51_g1536 = normalize( ( normalizeResult48_g1536 + localStereoCameraViewDirection32_g1536 ) );
				float dotResult50_g1536 = dot( normalizedWorldNormal , normalizeResult51_g1536 );
				float blendOpSrc34_g1535 = ILMB576;
				float blendOpDest34_g1535 = dotResult50_g1536;
				float clampResult87_g1532 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1535) / max( blendOpSrc34_g1535, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_28 = (clampResult87_g1532).xxxx;
				float4 blendOpSrc30_g1524 = Base12_g1524;
				float4 blendOpDest30_g1524 = temp_cast_28;
				float4 lerpBlendMode30_g1524 = lerp(blendOpDest30_g1524,min( blendOpSrc30_g1524 , blendOpDest30_g1524 ),0.9);
				float3 desaturateInitialColor9_g1527 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1524 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1527 = dot( desaturateInitialColor9_g1527, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1527 = lerp( desaturateInitialColor9_g1527, desaturateDot9_g1527.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 temp_output_95_0_g1524 = ( float4( desaturateVar9_g1527 , 0.0 ) + Base12_g1524 );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1525 = ( temp_output_95_0_g1524 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1525 = dot( desaturateInitialColor9_g1525, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1525 = lerp( desaturateInitialColor9_g1525, desaturateDot9_g1525.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 SSS578 = temp_output_993_0[1];
				float4 SSS14_g1524 = float4( SSS578 , 0.0 );
				float4 temp_output_97_0_g1524 = ( temp_output_95_0_g1524 * SSS14_g1524 );
				float3 desaturateInitialColor9_g1528 = ( temp_output_97_0_g1524 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1528 = dot( desaturateInitialColor9_g1528, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1528 = lerp( desaturateInitialColor9_g1528, desaturateDot9_g1528.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc51_g1524 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1524 = temp_output_97_0_g1524;
				float4 lerpBlendMode51_g1524 = lerp(blendOpDest51_g1524,2.0f*blendOpDest51_g1524*blendOpSrc51_g1524 + blendOpDest51_g1524*blendOpDest51_g1524*(1.0f - 2.0f*blendOpSrc51_g1524),0.5);
				float3 desaturateInitialColor9_g1526 = ( ( saturate( lerpBlendMode51_g1524 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1526 = dot( desaturateInitialColor9_g1526, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1526 = lerp( desaturateInitialColor9_g1526, desaturateDot9_g1526.xxx, ( 1.0 - _Shadow2Saturation ) );
				float VertexR33_g1532 = i.ase_color.r;
				float dotResult46_g1536 = dot( ifLocalVar9_g1536 , normalizedWorldNormal );
				float temp_output_36_0_g1535 = ( ( dotResult46_g1536 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1535 = ILMG574;
				float temp_output_1064_0 = ( temp_output_36_0_g1535 * temp_output_1_0_g1535 );
				float NdL20_g1532 = temp_output_1064_0;
				float temp_output_2_0_g1533 = NdL20_g1532;
				float temp_output_3_0_g1533 = -_Shadow1Smoothness;
				float temp_output_9_0_g1532 = _Shadow1Push;
				float temp_output_11_0_g1532 = _Shadow2Push;
				float clampResult15_g1532 = clamp( temp_output_9_0_g1532 , temp_output_11_0_g1532 , temp_output_9_0_g1532 );
				float RealShadow1Push16_g1532 = clampResult15_g1532;
				float temp_output_1_0_g1533 = RealShadow1Push16_g1532;
				float smoothstepResult6_g1533 = smoothstep( ( ( temp_output_2_0_g1533 / 1.0 ) + temp_output_3_0_g1533 ) , temp_output_2_0_g1533 , temp_output_1_0_g1533);
				float lerpResult7_g1533 = lerp( smoothstepResult6_g1533 , ( temp_output_1_0_g1533 >= temp_output_2_0_g1533 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1533 ? 1.0 : 0.0 ));
				float clampResult17_g1532 = clamp( temp_output_11_0_g1532 , temp_output_11_0_g1532 , temp_output_9_0_g1532 );
				float RealShadow2Push18_g1532 = clampResult17_g1532;
				float temp_output_2_0_g1534 = NdL20_g1532;
				float temp_output_3_0_g1534 = -_Shadow2Smoothness;
				float temp_output_1_0_g1534 = RealShadow2Push18_g1532;
				...
				float temp_output_42_0_g1532 = max( max( ( 1.0 - ( VertexR33_g1532 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1534 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1532 = ( max( ( 1.0 - ( VertexR33_g1532 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1533 , ( RealShadow1Push16_g1532 >= RealShadow2Push18_g1532 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1532 );
				float3 lerpResult100_g1524 = lerp( desaturateVar9_g1528 , desaturateVar9_g1526 , ( 1.0 - temp_output_43_0_g1532 ));
				float clampResult90_g1532 = clamp( ( 1.0 - ( temp_output_43_0_g1532 + temp_output_42_0_g1532 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1524 = clampResult90_g1532;
				float4 lerpResult101_g1524 = lerp( float4( desaturateVar9_g1525 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1524 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1524 ));
				float EnableRimlight82_g1532 = _EnableRimlight;
				float dotResult31_g1536 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1536 );
				float SSSA581 = tex2DNode297.a;
				float BaseA580 = tex2DNode296.a;
				float blendOpSrc15_g1535 = SSSA581;
				float blendOpDest15_g1535 = BaseA580;
				float NdV48_g1532 = ( ( 1.0 - ( dotResult31_g1536 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1535 - blendOpDest15_g1535 ) )) ) );
				float clampResult91_g1532 = clamp( temp_output_42_0_g1532 , 0.0 , 1.0 );
				float clampResult88_g1532 = clamp( ( ceil( ( ( NdV48_g1532 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1532 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1532 = ( EnableRimlight82_g1532 == 1.0 ? clampResult88_g1532 : 0.0 );
				float3 desaturateInitialColor9_g1529 = ( ( Base12_g1524 * temp_output_94_0_g1532 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1529 = dot( desaturateInitialColor9_g1529, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1529 = lerp( desaturateInitialColor9_g1529, desaturateDot9_g1529.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1524 + float4( desaturateVar9_g1529 , 0.0 ) );
				...
				float EmissionRampMask920 = ( ( ( temp_output_94_0_g1532 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1532 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1532 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1532 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1532 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
...
/*ASEBEGIN
Version=18900
-2009;121;1790;816;-1885.858;-3453.665;1.755237;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1035;4243.784,3442.179;Inherit;False;Emission - Guilty Gear Xrd;-1;;1531;0804f3eb9e8a1224897e481e37ef96e3;0;13;17;FLOAT;0;False;22;FLOAT;0;False;20;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;634;1049.433,2895.548;Inherit;False;Is There A Light;-1;;1530;65e24b0fdfa2e3146a301178490755c7;0;0;2;FLOAT;0;FLOAT;15
...
Node;AmplifyShaderEditor.FunctionNode;1064;2707.013,3668.041;Inherit;False;Final Dot Calculation;-1;;1535;966aa02f52a17a443a5106621d0d8d24;0;9;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1536;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.RangedFloatNode;727;2992,4288;Inherit;False;Property;_Shadow2Push;Shadow 2 Push;23;0;Create;True;0;0;0;False;0;False;-1;0.2;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;7678.969,5104.001;Inherit;False;ASWOutline;-1;;1523;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1066;8426.12,4375.02;Float;False;True;-1;2;ASWGuiltyGearXrdGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v8.0.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;False;False;;False;0
...
WireConnection;965;121;1076;0
WireConnection;965;10;716;0
WireConnection;965;11;727;0
WireConnection;965;120;1077;0
...
ASEEND*/
//CHKSM=D070316D8752482B92437B784384AED742AF7EC2