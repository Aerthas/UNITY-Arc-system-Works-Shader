...
Shader ".Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v7.2.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix0375_g1487(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1487(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1485(  )
			{
			...
			float3 StereoCameraViewDirection32_g1485( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float3 localViewMatrix0375_g1487 = ViewMatrix0375_g1487();
				float3 normalizeResult384_g1487 = normalize( localViewMatrix0375_g1487 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_380_0_g1487 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1487 = ViewMatrix1373_g1487();
				float3 normalizeResult376_g1487 = normalize( localViewMatrix1373_g1487 );
				float3 localStereoCameraViewPosition30_g1485 = StereoCameraViewPosition30_g1485();
				float3 rotatedValue385_g1487 = RotateAroundAxis( temp_output_380_0_g1487, localStereoCameraViewPosition30_g1485, normalizeResult376_g1487, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1487 = RotateAroundAxis( temp_output_380_0_g1487, rotatedValue385_g1487, normalize( normalizeResult384_g1487 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1487 = normalize( ( rotatedValue387_g1487 - temp_output_380_0_g1487 ) );
				float3 normalizeResult38_g1485 = normalize( normalizeResult389_g1487 );
				float3 appendResult15_g1486 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1486 = normalize( appendResult15_g1486 );
				float3 normalizeResult26_g1485 = normalize( normalizeResult2_g1486 );
				float3 ifLocalVar3_g1485 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1485 = normalizeResult38_g1485;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1485 = normalizeResult26_g1485;
				...
				#endif //aselc
				float clampResult7_g1481 = clamp( ( ( abs( worldSpaceLightDir ).x > float3( 0,0,0 ) ? 1.0 : 0.0 ) + ( ase_lightColor.a > 0.0 ? 1.0 : 0.0 ) ) , 0.0 , 1.0 );
				float4 color14_g1481 = IsGammaSpace() ? float4(1,0,0,0) : float4(1,0,0,0);
				float4 color8_g1481 = IsGammaSpace() ? float4(0,1,0,0) : float4(0,1,0,0);
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1481 = color8_g1481;
				#else
				float4 staticSwitch9_g1481 = ( clampResult7_g1481 * color14_g1481 );
				#endif
				float4 break10_g1481 = staticSwitch9_g1481;
				float IsThereWorldLight450 = break10_g1481.r;
				float3 ifLocalVar8_g1485 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1485 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1485 = ifLocalVar3_g1485;
				float3 ifLocalVar9_g1485 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1485 = ifLocalVar3_g1485;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1485 = ifLocalVar8_g1485;
				float3 normalizeResult48_g1485 = normalize( ifLocalVar9_g1485 );
				float3 worldPos32_g1485 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1485 = StereoCameraViewDirection32_g1485( worldPos32_g1485 );
				float3 normalizeResult51_g1485 = normalize( ( normalizeResult48_g1485 + localStereoCameraViewDirection32_g1485 ) );
				float dotResult50_g1485 = dot( normalizedWorldNormal , normalizeResult51_g1485 );
				float blendOpSrc34_g1489 = ILMB576;
				float blendOpDest34_g1489 = dotResult50_g1485;
				float clampResult87_g1484 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1489) / max( blendOpSrc34_g1489, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_28 = (clampResult87_g1484).xxxx;
				float4 blendOpSrc30_g1491 = Base12_g1491;
				float4 blendOpDest30_g1491 = temp_cast_28;
				float4 lerpBlendMode30_g1491 = lerp(blendOpDest30_g1491,min( blendOpSrc30_g1491 , blendOpDest30_g1491 ),0.9);
				float3 desaturateInitialColor9_g1494 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1491 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1494 = dot( desaturateInitialColor9_g1494, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1494 = lerp( desaturateInitialColor9_g1494, desaturateDot9_g1494.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 temp_output_95_0_g1491 = ( float4( desaturateVar9_g1494 , 0.0 ) + Base12_g1491 );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1492 = ( temp_output_95_0_g1491 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1492 = dot( desaturateInitialColor9_g1492, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1492 = lerp( desaturateInitialColor9_g1492, desaturateDot9_g1492.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 SSS578 = temp_output_993_0[1];
				float4 SSS14_g1491 = float4( SSS578 , 0.0 );
				float4 temp_output_97_0_g1491 = ( temp_output_95_0_g1491 * SSS14_g1491 );
				float3 desaturateInitialColor9_g1495 = ( temp_output_97_0_g1491 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1495 = dot( desaturateInitialColor9_g1495, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1495 = lerp( desaturateInitialColor9_g1495, desaturateDot9_g1495.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc51_g1491 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1491 = temp_output_97_0_g1491;
				...
				float3 desaturateInitialColor9_g1493 = ( ( saturate( lerpBlendMode51_g1491 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1493 = dot( desaturateInitialColor9_g1493, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1493 = lerp( desaturateInitialColor9_g1493, desaturateDot9_g1493.xxx, ( 1.0 - _Shadow2Saturation ) );
				float VertexR33_g1484 = i.ase_color.r;
				float dotResult46_g1485 = dot( ifLocalVar9_g1485 , normalizedWorldNormal );
				float temp_output_36_0_g1489 = ( ( dotResult46_g1485 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1489 = ILMG574;
				float temp_output_1064_0 = ( temp_output_36_0_g1489 * temp_output_1_0_g1489 );
				float NdL20_g1484 = temp_output_1064_0;
				float temp_output_9_0_g1484 = _Shadow1Push;
				float temp_output_11_0_g1484 = _Shadow2Push;
				float clampResult15_g1484 = clamp( temp_output_9_0_g1484 , temp_output_11_0_g1484 , temp_output_9_0_g1484 );
				float RealShadow1Push16_g1484 = clampResult15_g1484;
				float clampResult17_g1484 = clamp( temp_output_11_0_g1484 , temp_output_11_0_g1484 , temp_output_9_0_g1484 );
				float RealShadow2Push18_g1484 = clampResult17_g1484;
				float temp_output_42_0_g1484 = max( max( ( 1.0 - ( VertexR33_g1484 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1484 < RealShadow2Push18_g1484 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1484 = ( max( ( 1.0 - ( VertexR33_g1484 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1484 < RealShadow1Push16_g1484 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1484 >= RealShadow2Push18_g1484 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1484 );
				float3 lerpResult100_g1491 = lerp( desaturateVar9_g1495 , desaturateVar9_g1493 , ( 1.0 - temp_output_43_0_g1484 ));
				float clampResult90_g1484 = clamp( ( 1.0 - ( temp_output_43_0_g1484 + temp_output_42_0_g1484 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1491 = clampResult90_g1484;
				float4 lerpResult101_g1491 = lerp( float4( desaturateVar9_g1492 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1491 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1491 ));
				float EnableRimlight82_g1484 = _EnableRimlight;
				float dotResult31_g1485 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1485 );
				...
				float NdV48_g1484 = ( ( 1.0 - ( dotResult31_g1485 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1489 - blendOpDest15_g1489 ) )) ) );
				float clampResult91_g1484 = clamp( temp_output_42_0_g1484 , 0.0 , 1.0 );
				float clampResult88_g1484 = clamp( ( ceil( ( ( NdV48_g1484 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1484 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1484 = ( EnableRimlight82_g1484 == 1.0 ? clampResult88_g1484 : 0.0 );
				float3 desaturateInitialColor9_g1496 = ( ( Base12_g1491 * temp_output_94_0_g1484 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1496 = dot( desaturateInitialColor9_g1496, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1496 = lerp( desaturateInitialColor9_g1496, desaturateDot9_g1496.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1491 + float4( desaturateVar9_g1496 , 0.0 ) );
				float4 lerpResult1021 = lerp( ILMAColor1005 , ColorOut1025 , ILMA357);
				float LightColorSetting872 = _LightColorSetting;
				float ifLocalVar13_g1498 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1498 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1498 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_41 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_42 = (5.0).xxxx;
				float4 clampResult18_g1498 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				float4 temp_output_11_0_g1498 = ( ase_atten * clampResult18_g1498 );
				float4 temp_output_8_0_g1498 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1498 = 0;
				if( ifLocalVar13_g1498 > 0.0 )
				ifLocalVar3_g1498 = temp_output_11_0_g1498;
				else if( ifLocalVar13_g1498 == 0.0 )
				ifLocalVar3_g1498 = temp_output_8_0_g1498;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1498 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1498 );
				#else
				float4 staticSwitch9_g1498 = ifLocalVar3_g1498;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1498;
				float EmissionRampMask920 = ( ( ( temp_output_94_0_g1484 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1484 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1484 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1484 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1484 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				float4 temp_cast_43 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1498 = 0;
				if( ifLocalVar13_g1498 > 0.0 )
				ifLocalVar17_g1498 = clampResult18_g1498;
				else if( ifLocalVar13_g1498 == 0.0 )
				ifLocalVar17_g1498 = temp_output_8_0_g1498;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1498 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1498 = max( temp_cast_43 , ifLocalVar17_g1498 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1498;
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1497 = _OutlineThickness;
				float3 temp_output_135_0_g1497 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1497 ) + temp_output_33_0_g1497 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1497 = ObjSpaceViewDir( float4( temp_output_135_0_g1497 , 0.0 ) );
				float4 normalizeResult142_g1497 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1497 , 0.0 ) - v.vertex ) );
				float clampResult141_g1497 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1497 = lerp( float4( temp_output_135_0_g1497 , 0.0 ) , -normalizeResult142_g1497 , ( 1.0 - clampResult141_g1497 ));
				...
				v.vertex.xyz += lerpResult145_g1497.xyz;
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1010 = lerp( ILMAColor1005 , float4( temp_output_993_0[0] , 0.0 ) , ILMA357);
				float4 Base339 = ( ILMColorSetting1007 == 1.0 ? lerpResult1010 : float4( ( ILMA357 * temp_output_993_0[0] ) , 0.0 ) );
				float4 temp_output_13_0_g1497 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1497 * temp_output_13_0_g1497 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
-2365;171;2298;1017;-7048.634;-4586.832;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;912;7251.105,4997.887;Inherit;False;Property;_OutlineThickness;Outline Thickness;78;0;Create;True;0;0;0;True;0;False;1;9.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;7678.969,5104.001;Inherit;False;ASWOutline;-1;;1497;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.FunctionNode;1075;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1498;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;634;1049.433,2895.548;Inherit;False;Is There A Light;-1;;1481;65e24b0fdfa2e3146a301178490755c7;0;0;2;FLOAT;0;FLOAT;15
...
Node;AmplifyShaderEditor.FunctionNode;1035;4243.784,3442.179;Inherit;False;Emission - Guilty Gear Xrd;-1;;1488;0804f3eb9e8a1224897e481e37ef96e3;0;13;17;FLOAT;0;False;22;FLOAT;0;False;20;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1485;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1066;8426.12,4375.02;Float;False;True;-1;2;ASWGuiltyGearXrdGUI;100;8;.Aerthas/Arc System Works/Game Select/Guilty Gear Xrd/Opaque v7.2.1;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;False;False;;False;0
...
ASEEND*/
//CHKSM=FF4446148DDC780C42CD328C49B7C7926511251B