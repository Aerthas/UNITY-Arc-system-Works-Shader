	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float blendOpSrc34_g1507 = ILMB576;
				float blendOpDest34_g1507 = dotResult50_g1509;
				float clampResult87_g1506 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1507) / max( blendOpSrc34_g1507, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_28 = (clampResult87_g1506).xxxx;
				float4 blendOpSrc30_g1499 = Base12_g1499;
				float4 blendOpDest30_g1499 = temp_cast_28;
				float4 lerpBlendMode30_g1499 = lerp(blendOpDest30_g1499,min( blendOpSrc30_g1499 , blendOpDest30_g1499 ),0.9);
				float3 desaturateInitialColor9_g1502 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1499 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1502 = dot( desaturateInitialColor9_g1502, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1502 = lerp( desaturateInitialColor9_g1502, desaturateDot9_g1502.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 temp_output_95_0_g1499 = ( float4( desaturateVar9_g1502 , 0.0 ) + Base12_g1499 );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1500 = ( temp_output_95_0_g1499 * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1500 = dot( desaturateInitialColor9_g1500, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1500 = lerp( desaturateInitialColor9_g1500, desaturateDot9_g1500.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 SSS578 = temp_output_993_0[1];
				float4 SSS14_g1499 = float4( SSS578 , 0.0 );
				float4 temp_output_97_0_g1499 = ( temp_output_95_0_g1499 * SSS14_g1499 );
				float3 desaturateInitialColor9_g1503 = ( temp_output_97_0_g1499 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1503 = dot( desaturateInitialColor9_g1503, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1503 = lerp( desaturateInitialColor9_g1503, desaturateDot9_g1503.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc51_g1499 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1499 = temp_output_97_0_g1499;
				float4 lerpBlendMode51_g1499 = lerp(blendOpDest51_g1499,2.0f*blendOpDest51_g1499*blendOpSrc51_g1499 + blendOpDest51_g1499*blendOpDest51_g1499*(1.0f - 2.0f*blendOpSrc51_g1499),0.5);
				float3 desaturateInitialColor9_g1501 = ( ( saturate( lerpBlendMode51_g1499 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1501 = dot( desaturateInitialColor9_g1501, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1501 = lerp( desaturateInitialColor9_g1501, desaturateDot9_g1501.xxx, ( 1.0 - _Shadow2Saturation ) );
				float VertexR33_g1506 = i.ase_color.r;
				float dotResult46_g1509 = dot( ifLocalVar9_g1509 , normalizedWorldNormal );
				float temp_output_36_0_g1507 = ( ( dotResult46_g1509 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1507 = ILMG574;
				float temp_output_1064_0 = ( temp_output_36_0_g1507 * temp_output_1_0_g1507 );
				float NdL20_g1506 = temp_output_1064_0;
				...
				float3 lerpResult100_g1499 = lerp( desaturateVar9_g1503 , desaturateVar9_g1501 , ( 1.0 - temp_output_43_0_g1506 ));
				float clampResult90_g1506 = clamp( ( 1.0 - ( temp_output_43_0_g1506 + temp_output_42_0_g1506 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1499 = clampResult90_g1506;
				float4 lerpResult101_g1499 = lerp( float4( desaturateVar9_g1500 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1499 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1499 ));
				...
				float blendOpSrc15_g1507 = SSSA581;
				float blendOpDest15_g1507 = BaseA580;
				float NdV48_g1506 = ( ( 1.0 - ( dotResult31_g1509 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1507 - blendOpDest15_g1507 ) )) ) );
				float clampResult91_g1506 = clamp( temp_output_42_0_g1506 , 0.0 , 1.0 );
				float clampResult88_g1506 = clamp( ( ceil( ( ( NdV48_g1506 > 0.1 ? 1.0 : 0.0 ) * BaseA580 ) ) - clampResult91_g1506 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1506 = ( EnableRimlight82_g1506 == 1.0 ? clampResult88_g1506 : 0.0 );
				float3 desaturateInitialColor9_g1504 = ( ( Base12_g1499 * temp_output_94_0_g1506 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1504 = dot( desaturateInitialColor9_g1504, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1504 = lerp( desaturateInitialColor9_g1504, desaturateDot9_g1504.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1499 + float4( desaturateVar9_g1504 , 0.0 ) );
				...
				float EmissionRampMask920 = ( ( ( temp_output_94_0_g1506 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1506 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1506 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1506 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1506 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
...
/*ASEBEGIN
Version=18900
84;367;2298;1011;-6764.634;-4633.832;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1064;2707.013,3668.041;Inherit;False;Final Dot Calculation;-1;;1507;966aa02f52a17a443a5106621d0d8d24;0;9;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
ASEEND*/
//CHKSM=43491F294B812059E6E627B6F2F2918C2EE823F9