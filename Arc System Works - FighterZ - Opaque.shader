...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Opaque v7.2.1"
{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 StereoCameraViewDirection32_g1503( float3 worldPos )
			{
			...
			float3 ViewMatrix0375_g1505(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1505(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1503(  )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 Base12_g1493 = Base339;
				float EnableRimlight82_g1506 = _EnableRimlight;
				float3 ase_worldNormal = i.ase_texcoord2.xyz;
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 worldPos32_g1503 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1503 = StereoCameraViewDirection32_g1503( worldPos32_g1503 );
				float dotResult31_g1503 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1503 );
				float SSSA581 = tex2DNode297.a;
				float blendOpSrc15_g1492 = SSSA581;
				float blendOpDest15_g1492 = BaseA580;
				float NdV48_g1506 = ( ( 1.0 - ( dotResult31_g1503 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1492 - blendOpDest15_g1492 ) )) ) );
				float VertexR33_g1506 = i.ase_color.r;
				float LightDirectionSetting561 = _LightDirectionSetting;
				float FallbackLightDirection563 = _FallbackLightDirection;
				float3 localViewMatrix0375_g1505 = ViewMatrix0375_g1505();
				float3 normalizeResult384_g1505 = normalize( localViewMatrix0375_g1505 );
				float3 temp_output_380_0_g1505 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1505 = ViewMatrix1373_g1505();
				float3 normalizeResult376_g1505 = normalize( localViewMatrix1373_g1505 );
				float3 localStereoCameraViewPosition30_g1503 = StereoCameraViewPosition30_g1503();
				float3 rotatedValue385_g1505 = RotateAroundAxis( temp_output_380_0_g1505, localStereoCameraViewPosition30_g1503, normalizeResult376_g1505, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1505 = RotateAroundAxis( temp_output_380_0_g1505, rotatedValue385_g1505, normalize( normalizeResult384_g1505 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1505 = normalize( ( rotatedValue387_g1505 - temp_output_380_0_g1505 ) );
				float3 normalizeResult38_g1503 = normalize( normalizeResult389_g1505 );
				float3 appendResult15_g1504 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1504 = normalize( appendResult15_g1504 );
				float3 normalizeResult26_g1503 = normalize( normalizeResult2_g1504 );
				float3 ifLocalVar3_g1503 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1503 = normalizeResult38_g1503;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1503 = normalizeResult26_g1503;
				...
				float3 ifLocalVar8_g1503 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1503 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1503 = ifLocalVar3_g1503;
				float3 ifLocalVar9_g1503 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1503 = ifLocalVar3_g1503;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1503 = ifLocalVar8_g1503;
				float dotResult46_g1503 = dot( ifLocalVar9_g1503 , normalizedWorldNormal );
				float temp_output_36_0_g1492 = ( ( dotResult46_g1503 + _GlobalLightPush ) * i.ase_color.r );
				...
				float temp_output_1_0_g1492 = ILMG574;
				float temp_output_1077_0 = ( temp_output_36_0_g1492 * temp_output_1_0_g1492 );
				float NdL20_g1506 = temp_output_1077_0;
				float temp_output_9_0_g1506 = _Shadow1Push;
				float temp_output_11_0_g1506 = _Shadow2Push;
				float clampResult15_g1506 = clamp( temp_output_9_0_g1506 , temp_output_11_0_g1506 , temp_output_9_0_g1506 );
				float RealShadow1Push16_g1506 = clampResult15_g1506;
				float clampResult17_g1506 = clamp( temp_output_11_0_g1506 , temp_output_11_0_g1506 , temp_output_9_0_g1506 );
				float RealShadow2Push18_g1506 = clampResult17_g1506;
				float temp_output_42_0_g1506 = max( max( ( 1.0 - ( VertexR33_g1506 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1506 < RealShadow2Push18_g1506 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1506 = ( max( ( 1.0 - ( VertexR33_g1506 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1506 < RealShadow1Push16_g1506 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1506 >= RealShadow2Push18_g1506 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1506 );
				float temp_output_61_0_g1506 = ( 1.0 - ( temp_output_43_0_g1506 + temp_output_42_0_g1506 ) );
				float temp_output_75_0_g1506 = ceil( ( ( ( NdV48_g1506 * BaseA580 ) > 0.0 ? 1.0 : 0.0 ) * temp_output_61_0_g1506 ) );
				float clampResult88_g1506 = clamp( temp_output_75_0_g1506 , 0.0 , 1.0 );
				float temp_output_94_0_g1506 = ( EnableRimlight82_g1506 == 1.0 ? clampResult88_g1506 : 0.0 );
				float temp_output_6_0_g1493 = temp_output_94_0_g1506;
				float4 temp_cast_29 = (temp_output_6_0_g1493).xxxx;
				float4 blendOpSrc19_g1493 = Base12_g1493;
				float4 blendOpDest19_g1493 = temp_cast_29;
				float4 lerpBlendMode19_g1493 = lerp(blendOpDest19_g1493,min( blendOpSrc19_g1493 , blendOpDest19_g1493 ),0.9);
				float4 LightColor779 = _LightColor;
				float4 LightColor16_g1493 = LightColor779;
				float3 desaturateInitialColor9_g1495 = ( ( ( BaseA13_g1493 * ( saturate( lerpBlendMode19_g1493 )) ) + ( Base12_g1493 * temp_output_6_0_g1493 ) ) * LightColor16_g1493 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
				float desaturateDot9_g1495 = dot( desaturateInitialColor9_g1495, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1495 = lerp( desaturateInitialColor9_g1495, desaturateDot9_g1495.xxx, ( 1.0 - _HighlightRimlightSaturation ) );
				float ILMB576 = break292.z;
				float3 normalizeResult48_g1503 = normalize( ifLocalVar9_g1503 );
				float3 normalizeResult51_g1503 = normalize( ( normalizeResult48_g1503 + localStereoCameraViewDirection32_g1503 ) );
				float dotResult50_g1503 = dot( normalizedWorldNormal , normalizeResult51_g1503 );
				float blendOpSrc34_g1492 = ILMB576;
				float blendOpDest34_g1492 = dotResult50_g1503;
				float temp_output_68_0_g1506 = ( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1492) / max( blendOpSrc34_g1492, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) * temp_output_61_0_g1506 );
				float clampResult87_g1506 = clamp( temp_output_68_0_g1506 , 0.0 , 1.0 );
				float temp_output_29_0_g1493 = clampResult87_g1506;
				float4 temp_cast_31 = (temp_output_29_0_g1493).xxxx;
				float4 blendOpSrc30_g1493 = Base12_g1493;
				float4 blendOpDest30_g1493 = temp_cast_31;
				float4 lerpBlendMode30_g1493 = lerp(blendOpDest30_g1493,min( blendOpSrc30_g1493 , blendOpDest30_g1493 ),0.9);
				float3 desaturateInitialColor9_g1497 = ( ( ( BaseA13_g1493 * ( saturate( lerpBlendMode30_g1493 )) ) + ( Base12_g1493 * temp_output_29_0_g1493 ) ) * LightColor16_g1493 * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1497 = dot( desaturateInitialColor9_g1497, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1497 = lerp( desaturateInitialColor9_g1497, desaturateDot9_g1497.xxx, ( 1.0 - _SpecularSaturation ) );
				float temp_output_77_0_g1506 = ( temp_output_61_0_g1506 - temp_output_68_0_g1506 );
				float clampResult90_g1506 = clamp( ( EnableRimlight82_g1506 == 1.0 ? ( temp_output_77_0_g1506 - temp_output_75_0_g1506 ) : temp_output_77_0_g1506 ) , 0.0 , 1.0 );
				float3 desaturateInitialColor9_g1499 = ( ( Base12_g1493 * clampResult90_g1506 ) * LightColor16_g1493 * _BaseIntensity * _BaseTint ).rgb;
				...
				float4 SSS14_g1493 = float4( SSS578 , 0.0 );
				float4 AmbientColor780 = _AmbientColor;
				float4 AmbientColor68_g1493 = AmbientColor780;
				float3 desaturateInitialColor9_g1498 = ( ( temp_output_43_0_g1506 * Base12_g1493 * SSS14_g1493 ) * AmbientColor68_g1493 * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1498 = dot( desaturateInitialColor9_g1498, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1498 = lerp( desaturateInitialColor9_g1498, desaturateDot9_g1498.xxx, ( 1.0 - _Shadow1Saturation ) );
				float ILMR573 = break292.x;
				float temp_output_53_0_g1506 = ceil( ( ( ( temp_output_42_0_g1506 * NdV48_g1506 ) > 0.1 ? 1.0 : 0.0 ) * ILMR573 ) );
				float clampResult91_g1506 = clamp( ( EnableRimlight82_g1506 == 1.0 ? ( temp_output_42_0_g1506 - temp_output_53_0_g1506 ) : temp_output_42_0_g1506 ) , 0.0 , 1.0 );
				float4 blendOpSrc51_g1493 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1493 = ( Base12_g1493 * SSS14_g1493 );
				float4 lerpBlendMode51_g1493 = lerp(blendOpDest51_g1493,2.0f*blendOpDest51_g1493*blendOpSrc51_g1493 + blendOpDest51_g1493*blendOpDest51_g1493*(1.0f - 2.0f*blendOpSrc51_g1493),0.5);
				float3 desaturateInitialColor9_g1496 = ( ( clampResult91_g1506 * ( saturate( lerpBlendMode51_g1493 )) ) * AmbientColor68_g1493 * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1496 = dot( desaturateInitialColor9_g1496, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1496 = lerp( desaturateInitialColor9_g1496, desaturateDot9_g1496.xxx, ( 1.0 - _Shadow2Saturation ) );
				float clampResult92_g1506 = clamp( temp_output_53_0_g1506 , 0.0 , 1.0 );
				float temp_output_96_0_g1506 = ( EnableRimlight82_g1506 == 1.0 ? clampResult92_g1506 : 0.0 );
				float temp_output_60_0_g1493 = temp_output_96_0_g1506;
				float4 blendOpSrc56_g1493 = float4( 0,0,0,0 );
				float4 blendOpDest56_g1493 = ( Base12_g1493 * SSS14_g1493 );
				float4 lerpBlendMode56_g1493 = lerp(blendOpDest56_g1493,2.0f*blendOpDest56_g1493*blendOpSrc56_g1493 + blendOpDest56_g1493*blendOpDest56_g1493*(1.0f - 2.0f*blendOpSrc56_g1493),0.5);
				float4 temp_output_56_0_g1493 = ( saturate( lerpBlendMode56_g1493 ));
				float3 desaturateInitialColor9_g1494 = ( ( ( ( temp_output_60_0_g1493 * ( temp_output_56_0_g1493 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1493 * temp_output_56_0_g1493 ) ) * ILMR573 ) * AmbientColor68_g1493 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
				float desaturateDot9_g1494 = dot( desaturateInitialColor9_g1494, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1494 = lerp( desaturateInitialColor9_g1494, desaturateDot9_g1494.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
				float3 temp_output_787_0 = ( desaturateVar9_g1495 + desaturateVar9_g1497 + desaturateVar9_g1499 + desaturateVar9_g1498 + desaturateVar9_g1496 + desaturateVar9_g1494 );
				...
				float4 EmissionRampMask920 = ( ( ( temp_output_94_0_g1506 * _HighlightRimlightEmissiveToggle ) * _HighlightRimlightEmissionIntensity ) + ( ( clampResult87_g1506 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1506 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1506 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1506 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( temp_output_96_0_g1506 * _ShadowRimlightEmissiveToggle ) * _ShadowRimlightEmissionIntensity ) + ( ( 1.0 - ILMA357 ) * _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) + ( ( 1.0 - Detail807 ) * _BodyLinesEmissionToggle * _BodyLinesEmissionIntensity ) );
...
/*ASEBEGIN
Version=18900
84;367;2298;1011;-6306.687;-3895.899;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;912;6801.561,4223.573;Inherit;False;Property;_OutlineThickness;Outline Thickness;87;0;Create;True;0;0;0;False;0;False;0;9.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1042;4154.673,3311.612;Inherit;False;Emission - FighterZ;-1;;1491;2e32fe20ddeddef43b8b5dae014cc006;0;18;17;FLOAT;0;False;25;COLOR;0,0,0,0;False;24;FLOAT;0;False;20;FLOAT;0;False;26;FLOAT;0;False;27;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;22;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;21;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1077;2707.013,3668.041;Inherit;False;Final Dot Calculation;-1;;1492;966aa02f52a17a443a5106621d0d8d24;0;9;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1503;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
ASEEND*/
//CHKSM=94609C4690837F0CB4F019C51E5A12FC34EB7743