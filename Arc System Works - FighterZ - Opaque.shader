...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Opaque v8.0.0"
{
	Properties
	{
		...
		[ASEEnd]_Shadow2Smoothness("Shadow 2 Smoothness", Range( 0 , 1)) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			float3 StereoCameraViewDirection32_g1524( float3 worldPos )
			{
			...
			float3 ViewMatrix0375_g1526(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1526(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1524(  )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 Base12_g1513 = Base339;
				float EnableRimlight82_g1508 = _EnableRimlight;
				float3 ase_worldNormal = i.ase_texcoord2.xyz;
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 worldPos32_g1524 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1524 = StereoCameraViewDirection32_g1524( worldPos32_g1524 );
				float dotResult31_g1524 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1524 );
				float SSSA581 = tex2DNode297.a;
				float blendOpSrc15_g1511 = SSSA581;
				float blendOpDest15_g1511 = BaseA580;
				float NdV48_g1508 = ( ( 1.0 - ( dotResult31_g1524 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1511 - blendOpDest15_g1511 ) )) ) );
				...
				float3 localViewMatrix0375_g1526 = ViewMatrix0375_g1526();
				float3 normalizeResult384_g1526 = normalize( localViewMatrix0375_g1526 );
				float3 temp_output_380_0_g1526 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1526 = ViewMatrix1373_g1526();
				float3 normalizeResult376_g1526 = normalize( localViewMatrix1373_g1526 );
				float3 localStereoCameraViewPosition30_g1524 = StereoCameraViewPosition30_g1524();
				float3 rotatedValue385_g1526 = RotateAroundAxis( temp_output_380_0_g1526, localStereoCameraViewPosition30_g1524, normalizeResult376_g1526, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1526 = RotateAroundAxis( temp_output_380_0_g1526, rotatedValue385_g1526, normalize( normalizeResult384_g1526 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1526 = normalize( ( rotatedValue387_g1526 - temp_output_380_0_g1526 ) );
				float3 normalizeResult38_g1524 = normalize( normalizeResult389_g1526 );
				float3 appendResult15_g1525 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1525 = normalize( appendResult15_g1525 );
				float3 normalizeResult26_g1524 = normalize( normalizeResult2_g1525 );
				float3 ifLocalVar3_g1524 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1524 = normalizeResult38_g1524;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1524 = normalizeResult26_g1524;
				...
				float3 ifLocalVar8_g1524 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1524 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1524 = ifLocalVar3_g1524;
				float3 ifLocalVar9_g1524 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1524 = ifLocalVar3_g1524;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1524 = ifLocalVar8_g1524;
				float dotResult46_g1524 = dot( ifLocalVar9_g1524 , normalizedWorldNormal );
				float temp_output_36_0_g1511 = ( ( dotResult46_g1524 + _GlobalLightPush ) * i.ase_color.r );
				...
				float temp_output_1_0_g1511 = ILMG574;
				float temp_output_1077_0 = ( temp_output_36_0_g1511 * temp_output_1_0_g1511 );
				float NdL20_g1508 = temp_output_1077_0;
				float temp_output_2_0_g1509 = NdL20_g1508;
				float temp_output_3_0_g1509 = -_Shadow1Smoothness;
				...
				float temp_output_1_0_g1509 = RealShadow1Push16_g1508;
				float smoothstepResult6_g1509 = smoothstep( ( ( temp_output_2_0_g1509 / 1.0 ) + temp_output_3_0_g1509 ) , temp_output_2_0_g1509 , temp_output_1_0_g1509);
				float lerpResult7_g1509 = lerp( smoothstepResult6_g1509 , ( temp_output_1_0_g1509 >= temp_output_2_0_g1509 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1509 ? 1.0 : 0.0 ));
				...
				float temp_output_2_0_g1510 = NdL20_g1508;
				float temp_output_3_0_g1510 = -_Shadow2Smoothness;
				float temp_output_1_0_g1510 = RealShadow2Push18_g1508;
				float smoothstepResult6_g1510 = smoothstep( ( ( temp_output_2_0_g1510 / 1.0 ) + temp_output_3_0_g1510 ) , temp_output_2_0_g1510 , temp_output_1_0_g1510);
				float lerpResult7_g1510 = lerp( smoothstepResult6_g1510 , ( temp_output_1_0_g1510 >= temp_output_2_0_g1510 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1510 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1508 = max( max( ( 1.0 - ( VertexR33_g1508 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1510 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1508 = ( max( ( 1.0 - ( VertexR33_g1508 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1509 , ( RealShadow1Push16_g1508 >= RealShadow2Push18_g1508 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1508 );
				...
				float temp_output_6_0_g1513 = temp_output_94_0_g1508;
				float4 temp_cast_29 = (temp_output_6_0_g1513).xxxx;
				float4 blendOpSrc19_g1513 = Base12_g1513;
				float4 blendOpDest19_g1513 = temp_cast_29;
				float4 lerpBlendMode19_g1513 = lerp(blendOpDest19_g1513,min( blendOpSrc19_g1513 , blendOpDest19_g1513 ),0.9);
				float4 LightColor779 = _LightColor;
				float4 LightColor16_g1513 = LightColor779;
				float3 desaturateInitialColor9_g1514 = ( ( ( BaseA13_g1513 * ( saturate( lerpBlendMode19_g1513 )) ) + ( Base12_g1513 * temp_output_6_0_g1513 ) ) * LightColor16_g1513 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
				...
				float3 normalizeResult48_g1524 = normalize( ifLocalVar9_g1524 );
				float3 normalizeResult51_g1524 = normalize( ( normalizeResult48_g1524 + localStereoCameraViewDirection32_g1524 ) );
				float dotResult50_g1524 = dot( normalizedWorldNormal , normalizeResult51_g1524 );
				float blendOpSrc34_g1511 = ILMB576;
				float blendOpDest34_g1511 = dotResult50_g1524;
				float temp_output_68_0_g1508 = ( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1511) / max( blendOpSrc34_g1511, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) * temp_output_61_0_g1508 );
				float clampResult87_g1508 = clamp( temp_output_68_0_g1508 , 0.0 , 1.0 );
				float temp_output_29_0_g1513 = clampResult87_g1508;
				float4 temp_cast_31 = (temp_output_29_0_g1513).xxxx;
				float4 blendOpSrc30_g1513 = Base12_g1513;
				float4 blendOpDest30_g1513 = temp_cast_31;
				float4 lerpBlendMode30_g1513 = lerp(blendOpDest30_g1513,min( blendOpSrc30_g1513 , blendOpDest30_g1513 ),0.9);
				float3 desaturateInitialColor9_g1517 = ( ( ( BaseA13_g1513 * ( saturate( lerpBlendMode30_g1513 )) ) + ( Base12_g1513 * temp_output_29_0_g1513 ) ) * LightColor16_g1513 * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1517 = dot( desaturateInitialColor9_g1517, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1517 = lerp( desaturateInitialColor9_g1517, desaturateDot9_g1517.xxx, ( 1.0 - _SpecularSaturation ) );
				...
				float3 desaturateInitialColor9_g1519 = ( ( Base12_g1513 * clampResult90_g1508 ) * LightColor16_g1513 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1519 = dot( desaturateInitialColor9_g1519, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1519 = lerp( desaturateInitialColor9_g1519, desaturateDot9_g1519.xxx, ( 1.0 - _BaseSaturation ) );
				float3 SSS578 = temp_output_995_0[1];
				float4 SSS14_g1513 = float4( SSS578 , 0.0 );
				float4 AmbientColor780 = _AmbientColor;
				float4 AmbientColor68_g1513 = AmbientColor780;
				float3 desaturateInitialColor9_g1518 = ( ( temp_output_43_0_g1508 * Base12_g1513 * SSS14_g1513 ) * AmbientColor68_g1513 * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1518 = dot( desaturateInitialColor9_g1518, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1518 = lerp( desaturateInitialColor9_g1518, desaturateDot9_g1518.xxx, ( 1.0 - _Shadow1Saturation ) );
				...
				float4 blendOpSrc51_g1513 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1513 = ( Base12_g1513 * SSS14_g1513 );
				float4 lerpBlendMode51_g1513 = lerp(blendOpDest51_g1513,2.0f*blendOpDest51_g1513*blendOpSrc51_g1513 + blendOpDest51_g1513*blendOpDest51_g1513*(1.0f - 2.0f*blendOpSrc51_g1513),0.5);
				float3 desaturateInitialColor9_g1516 = ( ( clampResult91_g1508 * ( saturate( lerpBlendMode51_g1513 )) ) * AmbientColor68_g1513 * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1516 = dot( desaturateInitialColor9_g1516, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1516 = lerp( desaturateInitialColor9_g1516, desaturateDot9_g1516.xxx, ( 1.0 - _Shadow2Saturation ) );
				...
				float temp_output_60_0_g1513 = temp_output_96_0_g1508;
				float4 blendOpSrc56_g1513 = float4( 0,0,0,0 );
				float4 blendOpDest56_g1513 = ( Base12_g1513 * SSS14_g1513 );
				float4 lerpBlendMode56_g1513 = lerp(blendOpDest56_g1513,2.0f*blendOpDest56_g1513*blendOpSrc56_g1513 + blendOpDest56_g1513*blendOpDest56_g1513*(1.0f - 2.0f*blendOpSrc56_g1513),0.5);
				float4 temp_output_56_0_g1513 = ( saturate( lerpBlendMode56_g1513 ));
				float3 desaturateInitialColor9_g1515 = ( ( ( ( temp_output_60_0_g1513 * ( temp_output_56_0_g1513 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1513 * temp_output_56_0_g1513 ) ) * ILMR573 ) * AmbientColor68_g1513 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
				float desaturateDot9_g1515 = dot( desaturateInitialColor9_g1515, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1515 = lerp( desaturateInitialColor9_g1515, desaturateDot9_g1515.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
				float3 temp_output_787_0 = ( desaturateVar9_g1514 + desaturateVar9_g1517 + desaturateVar9_g1519 + desaturateVar9_g1518 + desaturateVar9_g1516 + desaturateVar9_g1515 );
				...
				float ifLocalVar13_g1512 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1512 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1512 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_41 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_42 = (5.0).xxxx;
				float4 clampResult18_g1512 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				float4 temp_output_11_0_g1512 = ( ase_atten * clampResult18_g1512 );
				float4 temp_output_8_0_g1512 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1512 = 0;
				if( ifLocalVar13_g1512 > 0.0 )
				ifLocalVar3_g1512 = temp_output_11_0_g1512;
				else if( ifLocalVar13_g1512 == 0.0 )
				ifLocalVar3_g1512 = temp_output_8_0_g1512;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1512 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1512 );
				#else
				float4 staticSwitch9_g1512 = ifLocalVar3_g1512;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1512;
				...
				float4 ifLocalVar17_g1512 = 0;
				if( ifLocalVar13_g1512 > 0.0 )
				ifLocalVar17_g1512 = clampResult18_g1512;
				else if( ifLocalVar13_g1512 == 0.0 )
				ifLocalVar17_g1512 = temp_output_8_0_g1512;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1512 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1512 = max( temp_cast_45 , ifLocalVar17_g1512 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1512;
				...
				float temp_output_48_0_g1520 = _DebugGroup;
				float temp_output_47_0_g1520 = _VertexChannel;
				float4 temp_output_59_0_g1520 = _DebugColor;
				float temp_output_50_0_g1520 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult984 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1520 = appendResult984;
				float4 break7_g1520 = temp_output_54_0_g1520;
				float temp_output_57_0_g1520 = 0.0;
				float4 Debug987 = ( temp_output_48_0_g1520 == 0.0 ? ( temp_output_47_0_g1520 == 0.0 ? i.ase_color : ( temp_output_47_0_g1520 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1520 ) : ( temp_output_47_0_g1520 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1520 ) : ( temp_output_47_0_g1520 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1520 ) : ( temp_output_47_0_g1520 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1520 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1520 == 1.0 ? ( temp_output_50_0_g1520 == 0.0 ? temp_output_54_0_g1520 : ( temp_output_50_0_g1520 == 1.0 ? ( break7_g1520.r * temp_output_59_0_g1520 ) : ( temp_output_50_0_g1520 == 2.0 ? ( break7_g1520.g * temp_output_59_0_g1520 ) : ( temp_output_50_0_g1520 == 3.0 ? ( break7_g1520.b * temp_output_59_0_g1520 ) : ( temp_output_50_0_g1520 == 4.0 ? ( break7_g1520.a * temp_output_59_0_g1520 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1520 == 2.0 ? ( temp_output_57_0_g1520 == 0.0 ? ( BaseA580 * temp_output_59_0_g1520 ) : ( temp_output_57_0_g1520 == 1.0 ? ( 0.0 * temp_output_59_0_g1520 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
...
/*ASEBEGIN
Version=18900
-2009;121;1790;816;-1972.47;-4000.103;1.691543;True;True
...
Node;AmplifyShaderEditor.SamplerNode;296;-2981.91,2744.822;Inherit;True;Property;_Base;Base;2;0;Create;True;0;0;0;False;0;False;-1;None;676577a58fbdd5341a8bb3370cc570d0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;297;-2937.471,2998.025;Inherit;True;Property;_SSS;SSS;3;0;Create;True;0;0;0;False;0;False;-1;None;c200affc58ff0d04ba64f3aa790da5fe;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;274;-1737.02,2839.592;Inherit;True;Property;_ILM;ILM;4;0;Create;True;0;0;0;False;0;False;-1;None;3a40ef586ce95154da960a02338f2adb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1080;3936,5888;Inherit;False;Property;_ShadowRimlightBaseColor;Shadow Rimlight Base Color;0;0;Create;True;0;0;0;False;0;False;0.2392157,0.2392157,0.5294118,0;0.239215,0.239215,0.5294118,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;711;3008,4096;Inherit;False;Property;_Shadow1Push;Shadow 1 Push;25;0;Create;True;0;0;0;False;0;False;0.5;0.488;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;960;-1099.532,4903.766;Inherit;False;Light Color Calculation;-1;;1512;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.RangedFloatNode;869;-1418.869,5197.192;Inherit;False;Property;_FakeGlobalLightIntensity;Fake Global Light Intensity;10;0;Create;True;0;0;0;False;0;False;0.4;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;986;175.4907,6202.33;Inherit;False;Debug;-1;;1520;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1524;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.FunctionNode;1042;4154.673,3311.612;Inherit;False;Emission - FighterZ;-1;;1527;2e32fe20ddeddef43b8b5dae014cc006;0;18;17;FLOAT;0;False;25;COLOR;0,0,0,0;False;24;FLOAT;0;False;20;FLOAT;0;False;26;FLOAT;0;False;27;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;22;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;21;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;727;3008,4288;Inherit;False;Property;_Shadow2Push;Shadow 2 Push;28;0;Create;True;0;0;0;False;0;False;0.2;0.304;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1083;9610.994,4024.884;Float;False;True;-1;2;ASWFighterZGUI;100;8;.Aerthas/Arc System Works/Game Select/FighterZ/Opaque v8.0.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1068;255;True;1067;255;True;1066;7;True;1065;1;True;1064;1;True;1063;1;True;1062;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1061;True;3;True;1071;True;True;0;True;1069;0;True;1070;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;False;False;;False;0
...
ASEEND*/
//CHKSM=0E5254D105845DDC906A75FA4E19D3F3E0E62926