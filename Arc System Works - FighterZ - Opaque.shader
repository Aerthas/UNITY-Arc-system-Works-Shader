...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Opaque v7.2.2"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 StereoCameraViewDirection32_g1520( float3 worldPos )
			{
			...
			float3 ViewMatrix0375_g1522(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1522(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1520(  )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 Base12_g1512 = Base339;
				float EnableRimlight82_g1508 = _EnableRimlight;
				float3 ase_worldNormal = i.ase_texcoord2.xyz;
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 worldPos32_g1520 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1520 = StereoCameraViewDirection32_g1520( worldPos32_g1520 );
				float dotResult31_g1520 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1520 );
				float SSSA581 = tex2DNode297.a;
				float blendOpSrc15_g1510 = SSSA581;
				float blendOpDest15_g1510 = BaseA580;
				float NdV48_g1508 = ( ( 1.0 - ( dotResult31_g1520 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1510 - blendOpDest15_g1510 ) )) ) );
				float VertexR33_g1508 = i.ase_color.r;
				float LightDirectionSetting561 = _LightDirectionSetting;
				float FallbackLightDirection563 = _FallbackLightDirection;
				float3 localViewMatrix0375_g1522 = ViewMatrix0375_g1522();
				float3 normalizeResult384_g1522 = normalize( localViewMatrix0375_g1522 );
				float3 temp_output_380_0_g1522 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1522 = ViewMatrix1373_g1522();
				float3 normalizeResult376_g1522 = normalize( localViewMatrix1373_g1522 );
				float3 localStereoCameraViewPosition30_g1520 = StereoCameraViewPosition30_g1520();
				float3 rotatedValue385_g1522 = RotateAroundAxis( temp_output_380_0_g1522, localStereoCameraViewPosition30_g1520, normalizeResult376_g1522, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1522 = RotateAroundAxis( temp_output_380_0_g1522, rotatedValue385_g1522, normalize( normalizeResult384_g1522 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1522 = normalize( ( rotatedValue387_g1522 - temp_output_380_0_g1522 ) );
				float3 normalizeResult38_g1520 = normalize( normalizeResult389_g1522 );
				float3 appendResult15_g1521 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1521 = normalize( appendResult15_g1521 );
				float3 normalizeResult26_g1520 = normalize( normalizeResult2_g1521 );
				float3 ifLocalVar3_g1520 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1520 = normalizeResult38_g1520;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1520 = normalizeResult26_g1520;
				...
				float3 ifLocalVar8_g1520 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1520 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1520 = ifLocalVar3_g1520;
				float3 ifLocalVar9_g1520 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1520 = ifLocalVar3_g1520;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1520 = ifLocalVar8_g1520;
				float dotResult46_g1520 = dot( ifLocalVar9_g1520 , normalizedWorldNormal );
				float temp_output_36_0_g1510 = ( ( dotResult46_g1520 + _GlobalLightPush ) * i.ase_color.r );
				...
				float temp_output_1_0_g1510 = ILMG574;
				float temp_output_1077_0 = ( temp_output_36_0_g1510 * temp_output_1_0_g1510 );
				float NdL20_g1508 = temp_output_1077_0;
				float temp_output_9_0_g1508 = _Shadow1Push;
				float temp_output_11_0_g1508 = _Shadow2Push;
				float clampResult15_g1508 = clamp( temp_output_9_0_g1508 , temp_output_11_0_g1508 , temp_output_9_0_g1508 );
				float RealShadow1Push16_g1508 = clampResult15_g1508;
				float clampResult17_g1508 = clamp( temp_output_11_0_g1508 , temp_output_11_0_g1508 , temp_output_9_0_g1508 );
				float RealShadow2Push18_g1508 = clampResult17_g1508;
				float temp_output_42_0_g1508 = max( max( ( 1.0 - ( VertexR33_g1508 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1508 < RealShadow2Push18_g1508 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1508 = ( max( ( 1.0 - ( VertexR33_g1508 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1508 < RealShadow1Push16_g1508 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1508 >= RealShadow2Push18_g1508 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1508 );
				float temp_output_61_0_g1508 = ( 1.0 - ( temp_output_43_0_g1508 + temp_output_42_0_g1508 ) );
				float temp_output_75_0_g1508 = ceil( ( ( ( NdV48_g1508 * BaseA580 ) > 0.0 ? 1.0 : 0.0 ) * temp_output_61_0_g1508 ) );
				float clampResult88_g1508 = clamp( temp_output_75_0_g1508 , 0.0 , 1.0 );
				float temp_output_94_0_g1508 = ( EnableRimlight82_g1508 == 1.0 ? clampResult88_g1508 : 0.0 );
				float temp_output_6_0_g1512 = temp_output_94_0_g1508;
				float4 temp_cast_29 = (temp_output_6_0_g1512).xxxx;
				float4 blendOpSrc19_g1512 = Base12_g1512;
				float4 blendOpDest19_g1512 = temp_cast_29;
				float4 lerpBlendMode19_g1512 = lerp(blendOpDest19_g1512,min( blendOpSrc19_g1512 , blendOpDest19_g1512 ),0.9);
				float4 LightColor779 = _LightColor;
				float4 LightColor16_g1512 = LightColor779;
				float3 desaturateInitialColor9_g1514 = ( ( ( BaseA13_g1512 * ( saturate( lerpBlendMode19_g1512 )) ) + ( Base12_g1512 * temp_output_6_0_g1512 ) ) * LightColor16_g1512 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
				float desaturateDot9_g1514 = dot( desaturateInitialColor9_g1514, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1514 = lerp( desaturateInitialColor9_g1514, desaturateDot9_g1514.xxx, ( 1.0 - _HighlightRimlightSaturation ) );
				float ILMB576 = break292.z;
				float3 normalizeResult48_g1520 = normalize( ifLocalVar9_g1520 );
				float3 normalizeResult51_g1520 = normalize( ( normalizeResult48_g1520 + localStereoCameraViewDirection32_g1520 ) );
				float dotResult50_g1520 = dot( normalizedWorldNormal , normalizeResult51_g1520 );
				float blendOpSrc34_g1510 = ILMB576;
				float blendOpDest34_g1510 = dotResult50_g1520;
				float temp_output_68_0_g1508 = ( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1510) / max( blendOpSrc34_g1510, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) * temp_output_61_0_g1508 );
				float clampResult87_g1508 = clamp( temp_output_68_0_g1508 , 0.0 , 1.0 );
				float temp_output_29_0_g1512 = clampResult87_g1508;
				float4 temp_cast_31 = (temp_output_29_0_g1512).xxxx;
				float4 blendOpSrc30_g1512 = Base12_g1512;
				float4 blendOpDest30_g1512 = temp_cast_31;
				float4 lerpBlendMode30_g1512 = lerp(blendOpDest30_g1512,min( blendOpSrc30_g1512 , blendOpDest30_g1512 ),0.9);
				float3 desaturateInitialColor9_g1516 = ( ( ( BaseA13_g1512 * ( saturate( lerpBlendMode30_g1512 )) ) + ( Base12_g1512 * temp_output_29_0_g1512 ) ) * LightColor16_g1512 * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1516 = dot( desaturateInitialColor9_g1516, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1516 = lerp( desaturateInitialColor9_g1516, desaturateDot9_g1516.xxx, ( 1.0 - _SpecularSaturation ) );
				float temp_output_77_0_g1508 = ( temp_output_61_0_g1508 - temp_output_68_0_g1508 );
				float clampResult90_g1508 = clamp( ( EnableRimlight82_g1508 == 1.0 ? ( temp_output_77_0_g1508 - temp_output_75_0_g1508 ) : temp_output_77_0_g1508 ) , 0.0 , 1.0 );
				float3 desaturateInitialColor9_g1518 = ( ( Base12_g1512 * clampResult90_g1508 ) * LightColor16_g1512 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1518 = dot( desaturateInitialColor9_g1518, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1518 = lerp( desaturateInitialColor9_g1518, desaturateDot9_g1518.xxx, ( 1.0 - _BaseSaturation ) );
				float3 SSS578 = temp_output_995_0[1];
				float4 SSS14_g1512 = float4( SSS578 , 0.0 );
				float4 AmbientColor780 = _AmbientColor;
				float4 AmbientColor68_g1512 = AmbientColor780;
				float3 desaturateInitialColor9_g1517 = ( ( temp_output_43_0_g1508 * Base12_g1512 * SSS14_g1512 ) * AmbientColor68_g1512 * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1517 = dot( desaturateInitialColor9_g1517, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1517 = lerp( desaturateInitialColor9_g1517, desaturateDot9_g1517.xxx, ( 1.0 - _Shadow1Saturation ) );
				float ILMR573 = break292.x;
				float temp_output_53_0_g1508 = ceil( ( ( ( temp_output_42_0_g1508 * NdV48_g1508 ) > 0.1 ? 1.0 : 0.0 ) * ILMR573 ) );
				float clampResult91_g1508 = clamp( ( EnableRimlight82_g1508 == 1.0 ? ( temp_output_42_0_g1508 - temp_output_53_0_g1508 ) : temp_output_42_0_g1508 ) , 0.0 , 1.0 );
				float4 blendOpSrc51_g1512 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1512 = ( Base12_g1512 * SSS14_g1512 );
				float4 lerpBlendMode51_g1512 = lerp(blendOpDest51_g1512,2.0f*blendOpDest51_g1512*blendOpSrc51_g1512 + blendOpDest51_g1512*blendOpDest51_g1512*(1.0f - 2.0f*blendOpSrc51_g1512),0.5);
				float3 desaturateInitialColor9_g1515 = ( ( clampResult91_g1508 * ( saturate( lerpBlendMode51_g1512 )) ) * AmbientColor68_g1512 * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1515 = dot( desaturateInitialColor9_g1515, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1515 = lerp( desaturateInitialColor9_g1515, desaturateDot9_g1515.xxx, ( 1.0 - _Shadow2Saturation ) );
				float clampResult92_g1508 = clamp( temp_output_53_0_g1508 , 0.0 , 1.0 );
				float temp_output_96_0_g1508 = ( EnableRimlight82_g1508 == 1.0 ? clampResult92_g1508 : 0.0 );
				float temp_output_60_0_g1512 = temp_output_96_0_g1508;
				float4 blendOpSrc56_g1512 = float4( 0,0,0,0 );
				float4 blendOpDest56_g1512 = ( Base12_g1512 * SSS14_g1512 );
				float4 lerpBlendMode56_g1512 = lerp(blendOpDest56_g1512,2.0f*blendOpDest56_g1512*blendOpSrc56_g1512 + blendOpDest56_g1512*blendOpDest56_g1512*(1.0f - 2.0f*blendOpSrc56_g1512),0.5);
				float4 temp_output_56_0_g1512 = ( saturate( lerpBlendMode56_g1512 ));
				float3 desaturateInitialColor9_g1513 = ( ( ( ( temp_output_60_0_g1512 * ( temp_output_56_0_g1512 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1512 * temp_output_56_0_g1512 ) ) * ILMR573 ) * AmbientColor68_g1512 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
				float desaturateDot9_g1513 = dot( desaturateInitialColor9_g1513, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1513 = lerp( desaturateInitialColor9_g1513, desaturateDot9_g1513.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
				float3 temp_output_787_0 = ( desaturateVar9_g1514 + desaturateVar9_g1516 + desaturateVar9_g1518 + desaturateVar9_g1517 + desaturateVar9_g1515 + desaturateVar9_g1513 );
				...
				float ifLocalVar13_g1511 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1511 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1511 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_41 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_42 = (5.0).xxxx;
				float4 clampResult18_g1511 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				float4 temp_output_11_0_g1511 = ( ase_atten * clampResult18_g1511 );
				float4 temp_output_8_0_g1511 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1511 = 0;
				if( ifLocalVar13_g1511 > 0.0 )
				ifLocalVar3_g1511 = temp_output_11_0_g1511;
				else if( ifLocalVar13_g1511 == 0.0 )
				ifLocalVar3_g1511 = temp_output_8_0_g1511;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1511 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1511 );
				#else
				float4 staticSwitch9_g1511 = ifLocalVar3_g1511;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1511;
				float3 ColorOut997 = temp_output_787_0;
				float4 EmissionRampMask920 = ( ( ( temp_output_94_0_g1508 * _HighlightRimlightEmissiveToggle ) * _HighlightRimlightEmissionIntensity ) + ( ( clampResult87_g1508 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1508 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1508 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1508 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( temp_output_96_0_g1508 * _ShadowRimlightEmissiveToggle ) * _ShadowRimlightEmissionIntensity ) + ( ( 1.0 - ILMA357 ) * _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) + ( ( 1.0 - Detail807 ) * _BodyLinesEmissionToggle * _BodyLinesEmissionIntensity ) );
				float4 temp_cast_45 = (EmissionRampMask920.r).xxxx;
				float4 ifLocalVar17_g1511 = 0;
				if( ifLocalVar13_g1511 > 0.0 )
				ifLocalVar17_g1511 = clampResult18_g1511;
				else if( ifLocalVar13_g1511 == 0.0 )
				ifLocalVar17_g1511 = temp_output_8_0_g1511;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1511 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1511 = max( temp_cast_45 , ifLocalVar17_g1511 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1511;
				...
				float temp_output_48_0_g1519 = _DebugGroup;
				float temp_output_47_0_g1519 = _VertexChannel;
				float4 temp_output_59_0_g1519 = _DebugColor;
				float temp_output_50_0_g1519 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult984 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1519 = appendResult984;
				float4 break7_g1519 = temp_output_54_0_g1519;
				float temp_output_57_0_g1519 = 0.0;
				float4 Debug987 = ( temp_output_48_0_g1519 == 0.0 ? ( temp_output_47_0_g1519 == 0.0 ? i.ase_color : ( temp_output_47_0_g1519 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1519 ) : ( temp_output_47_0_g1519 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1519 ) : ( temp_output_47_0_g1519 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1519 ) : ( temp_output_47_0_g1519 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1519 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1519 == 1.0 ? ( temp_output_50_0_g1519 == 0.0 ? temp_output_54_0_g1519 : ( temp_output_50_0_g1519 == 1.0 ? ( break7_g1519.r * temp_output_59_0_g1519 ) : ( temp_output_50_0_g1519 == 2.0 ? ( break7_g1519.g * temp_output_59_0_g1519 ) : ( temp_output_50_0_g1519 == 3.0 ? ( break7_g1519.b * temp_output_59_0_g1519 ) : ( temp_output_50_0_g1519 == 4.0 ? ( break7_g1519.a * temp_output_59_0_g1519 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1519 == 2.0 ? ( temp_output_57_0_g1519 == 0.0 ? ( BaseA580 * temp_output_59_0_g1519 ) : ( temp_output_57_0_g1519 == 1.0 ? ( 0.0 * temp_output_59_0_g1519 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1523 = _OutlineThickness;
				float3 temp_output_135_0_g1523 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1523 ) + temp_output_33_0_g1523 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1523 = ObjSpaceViewDir( float4( temp_output_135_0_g1523 , 0.0 ) );
				float4 normalizeResult142_g1523 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1523 , 0.0 ) - v.vertex ) );
				float clampResult141_g1523 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1523 = lerp( float4( temp_output_135_0_g1523 , 0.0 ) , -normalizeResult142_g1523 , ( 1.0 - clampResult141_g1523 ));
				
				o.ase_texcoord.xy = v.ase_texcoord.xy;
				o.ase_texcoord.zw = v.ase_texcoord1.xy;

				v.vertex.xyz += lerpResult145_g1523.xyz;
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1020 = lerp( ILMAColor992 , temp_output_1031_0 , ILMA357);
				float4 Base339 = ( _ILMColorSetting == 1.0 ? lerpResult1020 : ( ILMA357 * temp_output_1031_0 ) );
				float4 temp_output_13_0_g1523 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1523 * temp_output_13_0_g1523 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
-2072;177;1939;816;-1090.836;-2574.577;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;960;-1099.532,4903.766;Inherit;False;Light Color Calculation;-1;;1511;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;986;175.4907,6202.33;Inherit;False;Debug;-1;;1519;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1057;7155.288,4375.559;Inherit;False;ASWOutline;-1;;1523;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1520;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1083;9610.994,4024.884;Float;False;True;-1;2;ASWFighterZGUI;100;8;.Aerthas/Arc System Works/Game Select/FighterZ/Opaque v7.2.2;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1068;255;True;1067;255;True;1066;7;True;1065;1;True;1064;1;True;1063;1;True;1062;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1061;True;3;True;1071;True;True;0;True;1069;0;True;1070;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;False;False;;False;0
...
ASEEND*/
//CHKSM=C52D26BC1F56B0B7F33CCAEB72F98484B6AC4400