...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Opaque v8.1.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1393_g1531(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0394_g1531(  )
			{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float3 localViewMatrix1393_g1531 = ViewMatrix1393_g1531();
				float3 normalizeResult396_g1531 = normalize( localViewMatrix1393_g1531 );
				float temp_output_395_0_g1531 = radians( -_ViewDirOffsetYaw );
				float3 localViewMatrix0394_g1531 = ViewMatrix0394_g1531();
				float3 normalizeResult399_g1531 = normalize( localViewMatrix0394_g1531 );
				float3 rotatedValue400_g1531 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult399_g1531, normalizeResult396_g1531, temp_output_395_0_g1531 );
				float3 temp_output_408_0_g1531 = ( ase_worldPos - i.ase_texcoord4.xyz );
				float3 localStereoCameraViewPosition30_g1529 = StereoCameraViewPosition30_g1529();
				float3 rotatedValue401_g1531 = RotateAroundAxis( temp_output_408_0_g1531, localStereoCameraViewPosition30_g1529, normalizeResult396_g1531, temp_output_395_0_g1531 );
				float3 rotatedValue403_g1531 = RotateAroundAxis( temp_output_408_0_g1531, rotatedValue401_g1531, rotatedValue400_g1531, radians( _ViewDirOffsetPitch ) );
				float3 normalizeResult38_g1529 = normalize( ( rotatedValue403_g1531 - temp_output_408_0_g1531 ) );
				...
				float temp_output_1077_0 = ( temp_output_36_0_g1532 * temp_output_1_0_g1532 );
				...
				float4 temp_cast_29 = (temp_output_6_0_g1537).xxxx;
				float4 blendOpSrc19_g1537 = Base12_g1537;
				float4 blendOpDest19_g1537 = temp_cast_29;
				...
				float4 temp_cast_31 = (temp_output_29_0_g1537).xxxx;
				float4 blendOpSrc30_g1537 = Base12_g1537;
				float4 blendOpDest30_g1537 = temp_cast_31;
				...
				float4 clampResult18_g1544 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				...
				#else
				float4 staticSwitch30_g1544 = max( temp_cast_47 , ifLocalVar17_g1544 );
				#endif
...
/*ASEBEGIN
Version=18900
2975;274;1355;932;-1647.426;-2001.536;3.37794;True;True
...
Node;AmplifyShaderEditor.SamplerNode;296;-2981.91,2744.822;Inherit;True;Property;_Base;Base;2;0;Create;True;0;0;0;False;0;False;-1;None;77b48568ee1415f41903ee6ff584ba49;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6C316EA9777DF64E3801A9D4AEB09B901B765872