...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Opaque v7.1.0"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_33_0_g1445 = _OutlineThickness;
			float3 temp_output_135_0_g1445 = ( ( ase_vertexNormal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.color.g * temp_output_33_0_g1445 ) + temp_output_33_0_g1445 ) * v.color.a ) );
			float3 objectSpaceViewDir136_g1445 = ObjSpaceViewDir( float4( temp_output_135_0_g1445 , 0.0 ) );
			float4 ase_vertex4Pos = v.vertex;
			float4 normalizeResult142_g1445 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1445 , 0.0 ) - ase_vertex4Pos ) );
			float clampResult141_g1445 = clamp( ( v.color.b + _DepthOffset ) , 0.0 , 1.0 );
			float4 lerpResult145_g1445 = lerp( float4( temp_output_135_0_g1445 , 0.0 ) , -normalizeResult142_g1445 , ( 1.0 - clampResult141_g1445 ));
			float3 outlineVar = lerpResult145_g1445.xyz;
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_output_13_0_g1445 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
			o.Emission = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1445 * temp_output_13_0_g1445 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_6_0_g1435 = temp_output_94_0_g1412;
			float4 temp_cast_71 = (temp_output_6_0_g1435).xxxx;
			float4 blendOpSrc19_g1435 = Base12_g1435;
			float4 blendOpDest19_g1435 = temp_cast_71;
			float4 lerpBlendMode19_g1435 = lerp(blendOpDest19_g1435,min( blendOpSrc19_g1435 , blendOpDest19_g1435 ),0.9);
			float4 LightColor779 = _LightColor;
			float4 LightColor16_g1435 = LightColor779;
			float3 desaturateInitialColor9_g1437 = ( ( ( BaseA13_g1435 * ( saturate( lerpBlendMode19_g1435 )) ) + ( Base12_g1435 * temp_output_6_0_g1435 ) ) * LightColor16_g1435 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
			float desaturateDot9_g1437 = dot( desaturateInitialColor9_g1437, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1437 = lerp( desaturateInitialColor9_g1437, desaturateDot9_g1437.xxx, ( 1.0 - _HighlightRimlightSaturation ) );
			...
			float temp_output_29_0_g1435 = clampResult87_g1412;
			float4 temp_cast_73 = (temp_output_29_0_g1435).xxxx;
			float4 blendOpSrc30_g1435 = Base12_g1435;
			float4 blendOpDest30_g1435 = temp_cast_73;
			float4 lerpBlendMode30_g1435 = lerp(blendOpDest30_g1435,min( blendOpSrc30_g1435 , blendOpDest30_g1435 ),0.9);
			float3 desaturateInitialColor9_g1439 = ( ( ( BaseA13_g1435 * ( saturate( lerpBlendMode30_g1435 )) ) + ( Base12_g1435 * temp_output_29_0_g1435 ) ) * LightColor16_g1435 * _SpecularIntensity * _SpecularTint ).rgb;
			float desaturateDot9_g1439 = dot( desaturateInitialColor9_g1439, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1439 = lerp( desaturateInitialColor9_g1439, desaturateDot9_g1439.xxx, ( 1.0 - _SpecularSaturation ) );
			...
			float3 desaturateInitialColor9_g1441 = ( ( Base12_g1435 * clampResult90_g1412 ) * LightColor16_g1435 * _BaseIntensity * _BaseTint ).rgb;
			float desaturateDot9_g1441 = dot( desaturateInitialColor9_g1441, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1441 = lerp( desaturateInitialColor9_g1441, desaturateDot9_g1441.xxx, ( 1.0 - _BaseSaturation ) );
			float3 SSS578 = temp_output_995_0[1];
			float4 SSS14_g1435 = float4( SSS578 , 0.0 );
			float4 AmbientColor780 = _AmbientColor;
			float4 AmbientColor68_g1435 = AmbientColor780;
			float3 desaturateInitialColor9_g1440 = ( ( temp_output_43_0_g1412 * Base12_g1435 * SSS14_g1435 ) * AmbientColor68_g1435 * _Shadow1Intensity * _Shadow1Tint ).rgb;
			float desaturateDot9_g1440 = dot( desaturateInitialColor9_g1440, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1440 = lerp( desaturateInitialColor9_g1440, desaturateDot9_g1440.xxx, ( 1.0 - _Shadow1Saturation ) );
			...
			float4 blendOpSrc51_g1435 = float4( 0,0,0,0 );
			float4 blendOpDest51_g1435 = ( Base12_g1435 * SSS14_g1435 );
			float4 lerpBlendMode51_g1435 = lerp(blendOpDest51_g1435,2.0f*blendOpDest51_g1435*blendOpSrc51_g1435 + blendOpDest51_g1435*blendOpDest51_g1435*(1.0f - 2.0f*blendOpSrc51_g1435),0.5);
			float3 desaturateInitialColor9_g1438 = ( ( clampResult91_g1412 * ( saturate( lerpBlendMode51_g1435 )) ) * AmbientColor68_g1435 * _Shadow2Intensity * _Shadow2Tint ).rgb;
			float desaturateDot9_g1438 = dot( desaturateInitialColor9_g1438, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1438 = lerp( desaturateInitialColor9_g1438, desaturateDot9_g1438.xxx, ( 1.0 - _Shadow2Saturation ) );
			...
			float temp_output_60_0_g1435 = temp_output_96_0_g1412;
			float4 blendOpSrc56_g1435 = float4( 0,0,0,0 );
			float4 blendOpDest56_g1435 = ( Base12_g1435 * SSS14_g1435 );
			float4 lerpBlendMode56_g1435 = lerp(blendOpDest56_g1435,2.0f*blendOpDest56_g1435*blendOpSrc56_g1435 + blendOpDest56_g1435*blendOpDest56_g1435*(1.0f - 2.0f*blendOpSrc56_g1435),0.5);
			float4 temp_output_56_0_g1435 = ( saturate( lerpBlendMode56_g1435 ));
			float3 desaturateInitialColor9_g1436 = ( ( ( ( temp_output_60_0_g1435 * ( temp_output_56_0_g1435 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1435 * temp_output_56_0_g1435 ) ) * ILMR573 ) * AmbientColor68_g1435 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
			float desaturateDot9_g1436 = dot( desaturateInitialColor9_g1436, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1436 = lerp( desaturateInitialColor9_g1436, desaturateDot9_g1436.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
			float3 temp_output_787_0 = ( desaturateVar9_g1437 + desaturateVar9_g1439 + desaturateVar9_g1441 + desaturateVar9_g1440 + desaturateVar9_g1438 + desaturateVar9_g1436 );
			...
			float ifLocalVar13_g1442 = 0;
			if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1442 = 0.0;
			else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1442 = IsThereWorldLight450;
			float4 temp_cast_83 = (_MinimumGlobalLightIntensity).xxxx;
			float4 temp_cast_84 = (5.0).xxxx;
			float4 clampResult18_g1442 = clamp( ase_lightColor , temp_cast_83 , temp_cast_84 );
			float4 temp_output_11_0_g1442 = ( ase_lightAtten * clampResult18_g1442 );
			float4 temp_output_8_0_g1442 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
			float4 ifLocalVar3_g1442 = 0;
			if( ifLocalVar13_g1442 > 0.0 )
				ifLocalVar3_g1442 = temp_output_11_0_g1442;
			else if( ifLocalVar13_g1442 == 0.0 )
				ifLocalVar3_g1442 = temp_output_8_0_g1442;
			#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1442 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1442 );
			#else
				float4 staticSwitch9_g1442 = ifLocalVar3_g1442;
			#endif
			float4 GlobalLightColor944 = staticSwitch9_g1442;
			float temp_output_48_0_g1443 = _DebugGroup;
			float temp_output_47_0_g1443 = _VertexChannel;
			float4 temp_output_59_0_g1443 = _DebugColor;
			float temp_output_50_0_g1443 = _ILMChannel;
			float3 ILM988 = linearToGamma277;
			float4 appendResult984 = (float4(ILM988 , ILMA357));
			float4 temp_output_54_0_g1443 = appendResult984;
			float4 break7_g1443 = temp_output_54_0_g1443;
			float temp_output_57_0_g1443 = 0.0;
			float4 Debug987 = ( temp_output_48_0_g1443 == 0.0 ? ( temp_output_47_0_g1443 == 0.0 ? i.vertexColor : ( temp_output_47_0_g1443 == 1.0 ? ( i.vertexColor.r * temp_output_59_0_g1443 ) : ( temp_output_47_0_g1443 == 2.0 ? ( i.vertexColor.g * temp_output_59_0_g1443 ) : ( temp_output_47_0_g1443 == 3.0 ? ( i.vertexColor.b * temp_output_59_0_g1443 ) : ( temp_output_47_0_g1443 == 4.0 ? ( i.vertexColor.a * temp_output_59_0_g1443 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1443 == 1.0 ? ( temp_output_50_0_g1443 == 0.0 ? temp_output_54_0_g1443 : ( temp_output_50_0_g1443 == 1.0 ? ( break7_g1443.r * temp_output_59_0_g1443 ) : ( temp_output_50_0_g1443 == 2.0 ? ( break7_g1443.g * temp_output_59_0_g1443 ) : ( temp_output_50_0_g1443 == 3.0 ? ( break7_g1443.b * temp_output_59_0_g1443 ) : ( temp_output_50_0_g1443 == 4.0 ? ( break7_g1443.a * temp_output_59_0_g1443 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1443 == 2.0 ? ( temp_output_57_0_g1443 == 0.0 ? ( BaseA580 * temp_output_59_0_g1443 ) : ( temp_output_57_0_g1443 == 1.0 ? ( 0.0 * temp_output_59_0_g1443 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float temp_output_94_0_g1412 = ( EnableRimlight82_g1412 == 1.0 ? clampResult88_g1412 : 0.0 );
			float temp_output_6_0_g1435 = temp_output_94_0_g1412;
			float4 temp_cast_29 = (temp_output_6_0_g1435).xxxx;
			float4 blendOpSrc19_g1435 = Base12_g1435;
			float4 blendOpDest19_g1435 = temp_cast_29;
			float4 lerpBlendMode19_g1435 = lerp(blendOpDest19_g1435,min( blendOpSrc19_g1435 , blendOpDest19_g1435 ),0.9);
			float4 LightColor779 = _LightColor;
			float4 LightColor16_g1435 = LightColor779;
			float3 desaturateInitialColor9_g1437 = ( ( ( BaseA13_g1435 * ( saturate( lerpBlendMode19_g1435 )) ) + ( Base12_g1435 * temp_output_6_0_g1435 ) ) * LightColor16_g1435 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
			...
			float clampResult87_g1412 = clamp( temp_output_68_0_g1412 , 0.0 , 1.0 );
			float temp_output_29_0_g1435 = clampResult87_g1412;
			float4 temp_cast_31 = (temp_output_29_0_g1435).xxxx;
			float4 blendOpSrc30_g1435 = Base12_g1435;
			float4 blendOpDest30_g1435 = temp_cast_31;
			float4 lerpBlendMode30_g1435 = lerp(blendOpDest30_g1435,min( blendOpSrc30_g1435 , blendOpDest30_g1435 ),0.9);
			float3 desaturateInitialColor9_g1439 = ( ( ( BaseA13_g1435 * ( saturate( lerpBlendMode30_g1435 )) ) + ( Base12_g1435 * temp_output_29_0_g1435 ) ) * LightColor16_g1435 * _SpecularIntensity * _SpecularTint ).rgb;
			float desaturateDot9_g1439 = dot( desaturateInitialColor9_g1439, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar9_g1439 = lerp( desaturateInitialColor9_g1439, desaturateDot9_g1439.xxx, ( 1.0 - _SpecularSaturation ) );
			...
			float4 clampResult18_g1442 = clamp( ase_lightColor , temp_cast_39 , temp_cast_40 );
			float4 temp_output_8_0_g1442 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
			float4 ifLocalVar17_g1442 = 0;
			if( ifLocalVar13_g1442 > 0.0 )
				ifLocalVar17_g1442 = clampResult18_g1442;
			else if( ifLocalVar13_g1442 == 0.0 )
				ifLocalVar17_g1442 = temp_output_8_0_g1442;
			float4 EmissionLightColor947 = ifLocalVar17_g1442;
...
/*ASEBEGIN
Version=18900
-2405;253;2298;1017;-932.6714;-2401.142;1.117474;True;True
...
Node;AmplifyShaderEditor.SamplerNode;296;-2981.91,2744.822;Inherit;True;Property;_Base;Base;2;0;Create;True;0;0;0;False;0;False;-1;None;53463d7cfa7969d459ddb88faaabbee3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;297;-2937.471,2998.025;Inherit;True;Property;_SSS;SSS;3;0;Create;True;0;0;0;False;0;False;-1;None;8362ff8211a28ae459012858890fee37;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;828;-2717.466,3954.571;Inherit;False;Property;_Target2Color;Target 2 Color;41;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2235284,0.2196068,0.1921559,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;851;-2717.466,4626.572;Inherit;False;Property;_Source4Color;Source 4 Color;47;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2470578,0.1607834,0.117646,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;848;-2717.466,4402.572;Inherit;False;Property;_Target3Color;Target 3 Color;45;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.3215676,0.4235284,0.6666667,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;826;-2717.466,3730.571;Inherit;False;Property;_Source2Color;Source 2 Color;39;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2039205,0.1568618,0.1372539,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;852;-2717.466,4850.572;Inherit;False;Property;_Target4Color;Target 4 Color;49;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.937255,0.854902,0.635294,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;274;-1737.02,2839.592;Inherit;True;Property;_ILM;ILM;4;0;Create;True;0;0;0;False;0;False;-1;None;e09589e88f340a1479854462e291c64b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;471;941.7625,3929.256;Inherit;False;Property;_ViewDirOffsetPitch;View Dir Offset Pitch;13;0;Create;True;0;0;0;False;0;False;0;55;-90;90;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;472;941.7625,4009.256;Inherit;False;Property;_ViewDirOffsetYaw;View Dir Offset Yaw;14;0;Create;True;0;0;0;False;0;False;0;-45;-90;90;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;727;3008,4224;Inherit;False;Property;_Shadow2Push;Shadow 2 Push;28;0;Create;True;0;0;0;False;0;False;0.2;0.209;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;731;2992,4288;Inherit;False;Property;_Shadow2VertexRThreshold;Shadow 2 VertexR Threshold;29;0;Create;True;0;0;0;False;0;False;0.1;0.318;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;716;2992,4160;Inherit;False;Property;_Shadow1VertexRThreshold;Shadow 1 VertexR Threshold;27;0;Create;True;0;0;0;False;0;False;0.5;0.48;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;732;2992,4352;Inherit;False;Property;_PermanentShadowThreshold;Permanent Shadow Threshold;30;0;Create;True;0;0;0;False;0;False;0.1;0.04;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1080;3936,5888;Inherit;False;Property;_ShadowRimlightBaseColor;Shadow Rimlight Base Color;0;0;Create;True;0;0;0;False;0;False;0.2392157,0.2392157,0.5294118,0;0.2392157,0.2392157,0.5294118,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;869;-1418.869,5197.192;Inherit;False;Property;_FakeGlobalLightIntensity;Fake Global Light Intensity;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;980;-241.5962,5906.203;Inherit;False;Property;_DebugGroup;Debug Group;101;1;[Enum];Create;True;0;3;Vertex Colors;0;ILM Channels;1;Base Alpha;2;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;960;-1099.532,4903.766;Inherit;False;Light Color Calculation;-1;;1442;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;6;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.RangedFloatNode;981;-289.1011,6238.182;Inherit;False;Property;_ILMChannel;ILM Channel;103;1;[Enum];Create;True;0;5;All Channels;0;Red;1;Green;2;Blue;3;Alpha;4;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;986;175.4907,6202.33;Inherit;False;Debug;-1;;1443;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;909;6799.561,4442.573;Inherit;False;Property;_OutlineColor;Outline Color;89;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;933;7737.247,3247.347;Inherit;False;Property;_EmissionIntensity;Emission Intensity;23;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1057;7155.288,4375.559;Inherit;False;ASWOutline;-1;;1445;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.GetLocalVarNode;1073;8233.238,3778.795;Inherit;False;1072;myVarName;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;266;8477.993,3602.784;Float;False;True;-1;2;ASWFighterZGUI;0;0;CustomLighting;.Aerthas/Arc System Works/Game Select/FighterZ/Opaque v7.1.0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;True;1061;0;True;1071;True;0;True;1069;0;True;1070;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;14;all;True;True;True;True;0;False;-1;True;0;False;1068;255;True;1067;255;True;1066;0;True;1065;0;True;1064;0;True;1063;0;True;1062;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=193A65B99F3B7D6E4B2BFC0129BE5B0E5E2C1FC6