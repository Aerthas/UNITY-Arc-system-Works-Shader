...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Opaque v8.1.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix0375_g1531(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1531(  )
			{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float NdV48_g1508 = ( ( 1.0 - ( dotResult31_g1529 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1511 - blendOpDest15_g1511 ) )) ) );
				...
				float3 localViewMatrix0375_g1531 = ViewMatrix0375_g1531();
				float3 normalizeResult384_g1531 = normalize( localViewMatrix0375_g1531 );
				float3 temp_output_380_0_g1531 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1531 = ViewMatrix1373_g1531();
				float3 normalizeResult376_g1531 = normalize( localViewMatrix1373_g1531 );
				float3 localStereoCameraViewPosition30_g1529 = StereoCameraViewPosition30_g1529();
				float3 rotatedValue385_g1531 = RotateAroundAxis( temp_output_380_0_g1531, localStereoCameraViewPosition30_g1529, normalizeResult376_g1531, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1531 = RotateAroundAxis( temp_output_380_0_g1531, rotatedValue385_g1531, normalize( normalizeResult384_g1531 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1531 = normalize( ( rotatedValue387_g1531 - temp_output_380_0_g1531 ) );
				float3 normalizeResult38_g1529 = normalize( normalizeResult389_g1531 );
				...
				float temp_output_36_0_g1511 = ( ( dotResult46_g1529 + _GlobalLightPush ) * i.ase_color.r );
				...
				float temp_output_6_0_g1521 = temp_output_94_0_g1508;
				float4 temp_cast_29 = (temp_output_6_0_g1521).xxxx;
				float4 blendOpSrc19_g1521 = Base12_g1521;
				float4 blendOpDest19_g1521 = temp_cast_29;
				float4 lerpBlendMode19_g1521 = lerp(blendOpDest19_g1521,min( blendOpSrc19_g1521 , blendOpDest19_g1521 ),0.9);
				float4 LightColor779 = _LightColor;
				float4 LightColor16_g1521 = LightColor779;
				float3 desaturateInitialColor9_g1522 = ( ( ( BaseA13_g1521 * ( saturate( lerpBlendMode19_g1521 )) ) + ( Base12_g1521 * temp_output_6_0_g1521 ) ) * LightColor16_g1521 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
				float desaturateDot9_g1522 = dot( desaturateInitialColor9_g1522, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1522 = lerp( desaturateInitialColor9_g1522, desaturateDot9_g1522.xxx, ( 1.0 - _HighlightRimlightSaturation ) );
				...
				float blendOpDest34_g1511 = dotResult50_g1529;
				...
				float temp_output_29_0_g1521 = clampResult87_g1508;
				float4 temp_cast_31 = (temp_output_29_0_g1521).xxxx;
				...
				float3 desaturateInitialColor9_g1525 = ( ( ( BaseA13_g1521 * ( saturate( lerpBlendMode30_g1521 )) ) + ( Base12_g1521 * temp_output_29_0_g1521 ) ) * LightColor16_g1521 * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1525 = dot( desaturateInitialColor9_g1525, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1525 = lerp( desaturateInitialColor9_g1525, desaturateDot9_g1525.xxx, ( 1.0 - _SpecularSaturation ) );
				...
				float3 desaturateInitialColor9_g1527 = ( ( Base12_g1521 * clampResult90_g1508 ) * LightColor16_g1521 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1527 = dot( desaturateInitialColor9_g1527, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1527 = lerp( desaturateInitialColor9_g1527, desaturateDot9_g1527.xxx, ( 1.0 - _BaseSaturation ) );
				float3 SSS578 = temp_output_995_0[1];
				float4 SSS14_g1521 = float4( SSS578 , 0.0 );
				float4 AmbientColor780 = _AmbientColor;
				float4 AmbientColor68_g1521 = AmbientColor780;
				float3 desaturateInitialColor9_g1526 = ( ( temp_output_43_0_g1508 * Base12_g1521 * SSS14_g1521 ) * AmbientColor68_g1521 * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1526 = dot( desaturateInitialColor9_g1526, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1526 = lerp( desaturateInitialColor9_g1526, desaturateDot9_g1526.xxx, ( 1.0 - _Shadow1Saturation ) );
				...
				float4 blendOpSrc51_g1521 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1521 = ( Base12_g1521 * SSS14_g1521 );
				...
				float3 desaturateInitialColor9_g1524 = ( ( clampResult91_g1508 * ( saturate( lerpBlendMode51_g1521 )) ) * AmbientColor68_g1521 * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1524 = dot( desaturateInitialColor9_g1524, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1524 = lerp( desaturateInitialColor9_g1524, desaturateDot9_g1524.xxx, ( 1.0 - _Shadow2Saturation ) );
				...
				float temp_output_60_0_g1521 = temp_output_96_0_g1508;
				float4 blendOpSrc56_g1521 = float4( 0,0,0,0 );
				float4 blendOpDest56_g1521 = ( Base12_g1521 * SSS14_g1521 );
				float4 lerpBlendMode56_g1521 = lerp(blendOpDest56_g1521,2.0f*blendOpDest56_g1521*blendOpSrc56_g1521 + blendOpDest56_g1521*blendOpDest56_g1521*(1.0f - 2.0f*blendOpSrc56_g1521),0.5);
				float4 temp_output_56_0_g1521 = ( saturate( lerpBlendMode56_g1521 ));
				float3 desaturateInitialColor9_g1523 = ( ( ( ( temp_output_60_0_g1521 * ( temp_output_56_0_g1521 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1521 * temp_output_56_0_g1521 ) ) * ILMR573 ) * AmbientColor68_g1521 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
				float desaturateDot9_g1523 = dot( desaturateInitialColor9_g1523, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1523 = lerp( desaturateInitialColor9_g1523, desaturateDot9_g1523.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
				float3 temp_output_787_0 = ( desaturateVar9_g1522 + desaturateVar9_g1525 + desaturateVar9_g1527 + desaturateVar9_g1526 + desaturateVar9_g1524 + desaturateVar9_g1523 );
				...
				float4 temp_cast_45 = (( _EmissionMaskIntensity * tex2D( _EmissionMask, uv_EmissionMask ).r )).xxxx;
				float4 EmissionRampMask920 = max( ( ( ( temp_output_94_0_g1508 * _HighlightRimlightEmissiveToggle ) * _HighlightRimlightEmissionIntensity ) + ( ( clampResult87_g1508 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1508 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1508 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1508 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( temp_output_96_0_g1508 * _ShadowRimlightEmissiveToggle ) * _ShadowRimlightEmissionIntensity ) + ( ( 1.0 - ILMA357 ) * _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) + ( ( 1.0 - Detail807 ) * _BodyLinesEmissionToggle * _BodyLinesEmissionIntensity ) ) , temp_cast_45 );
				float4 temp_cast_47 = (EmissionRampMask920.r).xxxx;
				...
				#else
				float4 staticSwitch30_g1512 = max( temp_cast_47 , ifLocalVar17_g1512 );
				#endif
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1528 = _OutlineThickness;
				float3 temp_output_135_0_g1528 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1528 ) + temp_output_33_0_g1528 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1528 = ObjSpaceViewDir( float4( temp_output_135_0_g1528 , 0.0 ) );
				float4 normalizeResult142_g1528 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1528 , 0.0 ) - v.vertex ) );
				float clampResult141_g1528 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1528 = lerp( float4( temp_output_135_0_g1528 , 0.0 ) , -normalizeResult142_g1528 , ( 1.0 - clampResult141_g1528 ));
				
				o.ase_texcoord.xy = v.ase_texcoord.xy;
				o.ase_texcoord.zw = v.ase_texcoord1.xy;

				v.vertex.xyz += lerpResult145_g1528.xyz;
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1020 = lerp( ILMAColor992 , temp_output_1031_0 , ILMA357);
				float4 Base339 = ( _ILMColorSetting == 1.0 ? lerpResult1020 : ( ILMA357 * temp_output_1031_0 ) );
				float4 temp_output_13_0_g1528 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1528 * temp_output_13_0_g1528 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
-2301;179;2236;938;-3164.607;-2771.973;1.054913;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;823;-2781.466,3442.571;Inherit;False;Property;_Source1Fuzziness;Source 1 Fuzziness;36;0;Create;True;0;0;0;False;0;False;0;0.4;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;828;-2717.466,3954.571;Inherit;False;Property;_Target2Color;Target 2 Color;41;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.9647059,0.4941176,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;851;-2717.466,4626.572;Inherit;False;Property;_Source4Color;Source 4 Color;47;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;824;-2717.466,3506.571;Inherit;False;Property;_Target1Color;Target 1 Color;37;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.4039215,0.8078432,0.8666667,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;822;-2749.466,3282.571;Inherit;False;Property;_Source1Color;Source 1 Color;35;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.5372549,0.7176471,0.290196,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;826;-2717.466,3730.571;Inherit;False;Property;_Source2Color;Source 2 Color;39;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.1921568,0.1764705,0.235294,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;847;-2717.466,4178.572;Inherit;False;Property;_Source3Color;Source 3 Color;43;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.2588234,0.4627449,0.07450975,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;846;-2781.466,4338.572;Inherit;False;Property;_Source3Fuzziness;Source 3 Fuzziness;44;0;Create;True;0;0;0;False;0;False;0.01;0.135;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;852;-2717.466,4850.572;Inherit;False;Property;_Target4Color;Target 4 Color;49;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;848;-2717.466,4402.572;Inherit;False;Property;_Target3Color;Target 3 Color;45;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.1686273,0.5882353,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;885;4016,4736;Inherit;False;Property;_SpecularIntensity;Specular Intensity;62;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1057;7155.288,4375.559;Inherit;False;ASWOutline;-1;;1528;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.RangedFloatNode;727;3008,4288;Inherit;False;Property;_Shadow2Push;Shadow 2 Push;28;0;Create;True;0;0;0;False;0;False;0.2;0.2;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1091;4154.673,3311.612;Inherit;False;Emission - FighterZ;-1;;1533;2e32fe20ddeddef43b8b5dae014cc006;0;20;32;FLOAT;0;False;31;FLOAT;0;False;17;FLOAT;0;False;25;COLOR;0,0,0,0;False;24;FLOAT;0;False;20;FLOAT;0;False;26;FLOAT;0;False;27;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;22;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;21;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1087;8477.993,3602.784;Float;False;False;-1;2;ASEMaterialInspector;100;8;New Amplify Shader;fd5163ddf7350f946aff871fd3d7e3fe;True;ShadowCaster;0;4;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1083;9610.994,4024.884;Float;False;True;-1;2;ASWFighterZGUI;100;8;.Aerthas/Arc System Works/Game Select/FighterZ/Opaque v8.1.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1068;255;True;1067;255;True;1066;7;True;1065;1;True;1064;1;True;1063;1;True;1062;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1061;True;3;True;1071;True;True;0;True;1069;0;True;1070;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;False;False;;False;0
...
ASEEND*/
//CHKSM=7740921924573C82EE91359C9B11179C75B14584