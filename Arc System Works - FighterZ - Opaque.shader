...
Shader ".Aerthas/Arc System Works/Game Select/FighterZ/Opaque v7.2.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 StereoCameraViewDirection32_g1498( float3 worldPos )
			{
			...
			float3 ViewMatrix0375_g1500(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1500(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1498(  )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 Base12_g1491 = Base339;
				float EnableRimlight82_g1486 = _EnableRimlight;
				float3 ase_worldNormal = i.ase_texcoord2.xyz;
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 worldPos32_g1498 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1498 = StereoCameraViewDirection32_g1498( worldPos32_g1498 );
				float dotResult31_g1498 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1498 );
				float SSSA581 = tex2DNode297.a;
				float blendOpSrc15_g1489 = SSSA581;
				float blendOpDest15_g1489 = BaseA580;
				float NdV48_g1486 = ( ( 1.0 - ( dotResult31_g1498 + ( 1.0 - _RimlightSize ) ) ) * ( 1.0 - ( saturate( abs( blendOpSrc15_g1489 - blendOpDest15_g1489 ) )) ) );
				float VertexR33_g1486 = i.ase_color.r;
				float LightDirectionSetting561 = _LightDirectionSetting;
				float FallbackLightDirection563 = _FallbackLightDirection;
				float3 localViewMatrix0375_g1500 = ViewMatrix0375_g1500();
				float3 normalizeResult384_g1500 = normalize( localViewMatrix0375_g1500 );
				float3 temp_output_380_0_g1500 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1500 = ViewMatrix1373_g1500();
				float3 normalizeResult376_g1500 = normalize( localViewMatrix1373_g1500 );
				float3 localStereoCameraViewPosition30_g1498 = StereoCameraViewPosition30_g1498();
				float3 rotatedValue385_g1500 = RotateAroundAxis( temp_output_380_0_g1500, localStereoCameraViewPosition30_g1498, normalizeResult376_g1500, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1500 = RotateAroundAxis( temp_output_380_0_g1500, rotatedValue385_g1500, normalize( normalizeResult384_g1500 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1500 = normalize( ( rotatedValue387_g1500 - temp_output_380_0_g1500 ) );
				float3 normalizeResult38_g1498 = normalize( normalizeResult389_g1500 );
				float3 appendResult15_g1499 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1499 = normalize( appendResult15_g1499 );
				float3 normalizeResult26_g1498 = normalize( normalizeResult2_g1499 );
				float3 ifLocalVar3_g1498 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1498 = normalizeResult38_g1498;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1498 = normalizeResult26_g1498;
				...
				#endif //aselc
				float clampResult7_g1487 = clamp( ( ( abs( worldSpaceLightDir ).x > float3( 0,0,0 ) ? 1.0 : 0.0 ) + ( ase_lightColor.a > 0.0 ? 1.0 : 0.0 ) ) , 0.0 , 1.0 );
				float4 color14_g1487 = IsGammaSpace() ? float4(1,0,0,0) : float4(1,0,0,0);
				float4 color8_g1487 = IsGammaSpace() ? float4(0,1,0,0) : float4(0,1,0,0);
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1487 = color8_g1487;
				#else
				float4 staticSwitch9_g1487 = ( clampResult7_g1487 * color14_g1487 );
				#endif
				float4 break10_g1487 = staticSwitch9_g1487;
				float IsThereWorldLight450 = break10_g1487.r;
				float3 ifLocalVar8_g1498 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1498 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1498 = ifLocalVar3_g1498;
				float3 ifLocalVar9_g1498 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1498 = ifLocalVar3_g1498;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1498 = ifLocalVar8_g1498;
				float dotResult46_g1498 = dot( ifLocalVar9_g1498 , normalizedWorldNormal );
				float temp_output_36_0_g1489 = ( ( dotResult46_g1498 + _GlobalLightPush ) * i.ase_color.r );
				...
				float temp_output_1_0_g1489 = ILMG574;
				float temp_output_1077_0 = ( temp_output_36_0_g1489 * temp_output_1_0_g1489 );
				float NdL20_g1486 = temp_output_1077_0;
				float temp_output_9_0_g1486 = _Shadow1Push;
				float temp_output_11_0_g1486 = _Shadow2Push;
				float clampResult15_g1486 = clamp( temp_output_9_0_g1486 , temp_output_11_0_g1486 , temp_output_9_0_g1486 );
				float RealShadow1Push16_g1486 = clampResult15_g1486;
				float clampResult17_g1486 = clamp( temp_output_11_0_g1486 , temp_output_11_0_g1486 , temp_output_9_0_g1486 );
				float RealShadow2Push18_g1486 = clampResult17_g1486;
				float temp_output_42_0_g1486 = max( max( ( 1.0 - ( VertexR33_g1486 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , ( NdL20_g1486 < RealShadow2Push18_g1486 ? 1.0 : 0.0 ) ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1486 = ( max( ( 1.0 - ( VertexR33_g1486 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( ( NdL20_g1486 < RealShadow1Push16_g1486 ? 1.0 : 0.0 ) , ( RealShadow1Push16_g1486 >= RealShadow2Push18_g1486 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1486 );
				float temp_output_61_0_g1486 = ( 1.0 - ( temp_output_43_0_g1486 + temp_output_42_0_g1486 ) );
				float temp_output_75_0_g1486 = ceil( ( ( ( NdV48_g1486 * BaseA580 ) > 0.0 ? 1.0 : 0.0 ) * temp_output_61_0_g1486 ) );
				float clampResult88_g1486 = clamp( temp_output_75_0_g1486 , 0.0 , 1.0 );
				float temp_output_94_0_g1486 = ( EnableRimlight82_g1486 == 1.0 ? clampResult88_g1486 : 0.0 );
				float temp_output_6_0_g1491 = temp_output_94_0_g1486;
				float4 temp_cast_29 = (temp_output_6_0_g1491).xxxx;
				float4 blendOpSrc19_g1491 = Base12_g1491;
				float4 blendOpDest19_g1491 = temp_cast_29;
				float4 lerpBlendMode19_g1491 = lerp(blendOpDest19_g1491,min( blendOpSrc19_g1491 , blendOpDest19_g1491 ),0.9);
				float4 LightColor779 = _LightColor;
				float4 LightColor16_g1491 = LightColor779;
				float3 desaturateInitialColor9_g1493 = ( ( ( BaseA13_g1491 * ( saturate( lerpBlendMode19_g1491 )) ) + ( Base12_g1491 * temp_output_6_0_g1491 ) ) * LightColor16_g1491 * _HighlightRimlightIntensity * _HighlightRimlightTint ).rgb;
				float desaturateDot9_g1493 = dot( desaturateInitialColor9_g1493, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1493 = lerp( desaturateInitialColor9_g1493, desaturateDot9_g1493.xxx, ( 1.0 - _HighlightRimlightSaturation ) );
				float ILMB576 = break292.z;
				float3 normalizeResult48_g1498 = normalize( ifLocalVar9_g1498 );
				float3 normalizeResult51_g1498 = normalize( ( normalizeResult48_g1498 + localStereoCameraViewDirection32_g1498 ) );
				float dotResult50_g1498 = dot( normalizedWorldNormal , normalizeResult51_g1498 );
				float blendOpSrc34_g1489 = ILMB576;
				float blendOpDest34_g1489 = dotResult50_g1498;
				float temp_output_68_0_g1486 = ( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1489) / max( blendOpSrc34_g1489, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) * temp_output_61_0_g1486 );
				float clampResult87_g1486 = clamp( temp_output_68_0_g1486 , 0.0 , 1.0 );
				float temp_output_29_0_g1491 = clampResult87_g1486;
				float4 temp_cast_31 = (temp_output_29_0_g1491).xxxx;
				float4 blendOpSrc30_g1491 = Base12_g1491;
				float4 blendOpDest30_g1491 = temp_cast_31;
				float4 lerpBlendMode30_g1491 = lerp(blendOpDest30_g1491,min( blendOpSrc30_g1491 , blendOpDest30_g1491 ),0.9);
				float3 desaturateInitialColor9_g1495 = ( ( ( BaseA13_g1491 * ( saturate( lerpBlendMode30_g1491 )) ) + ( Base12_g1491 * temp_output_29_0_g1491 ) ) * LightColor16_g1491 * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1495 = dot( desaturateInitialColor9_g1495, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1495 = lerp( desaturateInitialColor9_g1495, desaturateDot9_g1495.xxx, ( 1.0 - _SpecularSaturation ) );
				float temp_output_77_0_g1486 = ( temp_output_61_0_g1486 - temp_output_68_0_g1486 );
				float clampResult90_g1486 = clamp( ( EnableRimlight82_g1486 == 1.0 ? ( temp_output_77_0_g1486 - temp_output_75_0_g1486 ) : temp_output_77_0_g1486 ) , 0.0 , 1.0 );
				float3 desaturateInitialColor9_g1497 = ( ( Base12_g1491 * clampResult90_g1486 ) * LightColor16_g1491 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1497 = dot( desaturateInitialColor9_g1497, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1497 = lerp( desaturateInitialColor9_g1497, desaturateDot9_g1497.xxx, ( 1.0 - _BaseSaturation ) );
				float3 SSS578 = temp_output_995_0[1];
				float4 SSS14_g1491 = float4( SSS578 , 0.0 );
				float4 AmbientColor780 = _AmbientColor;
				float4 AmbientColor68_g1491 = AmbientColor780;
				float3 desaturateInitialColor9_g1496 = ( ( temp_output_43_0_g1486 * Base12_g1491 * SSS14_g1491 ) * AmbientColor68_g1491 * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1496 = dot( desaturateInitialColor9_g1496, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1496 = lerp( desaturateInitialColor9_g1496, desaturateDot9_g1496.xxx, ( 1.0 - _Shadow1Saturation ) );
				float ILMR573 = break292.x;
				float temp_output_53_0_g1486 = ceil( ( ( ( temp_output_42_0_g1486 * NdV48_g1486 ) > 0.1 ? 1.0 : 0.0 ) * ILMR573 ) );
				float clampResult91_g1486 = clamp( ( EnableRimlight82_g1486 == 1.0 ? ( temp_output_42_0_g1486 - temp_output_53_0_g1486 ) : temp_output_42_0_g1486 ) , 0.0 , 1.0 );
				float4 blendOpSrc51_g1491 = float4( 0,0,0,0 );
				float4 blendOpDest51_g1491 = ( Base12_g1491 * SSS14_g1491 );
				float4 lerpBlendMode51_g1491 = lerp(blendOpDest51_g1491,2.0f*blendOpDest51_g1491*blendOpSrc51_g1491 + blendOpDest51_g1491*blendOpDest51_g1491*(1.0f - 2.0f*blendOpSrc51_g1491),0.5);
				float3 desaturateInitialColor9_g1494 = ( ( clampResult91_g1486 * ( saturate( lerpBlendMode51_g1491 )) ) * AmbientColor68_g1491 * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1494 = dot( desaturateInitialColor9_g1494, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1494 = lerp( desaturateInitialColor9_g1494, desaturateDot9_g1494.xxx, ( 1.0 - _Shadow2Saturation ) );
				float clampResult92_g1486 = clamp( temp_output_53_0_g1486 , 0.0 , 1.0 );
				float temp_output_96_0_g1486 = ( EnableRimlight82_g1486 == 1.0 ? clampResult92_g1486 : 0.0 );
				float temp_output_60_0_g1491 = temp_output_96_0_g1486;
				float4 blendOpSrc56_g1491 = float4( 0,0,0,0 );
				float4 blendOpDest56_g1491 = ( Base12_g1491 * SSS14_g1491 );
				float4 lerpBlendMode56_g1491 = lerp(blendOpDest56_g1491,2.0f*blendOpDest56_g1491*blendOpSrc56_g1491 + blendOpDest56_g1491*blendOpDest56_g1491*(1.0f - 2.0f*blendOpSrc56_g1491),0.5);
				float4 temp_output_56_0_g1491 = ( saturate( lerpBlendMode56_g1491 ));
				float3 desaturateInitialColor9_g1492 = ( ( ( ( temp_output_60_0_g1491 * ( temp_output_56_0_g1491 + _ShadowRimlightBaseColor ) ) + ( temp_output_60_0_g1491 * temp_output_56_0_g1491 ) ) * ILMR573 ) * AmbientColor68_g1491 * _ShadowRimlightIntensity * _ShadowRimlightTint ).rgb;
				float desaturateDot9_g1492 = dot( desaturateInitialColor9_g1492, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1492 = lerp( desaturateInitialColor9_g1492, desaturateDot9_g1492.xxx, ( 1.0 - _ShadowRimlightSaturation ) );
				float3 temp_output_787_0 = ( desaturateVar9_g1493 + desaturateVar9_g1495 + desaturateVar9_g1497 + desaturateVar9_g1496 + desaturateVar9_g1494 + desaturateVar9_g1492 );
				...
				float4 clampResult18_g1490 = clamp( ase_lightColor , temp_cast_41 , temp_cast_42 );
				...
				float4 EmissionRampMask920 = ( ( ( temp_output_94_0_g1486 * _HighlightRimlightEmissiveToggle ) * _HighlightRimlightEmissionIntensity ) + ( ( clampResult87_g1486 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1486 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1486 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1486 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( temp_output_96_0_g1486 * _ShadowRimlightEmissiveToggle ) * _ShadowRimlightEmissionIntensity ) + ( ( 1.0 - ILMA357 ) * _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) + ( ( 1.0 - Detail807 ) * _BodyLinesEmissionToggle * _BodyLinesEmissionIntensity ) );
				...
				#else
				float4 staticSwitch30_g1490 = max( temp_cast_45 , ifLocalVar17_g1490 );
				#endif
				...
				float temp_output_48_0_g1502 = _DebugGroup;
				float temp_output_47_0_g1502 = _VertexChannel;
				float4 temp_output_59_0_g1502 = _DebugColor;
				float temp_output_50_0_g1502 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult984 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1502 = appendResult984;
				float4 break7_g1502 = temp_output_54_0_g1502;
				float temp_output_57_0_g1502 = 0.0;
				float4 Debug987 = ( temp_output_48_0_g1502 == 0.0 ? ( temp_output_47_0_g1502 == 0.0 ? i.ase_color : ( temp_output_47_0_g1502 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1502 ) : ( temp_output_47_0_g1502 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1502 ) : ( temp_output_47_0_g1502 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1502 ) : ( temp_output_47_0_g1502 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1502 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1502 == 1.0 ? ( temp_output_50_0_g1502 == 0.0 ? temp_output_54_0_g1502 : ( temp_output_50_0_g1502 == 1.0 ? ( break7_g1502.r * temp_output_59_0_g1502 ) : ( temp_output_50_0_g1502 == 2.0 ? ( break7_g1502.g * temp_output_59_0_g1502 ) : ( temp_output_50_0_g1502 == 3.0 ? ( break7_g1502.b * temp_output_59_0_g1502 ) : ( temp_output_50_0_g1502 == 4.0 ? ( break7_g1502.a * temp_output_59_0_g1502 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1502 == 2.0 ? ( temp_output_57_0_g1502 == 0.0 ? ( BaseA580 * temp_output_59_0_g1502 ) : ( temp_output_57_0_g1502 == 1.0 ? ( 0.0 * temp_output_59_0_g1502 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1501 = _OutlineThickness;
				float3 temp_output_135_0_g1501 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1501 ) + temp_output_33_0_g1501 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1501 = ObjSpaceViewDir( float4( temp_output_135_0_g1501 , 0.0 ) );
				float4 normalizeResult142_g1501 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1501 , 0.0 ) - v.vertex ) );
				float clampResult141_g1501 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1501 = lerp( float4( temp_output_135_0_g1501 , 0.0 ) , -normalizeResult142_g1501 , ( 1.0 - clampResult141_g1501 ));
				
				o.ase_texcoord.xy = v.ase_texcoord.xy;
				o.ase_texcoord.zw = v.ase_texcoord1.xy;

				v.vertex.xyz += lerpResult145_g1501.xyz;
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult1020 = lerp( ILMAColor992 , temp_output_1031_0 , ILMA357);
				float4 Base339 = ( _ILMColorSetting == 1.0 ? lerpResult1020 : ( ILMA357 * temp_output_1031_0 ) );
				float4 temp_output_13_0_g1501 = max( float4( 0,0,0,0 ) , ( 0.2 * Base339 ) );
				

				outOutlineColor = ( ( _OutlineEnableBaseColorMult > 0.0 ? ( temp_output_13_0_g1501 * temp_output_13_0_g1501 ) : _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=18900
3001;193;2298;1017;-6717.687;-3895.899;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;912;6801.561,4223.573;Inherit;False;Property;_OutlineThickness;Outline Thickness;87;0;Create;True;0;0;0;False;0;False;1;9.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;960;-1099.532,4903.766;Inherit;False;Light Color Calculation;-1;;1490;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.RangedFloatNode;1078;1743.728,2673.112;Inherit;False;Property;_Opacity;Opacity;111;0;Create;True;0;0;0;True;0;False;1;0.196;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1042;4154.673,3311.612;Inherit;False;Emission - FighterZ;-1;;1488;2e32fe20ddeddef43b8b5dae014cc006;0;18;17;FLOAT;0;False;25;COLOR;0,0,0,0;False;24;FLOAT;0;False;20;FLOAT;0;False;26;FLOAT;0;False;27;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;22;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;21;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1057;7155.288,4375.559;Inherit;False;ASWOutline;-1;;1501;ea9f2d47913480c4f9e91454af7efa45;0;7;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.FunctionNode;986;175.4907,6202.33;Inherit;False;Debug;-1;;1502;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1498;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.FunctionNode;634;1049.433,2895.548;Inherit;False;Is There A Light;-1;;1487;65e24b0fdfa2e3146a301178490755c7;0;0;2;FLOAT;0;FLOAT;15
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1083;9610.994,4024.884;Float;False;True;-1;2;ASWFighterZGUI;100;8;.Aerthas/Arc System Works/Game Select/FighterZ/Opaque v7.2.1;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;False;False;;False;0
...
ASEEND*/
//CHKSM=729DB54C10679B3C8176EA5ECD4943E215192888