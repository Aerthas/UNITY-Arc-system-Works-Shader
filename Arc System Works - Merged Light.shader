...
Shader ".Aerthas/Arc System Works/Merged Light v6.7.0"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float outlineVar = (( _EnableCameraDistanceMult > 0.0 ) ? ( 0.0001 * _OutlineThickness * break1163.w * min( ( break1163.y * distance( ase_worldPos , _WorldSpaceCameraPos ) ) , 1.0 ) * (( break1163.z > 0.1 ) ? 1.0 :  0.0 ) ) :  ( (( _EnableCameraDistanceMult > 0.0 ) ? 0.0 :  5.0 ) * 1E-05 * _OutlineThickness * break1163.z * break1163.w ) );
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_output_1375_0 = max( float4( 0,0,0,0 ) , ( 0.2 * Base183 ) );
			o.Emission = (( _EnableBaseColorMult > 0.0 ) ? ( temp_output_1375_0 * temp_output_1375_0 ) :  _OutlineColor ).rgb;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_106_0_g462 = DarkenHighlight538;
			float4 lerpResult122_g462 = lerp( temp_output_43_0_g462 , DarkHighlightColor1376 , temp_output_106_0_g462);
			float4 BaseSSS451 = ( temp_output_449_0 * _ShadowLayer1Intensity );
			float4 temp_output_42_0_g462 = BaseSSS451;
			float4 temp_output_41_0_g462 = Base183;
			...
			float4 temp_output_111_0_g462 = HighlightColor1381;
			...
			float temp_output_97_0_g462 = Highlight555;
			float4 lerpResult110_g462 = lerp( temp_output_41_0_g462 , temp_output_111_0_g462 , temp_output_97_0_g462);
			...
			float temp_output_37_0_g462 = DefaultDot14;
			float temp_output_40_0_g462 = SSSAlpha987;
			float ifLocalVar5_g464 = 0;
			if( temp_output_40_0_g462 >= ( 1.0 - _ShadowLayer1Gate ) )
				ifLocalVar5_g464 = 1.0;
			float lerpResult8_g464 = lerp( 1.0 , ( ( -1.0 + VertexColors441.x + temp_output_37_0_g462 ) - _ShadowLayer1Push ) , ifLocalVar5_g464);
			float2 uv_ILM113 = i.uv_texcoord;
			float4 tex2DNode113 = tex2D( _ILM, uv_ILM113 );
			float ILMG360 = tex2DNode113.g;
			float temp_output_1_0_g253 = ILMG360;
			float temp_output_20_0_g253 = ( 1.0 - ( 0.62 * temp_output_1_0_g253 ) );
			float ILMB117 = tex2DNode113.b;
			float4 color12_g253 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
			float4 temp_cast_9 = (Highlight555).xxxx;
			float4 temp_output_34_0_g253 = temp_cast_9;
			float4 temp_output_22_0_g253 = ( ( ILMB117 * 0.4 ) + ( color12_g253 + temp_output_34_0_g253 ) );
			float4 ifLocalVar24_g253 = 0;
			if( ( ( ( 1.0 - _ILMLayer1 ) * 0.1 ) + 0.9 ) >= temp_output_20_0_g253 )
				ifLocalVar24_g253 = temp_output_22_0_g253;
			float4 clampResult26_g253 = clamp( ifLocalVar24_g253 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float temp_output_44_0_g253 = ( 1.0 - VertexColors441.x );
			float4 color39_g253 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
			float4 temp_output_46_0_g253 = ( ( temp_output_1_0_g253 * 0.4 ) + ( temp_output_34_0_g253 + color39_g253 ) );
			float4 ifLocalVar49_g253 = 0;
			if( _VertexLayer1 >= temp_output_44_0_g253 )
				ifLocalVar49_g253 = temp_output_46_0_g253;
			float4 clampResult51_g253 = clamp( ifLocalVar49_g253 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float temp_output_38_0_g462 = ( clampResult26_g253.r * clampResult51_g253.x );
			float smoothstepResult23_g462 = smoothstep( 0.0 , ( _ShadowLayer1Fuzziness * 0.01 ) , ( lerpResult8_g464 * temp_output_38_0_g462 ));
			float PrimaryDot127_g462 = smoothstepResult23_g462;
			float4 lerpResult26_g462 = lerp( temp_output_42_0_g462 , lerpResult110_g462 , PrimaryDot127_g462);
			float ifLocalVar5_g463 = 0;
			if( temp_output_40_0_g462 >= ( 1.0 - _ShadowLayer2Gate ) )
				ifLocalVar5_g463 = 1.0;
			float lerpResult8_g463 = lerp( 1.0 , ( temp_output_37_0_g462 - _ShadowLayer2Push ) , ifLocalVar5_g463);
			float4 ifLocalVar23_g253 = 0;
			if( ( ( ( 1.0 - _ILMLayer2 ) * 0.1 ) + 0.9 ) >= temp_output_20_0_g253 )
				ifLocalVar23_g253 = temp_output_22_0_g253;
			float4 clampResult25_g253 = clamp( ifLocalVar23_g253 , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			float4 ifLocalVar50_g253 = 0;
			if( _VertexLayer2 >= temp_output_44_0_g253 )
				ifLocalVar50_g253 = temp_output_46_0_g253;
			float4 clampResult52_g253 = clamp( ifLocalVar50_g253 , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			float temp_output_39_0_g462 = ( clampResult25_g253.r * clampResult52_g253.x );
			float smoothstepResult25_g462 = smoothstep( 0.0 , ( _ShadowLayer2Fuzziness * 0.01 ) , ( lerpResult8_g463 * temp_output_39_0_g462 ));
			float SecondaryDot129_g462 = smoothstepResult25_g462;
			float4 lerpResult28_g462 = lerp( lerpResult122_g462 , lerpResult26_g462 , SecondaryDot129_g462);
			...
			float4 temp_output_91_0_g462 = SpecularColor924;
			float smoothstepResult82_g462 = smoothstep( 0.0 , ( _SpecularFuzzy * 0.01 ) , ( ( ( 1.0 - ( ( _SpecularSize * 4.0 ) - 2.0 ) ) * -0.2 ) + ( ILMB117 * temp_output_37_0_g462 * temp_output_38_0_g462 * temp_output_39_0_g462 ) ));
			float TertiaryDot131_g462 = smoothstepResult82_g462;
			float4 lerpResult58_g462 = lerp( lerpResult28_g462 , temp_output_91_0_g462 , TertiaryDot131_g462);
			float4 lerpResult142_g462 = lerp( temp_output_42_0_g462 , temp_output_41_0_g462 , PrimaryDot127_g462);
			float4 lerpResult143_g462 = lerp( temp_output_43_0_g462 , lerpResult142_g462 , SecondaryDot129_g462);
			float4 lerpResult144_g462 = lerp( lerpResult143_g462 , temp_output_91_0_g462 , TertiaryDot131_g462);
			float4 lerpResult145_g462 = lerp( ( temp_output_106_0_g462 * lerpResult144_g462 ) , temp_output_111_0_g462 , temp_output_97_0_g462);
			float4 clampResult33_g462 = clamp( (( FresnelSystem1380 == 0.0 ) ? lerpResult58_g462 :  lerpResult145_g462 ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			...
			#else
				float4 staticSwitch1175 = (( _METALLICGLOSSMAP )?( MetalMatCap111 ):( ( LightColor457 * clampResult33_g462 * ILMA118 * Detail443 ) ));
			#endif
...
/*ASEBEGIN
Version=17800
-1616;106;1532;824;4550.48;2718.374;1.6;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;801;-5057.826,1536.031;Inherit;False;2427.208;540.8108;Highlight;10;578;554;683;550;700;555;686;573;549;1443;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;701;-4988.627,2040.868;Inherit;False;Property;_HighlightScale;Highlight Scale;36;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;553;-5010.875,2121.062;Inherit;False;Property;_HighlightPower;Highlight Power;33;0;Create;True;0;0;False;0;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;518;-5027.414,-2187.151;Inherit;False;Property;_ShadowBrightness;Shadow Brightness;16;0;Create;True;0;0;False;0;1;0.431;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1427;-4473.219,3118.824;Inherit;False;Property;_GranblueDarkenScale;Granblue Darken Scale;39;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1429;-4426.142,3242.497;Inherit;False;Property;_GranblueDarkenPower;Granblue Darken Power;38;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;604;-4415.528,2109.793;Inherit;False;Property;_HighlightFreselFuzzy;Highlight Fresel Fuzzy;34;0;Create;True;0;0;False;0;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;440;-4494.364,-2092.458;Inherit;False;SSS;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;448;-3728.568,-2127.343;Inherit;False;SSS2;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;635;-3033.608,-1481.561;Inherit;False;Property;_SpecularIntensity;Specular Intensity;28;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;1092;-2699.973,58.57975;Inherit;False;2164.024;1346.082;;19;1371;1081;1088;1172;1086;1087;1084;1164;1085;1082;1357;1089;1161;1171;1163;1174;1372;1373;1375;Outline;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1122;-4976.409,-2551.839;Inherit;False;Property;_ViewDirOffsetY;View Dir Offset Y;43;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1259;-7663.72,-1726.337;Inherit;False;Property;_BaseSSSAlphaSwap;Base SSS Alpha Swap;53;1;[Enum];Create;True;2;Base Alpha   Fresnel Mask;0;SSS Alpha   Shadow Threshold;1;0;False;0;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1378;-3145.5,2953.073;Inherit;False;Property;_FresnelSystem;Fresnel System;32;1;[Enum];Create;True;2;FighterZ;0;Granblue;1;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;974;-4977.31,-2786.54;Inherit;False;Property;_FakeLightDirX;Fake Light Dir X;14;0;Create;True;0;0;False;0;35;35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1371;-2256.82,968.8718;Inherit;False;1110.714;400.5961;Camera Scale;7;1369;1363;1364;1365;1366;1368;1367;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldSpaceCameraPos;1367;-2216.168,1197.479;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;1368;-2168.82,1027.468;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;482;-5983.309,-43.72997;Inherit;False;Property;_ILMLayer1;ILM Layer 1;25;0;Create;True;0;0;False;0;0.6;0.6;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1174;-2637.891,801.228;Inherit;False;441;VertexColors;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;871;-4026.303,-1852.158;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;501;-5983.309,116.2702;Inherit;False;Property;_VertexLayer1;Vertex Layer 1;27;0;Create;True;0;0;False;0;0.31;0.31;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;490;-5983.309,36.26994;Inherit;False;Property;_ILMLayer2;ILM Layer 2;26;0;Create;True;0;0;False;0;0.3;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;1163;-2420.242,807.174;Inherit;False;FLOAT4;1;0;FLOAT4;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;451;-3836.556,-1866.135;Inherit;False;BaseSSS;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1372;-2370.553,162.1279;Inherit;False;Constant;_Float0;Float 0;57;0;Create;True;0;0;False;0;0.2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1007;-5442.675,121.4663;Inherit;False;Permanent Shadows;-1;;253;1ce4709ce3667c2438e413e9b79be23a;0;8;3;FLOAT;0;False;4;FLOAT;0;False;58;FLOAT;0;False;59;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;57;FLOAT4;0,0,0,0;False;34;FLOAT4;0,0,0,0;False;2;FLOAT;0;FLOAT;35
Node;AmplifyShaderEditor.CommentaryNode;1006;-4881.321,-1090.758;Inherit;False;1758.411;1891.205;;24;1395;1263;848;1396;1385;1450;935;463;990;1290;471;467;465;989;734;455;1321;832;834;1000;926;1320;460;625;Shading System;0.4313726,0,0.7843137,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1089;-2379.608,268.4732;Inherit;False;183;Base;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.DistanceOpNode;1366;-1882.457,1086.77;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;625;-4772.261,-1030.755;Inherit;False;Property;_SpecularSize;Specular Size;30;0;Create;True;0;0;False;0;0.46;0.725;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;460;-4772.261,-710.7552;Inherit;False;Property;_ShadowLayer1Push;Shadow Layer 1 Push;17;0;Create;True;0;0;False;0;0;0.299;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1171;-2561.716,504.7887;Inherit;False;Property;_EnableCameraDistanceMult;Enable Camera Distance Mult;57;1;[Enum];Create;True;2;Disable;0;Enable;1;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1365;-1722.261,1050.138;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;467;-4772.261,-470.7559;Inherit;False;Property;_ShadowLayer2Push;Shadow Layer 2 Push;21;0;Create;True;0;0;False;0;-0.3;0.023;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1084;-2142.204,202.6397;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;990;-4772.261,-390.7559;Inherit;False;Property;_ShadowLayer2Gate;Shadow Layer 2 Gate;22;0;Create;True;0;0;False;0;0.91;0.91;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMinOpNode;1364;-1567.825,1057.468;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCCompareGreater;1363;-1681.063,1154.338;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;1375;-1976.553,211.1279;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;1450;-3616.629,-476.5756;Inherit;False;Shading System;-1;;462;1670eb1c79b726744983c09eed1d95d8;0;23;86;FLOAT;0;False;87;FLOAT;0;False;91;COLOR;0,0,0,0;False;92;FLOAT;0;False;35;FLOAT;0;False;46;FLOAT;0;False;49;FLOAT;0;False;50;FLOAT;0;False;47;FLOAT;0;False;48;FLOAT;0;False;37;FLOAT;0;False;38;FLOAT;0;False;39;FLOAT;0;False;36;FLOAT4;0,0,0,0;False;41;FLOAT4;0,0,0,0;False;40;FLOAT;0;False;42;COLOR;0,0,0,0;False;43;COLOR;0,0,0,0;False;105;FLOAT;0;False;97;FLOAT;0;False;111;COLOR;0,0,0,0;False;106;FLOAT;0;False;112;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCCompareGreater;1357;-2218.656,591.2221;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1161;-2388.06,724.5901;Inherit;False;Property;_OutlineThickness;Outline Thickness;2;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1369;-1315.106,1018.872;Inherit;False;5;5;0;FLOAT;0.0001;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1373;-1810.553,203.1279;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1087;-1355.058,124.7704;Inherit;False;Property;_EnableOutline;Enable Outline;55;1;[Enum];Create;True;2;Disable;0;Yes I am lazy and want ugly outlines;1;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;521;-2368.178,-362.6326;Inherit;False;111;MetalMatCap;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1164;-1923.818,693.9681;Inherit;False;5;5;0;FLOAT;0;False;1;FLOAT;1E-05;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1085;-1884.975,101.5688;Inherit;False;Property;_EnableBaseColorMult;Enable Base Color Mult;56;1;[Enum];Create;True;2;Disable;0;Enable;1;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1082;-1978.986,362.9052;Inherit;False;Property;_OutlineColor;Outline Color;1;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;1209;-1267.37,-332.572;Inherit;False;1214;Debug;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCCompareGreater;1172;-988.0706,785.9795;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCCompareGreater;1088;-1135.458,131.9705;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCCompareGreater;1086;-1616.206,204.6483;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OutlineNode;1081;-815.4374,420.3261;Inherit;False;0;True;Masked;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-410.0485,-664.7245;Float;False;True;-1;2;ASWShaderGUI;0;0;CustomLighting;.Aerthas/Arc System Works/Merged Light v6.7.0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;1;RenderType=Opaque;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1363;0;1163;2
WireConnection;111;0;110;0
WireConnection;1375;1;1084;0
WireConnection;1450;86;625;0
WireConnection;1450;87;935;0
WireConnection;1450;91;926;0
WireConnection;1450;92;1290;0
WireConnection;1450;35;460;0
WireConnection;1450;46;1000;0
WireConnection;1450;49;834;0
WireConnection;1450;50;467;0
WireConnection;1450;47;990;0
WireConnection;1450;48;832;0
WireConnection;1450;37;734;0
WireConnection;1450;38;1321;0
WireConnection;1450;39;1320;0
WireConnection;1450;36;471;0
WireConnection;1450;41;455;0
WireConnection;1450;40;989;0
WireConnection;1450;42;463;0
WireConnection;1450;43;465;0
WireConnection;1450;105;1385;0
WireConnection;1450;97;1263;0
WireConnection;1450;111;848;0
WireConnection;1450;106;1396;0
WireConnection;1450;112;1395;0
WireConnection;1357;0;1171;0
WireConnection;1250;0;1252;0
WireConnection;1250;1;1253;0
WireConnection;1250;2;1262;0
WireConnection;1369;1;1161;0
WireConnection;1369;2;1163;3
WireConnection;1369;3;1364;0
WireConnection;1369;4;1363;0
WireConnection;1214;0;1250;0
WireConnection;1457;1;1455;0
WireConnection;513;0;515;0
WireConnection;513;1;1450;0
WireConnection;513;2;512;0
WireConnection;513;3;514;0
WireConnection;1373;0;1375;0
WireConnection;1373;1;1375;0
WireConnection;1164;0;1357;0
WireConnection;1164;2;1161;0
WireConnection;1164;3;1163;2
WireConnection;1164;4;1163;3
WireConnection;1172;0;1171;0
WireConnection;1172;2;1369;0
...
ASEEND*/
//CHKSM=7A71EC8758831D0E581B7E01ED99E50FDF2D3F82