...
Shader ".Aerthas/Arc System Works/Merged Light v6.2.2"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 appendResult15_g1 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
			float3 normalizeResult2_g1 = normalize( appendResult15_g1 );
			float3 MergedRealFakeLightDir86 = (( HasWorldLight87 > 0.0 ) ? ase_worldlightDir :  normalizeResult2_g1 );
			float3 ase_normWorldNormal = normalize( ase_worldNormal );
			float dotResult3 = dot( MergedRealFakeLightDir86 , ase_normWorldNormal );
			...
			float4 clampResult573 = clamp( ( ( Base183 + ( saturate( (( blendOpSrc548 > 0.5 ) ? max( blendOpDest548, 2.0 * ( blendOpSrc548 - 0.5 ) ) : min( blendOpDest548, 2.0 * blendOpSrc548 ) ) )) ) * (( _EnableFresnelHighlight )?( pow( saturate( fresnelNode550 ) , _HighlightFreselFuzzy ) ):( 0.0 )) ) , temp_cast_2 , float4( 1,1,1,0 ) );
			...
			float4 lerpResult732 = lerp( BaseSSS451 , Base183 , smoothstepResult731);
			...
			float smoothstepResult932 = smoothstep( 0.0 , ( _SpecularFuzzy * 0.01 ) , ( ( ( 1.0 - ( ( _SpecularSize * 4.0 ) - 2.0 ) ) * -0.2 ) + ( DefaultDot14 * ILMB117 * ILMPrimaryDot809 * ILMSecondaryDot811 * VertexPrimaryDot816 * VertexSecondaryDot817 ) ));
			...
			float4 FinalCustomLight202 = ( (( _EnableMetalMatcap )?( MetalMatCap111 ):( ( LightColor457 * clampResult776 * ILMA118 * Detail443 * GranblueFresnel846 ) )) + Highlight555 );
...
/*ASEBEGIN
Version=17800
-1851;91;1776;888;7587.263;2544.135;3.275617;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;518;-5159.741,2070.902;Inherit;False;Property;_ShadowBrightness;Shadow Brightness;15;0;Create;True;0;0;False;0;1;0.431;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;701;-2495.577,1903.004;Inherit;False;Property;_HighlightScale;Highlight Scale;33;0;Create;True;0;0;False;0;1;0.41;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;73;-5718.816,-1926.272;Inherit;False;2305.884;576.6858;Real or Fake light;15;730;86;87;85;83;82;80;77;78;76;75;74;974;975;973;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;829;-1279.506,1748.22;Inherit;False;Property;_EnableFresnelHighlight;Enable Fresnel Highlight;29;0;Create;True;0;0;False;0;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;975;-4635.732,-1432.256;Inherit;False;Property;_FakeLightDirY;Fake Light Dir Y;39;0;Create;True;0;0;False;0;-135;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;974;-4635.732,-1518.256;Inherit;False;Property;_FakeLightDirX;Fake Light Dir X;38;0;Create;True;0;0;False;0;35;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;973;-4344.732,-1491.256;Inherit;False;FakeLightDir;-1;;1;cd44a314984e6d54bbbf431a1fcdff4b;0;2;1;FLOAT;0;False;18;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;490;-4923.676,698.4321;Inherit;False;Property;_ILMLayer2;ILM Layer 2;23;0;Create;True;0;0;False;0;0.3;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-4961.202,237.8481;Inherit;False;Property;_ILMLayer1;ILM Layer 1;22;0;Create;True;0;0;False;0;0.6;0.6;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCCompareGreater;85;-4037.583,-1787.401;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;86;-3741.558,-1797.928;Float;False;MergedRealFakeLightDir;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;88;-5623.734,-1261.455;Inherit;False;86;MergedRealFakeLightDir;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;859;-1267.792,2249.132;Inherit;False;Property;_DarkHighlightMult;Dark Highlight Mult;37;0;Create;True;0;0;False;0;0.2392157,0.2392157,0.5294118,0;0.2392154,0.2392154,0.5294118,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;501;-4437.868,1084.394;Inherit;False;Property;_VertexLayer1;Vertex Layer 1;24;0;Create;True;0;0;False;0;0.31;0.31;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;508;-4476.512,1507.751;Inherit;False;Property;_VertexLayer2;Vertex Layer 2;25;0;Create;True;0;0;False;0;0.51;0.51;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;519;-5798.133,-751.0599;Inherit;False;2447.437;817.1572;;31;926;757;927;925;776;751;465;754;732;463;833;812;731;556;470;832;813;818;455;753;735;738;820;467;821;834;882;460;473;734;471;Normal Shadows;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;939;-6893.392,255.1044;Inherit;False;1532.617;669.3203;Specular Dot;17;825;824;826;823;625;627;626;631;937;932;936;935;873;629;822;976;978;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.DotProductOpNode;3;-5329.369,-1228.396;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;625;-6878.582,299.1044;Inherit;False;Property;_SpecularSize;Specular Size;27;0;Create;True;0;0;False;0;0.46;0.725;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;543;-4539.634,1870.385;Inherit;False;Property;_ShadowLayer2Intensity;Shadow Layer 2 Intensity;21;0;Create;True;0;0;False;0;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;460;-5355.416,-651.422;Inherit;False;Property;_ShadowLayer1Push;Shadow Layer 1 Push;16;0;Create;True;0;0;False;0;0;0.299;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;844;-2240.833,2703.143;Inherit;False;Property;_GranblueFresnelScale;Granblue Fresnel Scale;35;0;Create;True;0;0;False;0;1.12;1.12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;842;-2202.722,2882.335;Inherit;False;Property;_GranblueFresnelPower;Granblue Fresnel Power;34;0;Create;True;0;0;False;0;1.77;1.77;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;467;-5078.889,-220.1733;Inherit;False;Property;_ShadowLayer2Push;Shadow Layer 2 Push;19;0;Create;True;0;0;False;0;-0.3;-0.088;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;935;-6165.434,651.3436;Inherit;False;Property;_SpecularFuzzy;Specular Fuzzy;28;0;Create;True;0;0;False;0;0;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;635;-6418.509,1006.673;Inherit;False;Property;_SpecularIntensity;Specular Intensity;26;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;854;-1077.775,2626.47;Inherit;False;Property;_EnableGranblueBlackFresnel;Enable Granblue Black Fresnel;36;0;Create;True;0;0;False;0;0;2;0;FLOAT;1;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;120;-2814.559,23.83143;Inherit;False;1507.521;545.2363;;11;129;128;126;127;125;123;442;124;122;121;234;Outline;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;985;-1755.802,-513.3723;Inherit;False;459.2842;271.1678;Add Highlight;2;984;557;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;125;-2450.868,330.8223;Float;False;Property;_OutlineThickness;Outline Thickness;11;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;127;-2068.475,318.1515;Inherit;False;4;4;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;520;-2143.352,-475.5576;Inherit;False;Property;_EnableMetalMatcap;Enable Metal Matcap;7;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;557;-1705.802,-357.2044;Inherit;False;555;Highlight;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.OutlineNode;128;-1815.35,240.1357;Inherit;False;0;False;None;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;786;-1208.867,-526.889;Inherit;False;289.6;166;Finally output;1;202;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;984;-1450.518,-463.3722;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;246;-2536.632,-1491.87;Inherit;False;554.1174;504.4;;4;0;18;878;130;Output Shader;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;129;-1555.138,250.6232;Inherit;False;Outline;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;202;-1173.638,-469.3648;Inherit;False;FinalCustomLight;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;878;-2473.594,-1364.658;Inherit;False;TestingOutput;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;18;-2506.132,-1240.021;Inherit;False;202;FinalCustomLight;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;130;-2494.219,-1130.54;Inherit;False;129;Outline;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;797;-1969.9,2191.053;Inherit;False;183;Base;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-2246.512,-1441.87;Float;False;True;-1;2;ASWShaderGUI;0;0;CustomLighting;.Aerthas/Arc System Works/Merged Light v6.2.2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=A9AA2763ECAF2C21CBF13220EFAEA19E4C9563F8