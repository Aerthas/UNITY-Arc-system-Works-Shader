...
Shader ".Aerthas/Arc System Works/Merged Light v6.7.1"
{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_32_0_g487 = _EnableCameraDistanceMult;
			float temp_output_33_0_g487 = _OutlineThickness;
			...
			float4 break8_g487 = VertexColors441;
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float outlineVar = (( temp_output_32_0_g487 > 0.0 ) ? ( 0.0001 * temp_output_33_0_g487 * break8_g487.a * min( ( break8_g487.g * distance( ase_worldPos , _WorldSpaceCameraPos ) ) , 1.0 ) * (( break8_g487.b > 0.1 ) ? 1.0 :  0.0 ) ) :  ( (( temp_output_32_0_g487 > 0.0 ) ? 0.0 :  5.0 ) * 1E-05 * temp_output_33_0_g487 * break8_g487.b * break8_g487.a ) );
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_output_13_0_g487 = max( float4( 0,0,0,0 ) , ( 0.2 * Base183 ) );
			o.Emission = ( (( _EnableBaseColorMult > 0.0 ) ? ( temp_output_13_0_g487 * temp_output_13_0_g487 ) :  _OutlineColor ) * _OutlineColorIntensity ).rgb;
...
/*ASEBEGIN
Version=17800
283.2;178.4;1532;825;6259.044;1142.75;3.154158;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1468;-1111.61,329.3792;Inherit;False;ASWOutline;-1;;487;ea9f2d47913480c4f9e91454af7efa45;0;8;30;FLOAT;0;False;31;COLOR;0,0,0,0;False;32;FLOAT;0;False;33;FLOAT;0;False;34;COLOR;0,0,0,0;False;35;COLOR;0,0,0,0;False;36;FLOAT;0;False;37;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=49342F844FC20504A74BE53E30CBD79BBF3D79E2