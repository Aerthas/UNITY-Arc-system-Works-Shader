...
Shader ".Aerthas/Arc System Works/Merged Light v6.7.5"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_32_0_g508 = _EnableCameraDistanceMult;
			float temp_output_33_0_g508 = _OutlineThickness;
			...
			float4 break8_g508 = VertexColors441;
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float outlineVar = (( temp_output_32_0_g508 > 0.0 ) ? ( 0.0001 * temp_output_33_0_g508 * break8_g508.a * min( ( break8_g508.g * distance( ase_worldPos , _WorldSpaceCameraPos ) ) , 1.0 ) * (( break8_g508.b > 0.1 ) ? 1.0 :  0.0 ) ) :  ( (( temp_output_32_0_g508 > 0.0 ) ? 0.0 :  5.0 ) * 1E-05 * temp_output_33_0_g508 * break8_g508.b * break8_g508.a ) );
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_output_13_0_g508 = max( float4( 0,0,0,0 ) , ( 0.2 * Base183 ) );
			...
			#endif //aselc
			float clampResult128_g1 = clamp( ( (( abs( ase_worldlightDir ).x > float3( 0,0,0 ) ) ? 1.0 :  0.0 ) + (( ase_lightColor.a > 0.0 ) ? 1.0 :  0.0 ) ) , 0.0 , 1.0 );
			float4 temp_cast_3 = (_GlobalIntensityMinimum).xxxx;
			float4 clampResult123_g1 = clamp( (( (( _LightColor > 0.0 ) ? 0.0 :  clampResult128_g1 ) > 0.0 ) ? ase_lightColor :  ( _FakeLightColor * _FakeLightIntensity ) ) , temp_cast_3 , float4( 1,1,1,1 ) );
			float4 LightColorOut457 = clampResult123_g1;
			o.Emission = ( ( (( _EnableBaseColorMult > 0.0 ) ? ( temp_output_13_0_g508 * temp_output_13_0_g508 ) :  _OutlineColor ) * _OutlineColorIntensity ) * (( _EnableLightColorMult > 0.0 ) ? LightColorOut457 :  float4( 1,1,1,0 ) ) ).rgb;
		...
		float3 StereoCameraViewDirection194_g20( float3 worldPos )
		{
			#if UNITY_SINGLE_PASS_STEREO
			float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
			#else
		...
		float3 MyCustomExpression184_g20( float3 rotation , float inX , float inY , float inZ )
		{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 clampResult123_g1 = clamp( (( (( _LightColor > 0.0 ) ? 0.0 :  clampResult128_g1 ) > 0.0 ) ? ase_lightColor :  ( _FakeLightColor * _FakeLightIntensity ) ) , temp_cast_4 , float4( 1,1,1,1 ) );
			float4 LightColorOut457 = clampResult123_g1;
			...
			float3 appendResult186_g20 = (float3(radians( _ViewDirOffsetX ) , radians( _ViewDirOffsetY ) , 0.0));
			float3 rotation184_g20 = appendResult186_g20;
			float3 worldPos194_g20 = ase_worldPos;
			float3 localStereoCameraViewDirection194_g20 = StereoCameraViewDirection194_g20( worldPos194_g20 );
			float3 break195_g20 = localStereoCameraViewDirection194_g20;
			float inX184_g20 = break195_g20.x;
			float inY184_g20 = break195_g20.y;
			float inZ184_g20 = break195_g20.z;
			float3 localMyCustomExpression184_g20 = MyCustomExpression184_g20( rotation184_g20 , inX184_g20 , inY184_g20 , inZ184_g20 );
			float3 normalizeResult2_g20 = normalize( localMyCustomExpression184_g20 );
			float3 appendResult15_g21 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
			float3 normalizeResult2_g21 = normalize( appendResult15_g21 );
			float3 ase_normWorldNormal = normalize( ase_worldNormal );
			float dotResult28_g1 = dot( (( (( _LightDirection > 0.0 ) ? 0.0 :  clampResult128_g1 ) > 0.0 ) ? ase_worldlightDir :  (( _FakeLightFallbackDirection > 0.0 ) ? normalizeResult2_g20 :  normalizeResult2_g21 ) ) , ase_normWorldNormal );
			float DefaultDot14 = dotResult28_g1;
			...
			#else
				float4 staticSwitch1175 = (( _METALLICGLOSSMAP )?( MetalMatCap111 ):( ( LightColorOut457 * clampResult33_g488 * ILMA118 * Detail443 ) ));
			#endif
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 GlowMask1454 = (( _FADE )?( ( (( _GlowMaskMultSystem == 0.0 ) ? tex2DNode1461 :  lerpResult1529 ) * _GlowMaskIntensity * _GlowMaskTint * Base183 ) ):( float4( 0,0,0,0 ) ));
...
/*ASEBEGIN
Version=17800
-1744;108;1532;722;2291.011;2461.79;1.4589;True;True
Node;AmplifyShaderEditor.CommentaryNode;516;-5159.689,-2321.539;Inherit;False;3064.604;1228.404;;18;448;451;871;447;444;870;543;449;987;938;112;440;183;517;518;152;850;182;Color Information;0,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;182;-5034.406,-1859.533;Inherit;True;Property;_Base;Base;5;1;[NoScaleOffset];Create;True;0;0;False;0;-1;None;4e8fe899edab18c478b817038fd3a7fd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1094;-3894.344,2091.039;Inherit;False;Property;_COLOROVERLAY;_COLOROVERLAY;49;0;Create;True;0;0;False;0;1;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;543;-4250.695,-2232.29;Inherit;False;Property;_ShadowLayer2Intensity;Shadow Layer 2 Intensity;25;0;Create;True;0;0;False;0;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1218;-7924.091,-2592.703;Inherit;False;Property;_VertexDebugColor;Vertex Debug Color;48;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1238;-7905.327,-2020.835;Inherit;False;Property;_ILMDebugColor;ILM Debug Color;51;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1245;-7292.611,-2432.858;Inherit;False;Property;_ILMChannel;ILM Channel;50;1;[Enum];Create;True;4;Red   Specular Intensity;0;Green   Shading Occlusion;1;Blue   Specular Mask;2;Alpha   Diffuse Mult for body lines;3;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1240;-7449.178,-3144.344;Inherit;False;Property;_VertexChannel;Vertex Channel;47;1;[Enum];Create;True;4;Red   Occlusion Shading;0;Green   Outline Thickness mask for Camera Distance Mult;1;Blue   Outline Mask;2;Alpha   Outline Thickness;3;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1254;-8063.622,-1592.649;Inherit;False;Property;_BaseSSSAlphaColor;Base SSS Alpha Color;55;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;1015;-5096.366,-3457.942;Inherit;False;1500.462;1071.025;;12;457;14;1508;1057;947;975;217;1122;1116;974;1016;1513;Automatic Light System;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;1534;-1958.777,-2201.386;Inherit;False;1906.767;775.0455;;11;1529;1528;1461;1458;1457;1456;1462;1455;1454;1533;1527;Glow Mask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1508;-4946.254,-3234.523;Inherit;False;Property;_LightColor;Light Color;0;1;[Enum];Create;True;2;Automatic;0;Forced Fake;1;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;859;-2483.226,2311.408;Inherit;False;Property;_DarkHighlightMult;Dark Highlight Mult;38;0;Create;True;0;0;False;0;0.2392157,0.2392157,0.5294118,0;0.2392156,0.2392156,0.5294118,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1016;-4959.369,-3325.571;Inherit;False;Property;_LightDirection;Light Direction;1;1;[Enum];Create;True;2;Automatic;0;Forced Fake;1;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1122;-4962.254,-2642.523;Inherit;False;Property;_ViewDirOffsetY;View Dir Offset Y;44;0;Create;True;0;0;False;0;0;35;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1116;-4962.254,-2722.523;Inherit;False;Property;_ViewDirOffsetX;View Dir Offset X;43;0;Create;True;0;0;False;0;0;-35;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1513;-4961.422,-2531.428;Inherit;False;Property;_GlobalIntensityMinimum;Global Intensity Minimum;64;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1259;-7663.72,-1726.337;Inherit;False;Property;_BaseSSSAlphaSwap;Base SSS Alpha Swap;54;1;[Enum];Create;True;2;Base Alpha   Fresnel Mask;0;SSS Alpha   Shadow Threshold;1;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;870;-4367.617,-1749.946;Inherit;False;Property;_ShadowLayer1Intensity;Shadow Layer 1 Intensity;21;0;Create;True;0;0;False;0;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1523;-4503.298,-3238.075;Inherit;False;Merged Light Function;-1;;1;6a9b492f5059fcf4aa61bcbd0dc72ff9;0;10;71;FLOAT;0;False;46;FLOAT;0;False;126;FLOAT;0;False;42;FLOAT;0;False;41;FLOAT4;0,0,0,0;False;38;FLOAT;0;False;39;FLOAT;0;False;99;FLOAT;0;False;100;FLOAT;0;False;121;COLOR;0,0,0,0;False;2;COLOR;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1527;-1460.006,-2151.386;Inherit;False;Property;_GlowMaskMultSystem;Glow Mask Mult System;65;1;[Enum];Create;True;2;Mask Color;0;Base Color Lerped from Mask;1;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1252;-6112.622,-3053.384;Inherit;False;Property;_COLORADDSUBDIFF;_COLORADDSUBDIFF;46;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;1458;-1158.212,-1725.417;Inherit;False;Property;_GlowMaskTint;Glow Mask Tint;62;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;1290;-4676.261,-790.7552;Inherit;False;117;ILMB;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;1262;-6009.548,-1640.113;Inherit;False;Property;_COLORCOLOR;_COLORCOLOR;53;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1456;-1154.011,-1820.016;Inherit;False;Property;_GlowMaskIntensity;Glow Mask Intensity;60;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1253;-5975.554,-2470.118;Inherit;False;Property;_PIXELSNAP;PIXELSNAP;52;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;515;-2976.077,-488.8565;Inherit;False;457;LightColorOut;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1457;-554.8116,-1763.017;Inherit;False;Property;_FADE;_FADE;61;0;Create;True;0;0;False;0;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1085;-1854.716,726.7489;Inherit;False;Property;_EnableBaseColorMult;Enable Base Color Mult;58;1;[Enum];Create;True;2;Disable;0;Enable;1;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1095;-2146.107,-437.1112;Inherit;False;Property;_METALLICGLOSSMAP;_METALLICGLOSSMAP;42;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1466;-1851.008,804.0779;Inherit;False;Property;_OutlineColorIntensity;Outline Color Intensity;63;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1454;-292.0105,-1759.218;Inherit;False;GlowMask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1087;-1824.969,134.1684;Inherit;False;Property;_EnableOutline;Enable Outline;56;1;[Enum];Create;True;2;Disable;0;Yes I am lazy and want ugly outlines;1;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1517;-1843.639,878.1467;Inherit;False;Property;_EnableLightColorMult;Enable Light Color Mult;57;1;[Enum];Create;True;2;Disable;0;Enable;1;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1171;-1892.36,305.2689;Inherit;False;Property;_EnableCameraDistanceMult;Enable Camera Distance Mult;59;1;[Enum];Create;True;2;Disable;0;Enable;1;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1520;-1111.61,329.3792;Inherit;False;ASWOutline;-1;;508;ea9f2d47913480c4f9e91454af7efa45;0;10;30;FLOAT;0;False;31;COLOR;0,0,0,0;False;32;FLOAT;0;False;33;FLOAT;0;False;34;COLOR;0,0,0,0;False;35;COLOR;0,0,0,0;False;36;FLOAT;0;False;37;FLOAT;0;False;40;FLOAT;0;False;41;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1459;-656.4932,-626.2266;Inherit;False;1454;GlowMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1175;-1010.309,-445.1135;Inherit;False;Property;_ALPHABLEND;Enable Debug;45;0;Create;False;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-410.0485,-664.7245;Float;False;True;-1;2;ASWShaderGUI;0;0;CustomLighting;.Aerthas/Arc System Works/Merged Light v6.7.5;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;1;RenderType=Opaque;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1523;71;1057;0
WireConnection;1523;46;1016;0
WireConnection;1523;126;1508;0
WireConnection;1523;42;947;0
WireConnection;1523;41;217;0
WireConnection;1523;38;974;0
WireConnection;1523;39;975;0
WireConnection;1523;99;1116;0
WireConnection;1523;100;1122;0
WireConnection;1523;121;1513;0
...
ASEEND*/
//CHKSM=A53AAB88D654AB920CBA3604C95EC1458C7FFB8A