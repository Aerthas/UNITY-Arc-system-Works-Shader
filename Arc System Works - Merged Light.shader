...
Shader ".Aerthas/Arc System Works/Merged Light v6.9.0"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 objectSpaceViewDir66_g780 = ObjSpaceViewDir( float4( ase_vertex3Pos , 0.0 ) );
			float3 normalizeResult68_g780 = normalize( objectSpaceViewDir66_g780 );
			...
			float4 break59_g780 = VertexColors441;
			float3 ase_vertexNormal = v.normal.xyz;
			float temp_output_60_0_g780 = ( _OutlineThickness * break59_g780.a );
			float3 outlineVar = ( ( _DepthOffset * normalizeResult68_g780 * ( -0.001 * break59_g780.b ) ) + ( ase_vertexNormal * ( 1E-05 * (( _EnableCameraDistanceMult == 0.0 ) ? temp_output_60_0_g780 :  ( temp_output_60_0_g780 + ( break59_g780.g * eyeDepth * _CameraDistanceMult ) ) ) ) ) );
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_output_13_0_g780 = max( float4( 0,0,0,0 ) , ( 0.2 * Base183 ) );
			...
			o.Emission = ( ( (( _EnableBaseColorMult > 0.0 ) ? ( temp_output_13_0_g780 * temp_output_13_0_g780 ) :  _OutlineColor ) * _OutlineColorIntensity ) * (( _EnableLightColorMult > 0.0 ) ? LightColorOut457 :  float4( 1,1,1,0 ) ) ).rgb;
...
/*ASEBEGIN
Version=17800
-2452;173;2259;952;7917.405;2185.439;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;1911;-4864,-2176;Inherit;False;Property;_Source3Color;Source 3 Color;78;0;Create;True;0;0;False;0;1,1,1,1;0.2588235,0.4627451,0.07450979,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1907;-4864,-2608;Inherit;False;Property;_Source2Color;Source 2 Color;75;0;Create;True;0;0;False;0;1,1,1,1;0.1921569,0.1764705,0.2352941,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1908;-4864,-2352;Inherit;False;Property;_Target2Color;Target 2 Color;72;0;Create;True;0;0;False;0;1,1,1,1;0.9647059,0.4941176,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1900;-4928,-2864;Inherit;False;Property;_Source1Fuzziness;Source 1 Fuzziness;76;0;Create;True;0;0;False;0;0.01;0.4;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1912;-4928,-2000;Inherit;False;Property;_Source3Fuzziness;Source 3 Fuzziness;79;0;Create;True;0;0;False;0;0.01;0.135;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1897;-4864,-2784;Inherit;False;Property;_Target1Color;Target 1 Color;73;0;Create;True;0;0;False;0;1,1,1,1;0.4039216,0.8078432,0.8666667,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1899;-4864,-3040;Inherit;False;Property;_Source1Color;Source 1 Color;74;0;Create;True;0;0;False;0;1,1,1,1;0.5372549,0.7176471,0.2901961,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1631;-348.0558,-3217.669;Inherit;False;Property;_ILMColor;ILM Color;60;0;Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1913;-4864,-1920;Inherit;False;Property;_Target3Color;Target 3 Color;80;0;Create;True;0;0;False;0;1,1,1,1;0.1686274,0.5882353,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;518;-2738.113,-3195.975;Inherit;False;Property;_ShadowBrightness;Shadow Brightness;18;0;Create;True;0;0;False;0;1;0.431;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;701;-3967.442,1899.594;Inherit;False;Property;_HighlightScale;Highlight Scale;38;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1427;-4031.442,2059.594;Inherit;False;Property;_GranblueDarkenScale;Granblue Darken Scale;41;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1340;-3983.442,1579.593;Inherit;False;987;SSSAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1429;-4031.442,2139.594;Inherit;False;Property;_GranblueDarkenPower;Granblue Darken Power;40;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1062;-6891.034,-3934.861;Inherit;False;Property;_WrongVertexColors;WrongVertexColors;42;1;[Enum];Create;True;2;Yes they are;0;No they arent;1;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;635;-742.2524,-1511.617;Inherit;False;Property;_SpecularIntensity;Specular Intensity;30;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCCompareGreater;1067;-6532.034,-3887.861;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT4;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ColorNode;859;-5059.478,2025.973;Inherit;False;Property;_DarkHighlightMult;Dark Highlight Mult;39;0;Create;True;0;0;False;0;0.2392157,0.2392157,0.5294118,0;0.2392152,0.2392152,0.5294118,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;870;-1167.811,-2794.723;Inherit;False;Property;_ShadowLayer1Intensity;Shadow Layer 1 Intensity;22;0;Create;True;0;0;False;0;1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;947;-6838.802,-3165.786;Inherit;False;Property;_FakeLightIntensity;Fake Light Intensity;15;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1122;-6774.802,-2669.786;Inherit;False;Property;_ViewDirOffsetY;View Dir Offset Y;44;0;Create;True;0;0;False;0;0;15.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;975;-6774.802,-2829.786;Inherit;False;Property;_FakeLightDirY;Fake Light Dir Y;17;0;Create;True;0;0;False;0;-135;-135;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;217;-6774.802,-3085.786;Float;False;Property;_FakeLightColor;Fake Light Color;16;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;490;-5999.245,-202.7802;Inherit;False;Property;_ILMLayer2;ILM Layer 2;28;0;Create;True;0;0;False;0;0.3;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;460;-4772.261,-710.7552;Inherit;False;Property;_ShadowLayer1Push;Shadow Layer 1 Push;19;0;Create;True;0;0;False;0;0;0.299;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;625;-4772.261,-1030.755;Inherit;False;Property;_SpecularSize;Specular Size;32;0;Create;True;0;0;False;0;0.46;0.725;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;467;-4772.261,-470.7559;Inherit;False;Property;_ShadowLayer2Push;Shadow Layer 2 Push;23;0;Create;True;0;0;False;0;-0.3;0.023;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1218;-6843.505,-1996.021;Inherit;False;Property;_DebugColor;Debug Color;48;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1259;-6875.505,-1500.021;Inherit;False;Property;_BaseSSSAlphaSwap;Base SSS Alpha Swap;50;1;[Enum];Create;True;2;Base Alpha   Highlight Fresnel Scale;0;SSS Alpha   Shadow Fresnel Scale;1;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1092;-606.2374,-50.83687;Inherit;False;1406.359;1088.485;;12;1174;1518;1882;1082;1089;1087;1085;1161;1517;1466;1171;1943;Outline;0.9075414,0.5613208,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1087;-480,80;Inherit;False;Property;_EnableOutline;Enable Outline;51;1;[Toggle];Create;True;2;Disable;0;Yes I am lazy and want ugly outlines;1;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1089;-448,816;Inherit;False;183;Base;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1085;-512,736;Inherit;False;Property;_EnableBaseColorMult;Enable Base Color Mult;53;1;[Toggle];Create;True;2;Disable;0;Enable;1;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1517;-512,896;Inherit;False;Property;_EnableLightColorMult;Enable Light Color Mult;52;1;[Toggle];Create;True;2;Disable;0;Enable;1;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1082;-480,480;Inherit;False;Property;_OutlineColor;Outline Color;3;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;1518;-480,976;Inherit;False;457;LightColorOut;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1466;-512,656;Inherit;False;Property;_OutlineColorIntensity;Outline Color Intensity;57;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1945;163.9567,331.977;Inherit;False;ASWOutline;-1;;780;ea9f2d47913480c4f9e91454af7efa45;0;12;75;COLOR;0,0,0,0;False;30;FLOAT;0;False;33;FLOAT;0;False;32;FLOAT;0;False;47;FLOAT;0;False;76;FLOAT;0;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;40;FLOAT;0;False;98;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;1175;29.63205,-554.8836;Inherit;False;Property;_ALPHATEST;Enable Debug;46;0;Create;False;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;624.8439,-778.4818;Float;False;True;-1;2;ASWShaderGUI;0;0;CustomLighting;.Aerthas/Arc System Works/Merged Light v6.9.0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;1;RenderType=Opaque;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1945;75;1174;0
WireConnection;1945;30;1087;0
WireConnection;1945;33;1161;0
WireConnection;1945;32;1171;0
WireConnection;1945;47;1882;0
WireConnection;1945;76;1943;0
WireConnection;1945;35;1082;0
WireConnection;1945;37;1466;0
WireConnection;1945;36;1085;0
WireConnection;1945;31;1089;0
WireConnection;1945;40;1517;0
WireConnection;1945;98;1518;0
WireConnection;1175;1;1705;0
WireConnection;1175;0;1209;0
WireConnection;0;2;1459;0
WireConnection;0;13;1175;0
WireConnection;0;11;1945;0
ASEEND*/
//CHKSM=D5C76E61B10B5B5BE6AF6A53B693B1327A999987