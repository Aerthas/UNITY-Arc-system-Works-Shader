...
Shader ".Aerthas/Arc System Works/Outline v4.1.2"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 objectSpaceViewDir66_g12 = ObjSpaceViewDir( float4( ase_vertex3Pos , 0.0 ) );
			float3 normalizeResult68_g12 = normalize( objectSpaceViewDir66_g12 );
			float temp_output_100_0_g12 = ( 1.0 - v.color.b );
			float saferPower104_g12 = max( temp_output_100_0_g12 , 0.0001 );
			float3 ase_vertexNormal = v.normal.xyz;
			float temp_output_60_0_g12 = ( _OutlineThickness * v.color.a );
			v.vertex.xyz += ( ( _DepthOffset * normalizeResult68_g12 * ( -0.001 * (( _DepthCalculation == 0.0 ) ? temp_output_100_0_g12 :  pow( saferPower104_g12 , 2.0 ) ) ) ) + ( ase_vertexNormal * ( 1E-05 * (( _EnableCameraDistanceMult == 0.0 ) ? temp_output_60_0_g12 :  ( temp_output_60_0_g12 + ( v.color.g * eyeDepth * _CameraDistanceMult ) ) ) ) ) );
		}
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_output_13_0_g12 = max( float4( 0,0,0,0 ) , ( 0.2 * tex2D( _Base, uv_Base16 ) ) );
			...
			c.rgb = ( ( (( _EnableBaseColorMult > 0.0 ) ? ( temp_output_13_0_g12 * temp_output_13_0_g12 ) :  _OutlineColor ) * _OutlineColorIntensity ) * (( _EnableLightColorMult > 0.0 ) ? (( (( _LightColorSetting > 0.0 ) ? 0.0 :  clampResult241 ) > 0.0 ) ? clampResult243 :  ( _FakeLightIntensity * _FakeLightColor ) ) :  float4( 1,1,1,0 ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
2560;213;2259;946;4548.935;1256.279;3.077607;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;217;-1360,32;Inherit;False;Property;_DepthOffset;Depth Offset;12;0;Create;True;0;0;False;0;1;1000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;282;-744.9083,28.20754;Inherit;False;ASWOutline;-1;;12;ea9f2d47913480c4f9e91454af7efa45;0;11;33;FLOAT;0;False;32;FLOAT;0;False;47;FLOAT;0;False;76;FLOAT;0;False;107;FLOAT;0;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;36;FLOAT;0;False;31;COLOR;0,0,0,0;False;40;FLOAT;0;False;98;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT3;109
...
WireConnection;282;33;34;0
WireConnection;282;32;41;0
WireConnection;282;47;160;0
WireConnection;282;76;217;0
WireConnection;282;107;269;0
WireConnection;282;35;20;0
WireConnection;282;37;107;0
WireConnection;282;36;29;0
WireConnection;282;31;16;0
WireConnection;282;40;125;0
WireConnection;282;98;248;0
WireConnection;0;13;282;0
WireConnection;0;11;282;109
ASEEND*/
//CHKSM=CD514FC40E3D3777B34C390F2F28E7856B74A3FE