...
Shader "Arc System Works/Fake Light" {
    Properties {
        ...
        _DiffuseTint ("Diffuse Tint", Color) = (0.9333333,0.9333333,0.9333333,1)
        ...
        _ShinePush ("Shine Push", Float ) = 1.2
