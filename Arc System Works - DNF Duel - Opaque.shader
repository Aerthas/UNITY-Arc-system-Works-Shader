...
Shader ".Aerthas/Arc System Works/Game Select/DNF Duel/Opaque v8.1.0"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix0375_g1693(  )
			{
				return UNITY_MATRIX_V[0];
			}
			
			float3 ViewMatrix1373_g1693(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 StereoCameraViewPosition30_g1691(  )
			{
			...
			float3 StereoCameraViewDirection32_g1691( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_5_0_g1807 = ILMColorSetting1007;
				...
				float ILMColorSetting60_g1694 = ILMColorSetting1007;
				float4 ILMAColor1005 = _ILMAlphaColor;
				float4 ILMAColor54_g1694 = ILMAColor1005;
				...
				float3x3 temp_output_67_0_g1677 = float3x3(linearToGamma1286, linearToGamma1287, float3( 0,0,0 ));
				...
				float3x3 temp_output_24_0_g1694 = ( _EnableColorReplacer == 0.0 ? float3x3(linearToGamma1286, linearToGamma1287, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1677 == 5.0 ? lerpResult4_g1682 : ( temp_output_52_0_g1677 == 4.0 ? temp_output_105_0_g1677 : ( temp_output_52_0_g1677 == 3.0 ? temp_output_104_0_g1677 : ( temp_output_52_0_g1677 == 2.0 ? temp_output_102_0_g1677 : ( temp_output_52_0_g1677 == 1.0 ? temp_output_106_0_g1677 : float4( temp_output_67_0_g1677[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1682.rgb, float3( 0,0,0 )) );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1694 = ILMA357;
				float4 lerpResult12_g1694 = lerp( ILMAColor54_g1694 , float4( temp_output_24_0_g1694[0] , 0.0 ) , ILMA57_g1694);
				float4 Base339 = ( ILMColorSetting60_g1694 == 1.0 ? lerpResult12_g1694 : float4( temp_output_24_0_g1694[0] , 0.0 ) );
				float4 Base12_g1800 = Base339;
				...
				float3 localViewMatrix0375_g1693 = ViewMatrix0375_g1693();
				float3 normalizeResult384_g1693 = normalize( localViewMatrix0375_g1693 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_380_0_g1693 = ( float3( 0,0,0 ) + ase_worldPos );
				float3 localViewMatrix1373_g1693 = ViewMatrix1373_g1693();
				float3 normalizeResult376_g1693 = normalize( localViewMatrix1373_g1693 );
				float3 localStereoCameraViewPosition30_g1691 = StereoCameraViewPosition30_g1691();
				float3 rotatedValue385_g1693 = RotateAroundAxis( temp_output_380_0_g1693, localStereoCameraViewPosition30_g1691, normalizeResult376_g1693, radians( ( _ViewDirOffsetYaw * -1.0 ) ) );
				float3 rotatedValue387_g1693 = RotateAroundAxis( temp_output_380_0_g1693, rotatedValue385_g1693, normalize( normalizeResult384_g1693 ), radians( ( _ViewDirOffsetPitch * 1.0 ) ) );
				float3 normalizeResult389_g1693 = normalize( ( rotatedValue387_g1693 - temp_output_380_0_g1693 ) );
				float3 normalizeResult38_g1691 = normalize( normalizeResult389_g1693 );
				float3 appendResult15_g1692 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1692 = normalize( appendResult15_g1692 );
				float3 normalizeResult26_g1691 = normalize( normalizeResult2_g1692 );
				float3 ifLocalVar3_g1691 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1691 = normalizeResult38_g1691;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1691 = normalizeResult26_g1691;
				...
				float3 ifLocalVar8_g1691 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1691 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1691 = ifLocalVar3_g1691;
				float3 ifLocalVar9_g1691 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1691 = ifLocalVar3_g1691;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1691 = ifLocalVar8_g1691;
				float3 normalizeResult48_g1691 = normalize( ifLocalVar9_g1691 );
				float3 worldPos32_g1691 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1691 = StereoCameraViewDirection32_g1691( worldPos32_g1691 );
				float3 normalizeResult51_g1691 = normalize( ( normalizeResult48_g1691 + localStereoCameraViewDirection32_g1691 ) );
				float dotResult50_g1691 = dot( normalizedWorldNormal , normalizeResult51_g1691 );
				float blendOpSrc34_g1695 = ILMB576;
				float blendOpDest34_g1695 = dotResult50_g1691;
				float clampResult87_g1790 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1695) / max( blendOpSrc34_g1695, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_31 = (clampResult87_g1790).xxxx;
				float4 blendOpSrc30_g1800 = Base12_g1800;
				float4 blendOpDest30_g1800 = temp_cast_31;
				float4 lerpBlendMode30_g1800 = lerp(blendOpDest30_g1800,min( blendOpSrc30_g1800 , blendOpDest30_g1800 ),0.9);
				float3 desaturateInitialColor9_g1803 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1800 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1803 = dot( desaturateInitialColor9_g1803, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1803 = lerp( desaturateInitialColor9_g1803, desaturateDot9_g1803.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1805 = ( ( float4( desaturateVar9_g1803 , 0.0 ) + Base12_g1800 ) * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1805 = dot( desaturateInitialColor9_g1805, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1805 = lerp( desaturateInitialColor9_g1805, desaturateDot9_g1805.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 blendOpSrc32_g1694 = temp_output_24_0_g1694[0];
				float3 blendOpDest32_g1694 = temp_output_24_0_g1694[1];
				float4 lerpResult17_g1694 = lerp( ( ILMAColor54_g1694 * float4( ( saturate( abs( blendOpSrc32_g1694 - blendOpDest32_g1694 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1694[1] , 0.0 ) , ILMA57_g1694);
				float4 SSS578 = ( ILMColorSetting60_g1694 == 1.0 ? lerpResult17_g1694 : float4( temp_output_24_0_g1694[1] , 0.0 ) );
				float4 SSS14_g1800 = SSS578;
				float3 desaturateInitialColor9_g1802 = ( SSS14_g1800 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1802 = dot( desaturateInitialColor9_g1802, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1802 = lerp( desaturateInitialColor9_g1802, desaturateDot9_g1802.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc108_g1800 = float4( 0,0,0,0 );
				float4 blendOpDest108_g1800 = Base12_g1800;
				float4 blendOpSrc51_g1800 = ( saturate( min( blendOpSrc108_g1800 , blendOpDest108_g1800 ) ));
				float4 blendOpDest51_g1800 = SSS14_g1800;
				float4 lerpBlendMode51_g1800 = lerp(blendOpDest51_g1800,2.0f*blendOpDest51_g1800*blendOpSrc51_g1800 + blendOpDest51_g1800*blendOpDest51_g1800*(1.0f - 2.0f*blendOpSrc51_g1800),0.5);
				float3 desaturateInitialColor9_g1801 = ( ( saturate( lerpBlendMode51_g1800 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1801 = dot( desaturateInitialColor9_g1801, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1801 = lerp( desaturateInitialColor9_g1801, desaturateDot9_g1801.xxx, ( 1.0 - _Shadow2Saturation ) );
				float VertexR33_g1790 = pow( pow( i.ase_color.r , 2.2 ) , 2.2 );
				float dotResult46_g1691 = dot( ifLocalVar9_g1691 , normalizedWorldNormal );
				float temp_output_36_0_g1695 = ( ( dotResult46_g1691 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1695 = ILMG574;
				float NdL20_g1790 = ( temp_output_36_0_g1695 * temp_output_1_0_g1695 );
				float temp_output_2_0_g1791 = NdL20_g1790;
				float temp_output_3_0_g1791 = -_Shadow1Smoothness;
				float temp_output_9_0_g1790 = _Shadow1Push;
				float temp_output_11_0_g1790 = _Shadow2Push;
				float clampResult15_g1790 = clamp( temp_output_9_0_g1790 , temp_output_11_0_g1790 , temp_output_9_0_g1790 );
				float RealShadow1Push16_g1790 = clampResult15_g1790;
				float temp_output_1_0_g1791 = RealShadow1Push16_g1790;
				float smoothstepResult6_g1791 = smoothstep( ( ( temp_output_2_0_g1791 / 1.0 ) + temp_output_3_0_g1791 ) , temp_output_2_0_g1791 , temp_output_1_0_g1791);
				float lerpResult7_g1791 = lerp( smoothstepResult6_g1791 , ( temp_output_1_0_g1791 >= temp_output_2_0_g1791 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1791 ? 1.0 : 0.0 ));
				float clampResult17_g1790 = clamp( temp_output_11_0_g1790 , temp_output_11_0_g1790 , temp_output_9_0_g1790 );
				float RealShadow2Push18_g1790 = clampResult17_g1790;
				float temp_output_2_0_g1792 = NdL20_g1790;
				float temp_output_3_0_g1792 = -_Shadow2Smoothness;
				float temp_output_1_0_g1792 = RealShadow2Push18_g1790;
				float smoothstepResult6_g1792 = smoothstep( ( ( temp_output_2_0_g1792 / 1.0 ) + temp_output_3_0_g1792 ) , temp_output_2_0_g1792 , temp_output_1_0_g1792);
				float lerpResult7_g1792 = lerp( smoothstepResult6_g1792 , ( temp_output_1_0_g1792 >= temp_output_2_0_g1792 ? 1.0 : 0.0 ) , ( 0.0 == temp_output_3_0_g1792 ? 1.0 : 0.0 ));
				float temp_output_42_0_g1790 = max( max( ( 1.0 - ( VertexR33_g1790 > _Shadow2VertexRThreshold ? 1.0 : 0.0 ) ) , lerpResult7_g1792 ) , ( ILMG574 < _PermanentShadowThreshold ? 1.0 : 0.0 ) );
				float temp_output_43_0_g1790 = ( max( ( 1.0 - ( VertexR33_g1790 > _Shadow1VertexRThreshold ? 1.0 : 0.0 ) ) , min( lerpResult7_g1791 , ( RealShadow1Push16_g1790 >= RealShadow2Push18_g1790 ? 1.0 : 0.0 ) ) ) - temp_output_42_0_g1790 );
				float3 lerpResult100_g1800 = lerp( desaturateVar9_g1802 , desaturateVar9_g1801 , ( 1.0 - temp_output_43_0_g1790 ));
				float clampResult90_g1790 = clamp( ( 1.0 - ( temp_output_43_0_g1790 + temp_output_42_0_g1790 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1800 = clampResult90_g1790;
				float4 lerpResult101_g1800 = lerp( float4( desaturateVar9_g1805 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1800 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1800 ));
				float EnableRimlight82_g1790 = _EnableRimlight;
				float dotResult31_g1691 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1691 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g1790 = ( ( 1.0 - ( dotResult31_g1691 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				float clampResult91_g1790 = clamp( temp_output_42_0_g1790 , 0.0 , 1.0 );
				float clampResult88_g1790 = clamp( ( ceil( ( NdV48_g1790 > 0.1 ? 1.0 : 0.0 ) ) - clampResult91_g1790 ) , 0.0 , 1.0 );
				float temp_output_94_0_g1790 = ( EnableRimlight82_g1790 == 1.0 ? clampResult88_g1790 : 0.0 );
				float3 desaturateInitialColor9_g1804 = ( ( Base12_g1800 * temp_output_94_0_g1790 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1804 = dot( desaturateInitialColor9_g1804, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1804 = lerp( desaturateInitialColor9_g1804, desaturateDot9_g1804.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1800 + float4( desaturateVar9_g1804 , 0.0 ) );
				float4 temp_output_1_0_g1807 = ColorOut1025;
				float temp_output_6_0_g1807 = ILMA357;
				float4 lerpResult14_g1807 = lerp( float4( 0,0,0,0 ) , temp_output_1_0_g1807 , temp_output_6_0_g1807);
				float4 lerpResult10_g1807 = lerp( ILMAColor1005 , temp_output_1_0_g1807 , temp_output_6_0_g1807);
				float4 blendOpSrc1273 = float4( PAT1066 , 0.0 );
				float4 blendOpDest1273 = ( temp_output_5_0_g1807 == 0.0 ? lerpResult14_g1807 : ( temp_output_5_0_g1807 == 2.0 ? lerpResult10_g1807 : temp_output_1_0_g1807 ) );
				...
				float ifLocalVar13_g1806 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1806 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1806 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_47 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_48 = (5.0).xxxx;
				float4 clampResult18_g1806 = clamp( ase_lightColor , temp_cast_47 , temp_cast_48 );
				float4 temp_output_11_0_g1806 = ( ase_atten * clampResult18_g1806 );
				float4 temp_output_8_0_g1806 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1806 = 0;
				if( ifLocalVar13_g1806 > 0.0 )
				ifLocalVar3_g1806 = temp_output_11_0_g1806;
				else if( ifLocalVar13_g1806 == 0.0 )
				ifLocalVar3_g1806 = temp_output_8_0_g1806;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1806 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1806 );
				#else
				float4 staticSwitch9_g1806 = ifLocalVar3_g1806;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1806;
				float temp_output_12_0_g1799 = ( ( ( temp_output_94_0_g1790 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1790 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1790 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1790 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1790 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				float SSSA581 = tex2DNode297.a;
				float temp_output_28_0_g1799 = ( _SSSAlphaEmissiveToggle * ( SSSA581 >= 0.5 ? _SSSAlphaEmissiveIntensity : 0.0 ) );
				float clampResult30_g1799 = clamp( ( temp_output_12_0_g1799 - temp_output_28_0_g1799 ) , 0.0 , temp_output_12_0_g1799 );
				...
				float EmissionRampMask920 = max( ( clampResult30_g1799 + temp_output_28_0_g1799 ) , ( tex2DNode1292.r * _EmissionMaskIntensity ) );
				float4 temp_cast_50 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1806 = 0;
				if( ifLocalVar13_g1806 > 0.0 )
				ifLocalVar17_g1806 = clampResult18_g1806;
				else if( ifLocalVar13_g1806 == 0.0 )
				ifLocalVar17_g1806 = temp_output_8_0_g1806;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1806 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1806 = max( temp_cast_50 , ifLocalVar17_g1806 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1806;
				...
				float temp_output_48_0_g1808 = _DebugGroup;
				float temp_output_47_0_g1808 = _VertexChannel;
				float4 temp_output_59_0_g1808 = _DebugColor;
				float temp_output_50_0_g1808 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1808 = appendResult1031;
				float4 break7_g1808 = temp_output_54_0_g1808;
				float temp_output_57_0_g1808 = _BaseSSSAlphaSwap;
				float4 Debug987 = ( temp_output_48_0_g1808 == 0.0 ? ( temp_output_47_0_g1808 == 0.0 ? i.ase_color : ( temp_output_47_0_g1808 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1808 ) : ( temp_output_47_0_g1808 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1808 ) : ( temp_output_47_0_g1808 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1808 ) : ( temp_output_47_0_g1808 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1808 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1808 == 1.0 ? ( temp_output_50_0_g1808 == 0.0 ? temp_output_54_0_g1808 : ( temp_output_50_0_g1808 == 1.0 ? ( break7_g1808.r * temp_output_59_0_g1808 ) : ( temp_output_50_0_g1808 == 2.0 ? ( break7_g1808.g * temp_output_59_0_g1808 ) : ( temp_output_50_0_g1808 == 3.0 ? ( break7_g1808.b * temp_output_59_0_g1808 ) : ( temp_output_50_0_g1808 == 4.0 ? ( break7_g1808.a * temp_output_59_0_g1808 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1808 == 2.0 ? ( temp_output_57_0_g1808 == 0.0 ? ( BaseA580 * temp_output_59_0_g1808 ) : ( temp_output_57_0_g1808 == 1.0 ? ( SSSA581 * temp_output_59_0_g1808 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1809 = _OutlineThickness;
				float3 temp_output_135_0_g1809 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1809 ) + temp_output_33_0_g1809 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1809 = ObjSpaceViewDir( float4( temp_output_135_0_g1809 , 0.0 ) );
				float4 normalizeResult142_g1809 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1809 , 0.0 ) - v.vertex ) );
				float clampResult141_g1809 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1809 = lerp( float4( temp_output_135_0_g1809 , 0.0 ) , -normalizeResult142_g1809 , ( 1.0 - clampResult141_g1809 ));
				

				v.vertex.xyz += lerpResult145_g1809.xyz;
...
/*ASEBEGIN
Version=18900
2825;223;2236;938;-3180.821;-2628.951;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1246;-773.3103,3658.812;Inherit;False;DNFD Shadow Priority Color Change;-1;;1694;6f70430ee27dd1841a12c4dce3941265;0;4;24;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;30;FLOAT;0;False;27;FLOAT;0;False;28;COLOR;0,0,0,0;False;2;COLOR;0;COLOR;23
...
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1691;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.FunctionNode;1085;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1695;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.RangedFloatNode;1289;4461.976,3098.44;Inherit;False;Property;_EmissionMaskIntensity;Emission Mask Intensity;111;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1261;5356.86,4424.475;Inherit;False;DNFD Line Priority Color Change;-1;;1807;16fce825486809843b5aabaeda9d4178;0;4;1;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1181;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1806;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;1;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1808;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1234;7017.036,6196.313;Inherit;False;ASWOutline - DNFD;-1;;1809;7598781ca2a4eab40b2e2ba76cac5428;0;5;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1188;8668.341,4363.591;Float;False;True;-1;2;ASWDNFDuelGUI;100;8;.Aerthas/Arc System Works/Game Select/DNF Duel/Opaque v8.1.0;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;True;2;0;False;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;True;True;False;;False;0
...
WireConnection;1282;1;1085;0
WireConnection;1282;3;1085;8
WireConnection;1282;2;1085;9
WireConnection;1282;7;729;0
WireConnection;1282;80;758;0
WireConnection;1282;8;746;0
WireConnection;1282;9;711;0
WireConnection;1282;121;1206;0
WireConnection;1282;10;716;0
WireConnection;1282;11;727;0
WireConnection;1282;120;1207;0
WireConnection;1282;12;731;0
WireConnection;1282;13;732;0
WireConnection;1282;97;922;0
WireConnection;1282;101;923;0
WireConnection;1282;104;924;0
WireConnection;1282;107;925;0
WireConnection;1282;110;926;0
...
WireConnection;1201;1;1282;100
WireConnection;1201;2;1282;103
WireConnection;1201;3;1282;106
WireConnection;1201;4;1282;109
WireConnection;1201;5;1282;112
WireConnection;1222;6;1282;76
WireConnection;1222;29;1282;69
WireConnection;1222;39;1282;62
WireConnection;1222;41;1282;0
...
ASEEND*/
//CHKSM=D4D259F42D3706425B833B5C2A5CE620B3108799