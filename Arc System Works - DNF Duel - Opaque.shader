...
Shader ".Aerthas/Arc System Works/Game Select/DNF Duel/Opaque v8.1.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1393_g1816(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0394_g1816(  )
			{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_5_0_g1835 = ILMColorSetting1007;
				...
				float ILMColorSetting60_g1813 = ILMColorSetting1007;
				float4 ILMAColor1005 = _ILMAlphaColor;
				float4 ILMAColor54_g1813 = ILMAColor1005;
				...
				float3x3 temp_output_24_0_g1813 = ( _EnableColorReplacer == 0.0 ? float3x3(linearToGamma1286, linearToGamma1287, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1807 == 5.0 ? lerpResult4_g1812 : ( temp_output_52_0_g1807 == 4.0 ? temp_output_105_0_g1807 : ( temp_output_52_0_g1807 == 3.0 ? temp_output_104_0_g1807 : ( temp_output_52_0_g1807 == 2.0 ? temp_output_102_0_g1807 : ( temp_output_52_0_g1807 == 1.0 ? temp_output_106_0_g1807 : float4( temp_output_67_0_g1807[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1812.rgb, float3( 0,0,0 )) );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1813 = ILMA357;
				float4 lerpResult12_g1813 = lerp( ILMAColor54_g1813 , float4( temp_output_24_0_g1813[0] , 0.0 ) , ILMA57_g1813);
				float4 Base339 = ( ILMColorSetting60_g1813 == 1.0 ? lerpResult12_g1813 : float4( temp_output_24_0_g1813[0] , 0.0 ) );
				float4 Base12_g1827 = Base339;
				...
				float3 localViewMatrix1393_g1816 = ViewMatrix1393_g1816();
				float3 normalizeResult396_g1816 = normalize( localViewMatrix1393_g1816 );
				float temp_output_395_0_g1816 = radians( -_ViewDirOffsetYaw );
				float3 localViewMatrix0394_g1816 = ViewMatrix0394_g1816();
				float3 normalizeResult399_g1816 = normalize( localViewMatrix0394_g1816 );
				float3 rotatedValue400_g1816 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult399_g1816, normalizeResult396_g1816, temp_output_395_0_g1816 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_408_0_g1816 = ( ase_worldPos - i.ase_texcoord4.xyz );
				float3 localStereoCameraViewPosition30_g1814 = StereoCameraViewPosition30_g1814();
				float3 rotatedValue401_g1816 = RotateAroundAxis( temp_output_408_0_g1816, localStereoCameraViewPosition30_g1814, normalizeResult396_g1816, temp_output_395_0_g1816 );
				float3 rotatedValue403_g1816 = RotateAroundAxis( temp_output_408_0_g1816, rotatedValue401_g1816, rotatedValue400_g1816, radians( _ViewDirOffsetPitch ) );
				float3 normalizeResult38_g1814 = normalize( ( rotatedValue403_g1816 - temp_output_408_0_g1816 ) );
				...
				float blendOpSrc34_g1817 = ILMB576;
				float blendOpDest34_g1817 = dotResult50_g1814;
				float clampResult87_g1824 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1817) / max( blendOpSrc34_g1817, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_31 = (clampResult87_g1824).xxxx;
				float4 blendOpSrc30_g1827 = Base12_g1827;
				float4 blendOpDest30_g1827 = temp_cast_31;
				float4 lerpBlendMode30_g1827 = lerp(blendOpDest30_g1827,min( blendOpSrc30_g1827 , blendOpDest30_g1827 ),0.9);
				float3 desaturateInitialColor9_g1830 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1827 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1830 = dot( desaturateInitialColor9_g1830, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1830 = lerp( desaturateInitialColor9_g1830, desaturateDot9_g1830.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1832 = ( ( float4( desaturateVar9_g1830 , 0.0 ) + Base12_g1827 ) * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1832 = dot( desaturateInitialColor9_g1832, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1832 = lerp( desaturateInitialColor9_g1832, desaturateDot9_g1832.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 blendOpSrc32_g1813 = temp_output_24_0_g1813[0];
				float3 blendOpDest32_g1813 = temp_output_24_0_g1813[1];
				float4 lerpResult17_g1813 = lerp( ( ILMAColor54_g1813 * float4( ( saturate( abs( blendOpSrc32_g1813 - blendOpDest32_g1813 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1813[1] , 0.0 ) , ILMA57_g1813);
				float4 SSS578 = ( ILMColorSetting60_g1813 == 1.0 ? lerpResult17_g1813 : float4( temp_output_24_0_g1813[1] , 0.0 ) );
				float4 SSS14_g1827 = SSS578;
				float3 desaturateInitialColor9_g1829 = ( SSS14_g1827 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1829 = dot( desaturateInitialColor9_g1829, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1829 = lerp( desaturateInitialColor9_g1829, desaturateDot9_g1829.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc108_g1827 = float4( 0,0,0,0 );
				float4 blendOpDest108_g1827 = Base12_g1827;
				float4 blendOpSrc51_g1827 = ( saturate( min( blendOpSrc108_g1827 , blendOpDest108_g1827 ) ));
				float4 blendOpDest51_g1827 = SSS14_g1827;
				float4 lerpBlendMode51_g1827 = lerp(blendOpDest51_g1827,2.0f*blendOpDest51_g1827*blendOpSrc51_g1827 + blendOpDest51_g1827*blendOpDest51_g1827*(1.0f - 2.0f*blendOpSrc51_g1827),0.5);
				float3 desaturateInitialColor9_g1828 = ( ( saturate( lerpBlendMode51_g1827 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1828 = dot( desaturateInitialColor9_g1828, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1828 = lerp( desaturateInitialColor9_g1828, desaturateDot9_g1828.xxx, ( 1.0 - _Shadow2Saturation ) );
				...
				float temp_output_36_0_g1817 = ( ( dotResult46_g1814 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1817 = ILMG574;
				float NdL20_g1824 = ( temp_output_36_0_g1817 * temp_output_1_0_g1817 );
				...
				float3 lerpResult100_g1827 = lerp( desaturateVar9_g1829 , desaturateVar9_g1828 , ( 1.0 - temp_output_43_0_g1824 ));
				float clampResult90_g1824 = clamp( ( 1.0 - ( temp_output_43_0_g1824 + temp_output_42_0_g1824 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1827 = clampResult90_g1824;
				float4 lerpResult101_g1827 = lerp( float4( desaturateVar9_g1832 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1827 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1827 ));
				...
				float3 desaturateInitialColor9_g1831 = ( ( Base12_g1827 * temp_output_94_0_g1824 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1831 = dot( desaturateInitialColor9_g1831, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1831 = lerp( desaturateInitialColor9_g1831, desaturateDot9_g1831.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1827 + float4( desaturateVar9_g1831 , 0.0 ) );
				float4 temp_output_1_0_g1835 = ColorOut1025;
				float temp_output_6_0_g1835 = ILMA357;
				float4 lerpResult14_g1835 = lerp( float4( 0,0,0,0 ) , temp_output_1_0_g1835 , temp_output_6_0_g1835);
				float4 lerpResult10_g1835 = lerp( ILMAColor1005 , temp_output_1_0_g1835 , temp_output_6_0_g1835);
				float4 blendOpSrc1273 = float4( PAT1066 , 0.0 );
				float4 blendOpDest1273 = ( temp_output_5_0_g1835 == 0.0 ? lerpResult14_g1835 : ( temp_output_5_0_g1835 == 2.0 ? lerpResult10_g1835 : temp_output_1_0_g1835 ) );
				...
				float ifLocalVar13_g1834 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1834 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1834 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_47 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_48 = (5.0).xxxx;
				float4 clampResult18_g1834 = clamp( ase_lightColor , temp_cast_47 , temp_cast_48 );
				float4 temp_output_11_0_g1834 = ( ase_atten * clampResult18_g1834 );
				float4 temp_output_8_0_g1834 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1834 = 0;
				if( ifLocalVar13_g1834 > 0.0 )
				ifLocalVar3_g1834 = temp_output_11_0_g1834;
				else if( ifLocalVar13_g1834 == 0.0 )
				ifLocalVar3_g1834 = temp_output_8_0_g1834;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1834 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1834 );
				#else
				float4 staticSwitch9_g1834 = ifLocalVar3_g1834;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1834;
				float temp_output_12_0_g1833 = ( ( ( temp_output_94_0_g1824 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1824 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1824 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1824 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1824 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				float SSSA581 = tex2DNode297.a;
				float temp_output_28_0_g1833 = ( _SSSAlphaEmissiveToggle * ( SSSA581 >= 0.5 ? _SSSAlphaEmissiveIntensity : 0.0 ) );
				float clampResult30_g1833 = clamp( ( temp_output_12_0_g1833 - temp_output_28_0_g1833 ) , 0.0 , temp_output_12_0_g1833 );
				...
				float EmissionRampMask920 = max( ( clampResult30_g1833 + temp_output_28_0_g1833 ) , ( tex2DNode1292.r * _EmissionMaskIntensity ) );
				float4 temp_cast_50 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1834 = 0;
				if( ifLocalVar13_g1834 > 0.0 )
				ifLocalVar17_g1834 = clampResult18_g1834;
				else if( ifLocalVar13_g1834 == 0.0 )
				ifLocalVar17_g1834 = temp_output_8_0_g1834;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1834 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1834 = max( temp_cast_50 , ifLocalVar17_g1834 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1834;
				...
				float temp_output_48_0_g1836 = _DebugGroup;
				float temp_output_47_0_g1836 = _VertexChannel;
				float4 temp_output_59_0_g1836 = _DebugColor;
				float temp_output_50_0_g1836 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1836 = appendResult1031;
				float4 break7_g1836 = temp_output_54_0_g1836;
				float temp_output_57_0_g1836 = _BaseSSSAlphaSwap;
				float4 Debug987 = ( temp_output_48_0_g1836 == 0.0 ? ( temp_output_47_0_g1836 == 0.0 ? i.ase_color : ( temp_output_47_0_g1836 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1836 ) : ( temp_output_47_0_g1836 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1836 ) : ( temp_output_47_0_g1836 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1836 ) : ( temp_output_47_0_g1836 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1836 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1836 == 1.0 ? ( temp_output_50_0_g1836 == 0.0 ? temp_output_54_0_g1836 : ( temp_output_50_0_g1836 == 1.0 ? ( break7_g1836.r * temp_output_59_0_g1836 ) : ( temp_output_50_0_g1836 == 2.0 ? ( break7_g1836.g * temp_output_59_0_g1836 ) : ( temp_output_50_0_g1836 == 3.0 ? ( break7_g1836.b * temp_output_59_0_g1836 ) : ( temp_output_50_0_g1836 == 4.0 ? ( break7_g1836.a * temp_output_59_0_g1836 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1836 == 2.0 ? ( temp_output_57_0_g1836 == 0.0 ? ( BaseA580 * temp_output_59_0_g1836 ) : ( temp_output_57_0_g1836 == 1.0 ? ( SSSA581 * temp_output_59_0_g1836 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_33_0_g1837 = _OutlineThickness;
				float3 temp_output_135_0_g1837 = ( ( v.ase_normal * 2E-05 ) * ( ( ( _EnableCameraDistanceMult * eyeDepth * v.ase_color.g * temp_output_33_0_g1837 ) + temp_output_33_0_g1837 ) * v.ase_color.a ) );
				float3 objectSpaceViewDir136_g1837 = ObjSpaceViewDir( float4( temp_output_135_0_g1837 , 0.0 ) );
				float4 normalizeResult142_g1837 = ASESafeNormalize( ( float4( objectSpaceViewDir136_g1837 , 0.0 ) - v.vertex ) );
				float clampResult141_g1837 = clamp( ( v.ase_color.b + _DepthOffset ) , 0.0 , 1.0 );
				float4 lerpResult145_g1837 = lerp( float4( temp_output_135_0_g1837 , 0.0 ) , -normalizeResult142_g1837 , ( 1.0 - clampResult141_g1837 ));
				

				v.vertex.xyz += lerpResult145_g1837.xyz;
...
/*ASEBEGIN
Version=18900
2975;274;1355;932;-2915.048;-3403.503;1.3;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1246;-773.3103,3658.812;Inherit;False;DNFD Shadow Priority Color Change;-1;;1813;6f70430ee27dd1841a12c4dce3941265;0;4;24;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;30;FLOAT;0;False;27;FLOAT;0;False;28;COLOR;0,0,0,0;False;2;COLOR;0;COLOR;23
...
Node;AmplifyShaderEditor.FunctionNode;1085;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1817;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;1181;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1834;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;1;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1261;5356.86,4424.475;Inherit;False;DNFD Line Priority Color Change;-1;;1835;16fce825486809843b5aabaeda9d4178;0;4;1;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1836;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1234;7017.036,6196.313;Inherit;False;ASWOutline - DNFD;-1;;1837;7598781ca2a4eab40b2e2ba76cac5428;0;5;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;2;COLOR;0;FLOAT4;109
...
ASEEND*/
//CHKSM=9FFF3ECD279B4BD11B98A91C775290EF190B38DC