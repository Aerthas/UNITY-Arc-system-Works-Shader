...
Shader ".Aerthas/Arc System Works/Game Select/DNF Duel/Transparent v8.1.3"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1418_g1539(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0417_g1539(  )
			{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_5_0_g1832 = ILMColorSetting1007;
				...
				float3 localViewMatrix1418_g1539 = ViewMatrix1418_g1539();
				float3 normalizeResult422_g1539 = normalize( localViewMatrix1418_g1539 );
				int localIsInMirror411_g1539 = ( unity_CameraProjection[2][0] != 0.f || unity_CameraProjection[2][1] != 0.f );
				float temp_output_297_0_g1539 = _ViewDirOffsetYaw;
				float temp_output_424_0_g1539 = radians( ( (float)localIsInMirror411_g1539 == 0.0 ? -temp_output_297_0_g1539 : temp_output_297_0_g1539 ) );
				float3 localViewMatrix0417_g1539 = ViewMatrix0417_g1539();
				float3 normalizeResult425_g1539 = normalize( localViewMatrix0417_g1539 );
				float3 rotatedValue428_g1539 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult425_g1539, normalizeResult422_g1539, temp_output_424_0_g1539 );
				float3 normalizeResult429_g1539 = normalize( rotatedValue428_g1539 );
				int localIsInMirror423_g1539 = ( unity_CameraProjection[2][0] != 0.f || unity_CameraProjection[2][1] != 0.f );
				float temp_output_296_0_g1539 = _ViewDirOffsetPitch;
				float3 localStereoCameraViewPosition30_g1537 = StereoCameraViewPosition30_g1537();
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 rotatedValue431_g1539 = RotateAroundAxis( float3( 0,0,0 ), ( localStereoCameraViewPosition30_g1537 - ( ase_worldPos - i.ase_texcoord4.xyz ) ), normalizeResult422_g1539, temp_output_424_0_g1539 );
				float3 rotatedValue432_g1539 = RotateAroundAxis( float3( 0,0,0 ), rotatedValue431_g1539, normalizeResult429_g1539, radians( ( (float)localIsInMirror423_g1539 == 0.0 ? temp_output_296_0_g1539 : -temp_output_296_0_g1539 ) ) );
				float3 normalizeResult433_g1539 = ASESafeNormalize( rotatedValue432_g1539 );
				float3 normalizeResult38_g1537 = normalize( normalizeResult433_g1539 );
				...
				float blendOpSrc34_g1541 = ILMB576;
				float blendOpDest34_g1541 = dotResult50_g1537;
				float clampResult87_g1818 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1541) / max( blendOpSrc34_g1541, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_33 = (clampResult87_g1818).xxxx;
				float4 blendOpSrc30_g1824 = Base12_g1824;
				float4 blendOpDest30_g1824 = temp_cast_33;
				...
				float temp_output_1087_0 = ( ( ( ( dotResult46_g1537 + _GlobalLightPush ) * i.ase_color.r ) * 0.5 ) + ( ( ILMG574 * 2.0 ) - 1.0 ) );
				...
				float NdV48_g1818 = ( ( 1.0 - ( dotResult31_g1537 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				...
				float4 temp_output_1_0_g1832 = ColorOut1025;
				float temp_output_6_0_g1832 = ILMA357;
				float4 lerpResult14_g1832 = lerp( float4( 0,0,0,0 ) , temp_output_1_0_g1832 , temp_output_6_0_g1832);
				float4 lerpResult10_g1832 = lerp( ILMAColor1005 , temp_output_1_0_g1832 , temp_output_6_0_g1832);
				float4 blendOpSrc1115 = float4( PAT1062 , 0.0 );
				float4 blendOpDest1115 = ( temp_output_5_0_g1832 == 0.0 ? lerpResult14_g1832 : ( temp_output_5_0_g1832 == 2.0 ? lerpResult10_g1832 : temp_output_1_0_g1832 ) );
				...
				float ifLocalVar13_g1831 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1831 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1831 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_49 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_50 = (5.0).xxxx;
				float4 clampResult18_g1831 = clamp( ase_lightColor , temp_cast_49 , temp_cast_50 );
				float4 temp_output_11_0_g1831 = ( ase_atten * clampResult18_g1831 );
				float4 temp_output_8_0_g1831 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1831 = 0;
				if( ifLocalVar13_g1831 > 0.0 )
				ifLocalVar3_g1831 = temp_output_11_0_g1831;
				else if( ifLocalVar13_g1831 == 0.0 )
				ifLocalVar3_g1831 = temp_output_8_0_g1831;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1831 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1831 );
				#else
				float4 staticSwitch9_g1831 = ifLocalVar3_g1831;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1831;
				...
				float4 ifLocalVar17_g1831 = 0;
				if( ifLocalVar13_g1831 > 0.0 )
				ifLocalVar17_g1831 = clampResult18_g1831;
				else if( ifLocalVar13_g1831 == 0.0 )
				ifLocalVar17_g1831 = temp_output_8_0_g1831;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1831 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1831 = max( temp_cast_52 , ifLocalVar17_g1831 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1831;
				...
				float temp_output_48_0_g1833 = _DebugGroup;
				float temp_output_47_0_g1833 = _VertexChannel;
				float4 temp_output_59_0_g1833 = _DebugColor;
				float temp_output_50_0_g1833 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1833 = appendResult1031;
				float4 break7_g1833 = temp_output_54_0_g1833;
				float temp_output_57_0_g1833 = _BaseSSSAlphaSwap;
				float4 Debug987 = ( temp_output_48_0_g1833 == 0.0 ? ( temp_output_47_0_g1833 == 0.0 ? i.ase_color : ( temp_output_47_0_g1833 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1833 ) : ( temp_output_47_0_g1833 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1833 ) : ( temp_output_47_0_g1833 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1833 ) : ( temp_output_47_0_g1833 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1833 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1833 == 1.0 ? ( temp_output_50_0_g1833 == 0.0 ? temp_output_54_0_g1833 : ( temp_output_50_0_g1833 == 1.0 ? ( break7_g1833.r * temp_output_59_0_g1833 ) : ( temp_output_50_0_g1833 == 2.0 ? ( break7_g1833.g * temp_output_59_0_g1833 ) : ( temp_output_50_0_g1833 == 3.0 ? ( break7_g1833.b * temp_output_59_0_g1833 ) : ( temp_output_50_0_g1833 == 4.0 ? ( break7_g1833.a * temp_output_59_0_g1833 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1833 == 2.0 ? ( temp_output_57_0_g1833 == 0.0 ? ( BaseA580 * temp_output_59_0_g1833 ) : ( temp_output_57_0_g1833 == 1.0 ? ( SSSA581 * temp_output_59_0_g1833 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
...
/*ASEBEGIN
Version=18900
2793;227;2049;932;-3235.908;-2743.905;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1087;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1541;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;1093;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1831;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1114;5319.187,4365.347;Inherit;False;DNFD Line Priority Color Change;-1;;1832;16fce825486809843b5aabaeda9d4178;0;4;1;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1833;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1117;5503.096,5102.752;Inherit;False;ASWOutline - DNFD;-1;;1834;7598781ca2a4eab40b2e2ba76cac5428;0;5;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;2;COLOR;0;FLOAT4;109
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1095;8484.438,4278.705;Float;False;True;-1;2;ASWDNFDuelGUI;100;8;.Aerthas/Arc System Works/Game Select/DNF Duel/Transparent v8.1.3;fd5163ddf7350f946aff871fd3d7e3fe;True;ForwardBase;0;0;ForwardBase;3;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;True;True;True;255;True;1038;255;True;1039;255;True;1040;7;True;1041;1;True;1042;1;True;1043;1;True;1044;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;1;True;1046;True;3;True;1052;True;True;0;True;1049;0;True;1050;True;1;LightMode=ForwardBase;True;2;0;;0;0;Standard;0;0;5;True;True;False;False;True;False;;False;0
...
ASEEND*/
//CHKSM=CBFD146C15CB7EC4FBD438BB73467793419E21F0