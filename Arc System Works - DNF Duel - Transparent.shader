...
Shader ".Aerthas/Arc System Works/Game Select/DNF Duel/Transparent v8.1.1"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1393_g1535(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0394_g1535(  )
			{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float3 localViewMatrix1393_g1535 = ViewMatrix1393_g1535();
				float3 normalizeResult396_g1535 = normalize( localViewMatrix1393_g1535 );
				float temp_output_395_0_g1535 = radians( -_ViewDirOffsetYaw );
				float3 localViewMatrix0394_g1535 = ViewMatrix0394_g1535();
				float3 normalizeResult399_g1535 = normalize( localViewMatrix0394_g1535 );
				float3 rotatedValue400_g1535 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult399_g1535, normalizeResult396_g1535, temp_output_395_0_g1535 );
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 temp_output_408_0_g1535 = ( ase_worldPos - i.ase_texcoord4.xyz );
				float3 localStereoCameraViewPosition30_g1533 = StereoCameraViewPosition30_g1533();
				float3 rotatedValue401_g1535 = RotateAroundAxis( temp_output_408_0_g1535, localStereoCameraViewPosition30_g1533, normalizeResult396_g1535, temp_output_395_0_g1535 );
				float3 rotatedValue403_g1535 = RotateAroundAxis( temp_output_408_0_g1535, rotatedValue401_g1535, rotatedValue400_g1535, radians( _ViewDirOffsetPitch ) );
				float3 normalizeResult38_g1533 = normalize( ( rotatedValue403_g1535 - temp_output_408_0_g1535 ) );
				...
				float blendOpSrc34_g1537 = ILMB576;
				float blendOpDest34_g1537 = dotResult50_g1533;
				float clampResult87_g1818 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1537) / max( blendOpSrc34_g1537, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				...
				float temp_output_36_0_g1537 = ( ( dotResult46_g1533 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1537 = ILMG574;
				float temp_output_1087_0 = ( temp_output_36_0_g1537 * temp_output_1_0_g1537 );
				...
				float4 clampResult18_g1831 = clamp( ase_lightColor , temp_cast_47 , temp_cast_48 );
				...
				#else
				float4 staticSwitch30_g1831 = max( temp_cast_50 , ifLocalVar17_g1831 );
				#endif
...
/*ASEBEGIN
Version=18900
2975;274;1355;932;-3582.908;-2743.905;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1087;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1537;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
ASEEND*/
//CHKSM=3895225810696ED2F25FF23C159A703360D910BA