...
Shader ".Aerthas/Arc System Works/Game Select/DNF Duel/Transparent v8.1.4"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float3 ViewMatrix1418_g1543(  )
			{
				return UNITY_MATRIX_V[1];
			}
			
			float3 ViewMatrix0417_g1543(  )
			{
			...
			float3 StereoCameraViewPosition30_g1541(  )
			{
			...
			float3 StereoCameraViewDirection32_g1541( float3 worldPos )
			{
				#if UNITY_SINGLE_PASS_STEREO
				float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
				#else
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_5_0_g1838 = ILMColorSetting1007;
				...
				float ILMColorSetting60_g1540 = ILMColorSetting1007;
				float4 ILMAColor1005 = _ILMAlphaColor;
				float4 ILMAColor54_g1540 = ILMAColor1005;
				...
				float3x3 temp_output_24_0_g1540 = ( _EnableColorReplacer == 0.0 ? float3x3(linearToGamma1112, linearToGamma1113, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1496 == 5.0 ? lerpResult4_g1501 : ( temp_output_52_0_g1496 == 4.0 ? temp_output_105_0_g1496 : ( temp_output_52_0_g1496 == 3.0 ? temp_output_104_0_g1496 : ( temp_output_52_0_g1496 == 2.0 ? temp_output_102_0_g1496 : ( temp_output_52_0_g1496 == 1.0 ? temp_output_106_0_g1496 : float4( temp_output_67_0_g1496[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1501.rgb, float3( 0,0,0 )) );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1540 = ILMA357;
				float4 lerpResult12_g1540 = lerp( ILMAColor54_g1540 , float4( temp_output_24_0_g1540[0] , 0.0 ) , ILMA57_g1540);
				float4 Base1076 = ( ILMColorSetting60_g1540 == 1.0 ? lerpResult12_g1540 : float4( temp_output_24_0_g1540[0] , 0.0 ) );
				float4 Base12_g1831 = Base1076;
				...
				float3 localViewMatrix1418_g1543 = ViewMatrix1418_g1543();
				float3 normalizeResult422_g1543 = normalize( localViewMatrix1418_g1543 );
				int localIsInMirror411_g1543 = ( unity_CameraProjection[2][0] != 0.f || unity_CameraProjection[2][1] != 0.f );
				float temp_output_297_0_g1543 = _ViewDirOffsetYaw;
				float temp_output_424_0_g1543 = radians( ( (float)localIsInMirror411_g1543 == 0.0 ? -temp_output_297_0_g1543 : temp_output_297_0_g1543 ) );
				float3 localViewMatrix0417_g1543 = ViewMatrix0417_g1543();
				float3 normalizeResult425_g1543 = normalize( localViewMatrix0417_g1543 );
				float3 rotatedValue428_g1543 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult425_g1543, normalizeResult422_g1543, temp_output_424_0_g1543 );
				float3 normalizeResult429_g1543 = normalize( rotatedValue428_g1543 );
				int localIsInMirror423_g1543 = ( unity_CameraProjection[2][0] != 0.f || unity_CameraProjection[2][1] != 0.f );
				float temp_output_296_0_g1543 = _ViewDirOffsetPitch;
				float3 localStereoCameraViewPosition30_g1541 = StereoCameraViewPosition30_g1541();
				float3 ase_worldPos = i.ase_texcoord3.xyz;
				float3 rotatedValue431_g1543 = RotateAroundAxis( float3( 0,0,0 ), ( localStereoCameraViewPosition30_g1541 - ( ase_worldPos - i.ase_texcoord4.xyz ) ), normalizeResult422_g1543, temp_output_424_0_g1543 );
				float3 rotatedValue432_g1543 = RotateAroundAxis( float3( 0,0,0 ), rotatedValue431_g1543, normalizeResult429_g1543, radians( ( (float)localIsInMirror423_g1543 == 0.0 ? temp_output_296_0_g1543 : -temp_output_296_0_g1543 ) ) );
				float3 normalizeResult433_g1543 = ASESafeNormalize( rotatedValue432_g1543 );
				float3 normalizeResult38_g1541 = normalize( normalizeResult433_g1543 );
				float3 appendResult15_g1542 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
				float3 normalizeResult2_g1542 = normalize( appendResult15_g1542 );
				float3 normalizeResult26_g1541 = normalize( normalizeResult2_g1542 );
				float3 ifLocalVar3_g1541 = 0;
				if( FallbackLightDirection563 > 0.0 )
				ifLocalVar3_g1541 = normalizeResult38_g1541;
				else if( FallbackLightDirection563 == 0.0 )
				ifLocalVar3_g1541 = normalizeResult26_g1541;
				...
				float3 ifLocalVar8_g1541 = 0;
				if( IsThereWorldLight450 > 0.0 )
				ifLocalVar8_g1541 = worldSpaceLightDir;
				else if( IsThereWorldLight450 == 0.0 )
				ifLocalVar8_g1541 = ifLocalVar3_g1541;
				float3 ifLocalVar9_g1541 = 0;
				if( LightDirectionSetting561 > 0.0 )
				ifLocalVar9_g1541 = ifLocalVar3_g1541;
				else if( LightDirectionSetting561 == 0.0 )
				ifLocalVar9_g1541 = ifLocalVar8_g1541;
				float3 normalizeResult48_g1541 = normalize( ifLocalVar9_g1541 );
				float3 worldPos32_g1541 = ase_worldPos;
				float3 localStereoCameraViewDirection32_g1541 = StereoCameraViewDirection32_g1541( worldPos32_g1541 );
				float3 normalizeResult51_g1541 = normalize( ( normalizeResult48_g1541 + localStereoCameraViewDirection32_g1541 ) );
				float dotResult50_g1541 = dot( normalizedWorldNormal , normalizeResult51_g1541 );
				float blendOpSrc34_g1544 = ILMB576;
				float blendOpDest34_g1544 = dotResult50_g1541;
				float clampResult87_g1818 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1544) / max( blendOpSrc34_g1544, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				float4 temp_cast_33 = (clampResult87_g1818).xxxx;
				float4 blendOpSrc30_g1831 = Base12_g1831;
				float4 blendOpDest30_g1831 = temp_cast_33;
				float4 lerpBlendMode30_g1831 = lerp(blendOpDest30_g1831,min( blendOpSrc30_g1831 , blendOpDest30_g1831 ),0.9);
				float3 desaturateInitialColor9_g1834 = ( ( ILMR573 * ( saturate( lerpBlendMode30_g1831 )) ) * float4( 1,1,1,0 ) * _SpecularIntensity * _SpecularTint ).rgb;
				float desaturateDot9_g1834 = dot( desaturateInitialColor9_g1834, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1834 = lerp( desaturateInitialColor9_g1834, desaturateDot9_g1834.xxx, ( 1.0 - _SpecularSaturation ) );
				float4 LightColor779 = _LightColor;
				float3 desaturateInitialColor9_g1836 = ( ( float4( desaturateVar9_g1834 , 0.0 ) + Base12_g1831 ) * LightColor779 * _BaseIntensity * _BaseTint ).rgb;
				float desaturateDot9_g1836 = dot( desaturateInitialColor9_g1836, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1836 = lerp( desaturateInitialColor9_g1836, desaturateDot9_g1836.xxx, ( 1.0 - _BaseSaturation ) );
				float4 AmbientColor780 = _AmbientColor;
				float3 blendOpSrc32_g1540 = temp_output_24_0_g1540[0];
				float3 blendOpDest32_g1540 = temp_output_24_0_g1540[1];
				float4 lerpResult17_g1540 = lerp( ( ILMAColor54_g1540 * float4( ( saturate( abs( blendOpSrc32_g1540 - blendOpDest32_g1540 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1540[1] , 0.0 ) , ILMA57_g1540);
				float4 SSS1077 = ( ILMColorSetting60_g1540 == 1.0 ? lerpResult17_g1540 : float4( temp_output_24_0_g1540[1] , 0.0 ) );
				float4 SSS14_g1831 = SSS1077;
				float3 desaturateInitialColor9_g1833 = ( SSS14_g1831 * float4( 1,1,1,0 ) * _Shadow1Intensity * _Shadow1Tint ).rgb;
				float desaturateDot9_g1833 = dot( desaturateInitialColor9_g1833, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1833 = lerp( desaturateInitialColor9_g1833, desaturateDot9_g1833.xxx, ( 1.0 - _Shadow1Saturation ) );
				float4 blendOpSrc108_g1831 = float4( 0,0,0,0 );
				float4 blendOpDest108_g1831 = Base12_g1831;
				float4 blendOpSrc51_g1831 = ( saturate( min( blendOpSrc108_g1831 , blendOpDest108_g1831 ) ));
				float4 blendOpDest51_g1831 = SSS14_g1831;
				float4 lerpBlendMode51_g1831 = lerp(blendOpDest51_g1831,2.0f*blendOpDest51_g1831*blendOpSrc51_g1831 + blendOpDest51_g1831*blendOpDest51_g1831*(1.0f - 2.0f*blendOpSrc51_g1831),0.5);
				float3 desaturateInitialColor9_g1832 = ( ( saturate( lerpBlendMode51_g1831 )) * float4( 1,1,1,0 ) * _Shadow2Intensity * _Shadow2Tint ).rgb;
				float desaturateDot9_g1832 = dot( desaturateInitialColor9_g1832, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1832 = lerp( desaturateInitialColor9_g1832, desaturateDot9_g1832.xxx, ( 1.0 - _Shadow2Saturation ) );
				float temp_output_126_0_g1818 = pow( i.ase_color.r , 2.2 );
				float VertexR33_g1818 = temp_output_126_0_g1818;
				float dotResult46_g1541 = dot( ifLocalVar9_g1541 , normalizedWorldNormal );
				float ILMG574 = break292.y;
				float temp_output_1087_0 = ( ( ( ( dotResult46_g1541 + _GlobalLightPush ) * i.ase_color.r ) * 0.5 ) + ( ( ILMG574 * 2.0 ) - 1.0 ) );
				...
				float3 lerpResult100_g1831 = lerp( desaturateVar9_g1833 , desaturateVar9_g1832 , ( 1.0 - temp_output_43_0_g1818 ));
				float clampResult90_g1818 = clamp( ( 1.0 - ( temp_output_43_0_g1818 + temp_output_42_0_g1818 ) ) , 0.0 , 1.0 );
				float temp_output_39_0_g1831 = clampResult90_g1818;
				float4 lerpResult101_g1831 = lerp( float4( desaturateVar9_g1836 , 0.0 ) , ( AmbientColor780 * float4( lerpResult100_g1831 , 0.0 ) ) , ( 1.0 - temp_output_39_0_g1831 ));
				float EnableRimlight82_g1818 = _EnableRimlight;
				float dotResult31_g1541 = dot( normalizedWorldNormal , localStereoCameraViewDirection32_g1541 );
				float BaseA580 = tex2DNode296.a;
				float NdV48_g1818 = ( ( 1.0 - ( dotResult31_g1541 + ( 1.0 - _RimlightSize ) ) ) * BaseA580 );
				...
				float3 desaturateInitialColor9_g1835 = ( ( Base12_g1831 * temp_output_94_0_g1818 ) * float4( 1,1,1,0 ) * _RimlightIntensity * _RimlightTint ).rgb;
				float desaturateDot9_g1835 = dot( desaturateInitialColor9_g1835, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar9_g1835 = lerp( desaturateInitialColor9_g1835, desaturateDot9_g1835.xxx, ( 1.0 - _RimlightSaturation ) );
				float4 ColorOut1025 = ( lerpResult101_g1831 + float4( desaturateVar9_g1835 , 0.0 ) );
				float4 temp_output_1_0_g1838 = ColorOut1025;
				float temp_output_6_0_g1838 = ILMA357;
				float4 lerpResult14_g1838 = lerp( float4( 0,0,0,0 ) , temp_output_1_0_g1838 , temp_output_6_0_g1838);
				float4 lerpResult10_g1838 = lerp( ILMAColor1005 , temp_output_1_0_g1838 , temp_output_6_0_g1838);
				float4 blendOpSrc1115 = float4( PAT1062 , 0.0 );
				float4 blendOpDest1115 = ( temp_output_5_0_g1838 == 0.0 ? lerpResult14_g1838 : ( temp_output_5_0_g1838 == 2.0 ? lerpResult10_g1838 : temp_output_1_0_g1838 ) );
				...
				float ifLocalVar13_g1837 = 0;
				if( LightColorSetting872 == 1.0 )
				ifLocalVar13_g1837 = 0.0;
				else if( LightColorSetting872 < 1.0 )
				ifLocalVar13_g1837 = IsThereWorldLight450;
				UNITY_LIGHT_ATTENUATION(ase_atten, i, ase_worldPos)
				float4 temp_cast_49 = (_MinimumGlobalLightIntensity).xxxx;
				float4 temp_cast_50 = (5.0).xxxx;
				float4 clampResult18_g1837 = clamp( ase_lightColor , temp_cast_49 , temp_cast_50 );
				float4 temp_output_11_0_g1837 = ( ase_atten * clampResult18_g1837 );
				float4 temp_output_8_0_g1837 = ( _FakeGlobalLightColor * _FakeGlobalLightIntensity );
				float4 ifLocalVar3_g1837 = 0;
				if( ifLocalVar13_g1837 > 0.0 )
				ifLocalVar3_g1837 = temp_output_11_0_g1837;
				else if( ifLocalVar13_g1837 == 0.0 )
				ifLocalVar3_g1837 = temp_output_8_0_g1837;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch9_g1837 = max( float4( 0,0,0,0 ) , temp_output_11_0_g1837 );
				#else
				float4 staticSwitch9_g1837 = ifLocalVar3_g1837;
				#endif
				float4 GlobalLightColor944 = staticSwitch9_g1837;
				float temp_output_12_0_g1830 = ( ( ( temp_output_94_0_g1818 * _RimlightEmissiveToggle ) * _RimlightEmissionIntensity ) + ( ( clampResult87_g1818 * _SpecularEmissiveToggle ) * _SpecularEmissionIntensity ) + ( ( clampResult90_g1818 * _BaseEmissiveToggle ) * _BaseEmissionIntensity ) + ( ( temp_output_43_0_g1818 * _Shadow1EmissiveToggle ) * _Shadow1EmissionIntensity ) + ( ( clampResult91_g1818 * _Shadow2EmissiveToggle ) * _Shadow2EmissionIntensity ) + ( ( 1.0 - ILMA357 ) * ( _ILMAlphaEmissionIntensity * _ILMAlphaLinesEmissionToggle ) ) );
				float SSSA581 = tex2DNode297.a;
				float temp_output_28_0_g1830 = ( _SSSAlphaEmissiveToggle * ( SSSA581 >= 0.5 ? _SSSAlphaEmissiveIntensity : 0.0 ) );
				float clampResult30_g1830 = clamp( ( temp_output_12_0_g1830 - temp_output_28_0_g1830 ) , 0.0 , temp_output_12_0_g1830 );
				float2 uv_EmissionMask = i.ase_texcoord1.zw * _EmissionMask_ST.xy + _EmissionMask_ST.zw;
				float EmissionRampMask920 = max( ( clampResult30_g1830 + temp_output_28_0_g1830 ) , ( tex2D( _EmissionMask, uv_EmissionMask ).r * _EmissionMaskIntensity ) );
				float4 temp_cast_52 = (EmissionRampMask920).xxxx;
				float4 ifLocalVar17_g1837 = 0;
				if( ifLocalVar13_g1837 > 0.0 )
				ifLocalVar17_g1837 = clampResult18_g1837;
				else if( ifLocalVar13_g1837 == 0.0 )
				ifLocalVar17_g1837 = temp_output_8_0_g1837;
				#ifdef UNITY_PASS_FORWARDADD
				float4 staticSwitch30_g1837 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch30_g1837 = max( temp_cast_52 , ifLocalVar17_g1837 );
				#endif
				float4 EmissionLightColor947 = staticSwitch30_g1837;
				...
				float temp_output_48_0_g1839 = _DebugGroup;
				float temp_output_47_0_g1839 = _VertexChannel;
				float4 temp_output_59_0_g1839 = _DebugColor;
				float temp_output_50_0_g1839 = _ILMChannel;
				float3 ILM988 = linearToGamma277;
				float4 appendResult1031 = (float4(ILM988 , ILMA357));
				float4 temp_output_54_0_g1839 = appendResult1031;
				float4 break7_g1839 = temp_output_54_0_g1839;
				float temp_output_57_0_g1839 = _BaseSSSAlphaSwap;
				float4 Debug987 = ( temp_output_48_0_g1839 == 0.0 ? ( temp_output_47_0_g1839 == 0.0 ? i.ase_color : ( temp_output_47_0_g1839 == 1.0 ? ( i.ase_color.r * temp_output_59_0_g1839 ) : ( temp_output_47_0_g1839 == 2.0 ? ( i.ase_color.g * temp_output_59_0_g1839 ) : ( temp_output_47_0_g1839 == 3.0 ? ( i.ase_color.b * temp_output_59_0_g1839 ) : ( temp_output_47_0_g1839 == 4.0 ? ( i.ase_color.a * temp_output_59_0_g1839 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1839 == 1.0 ? ( temp_output_50_0_g1839 == 0.0 ? temp_output_54_0_g1839 : ( temp_output_50_0_g1839 == 1.0 ? ( break7_g1839.r * temp_output_59_0_g1839 ) : ( temp_output_50_0_g1839 == 2.0 ? ( break7_g1839.g * temp_output_59_0_g1839 ) : ( temp_output_50_0_g1839 == 3.0 ? ( break7_g1839.b * temp_output_59_0_g1839 ) : ( temp_output_50_0_g1839 == 4.0 ? ( break7_g1839.a * temp_output_59_0_g1839 ) : float4( 0,0,0,0 ) ) ) ) ) ) : ( temp_output_48_0_g1839 == 2.0 ? ( temp_output_57_0_g1839 == 0.0 ? ( BaseA580 * temp_output_59_0_g1839 ) : ( temp_output_57_0_g1839 == 1.0 ? ( SSSA581 * temp_output_59_0_g1839 ) : float4( 0,0,0,0 ) ) ) : float4( 0,0,0,0 ) ) ) );
...
/*ASEBEGIN
Version=18900
2961;197;2049;932;3207.352;-2540.975;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;1110;-840.9477,3575.483;Inherit;False;DNFD Shadow Priority Color Change;-1;;1540;6f70430ee27dd1841a12c4dce3941265;0;4;24;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;30;FLOAT;0;False;27;FLOAT;0;False;28;COLOR;0,0,0,0;False;2;COLOR;0;COLOR;23
Node;AmplifyShaderEditor.FunctionNode;637;1422.762,3657.256;Inherit;False;Dot Creation;-1;;1541;fd90efbfe94791944bc1c5b55d8d67e4;0;7;12;FLOAT;0;False;17;FLOAT;0;False;16;FLOAT;0;False;29;FLOAT;0;False;28;FLOAT;0;False;33;FLOAT;0;False;34;FLOAT;0;False;3;FLOAT;0;FLOAT;42;FLOAT;52
...
Node;AmplifyShaderEditor.FunctionNode;1087;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1544;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
Node;AmplifyShaderEditor.FunctionNode;1114;5319.187,4365.347;Inherit;False;DNFD Line Priority Color Change;-1;;1838;16fce825486809843b5aabaeda9d4178;0;4;1;COLOR;0,0,0,0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1093;-1427.66,4325.012;Inherit;False;Light Color Calculation;-1;;1837;5b8f5c3f2a647dc4d89d921c89ebb0e5;0;7;25;FLOAT;0;False;10;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;6;COLOR;0,0,0,0;False;7;FLOAT;0;False;19;FLOAT;0;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;1033;152.7226,6096.615;Inherit;False;Debug;-1;;1839;6f93fc90e278e9a449a8e28c4cbb4ee4;0;8;48;FLOAT;0;False;59;COLOR;0,0,0,0;False;47;FLOAT;0;False;50;FLOAT;0;False;54;COLOR;0,0,0,0;False;57;FLOAT;0;False;55;FLOAT;0;False;56;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1117;5503.096,5102.752;Inherit;False;ASWOutline - DNFD;-1;;1840;7598781ca2a4eab40b2e2ba76cac5428;0;5;33;FLOAT;0;False;47;FLOAT;0;False;127;FLOAT;0.5;False;35;COLOR;0,0,0,0;False;37;FLOAT;0;False;2;COLOR;0;FLOAT4;109
...
ASEEND*/
//CHKSM=15E2529210BD98D13B7E00CB9A07B4871CB32064