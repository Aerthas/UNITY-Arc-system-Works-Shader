...
Shader ".Aerthas/Arc System Works/Game Select/DNF Duel/Transparent v8.1.2"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				float ILMColorSetting60_g1536 = ILMColorSetting1007;
				float4 ILMAColor1005 = _ILMAlphaColor;
				float4 ILMAColor54_g1536 = ILMAColor1005;
				...
				float3x3 temp_output_24_0_g1536 = ( _EnableColorReplacer == 0.0 ? float3x3(linearToGamma1112, linearToGamma1113, float3( 0,0,0 )) : float3x3(( temp_output_52_0_g1496 == 5.0 ? lerpResult4_g1501 : ( temp_output_52_0_g1496 == 4.0 ? temp_output_105_0_g1496 : ( temp_output_52_0_g1496 == 3.0 ? temp_output_104_0_g1496 : ( temp_output_52_0_g1496 == 2.0 ? temp_output_102_0_g1496 : ( temp_output_52_0_g1496 == 1.0 ? temp_output_106_0_g1496 : float4( temp_output_67_0_g1496[0] , 0.0 ) ) ) ) ) ).rgb, lerpResult19_g1501.rgb, float3( 0,0,0 )) );
				float ILMA357 = tex2DNode274.a;
				float ILMA57_g1536 = ILMA357;
				float4 lerpResult12_g1536 = lerp( ILMAColor54_g1536 , float4( temp_output_24_0_g1536[0] , 0.0 ) , ILMA57_g1536);
				float4 Base1076 = ( ILMColorSetting60_g1536 == 1.0 ? lerpResult12_g1536 : float4( temp_output_24_0_g1536[0] , 0.0 ) );
				...
				float blendOpSrc34_g1540 = ILMB576;
				float blendOpDest34_g1540 = dotResult50_g1537;
				float clampResult87_g1818 = clamp( ( ( saturate( ( 1.0 - ( ( 1.0 - blendOpDest34_g1540) / max( blendOpSrc34_g1540, 0.00001) ) ) )) > ( 1.0 - _SpecularSize ) ? 1.0 : 0.0 ) , 0.0 , 1.0 );
				...
				float3 blendOpSrc32_g1536 = temp_output_24_0_g1536[0];
				float3 blendOpDest32_g1536 = temp_output_24_0_g1536[1];
				float4 lerpResult17_g1536 = lerp( ( ILMAColor54_g1536 * float4( ( saturate( abs( blendOpSrc32_g1536 - blendOpDest32_g1536 ) )) , 0.0 ) ) , float4( temp_output_24_0_g1536[1] , 0.0 ) , ILMA57_g1536);
				float4 SSS1077 = ( ILMColorSetting60_g1536 == 1.0 ? lerpResult17_g1536 : float4( temp_output_24_0_g1536[1] , 0.0 ) );
				...
				float temp_output_36_0_g1540 = ( ( dotResult46_g1537 + _GlobalLightPush ) * i.ase_color.r );
				float ILMG574 = break292.y;
				float temp_output_1_0_g1540 = ILMG574;
				float temp_output_1087_0 = ( temp_output_36_0_g1540 * temp_output_1_0_g1540 );
...
Node;AmplifyShaderEditor.FunctionNode;1110;-840.9477,3575.483;Inherit;False;DNFD Shadow Priority Color Change;-1;;1536;6f70430ee27dd1841a12c4dce3941265;0;4;24;FLOAT3x3;0,0,0,1,1,1,1,0,1;False;30;FLOAT;0;False;27;FLOAT;0;False;28;COLOR;0,0,0,0;False;2;COLOR;0;COLOR;23
...
Node;AmplifyShaderEditor.FunctionNode;1087;2640,3664;Inherit;False;Final Dot Calculation Strive;-1;;1540;7fa0b619a5202f24c92b4cfbdde5487f;0;8;5;FLOAT;0;False;21;FLOAT;0;False;6;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;11;FLOAT;0;False;10;FLOAT;0;False;3;FLOAT;0;FLOAT;8;FLOAT;9
...
ASEEND*/
//CHKSM=44D85C0F5FBA65AE157DEA725F5AF09D3F15ACA8